  ...
  for (int i = 0; i < permutations.size(); i++) {
    ...
    processes[name] = {
      node("bedrock-" + permutation.os) {
        echo "Slave checkout"
        git([branch: "master", url:'ssh://git@stash:7999/tbio/phoenix.git', credentialsId: '8aa93893-84cc-45fc-a029-a42f21197bb3'])
        ...
        sshagent(credentials: ['8aa93893-84cc-45fc-a029-a42f21197bb3']) {
          ...
          extBedrock(permutation.name, permutation.browser, "src/test/ts")
        }
      }
    }
  }
