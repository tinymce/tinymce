define(
  ...
  function (Coupling, Disabling, Docking, Dragging, Focusing, Toggling, DomDefinition, AlloyTags, FieldPresence, FieldSchema, Objects, ValueSchema, Arr, Merger, Fun, Error) {
