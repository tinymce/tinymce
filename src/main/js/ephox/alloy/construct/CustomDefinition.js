define(
  ...
  function (Coupling, Disabling, Docking, Dragging, Focusing, Highlighting, Toggling, DomDefinition, AlloyTags, FieldPresence, FieldSchema, Objects, ValueSchema, Arr, Merger, Fun, Error) {
