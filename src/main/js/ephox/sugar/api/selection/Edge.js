define(
  'ephox.sugar.api.selection.Edge',
  ...
  function (Compare, Awareness, CursorPosition) {
    ...
    // This is doing exactly the same thing as the above isLeft method, checking to see if an element/offset selection endpoint is at the left edge of it's parent
    // after ascending up to that parent except we explicitly provide the element and it's offset instead of just using the selection object.
