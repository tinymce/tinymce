...
const focusBehaviours = <V>(detail: InputDetail): Behaviour.AlloyBehaviourRecord => {
...
const behaviours = <V>(detail: InputDetail): Behaviour.AlloyBehaviourRecord => {
...
const dom = <V>(detail: InputDetail): RawDomSchema => {
  return {
    tag: detail.tag(),
