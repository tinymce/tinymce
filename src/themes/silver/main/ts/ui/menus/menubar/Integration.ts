...
const defaultMenus = {
  ...
  format: { title: 'Format', items: 'forecolor | bold italic underline strikethrough superscript subscript codeformat | formats blockformats fontformats fontsizes align | removeformat' },
