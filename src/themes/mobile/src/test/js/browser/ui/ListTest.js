asynctest(
  ...
  function (GeneralSteps, Pipeline, Replacing, Memento, GuiSetup, TinyApis, TinyLoader, Body, Traverse, Features, TestTheme, TestUi, FormatChangers) {
    ...
    TestTheme.setup(body).use(
      function (realm, toolbar, socket) {
