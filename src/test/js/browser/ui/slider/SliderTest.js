asynctest(
  ...
  function (
    Chain, FocusTools, Keyboard, Keys, Logger, NamedChain, RawAssertions, Step, UiFinder, Waiter, Keying, Representing, GuiFactory, Slider, GuiSetup, PhantomSkipper,
    Fun, Result, navigator
  ) {
