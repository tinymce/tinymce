test(
  ...
  function (Truncate, Arbitraries, Assertions, Generators, Arr, Json, Attr, Body, Compare, Css, Insert, Node, PredicateFilter, Remove, SelectorFilter, Text, Traverse, Jsc) {
