define(
  ...
  function (InputHandlers, SelectionKeys, TableSelection, SelectionRange, WindowSelection, Fun, Option, TableLookup, Compare, DomEvent, MouseEvent, Element, Direction) {
