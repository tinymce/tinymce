...
UnitTest.asynctest('browser.tinymce.plugins.codesample.DblClickCodesampleTest', (success, failure) => {
  ...
  TinyLoader.setup(function (editor, onSuccess, onFailure) {
    ...
    Pipeline.async({},
      Log.steps('TBA', 'CodeSample: TBA-Open the dialog and check it has the right initial values. Set the codesample content, submit and check the editor content changes correctly. Double-click on the editor and check if the dialog opens with the correct language and content.', [
