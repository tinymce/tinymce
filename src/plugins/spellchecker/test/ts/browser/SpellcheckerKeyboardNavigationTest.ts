...
UnitTest.asynctest('browser.tinymce.plugins.spellchecker.SpellcheckerTest', function () {
  ...
  TinyLoader.setup(function (editor, onSuccess, onFailure) {
    ...
    Pipeline.async({}, Log.steps('TBA', 'Spellchecker: Reaching the spellchecker via the keyboard', [
      ...
      sFocusToolbar,
      sAssertFocused('File menu item', '.tox-mbtn:contains("File")'),
      sPressRight,
      sAssertFocused('Edit', '.tox-mbtn:contains("Edit")'),
      sPressRight,
      sAssertFocused('Edit', '.tox-mbtn:contains("View")'),
      sPressRight,
      sAssertFocused('Edit', '.tox-mbtn:contains("Insert")'),
      sPressRight,
      sAssertFocused('Edit', '.tox-mbtn:contains("Format")'),
      sPressRight,
      sAssertFocused('Edit', '.tox-mbtn:contains("Tools")'),
      sPressDown,
