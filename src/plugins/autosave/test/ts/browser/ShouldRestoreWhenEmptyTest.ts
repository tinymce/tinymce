...
UnitTest.asynctest('browser.tinymce.plugins.autosave.ShouldRestoreWhenEmptyTest', (success, failure) => {
  ...
  Pipeline.async({}, [
    Logger.t('should restore draft when empty with setting', Chain.asStep({}, [
      McEditor.cFromSettings({ skin_url: '/project/js/tinymce/skins/ui/oxide', plugins: 'autosave', autosave_prefix: testingPrefix }),
      ...
      McEditor.cRemove,
      McEditor.cFromSettings({ autosave_restore_when_empty: true, skin_url: '/project/js/tinymce/skins/ui/oxide', plugins: 'autosave', autosave_prefix: testingPrefix }),
      cAssertHasDraft(true),
