...
//		});
	...
	insert : function() {
		// Insert the contents from the input into the document
                ...
                var iframe = '<iframe src="https://apps.groupdocs.com/signature2/forms/SignEmbed/'+file_id+'?referer=TinyMCE-Signature/2.0" frameborder="0" width="'+width+'" height="'+height+'">'+
...
tinyMCEPopup.onInit.add(Groupdocs_signatureDialog.init, Groupdocs_signatureDialog);
