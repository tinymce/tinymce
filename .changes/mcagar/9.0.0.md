...
- `TinyState.withNoneditableRootEditor` and `TinyState.withNoneditableRootEditorAsync` now call the setEditableRoot API
  instead of using direct dom mutation. #TINY-10304
