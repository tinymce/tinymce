...
### Added
- New `removeCommand` to `editorCommands` API to remove existing commands. #TINY-13144
- New options `files_upload_handler`, `documents_file_types`, and `link_uploadtab` to the Link plugin. #TINY-13278
