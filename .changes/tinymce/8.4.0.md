...
- Editor option `content_id` that sets the id of the edited document. #TINY-13379
...
- Improved visual styling of inline diff highlights in Suggested Edits plugin. #TINY-13730
...
- Certain deletion keyboard events in lists could not be prevented. #TINY-13276
- Bundled content CSS is now loaded into preview iframes. #TINY-13190
- Attempting to remove a link after a `contentEditable="false"` element would not be possible. #TINY-13108
- Deleting a selection in an `li` didn't trigger `beforeinput`. #TINY-12793
...
- Script elements would incorrectly be removed by DomPurify when considered valid in the schema. #TINY-9655
- Iframe elements with children would incorrectly be removed by DomPurify. #TINY-9655
- Tables with unitless width or height attributes could not be resized correctly. #TINY-12797
