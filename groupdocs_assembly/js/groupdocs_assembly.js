...
//		});
	...
	insert : function() {
		// Insert the contents from the input into the document
                ...
                var iframe = '<iframe src="http://apps.groupdocs.com/assembly2/questionnaire-assembly/'+file_id+'?referer=TinyMCE-Assembly/1.0" frameborder="0" width="'+width+'" height="'+height+'">'+
...
tinyMCEPopup.onInit.add(Groupdocs_assemblyDialog.init, Groupdocs_assemblyDialog);
