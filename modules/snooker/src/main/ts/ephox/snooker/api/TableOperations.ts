...
export const makeRowHeader = RunOperation.run(opMakeRowHeader, RunOperation.onUnlockedRow, Fun.noop, Fun.noop, headerCellGenerator);
export const makeRowsHeader = RunOperation.run(opMakeRowsHeader, RunOperation.onUnlockedRows, Fun.noop, Fun.noop, headerCellGenerator);
export const makeRowBody = RunOperation.run(opMakeRowBody, RunOperation.onUnlockedRow, Fun.noop, Fun.noop, bodyCellGenerator);
export const makeRowsBody = RunOperation.run(opMakeRowsBody, RunOperation.onUnlockedRows, Fun.noop, Fun.noop, bodyCellGenerator);
export const makeRowFooter = RunOperation.run(opMakeRowFooter, RunOperation.onUnlockedRow, Fun.noop, Fun.noop, bodyCellGenerator);
export const makeRowsFooter = RunOperation.run(opMakeRowsFooter, RunOperation.onUnlockedRows, Fun.noop, Fun.noop, bodyCellGenerator);
