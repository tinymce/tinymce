...
const getUpOrLeftCells = (
  grid: RowCells[],
  selectedCells: DetailExt[],
...
const getOtherCells = (
  ...
  return details.map(function (selectedCells) {
    ...
    const downOrRightCells = getDownOrRightCells(
      grid,
      selectedCells,
      generators
    );
