...
const lookup = function (tags: string[], element: Element, _isRoot?): Option<Element> {
  ...
  const isRootOrUpperTable = function (elm) {
 ...
 */
const cell = function (element: Element, isRoot?) {
...
const notCell = function (element: Element, isRoot?) {
...
const table = function (element: Element, isRoot?) {
  return SelectorFind.closest(element, 'table', isRoot);
};

const row = function (element: Element, isRoot?) {
