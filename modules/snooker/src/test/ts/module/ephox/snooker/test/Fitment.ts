...
const measureTest = function (
  expected: { error: string } | { rowDelta: number; colDelta: number },
...
export { measureTest, tailorTest, tailorIVTest };
