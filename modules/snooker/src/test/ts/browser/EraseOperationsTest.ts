...
UnitTest.test('EraseOperationsTest', function () {
  ...
  Assertions.checkDelete(
    Option.some({ section: 0, row: 1, column: 0 }),
  ...
  Assertions.checkDelete(
    Option.some({ section: 0, row: 0, column: 0 }),
  ...
  Assertions.checkDelete(
    Option.some({ section: 0, row: 1, column: 1 }),
  ...
  Assertions.checkDelete(
    Option.some({ section: 0, row: 1, column: 2 }),
  ...
  Assertions.checkDelete(
    Option.some({ section: 0, row: 3, column: 3 }),
  ...
  Assertions.checkDelete(
    Option.some({ section: 0, row: 4, column: 7 }),
  ...
  const deleteExpectedContent15 =
    '<table border="1"><tbody><tr><td>row 0 cell 0 row 1 cell 0 </td><td>row 1 cell 1</td><td rowspan="2">row 0 cell 2 row 1 cell 2 row 2 cell 2 </td></tr><tr><td>row 2 cell 0</td><td>row 2 cell 1</td></tr><tr><td>row 3 cell 0</td><td>row 3 cell 1</td><td>row 3 cell 2</td></tr><tr><td>row 4 cell 0</td><td>row 4 cell 1</td><td>row 4 cell 2</td></tr></tbody></table>';
  const deleteExpected15 = {
    normal: deleteExpectedContent15,
    ie: deleteExpectedContent15
  };
  Assertions.checkDelete(
    Option.some({ section: 0, row: 0, column: 1 }),
  ...
  const deleteExpectedContent16 =
    '<table border="1"><tbody><tr><td>row 2 cell 0</td><td>row 2 cell 1</td><td>row 0 cell 2 row 1 cell 2 row 2 cell 2 </td></tr><tr><td>row 3 cell 0</td><td>row 3 cell 1</td><td>row 3 cell 2</td></tr><tr><td>row 4 cell 0</td><td>row 4 cell 1</td><td>row 4 cell 2</td></tr></tbody></table>';
  ...
  const deleteExpectedContent17 =
    '<table border="1"><tbody><tr><td rowspan="2">row 0 cell 0 row 1 cell 0 </td><td rowspan="3">row 0 cell 2 row 1 cell 2 row 2 cell 2 </td></tr><tr></tr><tr><td>row 2 cell 0</td></tr><tr><td>row 3 cell 0</td><td>row 3 cell 2</td></tr><tr><td>row 4 cell 0</td><td>row 4 cell 2</td></tr></tbody></table>';
  ...
  const deleteExpectedContent18 =
    '<table border="1"><tbody><tr><td rowspan="2">row 0 cell 0 row 1 cell 0 </td></tr><tr></tr><tr><td>row 2 cell 0</td></tr><tr><td>row 3 cell 0</td></tr><tr><td>row 4 cell 0</td></tr></tbody></table>';
