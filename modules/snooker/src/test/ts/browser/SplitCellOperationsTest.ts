...
UnitTest.test('MergeOperationsTest', function () {
  Assertions.checkOld(
    ...
    TableOperations.splitCellIntoRows,
    0,
    0,
    0
  );
  ...
  Assertions.checkOld(
    { section: 0, row: 0, column: 0 },
    '<table><tbody>' + '<tr><td>A1</td><td>?</td><td>B1</td></tr>' + '<tr><td colspan="2">A2</td><td>B2</td></tr>' + '</tbody></table>',

    '<table><tbody>' + '<tr><td>A1</td><td>B1</td></tr>' + '<tr><td>A2</td><td>B2</td></tr>' + '</tbody></table>',

    TableOperations.splitCellIntoColumns,
    0,
    0,
    0
  );
  ...
  Assertions.checkOld(
    ...
    '<table><thead>' + '<tr><td>A1</td><td>B1</td></tr>' + '<tr><td>A2</td><td>B2</td></tr>' + '</thead></table>',
  ...
  Assertions.checkOld(
    ...
    '<table><tfoot>' + '<tr><td>A1</td><td>B1</td></tr>' + '<tr><td>A2</td><td>B2</td></tr>' + '</tfoot></table>',
