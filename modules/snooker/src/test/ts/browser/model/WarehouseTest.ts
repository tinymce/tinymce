...
describe('WarehouseTest', () => {
  ...
  it('TINY-7041: should trim cols if there are more cols than cell columns', () => {
    check(
      [
        cg([ c('a', 1), c('b', 1), c('c', 1), c('d', 1) ]),
        f([ s('a', 1, 1), s('b', 1, 1), s('c', 1, 1) ], 'tbody')
      ],
      {
        access: {
  ...
  it('TINY-7041: should trim span col if there are more cols than cell columns', () => {
    check(
      [
        cg([ c('a', 4), c('b', 1) ]),
        f([ s('a', 1, 1), s('b', 1, 1), s('c', 1, 1) ], 'tbody')
