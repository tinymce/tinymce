...
UnitTest.asynctest('RenderTest', (success, failure) => {
  Pipeline.async({}, [
    Logger.t('Render table default options', Step.sync(() => {
      ...
      Assertions.assertStructure('Should be a table with default styles/attributes', ApproxStructure.build((s, str, arr) => s.element('table', {
        styles: {
          'width': str.is('100%'),
    ...
    Logger.t('Render table with percentages', Step.sync(() => {
      ...
      Assertions.assertStructure('Should be a table with percentages', ApproxStructure.build((s, str, arr) => s.element('table', {
        styles: {
    ...
    Logger.t('Render table with everything disabled', Step.sync(() => {
      ...
      Assertions.assertStructure('Should be a table with styles', ApproxStructure.build((s, str, arr) => s.element('table', {
        styles: {
          width: str.is('50%'),
          height: str.is('100px')
        },
