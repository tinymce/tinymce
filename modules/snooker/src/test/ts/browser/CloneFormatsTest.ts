...
UnitTest.test('CloneFormatsTest', function () {
  ...
  const noCloneTableFill = TableFill.cellOperations(
    Fun.noop,
    doc,
    noCloneFormats
  );
  ...
  const cellContent = Element.fromHtml(
    '<strong contenteditable="false"><em>stuff</em></strong>'
  );
