...
UnitTest.test('RecalculationsTest', function () {
  ...
  const d = (fakeEle: any, rowspan: number, colspan: number) =>
    Structs.detail(fakeEle as Element, rowspan, colspan);
  const r = (fakeEle: any, cells: Structs.Detail[], section: 'tbody') =>
  ...
  check(
    ...
    [
      r(
        'r0',
        [d('g', 1, 1), d('h', 1, 1), d('i', 1, 1), d('j', 1, 1), d('k', 1, 3)],
        'tbody'
      ),
      r(
        'r1',
      ...
      r(
        'r2',
        [d('r', 2, 1), d('s', 1, 1), d('t', 2, 1), d('u', 1, 1), d('v', 1, 1)],
        'tbody'
      )
    ],
