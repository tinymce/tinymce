...
UnitTest.test('MergeOperationsTest', function () {
  ...
  (function () {
    ...
    check(
      [r([en('a', false), en('a', false)], 'thead'), r([en('a', false), en('a', false)], 'thead')],
      [r([en('a', false), en('b', false)], 'thead'), r([en('c', false), en('d', false)], 'thead')],
      b(0, 0, 1, 1),
      'a'
    );
    check(
      [r([en('a', false), en('a', false)], 'tbody'), r([en('a', false), en('a', false)], 'tbody')],
      [r([en('a', false), en('b', false)], 'tbody'), r([en('c', false), en('d', false)], 'tbody')],
      b(0, 0, 1, 1),
      'a'
    );

    check(
      [r([en('a', false), en('a', false), en('c', false)], 'thead'), r([en('d', false), en('e', false), en('f', false)], 'tbody')],
      [r([en('a', false), en('b', false), en('c', false)], 'thead'), r([en('d', false), en('e', false), en('f', false)], 'tbody')],
      b(0, 0, 0, 1),
      'a'
    );
    check(
      [r([en('a', false), en('a', false), en('c', false)], 'tbody'), r([en('d', false), en('e', false), en('f', false)], 'tbody')],
      [r([en('a', false), en('b', false), en('c', false)], 'tbody'), r([en('d', false), en('e', false), en('f', false)], 'tbody')],
      b(0, 0, 0, 1),
      'a'
    );

    check(
      [r([en('a', false), en('a', false), en('a', false)], 'tbody'), r([en('a', false), en('a', false), en('a', false)], 'tbody')],
      [r([en('a', false), en('b', false), en('c', false)], 'tbody'), r([en('d', false), en('e', false), en('f', false)], 'tbody')],
      b(0, 0, 1, 2),
      'a'
    );
  ...
  (function () {
    ...
    check(
      [r([en('a', false), en('?', true)], 'tbody'), r([en('?', true), en('?', true)], 'tbody')],
      [r([en('a', false), en('a', false)], 'tbody'), r([en('a', false), en('a', false)], 'tbody')],
      'a'
    );
