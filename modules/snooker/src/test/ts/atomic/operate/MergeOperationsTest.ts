...
UnitTest.test('MergeOperationsTest', function () {
  ...
  (function () {
    const check = function (
      ...
      const actual = MergingOperations.merge(
        grid,
        bounds,
        Fun.tripleEquals,
        Fun.constant((lead as unknown) as Element)
      );
  ...
  (function () {
    const check = function (
      ...
      const actual = MergingOperations.unmerge(
        grid,
    ...
    check(
      [
        r(
          [en('a', false), en('b', false), en('?', true), en('c', false)],
          'thead'
        )
      ],
      [
    ...
    check(
      [
        ...
        r(
          [en('a', false), en('?', true), en('?', true), en('d', false)],
          'tbody'
        ),
        r(
          [en('f', false), en('?', true), en('?', true), en('e', false)],
          'tbody'
        )
      ],
      [
        ...
        r(
          [en('a', false), en('b', false), en('b', false), en('d', false)],
          'tbody'
        ),
        r(
          [en('f', false), en('b', false), en('b', false), en('e', false)],
          'tbody'
        )
      ],
      'b'
    ...
    check(
      [
        ...
        r(
          [en('?', true), en('b', false), en('b', false), en('d', false)],
          'tbody'
        ),
        r(
          [en('f', false), en('b', false), en('b', false), en('e', false)],
