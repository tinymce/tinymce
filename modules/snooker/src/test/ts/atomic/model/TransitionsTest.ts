...
UnitTest.test('TableCounterTest', function () {
  const dn = (fakeElement: any, rowspan: number, colspan: number, isNew: boolean) =>
    Structs.detailnew(fakeElement as Element, rowspan, colspan, isNew);
  ...
  check(
    [rd([dn('td1', 4, 3, false)], 'tbody'), rd([], 'tbody'), rd([], 'tbody'), rd([], 'tbody')],
    [
  ...
  check(
    [rd([dn('td1', 4, 3, false)], 'tfoot'), rd([], 'tfoot'), rd([], 'tfoot'), rd([], 'tfoot')],
    [
  ...
  check(
    [rd([dn('td1', 2, 3, false)], 'tbody'), rd([], 'tbody')],
    [r([en('td1', false), en('td1', false), en('td1', false)], 'tbody'), r([en('td1', false), en('td1', false), en('td1', false)], 'tbody')]
  );

  check(
    [rd([dn('td1', 1, 1, false)], 'thead'), rd([dn('td2', 1, 1, false)], 'tbody'), rd([dn('td3', 1, 1, false)], 'tfoot')],
    [r([en('td1', false)], 'thead'), r([en('td2', false)], 'tbody'), r([en('td3', false)], 'tfoot')]
  );

  check(
    [rd([dn('td1', 2, 2, false), dn('td3', 1, 1, false)], 'tbody'), rd([dn('td4', 1, 1, false)], 'tbody')],
    [r([en('td1', false), en('td1', false), en('td3', false)], 'tbody'), r([en('td1', false), en('td1', false), en('td4', false)], 'tbody')]
  );
