...
export interface SplitPosition<E> {
  fold: <U>(onNone: NoneHandler<U>, onStart: StartHandler<E, U>, onMiddle: MiddleHandler<E, U>, onEnd: EndHandler<E, U>) => U;
  match: <U>(branches: { none: NoneHandler<U>; start: StartHandler<E, U>; middle: MiddleHandler<E, U>; end: EndHandler<E, U> }) => U;
...
} = Adt.generate([{ none: [] }, { start: ['element'] }, { middle: ['before', 'after'] }, { end: ['element'] }]);
