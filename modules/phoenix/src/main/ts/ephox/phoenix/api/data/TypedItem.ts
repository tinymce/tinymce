...
interface TypedItemAdt<E, D> {
  fold: <U>(onBoundary: Handler<E, D, U>, onEmpty: Handler<E, D, U>, onText: Handler<E, D, U>, onNonEditable: Handler<E, D, U>) => U;
  match: <U>(branches: { boundary: Handler<E, D, U>; empty: Handler<E, D, U>; text: Handler<E, D, U>; nonEditable: Handler<E, D, U> }) => U;
...
const cata = function <E, D, U>(
  subject: TypedItem<E, D>,
