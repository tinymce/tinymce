...
const insertAtElement = function <E, D> (universe: Universe<E, D>, parent: E, offset: number): InjectPosition<E> {
 ...
 */
const atStartOf = function <E, D> (universe: Universe<E, D>, element: E, offset: number, injection: E): void {
