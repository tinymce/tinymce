...
Important for document outline and screen readers.`,name:"headingLevel",required:!1,type:{name:'"h2" | "h3" | "h4" | "h5" | "h6"'}},iconPosition:{defaultValue:{value:"start"},description:"Position of the chevron icon in the header.",name:"iconPosition",required:!1,type:{name:'"start" | "end"'}}}}}catch{}const F=z(),te={"chevron-down":F["chevron-down"],"chevron-up":F["chevron-up"]},ne={getIcon:t=>Y(te,t).getOrDie("Failed to get icon")},je={title:"components/Accordion",component:T,decorators:[t=>e.jsx(X,{resources:ne,children:e.jsx(t,{})})],parameters:{layout:"centered",docs:{description:{component:`
...
}`,...A.parameters?.docs?.source}}};const we=["Barebone","Styled"];export{w as Barebone,A as Styled,we as __namedExportsOrder,je as default};
