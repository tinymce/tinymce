import{j as s,c as I}from"./iframe-CHYBGZgy.js";import{B as N}from"./Button-CrAaX5jA.js";import{c as w}from"./Fun-DhDWU5Ah.js";const i=({icon:e,resolver:o})=>s.jsx("span",{className:I(["tox-icon"]),dangerouslySetInnerHTML:{__html:o(e)}});try{i.displayName="Icon",i.__docgenInfo={description:"",displayName:"Icon",props:{icon:{defaultValue:null,description:"The name of the icon",name:"icon",required:!0,type:{name:"string"}},resolver:{defaultValue:null,description:`The function to resolve the icon name to an html string.
