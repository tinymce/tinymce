import{j as e}from"./iframe-D0Ip0P04.js";import{R as a,H as r}from"./Draggable-pZ3gPEQZ.js";import"./Optional-CHj922Ci.js";import"./Fun--VEwoXIw.js";const g={title:"components/Draggable",component:a,parameters:{layout:"fullscreen",docs:{description:{component:`A draggable container component that allows users to reposition elements by dragging them around the viewport.
...
If you don't provide \`declaredSize\`, the element may move outside the viewport on window resize.`}}},argTypes:{popover:{table:{disable:!0}},initialPosition:{description:"The initial position of the draggable element. `top` and `left` can be provided as any valid CSS."},declaredSize:{description:`Optional declared size of the draggable element. This is used to ensure the Draggable element will not end up out of window on window resize.
You can omit setting this property if you don't care about window resize.
If you do care about it, but don't know the exact size of the element you'll have to calculate it using javascript.`}},tags:["autodocs","skip-visual-testing"]},l=s=>e.jsx(a,{...s,style:{position:"absolute"},children:e.jsx("div",{style:{width:250,height:250,backgroundColor:"#fef68a"},children:e.jsx(r,{children:e.jsx("div",{style:{width:"100%",height:50,backgroundColor:"#e8d96f",display:"flex",alignItems:"center",justifyContent:"center"},children:"Drag me"})})})}),t={args:{initialPosition:{top:"50px",left:"50px"},declaredSize:{width:"250px",height:"250px"}},parameters:{docs:{story:{inline:!1,iframeHeight:700}}},render:l};var o,i,n;t.parameters={...t.parameters,docs:{...(o=t.parameters)==null?void 0:o.docs,source:{originalSource:`{
  args: {
    initialPosition: {
      top: '50px',
      left: '50px'
