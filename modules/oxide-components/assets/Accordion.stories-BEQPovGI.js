import{r,j as e}from"./iframe-ClTj1tog.js";import{g as z}from"./icons-CeCQNAbo.js";import{A as J}from"./AutoResizingTextarea-DUlo-LtD.js";import{B as _}from"./Button-Diapmcyp.js";import{R as k,T as P,C as L}from"./Dropdown-BklnbJLU.js";import{I as S}from"./Icon-BlMSpGPx.js";import{R as H,I}from"./Menu-BdCseAzr.js";import{U as W}from"./UniverseProvider-J0bjKlJ1.js";import{c as O,f as Q}from"./Strings-DwL7BECk.js";import{a as V,O as M,n as X,i as Y}from"./Optional-CwIPeCD0.js";import{b as Z}from"./KeyboardNavigationHooks-BvnzJcxj.js";import{a as q,e as E}from"./Bem-Du84Tdvq.js";import{g as ee}from"./Obj-BEXbhZhc.js";import"./preload-helper-PPVm8Dsz.js";import"./SugarElement-jw9k3Vcm.js";import"./Visibility-HiPE8kkv.js";import"./Context-Dax7tU6T.js";import"./Id--8xy-NHg.js";import"./Num-xrWELwUY.js";import"./Universe-woeZfZgY.js";import"./PredicateFind--7pRSCFh.js";const x='button, a, input, textarea, select, [contenteditable], [role="textbox"]',U=r.createContext(null),te=()=>{const t=r.useContext(U);if(t===null)throw new Error("Accordion components must be used within Accordion.Root");return t},T=({children:t,allowMultiple:h=!1,defaultExpanded:o=[],expanded:f,onExpandedChange:c})=>{const[b,l]=r.useState(o),i=r.useRef(null),v=V(f),p=v?f:b,s=r.useCallback(m=>{let d;O(p,m)?d=Q(p,j=>j!==m):h?d=[...p,m]:d=[m],v?c?.(d):l(d)},[p,h,v,c]),C=r.useMemo(()=>({expandedItems:p,toggleItem:s,allowMultiple:h}),[p,s,h]);return Z({containerRef:i,selector:'.tox-accordion__item:not([aria-disabled="true"])',allowVertical:!0,allowHorizontal:!1,cycles:!1,focusIn:!0,execute:m=>{const d=document.activeElement;return d?.matches(x)??!1?M.none():d===m.dom?M.none():(m.dom.click(),M.some(!0))}}),e.jsx(U.Provider,{value:C,children:e.jsx("div",{ref:i,className:"tox-accordion",tabIndex:0,children:t})})},y=({id:t,title:h,disabled:o=!1,headingLevel:f="h3",iconPosition:c="start",children:b})=>{const{expandedItems:l,toggleItem:i}=te(),v=`tox-${t}-content`,p=`tox-${t}-header`,s=O(l,t),C=f,m=r.useCallback(()=>{o||i(t)},[o,i,t]),d=r.useCallback(n=>{const a=n.target,u=n.currentTarget;!a.closest(q("tox-accordion","header"))&&a!==u||a!==u&&(a.matches(x)||a.closest(x))||(u.focus(),o||i(t))},[o,i,t]),j=r.useCallback(n=>{if(n.key!=="Enter"&&n.key!==" "||(document.activeElement?.matches(x)??!1))return;const g=n.target,D=n.currentTarget;if(g===D)n.preventDefault(),o||i(t);else{if(g.matches(x)||g.closest(x))return;n.preventDefault(),o||i(t)}},[o,i,t]),B=r.useCallback(n=>{if(n.key!=="Escape")return;const a=n.target,u=n.currentTarget;a!==u&&(n.preventDefault(),u.focus(),a.matches(x)||n.stopPropagation())},[]),G=E("tox-accordion","item",{expanded:s}),K=E("tox-accordion","header",{expanded:s,disabled:o,"icon-end":c==="end"}),$=E("tox-accordion","content",{expanded:s,collapsed:!s}),R=e.jsx("span",{className:"tox-accordion__header-icon",children:e.jsx(S,{icon:s?"chevron-up":"chevron-down"})}),N=e.jsx("span",{className:"tox-accordion__header-text",children:h});return e.jsxs("div",{className:G,tabIndex:-1,"aria-disabled":o,onMouseDown:n=>{const a=n.target,u=n.currentTarget,g=a.closest(q("tox-accordion","header"));(V(g)||a===u)&&(n.currentTarget.focus(),n.preventDefault())},onClick:d,onKeyDown:n=>{j(n),B(n)},children:[e.jsx(C,{className:"tox-accordion__heading",children:e.jsx("button",{id:p,type:"button",className:K,"aria-expanded":s,"aria-controls":v,"aria-disabled":o,onClick:m,disabled:o,tabIndex:-1,children:c==="start"?e.jsxs(e.Fragment,{children:[R,N]}):e.jsxs(e.Fragment,{children:[N,R]})})}),e.jsx("div",{id:v,role:"region","aria-labelledby":p,"aria-hidden":!s,className:$,children:e.jsx("div",{className:"tox-accordion__content-inner",children:b})})]})};try{T.displayName="Root",T.__docgenInfo={description:`Accordion component for displaying collapsible content sections.
...
Important for document outline and screen readers.`,name:"headingLevel",required:!1,type:{name:'"h2" | "h3" | "h4" | "h5" | "h6"'}},iconPosition:{defaultValue:{value:"start"},description:"Position of the chevron icon in the header.",name:"iconPosition",required:!1,type:{name:'"start" | "end"'}}}}}catch{}const F=z(),ne={"chevron-down":F["chevron-down"],"chevron-up":F["chevron-up"]},oe={getIcon:t=>ee(ne,t).getOrDie("Failed to get icon"),translate:Y},Ce={title:"components/Accordion",component:T,decorators:[t=>e.jsx(W,{resources:oe,children:e.jsx(t,{})})],parameters:{layout:"centered",docs:{description:{component:`
...
}`,...A.parameters?.docs?.source}}};const _e=["Barebone","Styled"];export{w as Barebone,A as Styled,_e as __namedExportsOrder,Ce as default};
