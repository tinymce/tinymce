import{r as n,j as o}from"./iframe-BA8tVn17.js";import{B as r}from"./Button-DOIFPHD4.js";import{I}from"./IconButton-DRCK5fX0.js";import{U as W}from"./UniverseProvider-ByLtBE8b.js";import{e as to,m as no}from"./Strings-DwL7BECk.js";import{g as ro}from"./Id--8xy-NHg.js";import{O as j,a as v,b as U,i as so,c as io}from"./Optional-CwIPeCD0.js";import{f as ao,c as lo,d as co,s as y,r as O,b as po,e as q,h as uo,i as ho,j as bo,k as mo,l as xo}from"./KeyboardNavigationHooks-DoRpUkdk.js";import{S as F}from"./SugarElement-jw9k3Vcm.js";import{i as K,d as $}from"./PredicateFind--7pRSCFh.js";import"./preload-helper-PPVm8Dsz.js";import"./Bem-Du84Tdvq.js";import"./Obj-BEXbhZhc.js";import"./Icon-Bj07vmEB.js";import"./Universe-C1EEQTFw.js";import"./Num-xrWELwUY.js";import"./Visibility-HiPE8kkv.js";const z=n.createContext(null),J=()=>{const e=n.useContext(z);if(!v(e))throw new Error("useContextToolbarContext must be used within a ContextToolbarProvider");return e},go="6px",X=["button",'[role="button"]',".tox-button"],Y=X.join(", "),fo=no(X,e=>`${e}:not([disabled]):not([aria-disabled="true"])`).join(", "),To=e=>!mo(e,"disabled")&&xo(e,"aria-disabled")!=="true"&&e.dom.tabIndex>=0,Co=e=>t=>K(t)&&bo(t,e)&&To(t),Z=Co(Y),vo=(e,t)=>uo(e,t).map(s=>$(s,Z).exists(f=>ho(f,e))).getOr(!0),V=e=>{const t=F.fromDom(e);$(t,Z).fold(()=>q(t),q)},m=({children:e,persistent:t=!1,anchorRef:s,usePopover:f=!1})=>{const[d,i]=n.useState(!1),p=n.useRef(null),h=n.useRef(null),g=n.useCallback(()=>{i(!0)},[]),w=n.useCallback(()=>{i(!1)},[]),u=n.useCallback(()=>j.from(s?.current).orThunk(()=>j.from(p.current).map(F.fromDom).bind(ao).filter(K).map(b=>b.dom).orThunk(()=>j.from(p.current))).getOrNull(),[s,p]);n.useEffect(()=>{const b=u();if(v(b)&&!v(p.current)){const T=window.requestAnimationFrame(()=>{v(p.current)||i(!0)});return()=>window.cancelAnimationFrame(T)}},[u,p]),n.useEffect(()=>{const b=u();if(v(b)){const T=()=>{g()};return b.addEventListener("click",T),()=>{b.removeEventListener("click",T)}}},[u,g]);const R=n.useMemo(()=>({isOpen:d,open:g,close:w,triggerRef:p,toolbarRef:h,anchorRef:s,anchorElement:u(),getAnchorElement:u,persistent:t,usePopover:f}),[d,g,w,t,s,u,f]);return o.jsx(z.Provider,{value:R,children:e})},k=({children:e,onClick:t,onMouseDown:s})=>{const{open:f,triggerRef:d}=J(),i=n.useCallback(h=>{f(),t?.(h)},[f,t]),p=n.useCallback(h=>{h.preventDefault(),s?.(h)},[s]);return o.jsx("div",{ref:d,onClick:i,onMouseDown:p,children:e})},x=n.forwardRef(({children:e,onMouseDown:t,onEscape:s},f)=>{const{isOpen:d,toolbarRef:i,triggerRef:p,getAnchorElement:h,close:g,persistent:w,usePopover:u}=J();n.useImperativeHandle(f,()=>({focus:()=>{j.from(i.current).each(V)}}),[i]),n.useEffect(()=>{const c=i.current;if(!U(c)){if(!d){u&&c.hidePopover();return}u&&c.showPopover(),window.queueMicrotask(()=>{V(c)})}},[u,d,i]);const R=n.useMemo(()=>w?s:U(s)?g:()=>{s(),g()},[w,s,g]);lo({containerRef:i,...v(R)?{onEscape:R}:{}}),co({containerRef:i,selector:Y,useTabstopAt:c=>vo(c,".tox-toolbar__group"),cyclic:!0});const b=n.useCallback(c=>{if(d&&v(i.current)&&c.target instanceof Node){const B=i.current.contains(c.target),S=p.current?.contains(c.target)??!1,H=h()?.contains(c.target)??!1;!B&&!S&&!H&&g()}},[d,g,i,p,h]);n.useEffect(()=>{if(!w)return document.addEventListener("mousedown",b),()=>document.removeEventListener("mousedown",b)},[w,b]);const T=n.useMemo(()=>`--${ro("context-toolbar")}`,[]);n.useEffect(()=>{const c=h(),B=i.current;if(!d||!v(c)||!v(B))return;const S=F.fromDom(c),C=F.fromDom(B);y(S,"anchor-name",T),y(C,"position","absolute"),y(C,"margin","0"),y(C,"inset","unset"),y(C,"position-anchor",T);const H=`calc(anchor(${T} bottom) + ${go})`;return y(C,"top",H),y(C,"justify-self","anchor-center"),y(C,"position-try-fallbacks","flip-block, flip-inline, flip-block flip-inline"),()=>{O(S,"anchor-name"),to(["position","margin","inset","position-anchor","top","justify-self","position-try-fallbacks"],eo=>{O(C,eo)})}},[T,d,i,h]);const oo=n.useCallback(c=>{t?.(c)},[t]);return o.jsx("div",{ref:i,popover:u?"manual":void 0,tabIndex:-1,className:"tox-context-toolbar",style:{visibility:d?void 0:"hidden",pointerEvents:"auto"},onMouseDown:oo,children:o.jsx("div",{role:"toolbar",className:"tox-toolbar",children:e})})}),l=({children:e})=>{const t=n.useRef(null);return po({containerRef:t,selector:fo,execute:s=>(s.dom.click(),j.some(!0))}),o.jsx("div",{ref:t,role:"group",className:"tox-toolbar__group",children:e})};try{m.displayName="Root",m.__docgenInfo={description:"",displayName:"Root",props:{persistent:{defaultValue:{value:"false"},description:"",name:"persistent",required:!1,type:{name:"boolean"}},anchorRef:{defaultValue:null,description:"",name:"anchorRef",required:!1,type:{name:"RefObject<HTMLElement>"}},usePopover:{defaultValue:{value:"false"},description:"",name:"usePopover",required:!1,type:{name:"boolean"}}}}}catch{}try{k.displayName="Trigger",k.__docgenInfo={description:"",displayName:"Trigger",props:{onClick:{defaultValue:null,description:"",name:"onClick",required:!1,type:{name:"MouseEventHandler<HTMLDivElement>"}},onMouseDown:{defaultValue:null,description:"",name:"onMouseDown",required:!1,type:{name:"MouseEventHandler<HTMLDivElement>"}}}}}catch{}try{x.displayName="Toolbar",x.__docgenInfo={description:"",displayName:"Toolbar",props:{onMouseDown:{defaultValue:null,description:"",name:"onMouseDown",required:!1,type:{name:"MouseEventHandler<HTMLDivElement>"}},onEscape:{defaultValue:null,description:"",name:"onEscape",required:!1,type:{name:"(() => void)"}}}}}catch{}try{l.displayName="Group",l.__docgenInfo={description:"",displayName:"Group",props:{}}}catch{}const{fn:a}=__STORYBOOK_MODULE_TEST__,yo=`<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
...
</svg>`,Q={getIcon:io(yo),translate:so},Ho={title:"components/ContextToolbar",parameters:{layout:"centered",docs:{description:{component:`
...
}`,...P.parameters?.docs?.source}}};const Uo=["Basic","Persistent","WithIconButtons","ManyButtons","MixedContent","Corners","WithAnchorRef","ScrollAnchored","DisabledControls"];export{A as Basic,M as Corners,P as DisabledControls,N as ManyButtons,_ as MixedContent,G as Persistent,L as ScrollAnchored,D as WithAnchorRef,E as WithIconButtons,Uo as __namedExportsOrder,Ho as default};
