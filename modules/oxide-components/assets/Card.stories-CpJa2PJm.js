import{r as o,j as e}from"./iframe-ClTj1tog.js";import{g as W}from"./icons-CeCQNAbo.js";import{B as c}from"./Button-Diapmcyp.js";import{E as G}from"./ExpandableBox-9wHvYSwc.js";import{I as u}from"./Icon-BlMSpGPx.js";import{U as $}from"./UniverseProvider-J0bjKlJ1.js";import{b as P,e as C}from"./Bem-Du84Tdvq.js";import{O as X,a as V,i as Y}from"./Optional-CwIPeCD0.js";import{r as J}from"./Strings-DwL7BECk.js";import{b as Q}from"./KeyboardNavigationHooks-BvnzJcxj.js";import{g as Z}from"./Obj-BEXbhZhc.js";import"./preload-helper-PPVm8Dsz.js";import"./Universe-woeZfZgY.js";import"./SugarElement-jw9k3Vcm.js";import"./PredicateFind--7pRSCFh.js";import"./Num-xrWELwUY.js";import"./Visibility-HiPE8kkv.js";const E=o.createContext(null),D=o.createContext(null),ee=()=>o.useContext(E),H=()=>o.useContext(D),k=({children:t,focusedIndex:n,onFocusedIndexChange:i,selectedIndex:d,onSelectCard:a})=>{const l=o.useMemo(()=>({focusedIndex:n,selectedIndex:d,onFocusedIndexChange:i,onSelectCard:a}),[n,d,i,a]);return e.jsx(D.Provider,{value:l,children:t})},K=({children:t,className:n,ariaLabel:i,cycles:d,focusedIndex:a,selectedIndex:l,setFocusedIndex:r,onSelectCard:s})=>{const p=o.useRef(null);o.useEffect(()=>{p.current?.querySelectorAll(".tox-card")[a]?.scrollIntoView({block:"nearest",behavior:"smooth"})},[a]);const w=o.useMemo(()=>({focusedIndex:a,selectedIndex:l,setFocusedIndex:r,onSelectCard:s}),[a,l,r,s]);Q({containerRef:p,selector:".tox-card",allowVertical:!0,allowHorizontal:!1,cycles:d,closest:!1,execute:b=>(b.dom.click(),X.some(!0))});const S=P("tox-card-list")+(V(n)?` ${n}`:"");return e.jsx(E.Provider,{value:w,children:e.jsx("div",{ref:p,role:"listbox","aria-label":i??"Card list",className:S,children:t})})},te=({children:t,className:n,ariaLabel:i,cycles:d=!1})=>{const a=H();if(a===null)throw new Error("CardList: Controlled mode requires CardListController wrapper");const l=o.useCallback(s=>{a.onFocusedIndexChange(s)},[a]),r=o.useCallback(s=>{a.onSelectCard?.(s)},[a]);return e.jsx(K,{children:t,className:n,ariaLabel:i,cycles:d,focusedIndex:a.focusedIndex,selectedIndex:a.selectedIndex,setFocusedIndex:l,onSelectCard:r})},ne=({children:t,className:n,ariaLabel:i,cycles:d=!1,defaultFocusedIndex:a=0,defaultSelectedIndex:l,onSelectCard:r})=>{const[s,p]=o.useState(a),[w,S]=o.useState(l),b=o.useCallback(I=>{r?.(I),S(I)},[r]);return e.jsx(K,{children:t,className:n,ariaLabel:i,cycles:d,focusedIndex:s,selectedIndex:w,setFocusedIndex:p,onSelectCard:b})},v=t=>H()!==null?e.jsx(te,{...t}):e.jsx(ne,{...t});try{k.displayName="CardListController",k.__docgenInfo={description:"",displayName:"CardListController",props:{focusedIndex:{defaultValue:null,description:"Index of the currently focused card (required).",name:"focusedIndex",required:!0,type:{name:"number"}},onFocusedIndexChange:{defaultValue:null,description:"Callback fired when the focused index should change (required).",name:"onFocusedIndexChange",required:!0,type:{name:"(index: number) => void"}},selectedIndex:{defaultValue:null,description:"Index of the currently selected card.",name:"selectedIndex",required:!1,type:{name:"number"}},onSelectCard:{defaultValue:null,description:"Callback fired when a card is selected.",name:"onSelectCard",required:!1,type:{name:"((index: number) => void)"}}}}}catch{}try{v.displayName="CardList",v.__docgenInfo={description:"",displayName:"CardList",props:{className:{defaultValue:null,description:"Optional CSS class name to apply to the list container.",name:"className",required:!1,type:{name:"string"}},ariaLabel:{defaultValue:null,description:"Accessible label for the card list.",name:"ariaLabel",required:!1,type:{name:"string"}},cycles:{defaultValue:{value:"false"},description:"Whether to allow cycling through cards with arrow keys.",name:"cycles",required:!1,type:{name:"boolean"}},defaultFocusedIndex:{defaultValue:{value:"0"},description:`Index of the initially focused card (uncontrolled mode only).
...
Ignored when used inside CardListController.`,name:"onSelectCard",required:!1,type:{name:"((index: number) => void)"}}}}}catch{}const ae=t=>J(t,n=>e.jsx("div",{className:C("tox-skeleton","line"),style:{width:"100%"}},n)),h=({children:t,className:n,onSelect:i,selected:d=!1,ariaLabel:a,hasDecision:l=!1,index:r,loading:s=!1})=>{const p=ee(),w=p?.focusedIndex===r,S=p?.selectedIndex===r,b=o.useCallback(g=>{const f=g.target,F=g.currentTarget;f!==F&&(f.matches("button, a, input, textarea, select")||f.closest("button, a, input, textarea, select"))||(p&&r!==void 0&&(p.onSelectCard?.(r),p.setFocusedIndex(r)),i?.())},[i,p,r]),I=o.useCallback(g=>{if(g.key!=="Enter"&&g.key!==" ")return;const f=g.target,F=g.currentTarget;f!==F&&(f.matches("button, a, input, textarea, select")||f.closest("button, a, input, textarea, select"))},[]),M=o.useCallback(()=>{p&&r!==void 0&&p.setFocusedIndex(r)},[p,r]),U=P("tox-card",{selected:!s&&(w||d),"has-decision":l})+(s?" tox-skeleton":"")+(V(n)?` ${n}`:""),z=e.jsxs(e.Fragment,{children:[e.jsx("div",{className:C("tox-card","body"),children:ae(1)}),e.jsx("div",{className:C("tox-card","actions"),children:e.jsx("div",{className:C("tox-skeleton","line"),style:{width:"50%"}})})]});return e.jsx("div",{className:U,onClick:s?void 0:b,onKeyDown:s?void 0:I,onFocus:s?void 0:M,tabIndex:s?void 0:-1,role:"option","aria-label":a??`Card ${(r??0)+1}`,"aria-selected":S,"aria-busy":s,children:s?z:t})},y=({children:t,title:n})=>e.jsx("div",{className:C("tox-card","header"),children:V(n)?n:t}),m=({children:t})=>e.jsx("div",{className:C("tox-card","body"),children:t}),x=({children:t,layout:n="flex-start"})=>e.jsx("div",{className:C("tox-card","actions",{"space-between":n==="space-between","flex-start":n==="flex-start"}),children:t}),q=({children:t,type:n})=>e.jsx("div",{className:C("tox-card","highlight",{added:n==="added",deleted:n==="deleted",modified:n==="modified"}),children:t});try{h.displayName="Root",h.__docgenInfo={description:"",displayName:"Root",props:{className:{defaultValue:null,description:"",name:"className",required:!1,type:{name:"string"}},onSelect:{defaultValue:null,description:"",name:"onSelect",required:!1,type:{name:"(() => void)"}},selected:{defaultValue:{value:"false"},description:"",name:"selected",required:!1,type:{name:"boolean"}},ariaLabel:{defaultValue:null,description:"",name:"ariaLabel",required:!1,type:{name:"string"}},hasDecision:{defaultValue:{value:"false"},description:"",name:"hasDecision",required:!1,type:{name:"boolean"}},index:{defaultValue:null,description:`Index of this card within a CardList.
...
- **Icon**: For status indicators
        `}}},tags:["autodocs"],args:{}},B={parameters:{docs:{description:{story:`
**Default Card**
...
3. Press Enter/Space to select
        `}}},render:()=>{const[t,n]=o.useState(0),[i,d]=o.useState(void 0),a=[{id:1,title:"Grammar Fix",content:'Change "institution club" to "club institution"'},{id:2,title:"Spelling Correction",content:'Correct "tiki-taka" spelling'},{id:3,title:"Clarity Improvement",content:"Simplify complex sentence structure"},{id:4,title:"Style Enhancement",content:"Add transition words for better flow"},{id:5,title:"Fact Check",content:"Verify the 2008-2012 era claim"}];return e.jsx("div",{style:{width:"316px"},children:e.jsx(k,{focusedIndex:t,onFocusedIndexChange:n,selectedIndex:i,onSelectCard:d,children:e.jsx(v,{ariaLabel:"Review suggestions",cycles:!1,children:a.map((l,r)=>e.jsxs(h,{index:r,children:[e.jsx(y,{title:l.title}),e.jsx(m,{children:e.jsx("p",{style:{margin:0,fontSize:"14px"},children:l.content})}),e.jsxs(x,{children:[e.jsxs(c,{variant:"outlined",onClick:s=>{s.stopPropagation(),d(void 0)},children:[e.jsx(u,{icon:"close"}),"Skip"]}),e.jsxs(c,{variant:"outlined",onClick:s=>{s.stopPropagation(),d(r)},children:[e.jsx(u,{icon:"checkmark"}),"Apply"]})]})]},l.id))})})})}},T={parameters:{docs:{description:{story:`
...
}`,...T.parameters?.docs?.source}}};const ke=["Default","LongContent","WithActionButtons","CardStates","SidebarDensity","KeyboardNavigation","SkeletonLoading"];export{A as CardStates,B as Default,R as KeyboardNavigation,L as LongContent,N as SidebarDensity,T as SkeletonLoading,_ as WithActionButtons,ke as __namedExportsOrder,Se as default};
