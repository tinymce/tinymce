import{r as s,j as e}from"./iframe-DAP5kn6m.js";import{B as i}from"./Button-CjH6eH-P.js";import{I as M}from"./IconButton-DfwsWYA0.js";import{e as me}from"./Strings-D6HyETGk.js";import{g as xe}from"./Id-Iwcw0aEj.js";import{O as P,a as y,b as ge}from"./Optional-CHj922Ci.js";import{S as G,f as fe,i as ve,d as W,b as Te,c as Ce,e as ye,s as C,a as q,h as ke,p as we,j as je}from"./KeyboardNavigationHooks-CJGOvhB6.js";import{c as I}from"./Fun--VEwoXIw.js";import"./Bem-CMgfceZl.js";import"./Obj-BAtCA5NI.js";import"./Icon-DLgxDwJ-.js";const Re=t=>t.dom.classList!==void 0,Be=(t,o)=>Re(t)&&t.dom.classList.contains(o),he=s.createContext(null),be=()=>{const t=s.useContext(he);if(!y(t))throw new Error("useContextToolbarContext must be used within a ContextToolbarProvider");return t},Se="6px",x=({children:t,persistent:o=!1,anchorRef:r,usePopover:l=!1})=>{const[w,b]=s.useState(!1),d=s.useRef(null),m=s.useRef(null),f=s.useCallback(()=>{b(!0)},[]),j=s.useCallback(()=>{b(!1)},[]),u=s.useCallback(()=>P.from(r==null?void 0:r.current).orThunk(()=>P.from(d.current).map(G.fromDom).bind(fe).filter(ve).map(n=>n.dom).orThunk(()=>P.from(d.current))).getOrNull(),[r,d]);s.useEffect(()=>{const n=u();if(y(n)&&!y(d.current)){const c=window.requestAnimationFrame(()=>{y(d.current)||b(!0)});return()=>window.cancelAnimationFrame(c)}},[u,d]),s.useEffect(()=>{const n=u();if(y(n)){const c=()=>{f()};return n.addEventListener("click",c),()=>{n.removeEventListener("click",c)}}},[u,f]);const O=s.useMemo(()=>({isOpen:w,open:f,close:j,triggerRef:d,toolbarRef:m,anchorRef:r,anchorElement:u(),getAnchorElement:u,persistent:o,usePopover:l}),[w,f,j,o,r,u,l]);return e.jsx(he.Provider,{value:O,children:t})},k=({children:t,onClick:o,onMouseDown:r})=>{const{open:l,triggerRef:w}=be(),b=s.useCallback(m=>{l(),o==null||o(m)},[l,o]),d=s.useCallback(m=>{m.preventDefault(),r==null||r(m)},[r]);return e.jsx("div",{ref:w,onClick:b,onMouseDown:d,children:t})},g=({children:t,onMouseDown:o})=>{const{isOpen:r,toolbarRef:l,triggerRef:w,getAnchorElement:b,close:d,persistent:m,usePopover:f}=be();s.useEffect(()=>{const n=l.current;if(!ge(n)){if(!r){f&&n.hidePopover();return}f&&n.showPopover(),window.queueMicrotask(()=>{const c=G.fromDom(n);W(c,".tox-toolbar__group").bind(v=>W(v,'button, [role="button"]')).fold(()=>n.focus(),v=>Te(v))})}},[f,r,l]),Ce({containerRef:l,onEscape:m?void 0:d}),ye({containerRef:l,selector:"button, .tox-button",useTabstopAt:n=>we(n).filter(c=>Be(c,"tox-toolbar__group")).map(c=>{const T=je(c,"button, .tox-button");return T.length>0&&T[0].dom===n.dom}).getOr(!0),cyclic:!0});const j=s.useCallback(n=>{var c;if(r&&y(l.current)&&n.target instanceof Node){const T=l.current.contains(n.target),h=((c=w.current)==null?void 0:c.contains(n.target))??!1,v=b(),H=(v==null?void 0:v.contains(n.target))??!1;!T&&!h&&!H&&d()}},[r,d,l,w,b]);s.useEffect(()=>{if(!m)return document.addEventListener("mousedown",j),()=>document.removeEventListener("mousedown",j)},[m,j]);const u=s.useMemo(()=>`--${xe("context-toolbar")}`,[]);s.useEffect(()=>{const n=b(),c=l.current;if(!r||!y(n)||!y(c))return;const T=G.fromDom(n),h=G.fromDom(c);C(T,"anchor-name",u),C(h,"position","absolute"),C(h,"margin","0"),C(h,"inset","unset"),C(h,"position-anchor",u);const v=`calc(anchor(${u} bottom) + ${Se})`;return C(h,"top",v),C(h,"justify-self","anchor-center"),C(h,"position-try-fallbacks","flip-block, flip-inline, flip-block flip-inline"),()=>{q(T,"anchor-name"),me(["position","margin","inset","position-anchor","top","justify-self","position-try-fallbacks"],H=>{q(h,H)})}},[u,r,l,b]);const O=s.useCallback(n=>{o==null||o(n)},[o]);return e.jsx("div",{ref:l,popover:f?"manual":void 0,tabIndex:-1,className:"tox-context-toolbar",style:{visibility:r?void 0:"hidden",pointerEvents:"auto"},onMouseDown:O,children:e.jsx("div",{role:"toolbar",className:"tox-toolbar",children:t})})},p=({children:t})=>{const o=s.useRef(null);return ke({containerRef:o,selector:"button, .tox-button",execute:r=>(r.dom.click(),P.some(!0))}),e.jsx("div",{ref:o,role:"group",className:"tox-toolbar__group",children:t})};try{x.displayName="Root",x.__docgenInfo={description:"",displayName:"Root",props:{persistent:{defaultValue:{value:"false"},description:"",name:"persistent",required:!1,type:{name:"boolean"}},anchorRef:{defaultValue:null,description:"",name:"anchorRef",required:!1,type:{name:"RefObject<HTMLElement>"}},usePopover:{defaultValue:{value:"false"},description:"",name:"usePopover",required:!1,type:{name:"boolean"}}}}}catch{}try{k.displayName="Trigger",k.__docgenInfo={description:"",displayName:"Trigger",props:{onClick:{defaultValue:null,description:"",name:"onClick",required:!1,type:{name:"MouseEventHandler<HTMLDivElement>"}},onMouseDown:{defaultValue:null,description:"",name:"onMouseDown",required:!1,type:{name:"MouseEventHandler<HTMLDivElement>"}}}}}catch{}try{g.displayName="Toolbar",g.__docgenInfo={description:"",displayName:"Toolbar",props:{onMouseDown:{defaultValue:null,description:"",name:"onMouseDown",required:!1,type:{name:"MouseEventHandler<HTMLDivElement>"}}}}}catch{}try{p.displayName="Group",p.__docgenInfo={description:"",displayName:"Group",props:{}}}catch{}const{fn:a}=__STORYBOOK_MODULE_TEST__,D=`<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
...
</svg>`,He={title:"components/ContextToolbar",parameters:{layout:"centered",docs:{description:{component:`
...
}`,...(U=(F=R.parameters)==null?void 0:F.docs)==null?void 0:U.source}}};var K,z,$;B.parameters={...B.parameters,docs:{...(K=B.parameters)==null?void 0:K.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...($=(z=B.parameters)==null?void 0:z.docs)==null?void 0:$.source}}};var Y,Z,J;S.parameters={...S.parameters,docs:{...(Y=S.parameters)==null?void 0:Y.docs,source:{originalSource:`{
  render: () => {
    return <div className='tox' style={{
      position: 'relative'
    }}>
...
}`,...(J=(Z=S.parameters)==null?void 0:Z.docs)==null?void 0:J.source}}};var Q,X,ee;A.parameters={...A.parameters,docs:{...(Q=A.parameters)==null?void 0:Q.docs,source:{originalSource:`{
  render: () => {
    return <div className='tox' style={{
      position: 'relative'
    }}>
...
}`,...(ee=(X=A.parameters)==null?void 0:X.docs)==null?void 0:ee.source}}};var oe,te,ne;_.parameters={..._.parameters,docs:{...(oe=_.parameters)==null?void 0:oe.docs,source:{originalSource:`{
  render: () => {
    return <div className='tox' style={{
      position: 'relative'
    }}>
...
}`,...(ne=(te=_.parameters)==null?void 0:te.docs)==null?void 0:ne.source}}};var re,se,ie;E.parameters={...E.parameters,docs:{...(re=E.parameters)==null?void 0:re.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(ie=(se=E.parameters)==null?void 0:se.docs)==null?void 0:ie.source}}};var ae,le,ce;N.parameters={...N.parameters,docs:{...(ae=N.parameters)==null?void 0:ae.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(ce=(le=N.parameters)==null?void 0:le.docs)==null?void 0:ce.source}}};var de,pe,ue;L.parameters={...L.parameters,docs:{...(de=L.parameters)==null?void 0:de.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(ue=(pe=L.parameters)==null?void 0:pe.docs)==null?void 0:ue.source}}};const We=["Basic","Persistent","WithIconButtons","ManyButtons","MixedContent","Corners","WithAnchorRef","ScrollAnchored"];export{R as Basic,E as Corners,A as ManyButtons,_ as MixedContent,B as Persistent,L as ScrollAnchored,N as WithAnchorRef,S as WithIconButtons,We as __namedExportsOrder,He as default};
