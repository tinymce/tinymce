...
</svg>`,Q={getIcon:xo(vo)},Po={title:"components/ContextToolbar",parameters:{layout:"centered",docs:{description:{component:`
...
}`,...P.parameters?.docs?.source}}};const Io=["Basic","Persistent","WithIconButtons","ManyButtons","MixedContent","Corners","WithAnchorRef","ScrollAnchored","DisabledControls"];export{A as Basic,M as Corners,P as DisabledControls,N as ManyButtons,_ as MixedContent,G as Persistent,L as ScrollAnchored,D as WithAnchorRef,E as WithIconButtons,Io as __namedExportsOrder,Po as default};
