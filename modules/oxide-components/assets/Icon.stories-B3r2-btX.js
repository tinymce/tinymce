import{j as n}from"./iframe-W8sxua5T.js";import{I as r}from"./Icon-Cwsq9lTF.js";import{U as t}from"./UniverseProvider-DU3N7gon.js";import{g as s}from"./Obj-SoxFuRAr.js";import"./preload-helper-PPVm8Dsz.js";import"./Optional-BNsUfA-0.js";const c={"chevron-down":'<svg width="10" height="10"><path d="M8.7 2.2c.3-.3.8-.3 1 0 .4.4.4.9 0 1.2L5.7 7.8c-.3.3-.9.3-1.2 0L.2 3.4a.8.8 0 0 1 0-1.2c.3-.3.8-.3 1.1 0L5 6l3.7-3.8Z" fill-rule="nonzero"/></svg>',"chevron-up":'<svg width="10" height="10"><path d="M8.7 7.8 5 4 1.3 7.8c-.3.3-.8.3-1 0a.8.8 0 0 1 0-1.2l4.1-4.4c.3-.3.9-.3 1.2 0l4.2 4.4c.3.3.3.9 0 1.2-.3.3-.8.3-1.1 0Z" fill-rule="nonzero"/></svg>'},i={getIcon:e=>s(c,e).getOrDie("Failed to get icon")},v={title:"components/Icon",parameters:{docs:{description:{component:`
...
The \`Icon\` component uses the underlying UniverseContext state to fetch the SVG markup for the specified \`icon\`. This means that the Icon component always needs to be nested within a UniverseProvider.
        `}}},component:r,decorators:[e=>n.jsx(t,{resources:i,children:n.jsx(e,{})})],tags:["autodocs"]},a=e=>n.jsx("div",{style:{padding:"20px",border:"1px solid lightgray",display:"inline-block"},children:n.jsx(r,{...e})}),d={icon:"chevron-down"},o={args:{...d},render:a};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  args: {
    ...defaultProps
  },
  render
