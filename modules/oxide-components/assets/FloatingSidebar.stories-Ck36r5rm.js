import{j as i,c as b}from"./iframe-DrWVuu1b.js";import{U as _}from"./UniverseProvider-C50FEQcE.js";import{I as w}from"./IconButton-DYv9WnTR.js";import{b as S}from"./Bem-CMgfceZl.js";import{R as F,H as j}from"./Draggable-EiI0LnRf.js";import{c as H}from"./Fun--VEwoXIw.js";import"./Button-BgFXkPz6.js";import"./Universe-CQXn7SA1.js";import"./Optional-CHj922Ci.js";import"./Strings-D6HyETGk.js";import"./Obj-BAtCA5NI.js";const q=e=>{switch(e.origin){case"topleft":return{top:`${e.y}px`,left:`${e.x}px`};case"topright":return{top:`${e.y}px`,left:`calc(${e.x}px - var(--tox-private-floating-sidebar-width))`};case"bottomleft":return{top:`calc(${e.y}px - var(--tox-private-floating-sidebar-height))`,left:`${e.x}px`};case"bottomright":return{top:`calc(${e.y}px - var(--tox-private-floating-sidebar-height))`,left:`calc(${e.x}px - var(--tox-private-floating-sidebar-width))`}}},t=({isOpen:e=!0,children:x,style:f,...v})=>{const y=q(v.initialPosition??{x:0,y:0,origin:"topleft"});return i.jsx(F,{className:S("tox-floating-sidebar",{open:e}),initialPosition:y,allowedOverflow:{horizontal:.8},declaredSize:{width:"var(--tox-private-floating-sidebar-width)",height:"var(--tox-private-floating-sidebar-height)"},style:f,children:i.jsx("aside",{className:b(["tox-floating-sidebar__content-wrapper"]),children:x})})},a=({children:e})=>i.jsx(j,{children:i.jsx("header",{className:b(["tox-sidebar-content__header","tox-floating-sidebar__header"]),children:e})});try{t.displayName="Root",t.__docgenInfo={description:"",displayName:"Root",props:{isOpen:{defaultValue:{value:"true"},description:"",name:"isOpen",required:!1,type:{name:"boolean"}},initialPosition:{defaultValue:null,description:"",name:"initialPosition",required:!1,type:{name:"InitialPosition"}},style:{defaultValue:null,description:"",name:"style",required:!1,type:{name:"CSSProperties"}}}}}catch{}try{a.displayName="Header",a.__docgenInfo={description:"",displayName:"Header",props:{}}}catch{}const z={title:"components/FloatingSidebar",component:t,parameters:{layout:"centered",docs:{description:{component:`A draggable floating sidebar component, can be positioned anywhere on the screen.
...
}`,...(h=(g=r.parameters)==null?void 0:g.docs)==null?void 0:h.source}}};const J=["Example","ButtonInHeader","InitialPosition"];export{n as ButtonInHeader,o as Example,r as InitialPosition,J as __namedExportsOrder,z as default};
