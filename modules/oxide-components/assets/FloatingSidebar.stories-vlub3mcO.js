import{r as w,j as i,c as b}from"./iframe-Dt7rryTP.js";import{U as F}from"./UniverseProvider-CDuMBJFO.js";import{I as S}from"./IconButton-Ckf4lXzJ.js";import{b as j}from"./Bem-CMgfceZl.js";import{R as H,H as q}from"./Draggable-Crdz5sq7.js";import{c as P}from"./Fun--VEwoXIw.js";import"./Button-BeKEsU8h.js";import"./Icon-dpQFbj18.js";import"./Optional-CHj922Ci.js";import"./Strings-D6HyETGk.js";import"./Obj-BAtCA5NI.js";const R=e=>{switch(e.origin){case"topleft":return{top:`${e.y}px`,left:`${e.x}px`};case"topright":return{top:`${e.y}px`,left:`calc(${e.x}px - var(--tox-private-floating-sidebar-width))`};case"bottomleft":return{top:`calc(${e.y}px - var(--tox-private-floating-sidebar-height))`,left:`${e.x}px`};case"bottomright":return{top:`calc(${e.y}px - var(--tox-private-floating-sidebar-height))`,left:`calc(${e.x}px - var(--tox-private-floating-sidebar-width))`}}},t=({isOpen:e=!0,height:x=600,children:f,...v})=>{const y=w.useRef(null),_=R(v.initialPosition??{x:0,y:0,origin:"topleft"});return i.jsx(H,{ref:y,className:j("tox-floating-sidebar",{open:e}),style:{"--tox-private-floating-sidebar-requested-height":`${x}px`},initialPosition:_,declaredSize:{width:"var(--tox-private-floating-sidebar-width)",height:"var(--tox-private-floating-sidebar-height)"},children:i.jsx("aside",{className:b(["tox-floating-sidebar__content-wrapper"]),children:f})})},a=({children:e})=>i.jsx(q,{children:i.jsx("header",{className:b(["tox-sidebar-content__header","tox-floating-sidebar__header"]),children:e})});try{t.displayName="Root",t.__docgenInfo={description:"",displayName:"Root",props:{isOpen:{defaultValue:{value:"true"},description:"",name:"isOpen",required:!1,type:{name:"boolean"}},height:{defaultValue:{value:"600"},description:"",name:"height",required:!1,type:{name:"number"}},initialPosition:{defaultValue:null,description:"",name:"initialPosition",required:!1,type:{name:"InitialPosition"}}}}}catch{}try{a.displayName="Header",a.__docgenInfo={description:"",displayName:"Header",props:{}}}catch{}const U={title:"components/FloatingSidebar",component:t,parameters:{layout:"centered",docs:{description:{component:`A draggable floating sidebar component, can be positioned anywhere on the screen.
...
}`,...(m=(p=n.parameters)==null?void 0:p.docs)==null?void 0:m.source}}};var u,h,g;r.parameters={...r.parameters,docs:{...(u=r.parameters)==null?void 0:u.docs,source:{originalSource:`{
...
}`,...(g=(h=r.parameters)==null?void 0:h.docs)==null?void 0:g.source}}};const X=["Example","ButtonInHeader","InitialPosition"];export{n as ButtonInHeader,o as Example,r as InitialPosition,X as __namedExportsOrder,U as default};
