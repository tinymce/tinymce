import{r as s,j as t}from"./iframe-BBSycjvz.js";import{b as f}from"./KeyboardNavigationHooks-B0XVMoDd.js";import{c as b}from"./Fun-DfA6N4bS.js";import{O as y}from"./Optional-BMqOXurB.js";import"./preload-helper-PPVm8Dsz.js";import"./Strings-DatO8Mn0.js";import"./Num-xrWELwUY.js";const n=({classes:e})=>t.jsx("span",{className:e.join(" "),style:{display:"inline-block",width:"20px",height:"20px",margin:"2px",border:"1px solid "+(e.includes("stay")?"blue":"yellow")},tabIndex:-1}),u=s.forwardRef(({testId:e},r)=>t.jsxs("div",{"data-testid":e,ref:r,className:"flow-keying-test",style:{background:"white",width:"200px",height:"200px"},children:[t.jsx(n,{classes:["stay","one"]}),t.jsx(n,{classes:["stay","two"]}),t.jsx(n,{classes:["skip","three"]}),t.jsx(n,{classes:["skip","four"]}),t.jsx(n,{classes:["stay","five"]})]}));try{u.displayName="Container",u.__docgenInfo={description:"",displayName:"Container",props:{}}}catch{}const l={render:()=>{const e=s.useRef(null);return f({containerRef:e,selector:".stay",cycles:!0}),s.useEffect(()=>{e.current&&e.current.querySelector(".stay")?.focus()},[]),t.jsx(u,{ref:e,testId:"container"})}};l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{
  render: () => {
