...
<svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
...
</svg>`]]).get(e)||"",y={getIcon:k},x=e=>t.jsx(a,{onSubmit:e.onSubmit,placeholder:e.placeholder,label:e.label}),o={args:{label:"Some input:",placeholder:"value...",onSubmit:e=>{window.alert(`Form submitted with value: ${e}`)}},parameters:{docs:{story:{inline:!1,iframeHeight:700}}},render:x},n={args:{label:"URL",placeholder:"http://",onSubmit:e=>{window.alert(`Form submitted with value: ${e}`)}},parameters:{docs:{story:{inline:!1,iframeHeight:700}}},render:x};var u,p,d;o.parameters={...o.parameters,docs:{...(u=o.parameters)==null?void 0:u.docs,source:{originalSource:`{
  args: {
    label: 'Some input:',
    placeholder: 'value...',
    onSubmit: value => {
  ...
  render
}`,...(d=(p=o.parameters)==null?void 0:p.docs)==null?void 0:d.source}}};var h,b,f;n.parameters={...n.parameters,docs:{...(h=n.parameters)==null?void 0:h.docs,source:{originalSource:`{
  args: {
    label: 'URL',
    placeholder: 'http://',
    onSubmit: value => {
  ...
  render
}`,...(f=(b=n.parameters)==null?void 0:b.docs)==null?void 0:f.source}}};const T=["Example","Url"];export{o as Example,n as Url,T as __namedExportsOrder,N as default};
