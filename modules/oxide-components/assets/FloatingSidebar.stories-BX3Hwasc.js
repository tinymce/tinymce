import{r as c,j as i,f as d}from"./iframe-DvbYzFv_.js";import{I as S}from"./IconButton-skYOeQLz.js";import{R as P,H}from"./Draggable-XWzpDpWt.js";import{c as j}from"./Optional-Bk48EtMP.js";import"./Button-EKntp6Jz.js";import"./Bem-CYtV9GpZ.js";import"./Strings-ChBvWd27.js";const q=e=>{switch(e.origin){case"topleft":return{top:`${e.y}px`,left:`${e.x}px`};case"topright":return{top:`${e.y}px`,left:`calc(${e.x}px - var(--tox-private-floating-sidebar-width))`};case"bottomleft":return{top:`calc(${e.y}px - var(--tox-private-floating-sidebar-height))`,left:`${e.x}px`};case"bottomright":return{top:`calc(${e.y}px - var(--tox-private-floating-sidebar-height))`,left:`calc(${e.x}px - var(--tox-private-floating-sidebar-width))`}}},t=({isOpen:e=!0,height:y=600,children:_,...w})=>{const l=c.useRef(null),F=q(w.initialPosition??{x:0,y:0,origin:"topleft"});return c.useEffect(()=>{const s=l.current;s&&(e?s.showPopover():s.hidePopover())},[e]),i.jsx(P,{ref:l,popover:"manual",className:d(["tox-floating-sidebar"]),style:{"--tox-private-floating-sidebar-requested-height":`${y}px`},initialPosition:F,declaredSize:{width:"var(--tox-private-floating-sidebar-width)",height:"var(--tox-private-floating-sidebar-height)"},children:i.jsx("aside",{className:d(["tox-floating-sidebar__content-wrapper"]),children:_})})},a=({children:e})=>i.jsx(H,{children:i.jsx("header",{className:d(["tox-sidebar-content__header","tox-floating-sidebar__header"]),children:e})});try{t.displayName="Root",t.__docgenInfo={description:"",displayName:"Root",props:{isOpen:{defaultValue:{value:"true"},description:"",name:"isOpen",required:!1,type:{name:"boolean"}},height:{defaultValue:{value:"600"},description:"",name:"height",required:!1,type:{name:"number"}},initialPosition:{defaultValue:null,description:"",name:"initialPosition",required:!1,type:{name:"InitialPosition"}}}}}catch{}try{a.displayName="Header",a.__docgenInfo={description:"",displayName:"Header",props:{}}}catch{}const C={title:"components/FloatingSidebar",component:t,parameters:{layout:"centered",docs:{description:{component:`A draggable floating sidebar component that uses the Popover API and can be positioned anywhere on the screen.
...
}`,...(b=(g=n.parameters)==null?void 0:g.docs)==null?void 0:b.source}}};var v,f,x;r.parameters={...r.parameters,docs:{...(v=r.parameters)==null?void 0:v.docs,source:{originalSource:`{
...
}`,...(x=(f=r.parameters)==null?void 0:f.docs)==null?void 0:x.source}}};const L=["Example","ButtonInHeader","InitialPosition"];export{n as ButtonInHeader,o as Example,r as InitialPosition,L as __namedExportsOrder,C as default};
