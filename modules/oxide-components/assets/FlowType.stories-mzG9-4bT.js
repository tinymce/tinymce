...
}`,...(x=(h=c.parameters)==null?void 0:h.docs)==null?void 0:x.source}}};const i={render:()=>{const e=r.useRef(null);return p({containerRef:e,selector:".stay",cycles:!1}),r.useEffect(()=>{var s;e.current&&((s=e.current.querySelector(".stay"))==null||s.focus())},[]),t.jsx(d,{ref:e,testId:"container"})}};var g,w,j;i.parameters={...i.parameters,docs:{...(g=i.parameters)==null?void 0:g.docs,source:{originalSource:`{
  render: () => {
    const ref = useRef<HTMLDivElement>(null);
    useFlowKeyNavigation({
      containerRef: ref,
