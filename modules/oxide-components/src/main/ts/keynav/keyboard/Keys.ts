...
const SHIFT: ReadonlyArray<Key> = [{ code: 'Shift', key: 'Shift', which: 16 }];
...
const SPACE: ReadonlyArray<Key> = [{ code: 'Space', key: 'Space', which: 32 }];
const ESCAPE: ReadonlyArray<Key> = [{ code: 'Escape', key: ' ', which: 27 }];
