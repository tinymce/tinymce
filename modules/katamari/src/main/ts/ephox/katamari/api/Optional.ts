...
export class Optional<T> {
  ...
  */
   ...
   */
  public filter<T2 extends T>(predicate: (value: T) => value is T2): Optional<T2>;
  ...
  */
  public getOr<T2 = T>(replacement: T2): T | T2 {
  ...
  */
  public or<T2>(replacement: Optional<T2>): Optional<T | T2> {
   ...
   */
  public getOrThunk<T2 = T>(thunk: () => T2): T | T2 {
  ...
  /**
   ...
   meaning that this method will always return an Optional.
  */
  public orThunk<T2 = T>(thunk: () => Optional<T2>): Optional<T | T2> {
