...
describe('atomic.katamari.api.arr.ExistsTest', () => {
  it('Arr.exists: unit test', () => {
    ...
    assert.deepEqual(Arr.exists([], bottom), false);
    assert.deepEqual(Arr.exists([], always), false);
  });
