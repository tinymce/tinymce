...
UnitTest.test('Arr.groupBy: unit tests', () => {
  ...
  check([undefined, 1, 2, undefined, undefined, undefined, 1, 2], [[undefined], [1], [2], [undefined, undefined, undefined], [1], [2]]);
  check([{}, 1, 2, undefined, undefined, undefined, 1, 2], [[{}], [1], [2], [undefined, undefined, undefined], [1], [2]]);
...
UnitTest.test('Arr.groupBy: Adjacent groups have different hashes, and everything in a group has the same hash', () => {
  fc.assert(
    fc.property(fc.array(fc.integer()), fc.func(fc.asciiString()), (xs, f) => {
