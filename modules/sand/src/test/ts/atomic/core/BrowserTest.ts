...
UnitTest.test('BrowserTest', function () {
  function check(
    ...
    assert.eq(
      true,
      PlatformQuery[expectedQuery](platform),
      'The query ' +
        expectedQuery +
        ' should match.\nUser Agent: ' +
        userAgent +
  ...
  const checkOSVersion = function (
    ...
    assert.eq(
      expectedMajor,
      platform.os.version.major,
      'invalid major OS version ' +
        platform.os.version.major +
        ' for agent: ' +
        userAgent
    );
    assert.eq(
      expectedMinor,
      platform.os.version.minor,
      'invalid minor OS version ' +
        platform.os.version.minor +
        ' for agent: ' +
        userAgent
    );
  ...
  check(
    ...
    3,
    6,
    'Mozilla/5.0 (X11; U; Linux x86_64; en-US; rv:1.9.2.7) Gecko/20100723 Fedora/3.6.7-1.fc13 Firefox/3.6'
  );
  check(
    'isFirefox',
    'FreeBSD',
    ...
    3,
    6,
    'Mozilla/5.0 (X11; U; FreeBSD amd64; en-US; rv:1.9.2.20) Gecko/20110823 Firefox/3.6.20'
  );
  check(
    'isFirefox',
    'OSX',
    ...
    3,
    5,
    'Mozilla/5.0 (Macintosh; U; Intel Mac OS X 10.6; en-US; rv:1.9.1.9) Gecko/20100315 Firefox/3.5.9 GTB7'
  );
  ...
  checkOSVersion(
    3,
    0,
    'Mozilla/5.0 (Linux; U; Android 3.0; xx-xx; GT-P7100 Build/HRI83) AppleWebkit/534.13 (KHTML, like Gecko) Version/4.0 Safari/534.13'
  );
  checkOSVersion(
    4,
    0,
  ...
  checkOSVersion(
    9,
    2,
    'Mozilla/5.0 (iPad; CPU OS 9_2 like Mac OS X) AppleWebKit/601.1.46 (KHTML, like Gecko) Mobile/13C75'
  );
