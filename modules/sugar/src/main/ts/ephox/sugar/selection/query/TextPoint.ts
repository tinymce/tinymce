...
const locateOffset = function (
  doc: Element<Document>,
  textnode: Element<DomText>,
  x: number,
  y: number,
  ...
  const offset = Geometry.searchForPoint(
    rectForOffset,
    x,
    y,
    rect.right,
...
const locate = function (
  ...
  const foundRect = Arr.findMap<ClientRect | DOMRect, ClientRect | DOMRect>(
    rects,
    function (rect) {
