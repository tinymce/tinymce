...
import { type EventArgs, type EventFilter, type EventHandler, type EventUnbinder } from './events/Types';
...
import { type RawRect, type Rect, type StructRect } from './selection/Rect';
