...
describe('SugarFragment.fromHtml', () => {
  ...
  it('TINY-13526: should create fragment from single element', () => {
    const html = '<div>content</div>';
    const fragment = SugarFragment.fromHtml(html);
  ...
  it('TINY-13526: should create fragment from multiple sibling elements', () => {
  ...
  it('TINY-13526: should create fragment from nested elements', () => {
  ...
  it('TINY-13526: should create fragment from text and elements mixed', () => {
  ...
  it('TINY-13526: should create fragment from empty string', () => {
    const html = '';
    const fragment = SugarFragment.fromHtml(html);
    const children = Traverse.children(fragment);
  ...
  it('TINY-13526: should create fragment with attributes preserved', () => {
  ...
  it('TINY-13526: should handle rwo without table structure', () => {
  ...
  it('TINY-13526: should handle self-closing tags', () => {
  ...
  it('TINY-13526: should handle whitespace-only content', () => {
    const html = '   \n\t   ';
    const fragment = SugarFragment.fromHtml(html);
    const children = Traverse.children(fragment);
  ...
  it('TINY-13526: should create fragment with custom scope document', () => {
  ...
  it('TINY-13526: should handle malformed HTML', () => {
  ...
  it('TINY-13526: should handle script tags', () => {
  ...
  it('TINY-13526: should handle comments', () => {
  ...
  it('TINY-13526: should handle HTML entities', () => {
  ...
  it('TINY-13526: should handle special characters', () => {
  ...
  it('TINY-13526: should handle inline styles', () => {
