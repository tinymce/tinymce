...
UnitTest.asynctest('ScrollTest', (success, failure) => {
  ...
  if (!Math.sign) {
    // For IE: https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Math/sign
  ...
  testOne(
    ifr,
    {
      ...
      iframe: {
        id: 'vanilla',
        style: 'height:200px; width:500px; border: 7px dotted chartreuse;'
      },
      html: Option.none(),
      body: Option.some({
    ...
    function () {
      testOne(
        ifr,
        {
          ...
          iframe: {
            id: 'rtl',
            style: 'height:200px; width:500px; border: 7px solid blueviolet;'
          },
          html: Option.none(),
          body: Option.some({
            dir: 'rtl',
