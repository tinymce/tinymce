...
UnitTest.asynctest('Tooltipping Behaviour', (success, failure) => {
  ...
  GuiSetup.setup(
        ...
        Container.sketch({
          ...
          containerBehaviours: Behaviour.derive([
            Tooltipping.config({
              ...
              tooltipComponents: [GuiFactory.text(`${name}-tooltip`)]
            }),
            Focusing.config({})
          ])
        });
    ...
    (doc, _body, gui, component, _store) => {
      ...
      const sAssertSinkHtml = (html: string) =>
        Logger.t(
      ...
      return Arr.flatten([
        Logger.ts('Checking initial structure', [
          Assertions.sAssertStructure(
         ...
         */
        Logger.ts('Checking tooltips appear and disappear on focus and hover', [
