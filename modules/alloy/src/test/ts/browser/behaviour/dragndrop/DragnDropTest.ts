...
UnitTest.asynctest('DragnDropTest', (success, failure) => {
  ...
  GuiSetup.setup(
    ...
    (_doc, _body, _gui, _component, store) => [
      ...
      Logger.t(
        'Drag and drop with custom dataTransfer code',
        GeneralSteps.sequence(
          platform.browser.isIE()
            ...
            : [
                ...
                sAssertDraggedData('Should have expected data', store, {
                  data: 'c'
                })
              ]
        )
