...
UnitTest.asynctest('TogglingClassTest', (success, failure) => {
  GuiSetup.setup(
    ...
    (_doc, _body, _gui, component, _store) => {
        ...
        Step.sync(() => {
          Assertions.assertStructure(
            ...
            ApproxStructure.build((s, str, arr) =>
              s.element('div', {
                classes: [arr.has('test-selected'), arr.not('selected')],
                attrs: {
      ...
      const testNotSelected = (label: string) =>
        Step.sync(() => {
          Assertions.assertStructure(
            ...
            ApproxStructure.build((s, str, arr) =>
              s.element('div', {
                classes: [arr.not('test-selected'), arr.not('selected')],
                attrs: {
      ...
      const sToggleSet = (state: boolean) =>
        Step.sync(() => {
      ...
      return [
        ...
        assertIsSelected(
          'selected > toggle, toggle, deselect, deselect',
          false
        ),
        ...
        assertIsSelected(
          'selected > toggle, toggle, deselect, deselect, select',
          true
        ),
        sSelect,
        testIsSelected(
          'selected > toggle, toggle, deselect, deselect, select, select'
        ),
        assertIsSelected(
          'selected > toggle, toggle, deselect, deselect, select, select',
          true
        ...
        sToggleSet(false),
        testNotSelected(
          'selected > toggle, toggle, deselect, deselect, select, deselect'
        ),
        assertIsSelected(
          'selected > toggle, toggle, deselect, deselect, select, deselect',
          false
        ...
        sToggleSet(false),
        testNotSelected(
          'selected > toggle, toggle, deselect, deselect, select, deselect, deselect'
        ),
        assertIsSelected(
          'selected > toggle, toggle, deselect, deselect, select, deselect, deselect',
          false
        ...
        sToggleSet(true),
        testIsSelected(
          'selected > toggle, toggle, deselect, deselect, select, deselect, deselect, select'
        ),
        assertIsSelected(
          'selected > toggle, toggle, deselect, deselect, select, deselect, deselect, select',
          true
        ...
        sToggleSet(true),
        testIsSelected(
          'selected > toggle, toggle, deselect, deselect, select, deselect, deselect, select, select'
        ),
        assertIsSelected(
          'selected > toggle, toggle, deselect, deselect, select, deselect, deselect, select, select',
          true
        ...
        testNotSelected(
          'selected > toggle, toggle, deselect, deselect, select, deselect, deselect, select, select, event.exec'
        ),
        assertIsSelected(
          'selected > toggle, toggle, deselect, deselect, select, deselect, deselect, select, select, event.exec',
          false
