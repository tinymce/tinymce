    ...
    GuiSetup.setup(
      ...
      (_doc, _body, _gui, component, store) => {
        ...
        return [
          ...
          sSendTouchmove([{ clientX: 10, clientY: 100 }]),
          ...
          store.sAssertEq(
            'Should still be empty because there was only one touch point ',
            []
          ),
          ...
          store.sAssertEq(
            'Should still be empty because two valid events are required to start pinching ',
            []
          ),
          ...
          store.sAssertEq(
            'Should have increased in size (delta of differences)',
            [
              {
                method: 'punch',
                dx: 20 - 5 - (15 - 10),
          ...
          store.sAssertEq(
            'Should have decreased in size (delta of differences)',
            [
              {
                method: 'pinch',
                dx: 16 - 8 - (20 - 5),
