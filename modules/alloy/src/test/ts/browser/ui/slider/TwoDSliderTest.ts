  ...
  GuiSetup.setup(
        ...
        Slider.sketch({
          ...
          components: [
            Slider.parts()['top-left-edge']({
              dom: {
                tag: 'div',
                classes: ['twod-slider-test-top-left-edge'],
                styles: {
                  width: '25px',
                  height: '25px',
                  background: 'black'
            ...
            Slider.parts()['top-edge']({
              dom: {
                tag: 'div',
                classes: ['twod-slider-test-top-edge'],
                styles: {
                  width: '150px',
                  height: '25px',
                  background: 'white'
            ...
            Slider.parts()['top-right-edge']({
              dom: {
                tag: 'div',
                classes: ['twod-slider-test-top-right-edge'],
                styles: {
                  width: '25px',
                  height: '25px',
                  background: 'black'
            ...
            Slider.parts()['left-edge']({
              dom: {
                tag: 'div',
                classes: ['twod-slider-test-left-edge'],
                styles: {
                  width: '25px',
                  height: '150px',
                  background: 'white'
            ...
            Slider.parts().spectrum({
              dom: {
                tag: 'div',
                classes: ['twod-slider-test-spectrum'],
                styles: {
                  width: '150px',
                  height: '150px',
                  background: 'green'
            ...
            Slider.parts()['right-edge']({
              dom: {
                tag: 'div',
                classes: ['twod-slider-test-right-edge'],
                styles: {
                  width: '25px',
                  height: '150px',
                  background: 'white'
            ...
            Slider.parts()['bottom-left-edge']({
              dom: {
                tag: 'div',
                classes: ['twod-slider-test-bottom-left-edge'],
                styles: {
                  width: '25px',
                  height: '25px',
                  background: 'black'
            ...
            Slider.parts()['bottom-edge']({
              dom: {
                tag: 'div',
                classes: ['twod-slider-test-bottom-edge'],
                styles: {
                  width: '150px',
                  height: '25px',
                  background: 'white'
            ...
            Slider.parts()['bottom-right-edge']({
              dom: {
                tag: 'div',
                classes: ['twod-slider-test-bottom-right-edge'],
                styles: {
                  width: '25px',
                  height: '25px',
                  background: 'black'
            ...
            Slider.parts().thumb({
              dom: {
                tag: 'div',
                classes: ['twod-slider-test-thumb'],
                styles: {
                  width: '20px',
                  height: '20px',
                  background: 'gray'
    ...
    (doc, _body, _gui, component, _store) => {
      ...
      const cCheckThumbAtLeft = Chain.op((parts: any) => {
        Assert.eq(
          'Thumb (' +
            parts.thumbRect.left +
            '->' +
            parts.thumbRect.right +
            '), Left-Edge: (' +
            parts.ledgeRect.left +
            '->' +
            parts.ledgeRect.right +
            ')',
          true,
      ...
      const cCheckThumbAtRight = Chain.op((parts: any) => {
        Assert.eq(
          'Thumb (' +
            ...
            parts.thumbRect.right +
            '), Right-Edge: (' +
            parts.redgeRect.left +
            '->' +
            parts.redgeRect.right +
            ')',
          true,
      ...
      const cCheckThumbAtTop = Chain.op((parts: any) => {
        Assert.eq(
          'Thumb (' +
            parts.thumbRect.top +
            '->' +
            parts.thumbRect.bottom +
            '), Top-Edge: (' +
            parts.tedgeRect.top +
            '->' +
            parts.tedgeRect.bottom +
            ')',
          true,
      ...
      const cCheckThumbPastRight = Chain.op((parts: any) => {
        Assert.eq('Checking thumb past end of spectrum', true, parts.thumbRect.left > parts.spectrumRect.right);
      });

      const cCheckThumbBeforeLeft = Chain.op((parts: any) => {
        Assert.eq('Checking thumb before start of spectrum', true, parts.thumbRect.right < parts.spectrumRect.left);
      });

      const cCheckThumbPastBottom = Chain.op((parts: any) => {
        Assert.eq('Checking thumb past end of spectrum', true, parts.thumbRect.top > parts.spectrumRect.bottom);
      });

      const cCheckThumbBeforeTop = Chain.op((parts: any) => {
        Assert.eq('Checking thumb before start of spectrum', true, parts.thumbRect.bottom < parts.spectrumRect.top);
      });
      ...
      return [
        Logger.t(
          ...
          Waiter.sTryUntil(
            ...
            Chain.asStep({}, [cGetParts, cCheckThumbAtRight, cCheckThumbAtBottom, cCheckValue({ x: 200, y: 200 })])
          )
        ),
        ...
        Logger.t(
          ...
          Chain.asStep({}, [cGetParts, cCheckThumbAtLeft, cCheckThumbAtTop, cCheckValue({ x: 50, y: 50 })])
        ),
        ...
        Logger.t(
          ...
          Chain.asStep({}, [cGetParts, cCheckThumbPastRight, cCheckThumbAtBottom, cCheckValue({ x: 201, y: 200 })])
        ),
        Keyboard.sKeydown(doc, Keys.right(), {}),
        Logger.t(
        ...
        Logger.t(
          ...
          Chain.asStep({}, [cGetParts, cCheckThumbPastRight, cCheckThumbPastBottom, cCheckValue({ x: 201, y: 201 })])
        ),
        ...
        Logger.t(
          ...
          Chain.asStep({}, [cGetParts, cCheckThumbAtRight, cCheckThumbPastBottom, cCheckValue({ x: 200, y: 201 })])
        ),
        ...
        Logger.t(
          ...
          Chain.asStep({}, [cGetParts, cCheckThumbBeforeLeft, cCheckThumbAtTop, cCheckValue({ x: 49, y: 50 })])
        ),
        ...
        Logger.t(
          ...
          Chain.asStep({}, [cGetParts, cCheckThumbBeforeLeft, cCheckThumbBeforeTop, cCheckValue({ x: 49, y: 49 })])
        ),
