        ...
        Slider.sketch({
          ...
          components: [
            Slider.parts()['top-edge']({
              dom: {
                tag: 'div',
                classes: ['vertical-slider-test-top-edge'],
                styles: {
                  height: '40px',
                  width: '20px',
                  background: 'black'
            ...
            Slider.parts().spectrum({
              dom: {
                tag: 'div',
                classes: ['vertical-slider-test-spectrum'],
                styles: {
                  height: '150px',
                  background: 'green'
                }
            ...
            Slider.parts()['bottom-edge']({
              dom: {
                tag: 'div',
                classes: ['vertical-slider-test-bottom-edge'],
                styles: {
                  height: '40px',
                  width: '20px',
                  background: 'white'
            ...
            Slider.parts().thumb({
              dom: {
                tag: 'div',
                classes: ['vertical-slider-test-thumb'],
                styles: {
                  height: '20px',
                  width: '20px',
                  background: 'gray'
    ...
    (doc, _body, _gui, component, _store) => {
      ...
      return [
        Logger.t(
          ...
          Waiter.sTryUntil('Initial load can take a while', Chain.asStep({}, [cGetParts, cCheckThumbAtBottom, cCheckValue(200)]))
        ),
        ...
        Logger.t(
          ...
          Chain.asStep({}, [cGetParts, cCheckThumbAtTop, cCheckValue(50)])
        ),
        ...
        Logger.t(
          ...
          Chain.asStep({}, [cGetParts, cCheckThumbAtBottom, cCheckValue(200)])
        ),
        ...
        Logger.t('Checking that the thumb is past the max', Chain.asStep({}, [cGetParts, cCheckThumbPastBottom, cCheckValue(201)])),
        Keyboard.sKeydown(doc, Keys.down(), {}),
        Logger.t(
          'Pressed bottom at bottom edge. Checking that the thumb is still past the max and value has not changed',
          Chain.asStep({}, [cGetParts, cCheckThumbPastBottom, cCheckValue(201)])
        ),
        ...
        Keyboard.sKeydown(doc, Keys.up(), {}),
        Logger.t('Checking that the thumb is before the min', Chain.asStep({}, [cGetParts, cCheckThumbBeforeTop, cCheckValue(49)])),

        Keyboard.sKeydown(doc, Keys.up(), {}),
        Logger.t('Checking that the thumb is *still* before the min', Chain.asStep({}, [cGetParts, cCheckThumbBeforeTop, cCheckValue(49)])),

        Keyboard.sKeydown(doc, Keys.down(), {}),
        Logger.t('Checking that the thumb is at the top edge', Chain.asStep({}, [cGetParts, cCheckThumbAtTop, cCheckValue(50)])),
