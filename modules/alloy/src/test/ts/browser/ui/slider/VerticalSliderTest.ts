...
UnitTest.asynctest(
  'Browser Test: ui.slider.VerticalSliderTest',
  (success, failure) => {
    ...
    GuiSetup.setup(
      ...
      (doc, _body, _gui, component, _store) => {
        ...
        const cGetParts = NamedChain.asChain([
          ...
          NamedChain.direct(
            'slider',
            UiFinder.cFindIn('.vertical-slider-test-thumb'),
            'thumb'
          ),
          NamedChain.direct(
            'slider',
            UiFinder.cFindIn('.vertical-slider-test-top-edge'),
            'tedge'
          ),
          NamedChain.direct(
            'slider',
            UiFinder.cFindIn('.vertical-slider-test-bottom-edge'),
            'bedge'
          ),
          NamedChain.direct(
            'slider',
            UiFinder.cFindIn('.vertical-slider-test-spectrum'),
            'spectrum'
          ),
        ...
        return [
          ...
          Logger.t(
            ...
            Chain.asStep({}, [cGetParts, cCheckThumbBeforeTop, cCheckValue(49)])
          ),
          ...
          Keyboard.sKeydown(doc, Keys.down(), {}),
          sAssertValue(
            'Checking that the thumb is now one step further bottom',
            60
          ),
