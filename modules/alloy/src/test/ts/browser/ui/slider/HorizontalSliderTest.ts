...
UnitTest.asynctest(
  'Browser Test: ui.slider.HorizontalSliderTest',
  (success, failure) => {
    ...
    GuiSetup.setup(
      ...
      (doc, _body, _gui, component, _store) => {
        ...
        const cGetParts = NamedChain.asChain([
          ...
          NamedChain.direct(
            'slider',
            UiFinder.cFindIn('.horizontal-slider-test-thumb'),
            'thumb'
          ),
          NamedChain.direct(
            'slider',
            UiFinder.cFindIn('.horizontal-slider-test-left-edge'),
            'ledge'
          ),
          NamedChain.direct(
            'slider',
            UiFinder.cFindIn('.horizontal-slider-test-right-edge'),
            'redge'
          ),
          NamedChain.direct(
            'slider',
            UiFinder.cFindIn('.horizontal-slider-test-spectrum'),
            'spectrum'
          ),
        ...
        return [
          ...
          FocusTools.sTryOnSelector(
            ...
            doc,
            '.horizontal-slider-test-spectrum'
          ),
