        ...
        Slider.sketch({
          ...
          components: [
            Slider.parts()['left-edge']({
              dom: {
                tag: 'div',
                classes: ['horizontal-slider-test-left-edge'],
                styles: {
                  width: '40px',
                  height: '20px',
                  background: 'black'
            ...
            Slider.parts().spectrum({
              dom: {
                tag: 'div',
                classes: ['horizontal-slider-test-spectrum'],
                styles: {
                  height: '150px',
                  background: 'green'
                }
            ...
            Slider.parts()['right-edge']({
              dom: {
                tag: 'div',
                classes: ['horizontal-slider-test-right-edge'],
                styles: {
                  width: '40px',
                  height: '20px',
                  background: 'white'
            ...
            Slider.parts().thumb({
              dom: {
                tag: 'div',
                classes: ['horizontal-slider-test-thumb'],
                styles: {
                  width: '20px',
                  height: '20px',
                  background: 'gray'
    ...
    (doc, _body, _gui, component, _store) => {
      ...
      return [
        Logger.t(
          ...
          Waiter.sTryUntil('Initial load can take a while', Chain.asStep({}, [cGetParts, cCheckThumbAtRight, cCheckValue(200)]))
        ),
        ...
        Logger.t(
          ...
          Chain.asStep({}, [cGetParts, cCheckThumbAtLeft, cCheckValue(50)])
        ),
        ...
        Logger.t(
          ...
          Chain.asStep({}, [cGetParts, cCheckThumbAtRight, cCheckValue(200)])
        ),
        ...
        Logger.t('Checking that the thumb is past the max', Chain.asStep({}, [cGetParts, cCheckThumbPastRight, cCheckValue(201)])),
        Keyboard.sKeydown(doc, Keys.right(), {}),
        Logger.t(
          'Pressed right at right edge. Checking that the thumb is still past the max and value has not changed',
          Chain.asStep({}, [cGetParts, cCheckThumbPastRight, cCheckValue(201)])
        ),
        ...
        Keyboard.sKeydown(doc, Keys.left(), {}),
        Logger.t('Checking that the thumb is before the min', Chain.asStep({}, [cGetParts, cCheckThumbBeforeLeft, cCheckValue(49)])),

        Keyboard.sKeydown(doc, Keys.left(), {}),
        Logger.t(
          'Checking that the thumb is *still* before the min',
          Chain.asStep({}, [cGetParts, cCheckThumbBeforeLeft, cCheckValue(49)])
        ),

        Keyboard.sKeydown(doc, Keys.right(), {}),
        Logger.t('Checking that the thumb is at the left edge', Chain.asStep({}, [cGetParts, cCheckThumbAtLeft, cCheckValue(50)])),
