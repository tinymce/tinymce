  ...
  GuiSetup.setup(
    ...
    (doc, _body, gui, component, _store) => {
      ...
      return [
        ...
        NavigationUtils.highlights(gui.element(), Keys.down(), {}, [item('peo2'), item('peo1'), item('peo2')]),
        ...
        NavigationUtils.highlights(gui.element(), Keys.down(), {}, [item('new-value2'), item('new-value1')]),
        ...
        NavigationUtils.highlights(gui.element(), Keys.down(), {}, [item('new-value12'), item('new-value11')]),
        ...
        TestBroadcasts.sDismissOn('typeahead list option: should not close', gui, '.item[data-value="new-value1222"]'),
        ...
        NavigationUtils.highlights(gui.element(), Keys.down(), {}, [item('neo2')]),
        ...
        Waiter.sTryUntil('Selection should stay on neo2 if possible', UiFinder.sExists(gui.element(), item('neo2').selector)),
        ...
        Step.sync(() => {
          ...
          Assertions.assertEq(
            'Checking getValue after setValue',
            {
              value: 'neo3',
              meta: {
                text: 'Neo3'
