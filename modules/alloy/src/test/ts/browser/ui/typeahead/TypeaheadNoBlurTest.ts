...
UnitTest.asynctest(
  'Browser Test: .ui.typeahead.TypeaheadNoBlurTest',
  (success, failure) => {
    GuiSetup.setup(
      (store, _doc, _body) => {
              ...
              Typeahead.sketch({
                ...
                fetch(_input) {
                  const future = Future.pure([
                    {
                      type: 'item',
                      data: { value: 'choice1', meta: { text: 'choice1' } }
                    },
                    {
                      type: 'item',
                      data: { value: 'choice2', meta: { text: 'choice2' } }
                    }
                  ]);
      ...
      (doc, _body, gui, component, _store) => {
        ...
        return [
          ...
          Step.wait(100),
          steps.sWaitForMenu(
            'Blurring should NOT dismiss popup due to setting'
          ),
          ...
          steps.sWaitForNoMenu(
            'Escape should still dismiss regardless of setting'
          ),
            ...
            GeneralSteps.sequence([
              ...
              Chain.asStep(component.element(), [
                ...
                Assertions.cAssertEq(
                  'Active value should be the first option',
                  'choice1'
                )
              ]),
