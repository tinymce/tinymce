    ...
    (_doc, _body, _gui, component, _store) => {
      ...
      const testFocus = Logger.t(
        ...
        GeneralSteps.sequence([
          sCheckInputSelection('before focus', {
            start: defaultCursor,
            end: defaultCursor
          }),
          Step.sync(() => {
          ...
          sCheckInputSelection('after focus', {
            start: 0,
            end: 'initial Value'.length
          })
        ])
      );
      ...
      return [testStructure, testFocus, testRepresenting];
    },
    success,
    failure
  );
