      ...
      const inline = GuiFactory.build(
        InlineView.sketch({
          ...
          inlineBehaviours: Behaviour.derive([
            AddEventsBehaviour.config('inline-reposition-test', [AlloyEvents.run('test-reposition', store.adder('test-reposition-fired'))])
          ])
        })
      );
      ...
      const sCheckOpen = (label: string, component: AlloyComponent, selector: string) =>
        Logger.t(
          ...
          GeneralSteps.sequence([
            Waiter.sTryUntil('Test inline should not be DOM', UiFinder.sExists(gui.element(), selector)),
            Step.sync(() => {
      ...
      return [
        Logger.t(
          ...
          GeneralSteps.sequence([
            ...
            TestBroadcasts.sReposition('should not move on custom reposition', gui),
        ...
        Logger.t(
          ...
          GeneralSteps.sequence([
            ...
            TestBroadcasts.sReposition('should move on normal reposition', gui),
