...
UnitTest.asynctest('SlotContainerTest', (success, failure) => {
  GuiSetup.setup(
    ...
    (_doc, _body, _gui, component, _store) => {
      ...
      const sAssertButtonShowing = (label: string) =>
        sAssertSlotStructure(label, 'buttonB', (s, str, _arr) =>
          s.element('button', {
            attrs: {
      ...
      const sAssertButtonHidden = (label: string) =>
        sAssertSlotStructure(label, 'buttonB', (s, str, _arr) =>
          s.element('button', {
            attrs: {
      ...
      const sAssertInputShowing = (label: string) =>
        sAssertSlotStructure(label, 'inputA', (s, str, _arr) =>
          s.element('input', {
            attrs: {
              'aria-hidden': str.none()
            },
      ...
      const sAssertInputHidden = (label: string) =>
        sAssertSlotStructure(label, 'inputA', (s, str, _arr) =>
          s.element('input', {
            attrs: {
              'aria-hidden': str.is('true')
