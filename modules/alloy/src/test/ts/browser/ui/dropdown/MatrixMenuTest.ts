        ...
        Menu.sketch({
          ...
          items: Arr.map(
            [
              {
                type: 'item',
                data: { value: 'alpha', meta: {} },
                hasSubmenu: false
              },
              {
                type: 'item',
                data: { value: 'beta', meta: {} },
                hasSubmenu: false
              },
              {
                type: 'item',
                data: { value: 'gamma', meta: {} },
                hasSubmenu: false
              },
              {
                type: 'item',
                data: { value: 'delta', meta: {} },
                hasSubmenu: false
              }
            ],
      ...
      return [
        Chain.asStep({}, [
          NamedChain.asChain([
            ...
            cAssertSelectedStates(
              'After pressing left on menu (with delta focus)',
              [false, false, true, false]
            ),
            store.cAssertEq('After pressing left on delta', [
              'menu.events.focus'
            ]),
            store.cClear
          ])
