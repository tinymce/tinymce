    ...
    return [
      Chain.asStep({}, [
        NamedChain.asChain([
          ...
          NamedChain.direct('menu', cAssertStructure('After focusing item on alpha', ApproxStructure.build((s, str, arr) => s.element('ol', {
            classes: [
              arr.has('test-menu')
            ],
            children: [
          ...
          NamedChain.direct('menu', cAssertStructure('After focusing item on beta', ApproxStructure.build((s, str, arr) => s.element('ol', {
            classes: [
              arr.has('test-menu')
            ],
            children: [
