...
UnitTest.asynctest('TieredMenuWithoutImmediateHighlightTest', (success, failure) => {
  GuiSetup.setup(
                ...
                'menu-a': {
                  ...
                  items: Arr.map(
                    [
                      {
                        type: 'item',
                        data: { value: 'a-alpha', meta: { text: 'a-Alpha' } },
                        hasSubmenu: false
                      },
                      {
                        type: 'item',
                        data: { value: 'a-beta', meta: { text: 'a-Beta' } },
                        hasSubmenu: true
                      },
                      {
                        type: 'item',
                        data: { value: 'a-gamma', meta: { text: 'a-Gamma' } },
                        hasSubmenu: false
                      }
                    ],
                ...
                'a-beta': {
                  ...
                  items: Arr.map(
                    [
                      {
                        type: 'item',
                        data: { value: 'b-alpha', meta: { text: 'b-Alpha' } },
                        hasSubmenu: false
                      }
                    ],
                    TestDropdownMenu.renderItem
    ...
    (_doc, _body, _gui, component, store) => [
      ...
      store.sAssertEq('Focus is fired as soon as the tiered menu is active', ['onOpenMenu']),

      Step.sync(() => {
        TieredMenu.highlightPrimary(component);
      }),
      store.sAssertEq('Focus is fired as soon as the tiered menu is highlighted by API', ['onOpenMenu', 'menu.events.focus']),
