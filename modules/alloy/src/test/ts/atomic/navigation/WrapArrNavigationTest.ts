...
UnitTest.test('WrapArrNavigationTest', () => {
  ...
  Jsc.property('Regular grid: cycleUp and cycleDown should be symmetric', arbRegularGrid, (arb: GeneratedGrid) => {
  ...
  Jsc.property('Regular grid: cycleLeft and cycleRight should be symmetric', arbRegularGrid, (arb: GeneratedGrid) => {
    ...
    const afterRight = WrapArrNavigation.cycleRight(arb.values, afterLeft, arb.numRows, arb.numCols).getOrDie(
  ...
  Jsc.property(
    ...
    (arb: GeneratedIrregularGrid) => {
      const afterDown = WrapArrNavigation.cycleDown(arb.values, arb.index, arb.numRows, arb.numCols).getOrDie(
  ...
  Jsc.property(
    ...
    arbIrregularGrid,
    (arb: GeneratedIrregularGrid) => {
      const afterLeft = WrapArrNavigation.cycleLeft(arb.values, arb.index, arb.numRows, arb.numCols).getOrDie(
