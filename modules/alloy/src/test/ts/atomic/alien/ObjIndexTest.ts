...
UnitTest.test('ObjIndexTest', () => {
  ...
  Logger.sync('test 1: basic object ... overlap', () => {
    const actual = ObjIndex.byInnerKey(
      {
        aus: {
          population: 100
    ...
    assertSortedEq(
      'Checking grouping',
      {
        ...
        moose: [{ country: 'canada', value: 'yes' }]
      },
      actual
    );
  });
