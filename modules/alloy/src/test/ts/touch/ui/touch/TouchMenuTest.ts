...
UnitTest.asynctest('Browser Test: ui.touch.TouchMenuTest', (success, failure) => {
  ...
  GuiSetup.setup(
    ...
    (doc, _body, gui, component, store) => {
      ...
      return [
        GuiSetup.mAddStyles(doc, ['.test-selected-item { background-color: #cadbee; }']),
        ...
        Waiter.sTryUntil('Waiting for menu to disappear', UiFinder.sNotExists(gui.element(), '[role="menu"]')),
        ...
        Waiter.sTryUntil('Waiting until menu appears', UiFinder.sExists(gui.element(), '[role=menu]')),
