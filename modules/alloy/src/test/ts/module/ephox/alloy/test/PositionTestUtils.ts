...
const cAddPopupToSink = (sinkName: string) => NamedChain.bundle((data: any) => {
...
const cTestPopupInSink = (label: string, sinkName: string) => Chain.control(
...
const cTestSink = (label: string, sinkName: string) => ChainUtils.cLogging(
  label,
  [
...
const cTestSinkWithinBounds = (label: string, sinkName: string, bounds: Bounds) => ChainUtils.cLogging(
  label,
  [
...
const cScrollDown = (componentName: string, amount: string) => ChainUtils.cLogging(
