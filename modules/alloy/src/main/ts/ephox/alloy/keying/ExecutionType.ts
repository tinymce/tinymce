...
const getKeyupRules = (component: AlloyComponent, _simulatedEvent: NativeSimulatedEvent, executeConfig: ExecutingConfig, _executeState: Stateless): Array<KeyRules.KeyRule<ExecutingConfig, Stateless>> => {
