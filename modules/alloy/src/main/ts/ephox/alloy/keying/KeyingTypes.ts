...
const stopEventForFirefox: KeyRuleHandler<GeneralKeyingConfig, any> = (component: AlloyComponent, simulatedEvent: NativeSimulatedEvent) => Option.some<boolean>(true);
