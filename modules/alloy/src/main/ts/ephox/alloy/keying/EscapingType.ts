...
const doEscape: KeyRuleHandler<EscapingConfig, Stateless> = (component, simulatedEvent, escapeConfig, escapeState) => escapeConfig.onEscape(component, simulatedEvent);
