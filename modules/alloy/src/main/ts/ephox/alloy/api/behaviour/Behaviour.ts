...
export type ConfiguredBehaviour<
  C extends BehaviourConfigSpec,
  D extends BehaviourConfigDetail,
  S extends BehaviourState = BehaviourState
> = BehaviourTypes.ConfiguredBehaviour<C, D, S>;
...
export type NamedConfiguredBehaviour<
  C extends BehaviourConfigSpec,
  D extends BehaviourConfigDetail,
  S extends BehaviourState = BehaviourState
> = BehaviourTypes.NamedConfiguredBehaviour<C, D, S>;
export type AlloyBehaviour<
  C extends BehaviourConfigSpec,
  D extends BehaviourConfigDetail,
  S extends BehaviourState = BehaviourState
> = BehaviourTypes.AlloyBehaviour<C, D, S>;

export type AlloyBehaviourConfig<
  D extends BehaviourConfigDetail,
  S extends BehaviourState,
  A extends BehaviourTypes.BehaviourApisRecord<D, S>,
  E extends BehaviourTypes.BehaviourExtraRecord<E> = {}
> = BehaviourTypes.BehaviourConfig<D, S, A, E>;
export type BehaviourModeSpec<
  D extends BehaviourConfigDetail,
  S extends BehaviourState,
  A extends BehaviourTypes.BehaviourApisRecord<D, S>,
  E extends BehaviourTypes.BehaviourExtraRecord<E> = {}
...
export { derive, revoke, noActive, noApis, noExtra, create, createModes };
