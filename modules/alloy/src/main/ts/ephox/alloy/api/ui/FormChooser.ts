...
const factory: CompositeSketchFactory<FormChooserDetail, FormChooserSpec> = (
  detail,
  ...
  return {
    ...
    behaviours: SketchBehaviours.augment(detail.chooserBehaviours, [
      Keying.config({
        mode: 'flow',
