...
const factory: CompositeSketchFactory<CustomListDetail, CustomListSpec> = (
  detail,
  components,
  _spec,
  _external
  ...
  const getListContainer = (component: AlloyComponent) =>
    detail.shell
      ...
      : AlloyParts.getPart(component, detail, 'items');
...
const CustomList: CustomListSketcher = Sketcher.composite<
  CustomListSpec,
  CustomListDetail,
  CustomListApis
>({
