import { FieldPresence, ValueProcessorTypes, FieldSchema, Objects, ValueSchema } from '@ephox/boulder';
...
const schemas = (parts: PartType.PartTypeAdt[]): ValueProcessorTypes[] =>
...
const defaultUidsSchema = (partTypes: PartType.PartTypeAdt[]): ValueProcessorTypes => FieldSchema.field(
  'partUids',
  'partUids',
