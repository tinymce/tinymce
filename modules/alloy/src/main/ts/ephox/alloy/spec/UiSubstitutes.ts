...
const scan = <D extends CompositeSketchDetail>(
  owner: Option<string>,
  detail: D,
  compSpec: AlloySpec,
  placeholders: Record<string, Replacement>
...
const substitute = <D extends CompositeSketchDetail>(
  owner: Option<string>,
  detail: D,
  compSpec: AlloySpec,
  placeholders: Record<string, Replacement>
...
const substituteAll = <D extends CompositeSketchDetail>(
  owner: Option<string>,
  detail: D,
...
const substitutePlaces = <D extends CompositeSketchDetail>(
  owner: Option<string>,
  detail: D,
  components: AlloySpec[],
  placeholders: Record<string, UiSubstitutesAdt>
) => {
