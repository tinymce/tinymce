...
export interface ReplacingBehaviour
  extends Behaviour.AlloyBehaviour<ReplacingConfigSpec, ReplacingConfig> {
  config: (
    config: ReplacingConfigSpec
  ) => Behaviour.NamedConfiguredBehaviour<ReplacingConfigSpec, ReplacingConfig>;
  ...
  replaceAt: (
    ...
    replaceeIndex: number,
    replacer: Option<AlloySpec>
  ) => Option<AlloyComponent>;
  replaceBy: (
    component: AlloyComponent,
    replaceePred: (comp: AlloyComponent) => boolean,
    replacer: Option<AlloySpec>
  ) => Option<AlloyComponent>;
