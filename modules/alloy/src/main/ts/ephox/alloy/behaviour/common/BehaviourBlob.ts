...
export interface BehaviourConfigAndState<
  C extends BehaviourConfigDetail,
...
const generateFrom = (
  ...
  all: Array<
    AlloyBehaviour<BehaviourConfigSpec, BehaviourConfigDetail, BehaviourState>
  >
): BehaviourData<
  BehaviourConfigSpec,
  BehaviourConfigDetail,
...
> => {
  ...
  type B = Record<
    string,
    Option<
      BehaviourSpec<BehaviourConfigSpec, BehaviourConfigDetail, BehaviourState>
    >
  >;
