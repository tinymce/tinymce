...
export interface UnselectingBehaviour
  extends Behaviour.AlloyBehaviour<UnselectingConfigSpec, UnselectingConfig> {
  config: (
    config: UnselectingConfigSpec
  ) => Behaviour.NamedConfiguredBehaviour<
    UnselectingConfigSpec,
    UnselectingConfig
  >;
}
