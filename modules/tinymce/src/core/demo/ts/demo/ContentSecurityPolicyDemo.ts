...
const settings = {
  ...
  toolbar: 'undo redo sidebar1 align fontsizeselect fontfamily formatselect styleselect insertfile | styleselect | bold italic | alignleft aligncenter alignright alignjustify | ' +
