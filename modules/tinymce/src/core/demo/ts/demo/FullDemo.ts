...
export default function () {
  ...
  const settings = {
    ...
    toolbar: 'undo redo sidebar1 | bold italic underline strikethrough | alignleft aligncenter alignright alignjustify | align line-height fontsizeselect fontselect formatselect styleselect insertfile | styleselect | ' +
