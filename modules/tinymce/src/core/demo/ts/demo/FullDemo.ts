...
export default () => {
  ...
  const settings: RawEditorOptions = {
    ...
    toolbar: 'undo redo sidebar1 | bold italic underline strikethrough | alignleft aligncenter alignright alignjustify | align lineheight fontsizeselect fontfamily blocks styleselect insertfile | styleselect | ' +
