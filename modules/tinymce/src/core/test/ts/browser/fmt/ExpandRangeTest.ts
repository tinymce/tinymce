    ...
    function (editor, onSuccess, onFailure) {
      ...
      Pipeline.async(
        ...
        [
          tinyApis.sFocus(),
          Logger.t(
            'Expand inline format words',
            GeneralSteps.sequence([
              Logger.t(
                'In middle of single word in paragraph',
                Chain.asStep(editor, [
              ...
              Logger.t(
                'In middle of single word in paragraph with paragraph siblings',
                Chain.asStep(editor, [
              ...
              Logger.t(
                'In middle of single word wrapped in b',
                Chain.asStep(editor, [
              ...
              Logger.t(
                'In middle of word with bold siblings expand to sibling spaces',
                Chain.asStep(editor, [
              ...
              Logger.t(
                'In middle of word with block sibling and inline sibling expand to sibling space to the right',
                Chain.asStep(editor, [
              ...
              Logger.t(
                'In middle of word with block sibling and inline sibling expand to sibling space to the left',
                Chain.asStep(editor, [
              ...
              Logger.t(
                'In middle of middle word separated by nbsp characters',
                Chain.asStep(editor, [
                  cSetRawContent('<p>ab\u00a0cd\u00a0ef</p>'),
                  cExpandRng([0, 0], 4, [0, 0], 4, inlineFormat, false),
                  cAssertRange(editor, [0, 0], 3, [0, 0], 5)
              ...
              Logger.t(
                'In middle of single word in paragraph (index based)',
                Chain.asStep(editor, [
                  cSetRawContent('<p>ab</p>'),
              ...
              Logger.t(
                'In middle of single word wrapped in bold in paragraph (index based)',
                Chain.asStep(editor, [
                  cSetRawContent('<p><b>ab</b></p>'),
                  cExpandRng([0], 0, [0], 1, inlineFormat, false),
                  cAssertRange(editor, [], 0, [], 1)
          ...
          Logger.t(
            'Expand inline format words (remove format)',
            GeneralSteps.sequence([
              Logger.t(
                'In middle of single word in paragraph',
                Chain.asStep(editor, [
          ...
          Logger.t(
            'Expand selector format',
            GeneralSteps.sequence([
              Logger.t(
                'Do not expand over element if selector does not match',
                Chain.asStep(editor, [
                  cSetRawContent('<p>ab</p>'),
              ...
              Logger.t(
                'Expand since selector matches non collapsed',
                Chain.asStep(editor, [
                  cSetRawContent('<div>ab</div>'),
          ...
          Logger.t(
            'Expand selector format with collapsed property',
            GeneralSteps.sequence([
              Logger.t(
