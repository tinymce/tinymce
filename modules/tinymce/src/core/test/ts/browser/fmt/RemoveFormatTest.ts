...
UnitTest.asynctest(
  'browser.tinymce.core.fmt.RemoveFormatTest',
  (success, failure) => {
    SilverTheme();
      ...
      function (editor, onSuccess, onFailure) {
        ...
        Pipeline.async(
          ...
          [
            tinyApis.sFocus(),
            Logger.t(
              'Remove format with collapsed selection',
              GeneralSteps.sequence([
                Logger.t(
                  'In middle of single word wrapped in strong',
                  GeneralSteps.sequence([
                ...
                Logger.t(
                  'In middle of first of two words wrapped in strong',
                  GeneralSteps.sequence([
                ...
                Logger.t(
                  'In middle of last of two words wrapped in strong',
                  GeneralSteps.sequence([
                    tinyApis.sSetContent('<p><strong>ab cd</strong></p>'),
                ...
                Logger.t(
                  'In middle of first of two words wrapped in strong, with the first wrapped in em as well',
                  GeneralSteps.sequence([
                    tinyApis.sSetContent(
                      '<p><strong><em>ab</em> cd</strong></p>'
                    ),
                ...
                Logger.t(
                  'After first of two words, with multiple spaces wrapped in strong',
                  GeneralSteps.sequence([
                    tinyApis.sSetContent(
                    ...
                    tinyApis.sAssertContent(
                      '<p>ab&nbsp; &nbsp;<strong>cd</strong></p>'
                    ),
                    tinyApis.sAssertSelection([0, 0], 2, [0, 0], 2)
                  ])
                ),
                Logger.t(
                  'Before last of two words, with multiple spaces wrapped in strong',
                  GeneralSteps.sequence([
                    tinyApis.sSetContent(
                      '<p><strong>ab&nbsp; &nbsp;cd</strong></p>'
                    ),
            ...
            Logger.t(
              'Remove single format with collapsed selection',
              GeneralSteps.sequence([
                Logger.t(
                  'In middle of first of two words wrapped in strong and em',
                  GeneralSteps.sequence([
                    tinyApis.sSetContent(
                      '<p><em><strong>ab cd</strong></em></p>'
                    ),
                    tinyApis.sSetCursor([0, 0, 0, 0], 1),
                    sRemoveFormat(editor, boldFormat),
                    tinyApis.sAssertContent(
                      '<p><em>ab <strong>cd</strong></em></p>'
                    ),
                    tinyApis.sAssertSelection([0, 0, 0], 1, [0, 0, 0], 1)
                  ])
                ),
                Logger.t(
                  'After first of two words, with multiple spaces wrapped in strong and em',
                  GeneralSteps.sequence([
                    tinyApis.sSetContent(
                      '<p><em><strong>ab&nbsp; &nbsp;cd</strong></em></p>'
                    ),
