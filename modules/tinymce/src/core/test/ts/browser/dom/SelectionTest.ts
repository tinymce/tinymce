...
UnitTest.asynctest('browser.tinymce.core.dom.SelectionTest', function (
  ...
  suite.test('getContent contextual', function (editor) {
    ...
    editor.selection.setRng(rng);
    LegacyUnit.equal(
      editor.selection.getContent({ contextual: true }),
      '<em>ex</em>',
      'Get selected contents'
    );
  });
  ...
  suite.test('setContent', function (editor) {
    ...
    LegacyUnit.equal(
      editor.getContent(),
      '<p>text</p>',
      'Set contents to empty at selection (collapsed)'
    );
    rng = editor.selection.getRng();
    if (!document.createRange) {
      ...
      LegacyUnit.equalDom(
        rng.startContainer,
        editor.getBody().firstChild.firstChild,
        'Selection start container'
      );
  ...
  suite.test('getStart/getEnd', function (editor) {
    ...
    editor.selection.setRng(rng);
    LegacyUnit.equal(
      editor.selection.getStart().id,
      'a',
      'Selected contents (getStart)'
    );
    LegacyUnit.equal(
      editor.selection.getEnd().id,
      'b',
      'Selected contents (getEnd)'
    );
    ...
    LegacyUnit.equal(
      editor.selection.getStart().id,
      'a',
      'Selected contents (getStart, collapsed)'
    );
    LegacyUnit.equal(
      editor.selection.getEnd().id,
      'a',
      'Selected contents (getEnd, collapsed)'
    );
  });

  suite.test(
    'getSelectedBlocks with collapsed selection between elements',
    (editor: Editor) => {
      ...
      editor.selection.setRng(rng);
      LegacyUnit.equal(
        editor.selection.getSelectedBlocks().length,
        0,
  ...
  suite.test(
    'getStart/getEnd on comment should return parent element',
    function (editor) {
      ...
      LegacyUnit.equal(
        editor.selection.getStart().nodeName,
        'P',
        'Node name should be paragraph'
      );
      LegacyUnit.equal(
        editor.selection.getStart(true).nodeName,
        'P',
        'Node name should be paragraph'
      );
      LegacyUnit.equal(
        editor.selection.getEnd().nodeName,
        'P',
        'Node name should be paragraph'
      );
      LegacyUnit.equal(
        editor.selection.getEnd(true).nodeName,
        'P',
        'Node name should be paragraph'
      );
    }
  ...
  suite.test(
    'getBookmark/setBookmark (nonintrusive) - simple text selection',
    function (editor) {
      let rng, bookmark;
  ...
  suite.test(
    'getBookmark/setBookmark (nonintrusive) - Get non intrusive bookmark simple element selection',
    function (editor) {
      let rng, bookmark;
      ...
      LegacyUnit.equal(
        editor.selection.getContent(),
        '<strong>b</strong>',
        'Selected contents (element)'
      );
    }
  );

  suite.test(
    'getBookmark/setBookmark (nonintrusive) - Get non intrusive bookmark multiple elements text selection',
    function (editor) {
      let rng, bookmark;
  ...
  suite.test('getBookmark/setBookmark (nonintrusive)', function (editor) {
    ...
    editor.dom
      .select('p')[0]
      .appendChild(editor.dom.doc.createTextNode('text'));
    rng = editor.dom.createRng();
    ...
    LegacyUnit.equal(
      editor.getContent(),
      '<p>textaaatext</p>\n<p>text</p>',
      'Editor contents (fragmented, elements)'
    );
    editor.selection.moveToBookmark(bookmark);
    LegacyUnit.equal(
      editor.selection.getContent(),
      '<p>ext</p>\n<p>tex</p>',
      'Selected contents (fragmented, elements)'
    );
  });

  suite.test(
    'getBookmark/setBookmark (nonintrusive) - fragmentext text (normalized)',
    function (editor) {
      let rng, bookmark;
  ...
  suite.test(
    'getBookmark/setBookmark (nonintrusive) - fragmentext text with zwsp (normalized)',
    function (editor) {
      let rng, bookmark;
      ...
      editor.dom
        .select('p')[0]
        .appendChild(editor.dom.doc.createTextNode(Zwsp.ZWSP));
      editor.dom
        .select('p')[0]
        .appendChild(editor.dom.doc.createTextNode(Zwsp.ZWSP));
      editor.dom
  ...
  suite.test(
    'getBookmark/setBookmark (nonintrusive) - Get bookmark before image',
    function (editor) {
      let rng, bookmark;
  ...
  suite.test(
    'getBookmark/setBookmark (nonintrusive) - Get bookmark before/after image',
    function (editor) {
      let rng, bookmark;
  ...
  suite.test(
    'getBookmark/setBookmark (nonintrusive) - Get bookmark after image',
    function (editor) {
      let rng, bookmark;
  ...
  suite.test(
    'getBookmark/setBookmark (nonintrusive) - Get bookmark before element',
    function (editor) {
      let rng, bookmark;
  ...
  suite.test(
    'getBookmark/setBookmark (nonintrusive) - Get bookmark after element',
    function (editor) {
      let rng, bookmark;
  ...
  suite.test(
    'getBookmark/setBookmark (nonintrusive) - Get bookmark inside element',
    function (editor) {
      let rng, bookmark;
      ...
      LegacyUnit.equalDom(
        rng.startContainer,
        editor.getBody().childNodes[1].firstChild
      );
      LegacyUnit.equal(rng.startOffset, 1);
      LegacyUnit.equalDom(
        rng.endContainer,
  ...
  suite.test(
    'getBookmark/setBookmark (nonintrusive) - Get bookmark inside root text',
    function (editor) {
      let rng, bookmark;
  ...
  suite.test(
    'getBookmark/setBookmark (nonintrusive) - Get bookmark inside complex html',
    function (editor) {
      let rng, bookmark;

      editor.setContent(
        '<p>abc</p>123<p>123</p><p>123<b>123</b><table><tr><td>abc</td></tr></table></p>'
      );
      ...
      LegacyUnit.equalDom(
        rng.startContainer,
        editor.dom.select('td')[0].firstChild
      );
      LegacyUnit.equal(rng.startOffset, 1);
      LegacyUnit.equalDom(
        rng.endContainer,
  ...
  suite.test('select first p', function (editor) {
    ...
    LegacyUnit.equal(
      editor.selection.getContent(),
      '<p>text1</p>',
      'Select simple element, content'
    );
    LegacyUnit.equal(
      editor.selection.getStart().nodeName,
      'P',
      'Select simple element, nodeName'
    );
  });
  ...
  suite.test('select table', function (editor) {
    ...
    LegacyUnit.equal(
      ...
      'TABLE',
      'Select complex element, nodeName'
    );
  });

  suite.test('select table text 1', function (editor) {
    editor.setContent(
      '<table><tbody><tr><td id="a">text1</td><td id="b">text2</td></tr></tbody></table>'
    );
    editor.selection.select(editor.dom.select('table')[0], true);
    LegacyUnit.equal(
      editor.selection.getStart().id,
      'a',
      'Expand to text content 1 (start)'
    );
    LegacyUnit.equal(
      editor.selection.getEnd().id,
      'b',
      'Expand to text content 1 (end)'
    );
  });

  suite.test('select table text 2', function (editor) {
    editor.setContent(
      '<table><tbody><tr><td id="a"><br /></td><td id="b"><br /></td></tr></tbody></table>'
    );
    editor.selection.select(editor.dom.select('table')[0], true);
    LegacyUnit.equal(
      editor.dom.getParent(editor.selection.getStart(), 'td').id,
      'a',
      'Expand to text content 2 (start)'
    );
    LegacyUnit.equal(
      editor.dom.getParent(editor.selection.getEnd(), 'td').id,
      'b',
      'Expand to text content 2 (end)'
    );
  });
  ...
  suite.test('getNode', function (editor) {
    ...
    editor.setContent(
      '<p id="p1"><span id="s1">span1</span> word <span id="s2">span2</span> word <span id="s3">span3</span></p>'
    );
    rng = editor.dom.createRng();
    ...
    rng = editor.dom.createRng();
    rng.setStart(
      editor.dom.get('s2').previousSibling,
      (editor.dom.get('s2').previousSibling as Text).length
    );
    ...
    rng = editor.dom.createRng();
    rng.setStart(
      editor.dom.get('s3').previousSibling,
      (editor.dom.get('s3').previousSibling as Text).length
    );
    rng.setEnd(
      editor.dom.get('s3').lastChild,
      (editor.dom.get('s3').lastChild as Text).length
    );
    editor.selection.setRng(rng);
    LegacyUnit.equalDom(
      editor.selection.getNode(),
  ...
  suite.test(
    'normalize with contentEditable:false parent and contentEditable:true child element',
    function (editor) {
      editor.setContent(
        '<p contentEditable="false">a<em contentEditable="true">b</em></p>'
      );
  ...
  suite.test(
    'normalize with contentEditable:true parent and contentEditable:false child element',
    function (editor) {
      if (Env.browser.isIE()) {
        editor.setContent(
          '<p contentEditable="true">a<em contentEditable="false">b</em></p>'
        );
        LegacyUnit.setSelection(editor, 'em', 0);
        editor.selection.normalize();
        ...
        LegacyUnit.equal(
          (rng.startContainer.parentNode as HTMLElement).contentEditable !==
            'false',
          true
        );
        LegacyUnit.equal(rng.startOffset, 0);
  ...
  suite.test('normalize ignore img', function (editor) {
    ...
    LegacyUnit.equal(rng.startOffset, 0, 'startContainer offset');
    LegacyUnit.equal(
      rng.endContainer.nodeName,
      'BODY',
      'endContainer node name'
    );
    LegacyUnit.equal(rng.endContainer.nodeType, 1, 'endContainer node type');
  ...
  suite.test(
    'normalize lean start to the right if at end of text node',
    function (editor) {
      let rng;
  ...
  suite.test(
    `normalize lean left but don't walk out the parent block`,
    function (editor) {
      let rng;
  ...
  suite.test(
    'normalize lean left into empty inline elements when caret is before br',
    function (editor) {
      let rng;
  ...
  suite.test(
    'normalize lean left from br into formatter caret container',
    function (editor) {
      let rng;

      editor.getBody().innerHTML =
        '<p><span id="_mce_caret">' + Zwsp.ZWSP + '</span><br /></p>';
      rng = editor.dom.createRng();
      rng.setStartBefore(editor.getBody().firstChild.lastChild);
      rng.setEndBefore(editor.getBody().firstChild.lastChild);
      editor.selection.setRng(rng);
  ...
  suite.test(
    `normalize don't lean left into empty inline elements if there is a br element after caret`,
    function (editor) {
      let rng;
  ...
  suite.test(
    `normalize don't lean left into empty inline elements if there is a br element before caret`,
    function (editor) {
      let rng;
  ...
  suite.test(
    `normalize don't move start/end if it's before/after table`,
    function (editor) {
      let rng;
  ...
  */
  ...
  suite.test('custom elements', function (editor) {
    ...
    LegacyUnit.equal(
      editor.selection.getContent(),
      '<custom1>test</custom1><custom2>test</custom2>'
    );
  });
  ...
  suite.test('selectorChangedWithUnbind', function (editor) {
    ...
    LegacyUnit.equal(
      calls,
      1,
      'selectorChangedWithUnbind callback is only called once'
    );
...
*/
  suite.test('image selection webkit bug', function (editor) {
    const testImageSelection = function (
      inputHtml,
    ...
    testImageSelection(
      '<p>abc<img style="float: right;" src="#">def</p>',
      'P',
      1
    );
    ...
    testImageSelection(
      '<p>abc<img style="float: left;" src="#">def</p>',
      'P',
      1
    );
    testImageSelection(
      '<p dir="rtl"><img style="float: right;" src="#"></p>',
      'P',
      0
    );
    testImageSelection(
      '<p dir="rtl"><img style="float: right;" src="#">abc</p>',
      'P',
      0
    );
    testImageSelection(
      '<p dir="rtl">abc<img style="float: right;" src="#"></p>',
      'P',
      1
    );
    testImageSelection(
      '<p dir="rtl">abc<img style="float: right;" src="#">def</p>',
      'P',
      1
    );
    testImageSelection(
      '<p dir="rtl"><img style="float: left;" src="#"></p>',
      'P',
      0
    );
    testImageSelection(
      '<p dir="rtl"><img style="float: left;" src="#">abc</p>',
      'P',
      0
    );
    testImageSelection(
      '<p dir="rtl">abc<img style="float: left;" src="#"></p>',
      'P',
      1
    );
    testImageSelection(
      '<p dir="rtl">abc<img style="float: left;" src="#">def</p>',
      'P',
      1
    );
  });
