...
UnitTest.asynctest('browser.tinymce.core.dom.NodeTypeTest', function (
  ...
  suite.test('isText/isElement/isComment', function () {
    ...
    LegacyUnit.strictEqual(
      NodeType.isText(document.createElement('div')),
      false
    );
    LegacyUnit.strictEqual(NodeType.isText(document.createComment('x')), false);

    LegacyUnit.strictEqual(
      NodeType.isElement(document.createElement('div')),
      true
    );
    LegacyUnit.strictEqual(NodeType.isElement(null), false);
    LegacyUnit.strictEqual(
      NodeType.isElement(document.createTextNode('x')),
      false
    );
    LegacyUnit.strictEqual(
      NodeType.isElement(document.createComment('x')),
      false
    );

    LegacyUnit.strictEqual(
      NodeType.isComment(document.createComment('x')),
      true
    );
    LegacyUnit.strictEqual(NodeType.isComment(null), false);
    LegacyUnit.strictEqual(
      NodeType.isComment(document.createTextNode('x')),
      false
    );
    LegacyUnit.strictEqual(
      NodeType.isComment(document.createElement('div')),
      false
    );
  });
  ...
  suite.test('isContentEditableTrue', function () {
    ...
    LegacyUnit.strictEqual(
      NodeType.isContentEditableTrue(document.createComment('x')),
      false
    );
    LegacyUnit.strictEqual(
      NodeType.isContentEditableTrue(document.createTextNode('x')),
      false
    );
    LegacyUnit.strictEqual(
      NodeType.isContentEditableTrue(document.createElement('div')),
      false
    );
    LegacyUnit.strictEqual(
    ...
    LegacyUnit.strictEqual(
      NodeType.isContentEditableTrue(
        $('<div contentEditable="inherit"></div>')[0]
      ),
      false
    );
  });
  ...
  suite.test('isContentEditableFalse', function () {
    ...
    LegacyUnit.strictEqual(
      NodeType.isContentEditableFalse(document.createComment('x')),
      false
    );
    LegacyUnit.strictEqual(
      NodeType.isContentEditableFalse(document.createTextNode('x')),
      false
    );
    LegacyUnit.strictEqual(
      NodeType.isContentEditableFalse(document.createElement('div')),
      false
    );
    LegacyUnit.strictEqual(
  ...
  suite.test('hasPropValue', function () {
    ...
    LegacyUnit.strictEqual(
      hasTabIndex3($('<div tabIndex="3"></div>')[0]),
      true
    );
  ...
  suite.test('isBogus', function () {
    LegacyUnit.strictEqual(
      NodeType.isBogus($('<div data-mce-bogus="1"></div>')[0]),
      true
    );
    LegacyUnit.strictEqual(
      NodeType.isBogus($('<div data-mce-bogus="all"></div>')[0]),
      true
    );
    LegacyUnit.strictEqual(NodeType.isBogus($('<div></div>')[0]), false);
    LegacyUnit.strictEqual(
      NodeType.isBogus(document.createTextNode('test')),
      false
    );
  ...
  suite.test('isBogusAll', function () {
    LegacyUnit.strictEqual(
      NodeType.isBogusAll($('<div data-mce-bogus="1"></div>')[0]),
      false
    );
    LegacyUnit.strictEqual(
      NodeType.isBogusAll($('<div data-mce-bogus="all"></div>')[0]),
      true
    );
    LegacyUnit.strictEqual(NodeType.isBogusAll($('<div></div>')[0]), false);
    LegacyUnit.strictEqual(
      NodeType.isBogusAll(document.createTextNode('test')),
      false
    );
  ...
  suite.test('hasAttribute', function () {
    LegacyUnit.strictEqual(
      NodeType.hasAttribute('x')($('<div x="1"></div>')[0]),
      true
    );
    LegacyUnit.strictEqual(
      NodeType.hasAttribute('y')($('<div x="1"></div>')[0]),
      false
    );
  });
  ...
  suite.test('isTable', function () {
    LegacyUnit.strictEqual(
      NodeType.isTable($('<table><tr><td></td></tr></table>')[0]),
      true
    );
    LegacyUnit.strictEqual(NodeType.isTable($('<div></div>')[0]), false);
    LegacyUnit.strictEqual(
      NodeType.isTable(document.createTextNode('test')),
      false
    );
