...
UnitTest.asynctest(
  ...
  function (success, failure) {
    ...
    const sWaitForBookmark = function (
      editor,
      startPath,
      startOffset,
      endPath,
        ...
        Pipeline.async(
          ...
          browser.isIE() || browser.isEdge()
            ? [
                ...
                sAddTestDiv,
                Logger.t(
                  'restore even without second nodechange, restores on focusout',
                  Step.sync(function () {
                ...
                Logger.t(
                  'restore with second nodechange, restores on focusout',
                  Step.sync(function () {
                    editor.setContent('<p>a</p><p>b</p>');
            ...
            : [
                ...
                Logger.t(
                  'assert selection after no nodechanged, should not restore',
                  Step.sync(function () {
                    editor.setContent('<p>a</p><p>b</p>');
                ...
                Logger.t(
                  'assert selection after nodechanged, should restore',
                  Step.sync(function () {
                    editor.setContent('<p>a</p><p>b</p>');
                ...
                Logger.t(
                  'assert selection after keyup, should restore',
                  Step.sync(function () {
                    editor.setContent('<p>a</p><p>b</p>');
                ...
                Logger.t(
                  'assert selection after touchend, should restore',
                ...
                Logger.t(
                  'selection with mouseup outside editor body',
                  GeneralSteps.sequence([
                    Step.sync(function () {
                ...
                Logger.t(
                  'getSelectionRange event should fire on bookmarked ranges',
                  GeneralSteps.sequence([
                    sAddTestDiv,
                    Step.sync(() => {
                      const modifyRange = (e) => {
                      ...
                      Assertions.assertEq(
                        'Expect event to change the selection from a to b',
                        'b',
                        elm.innerHTML
                      );
                    }),
