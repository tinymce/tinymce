...
UnitTest.asynctest(
  ...
  function (success, failure) {
    ...
    const sSetContentOverride = function (
      editor,
      content,
      overrideContent,
      args
      ...
      function (editor, onSuccess, onFailure) {
        ...
        Pipeline.async(
          ...
          [
            ...
            Logger.t(
              'Should fill the body with x h1 instead of a before b in a paragraph',
              GeneralSteps.sequence([
                tinyApis.sSetContent('<p>b</p>'),
                tinyApis.sSetSelection([0, 0], 0, [0, 0], 0),
            ...
            Logger.t(
              'Insert content in middle of word, expanded selection',
              GeneralSteps.sequence([
            ...
            Logger.t(
              'Insert content in middle of word, collapsed selection',
              GeneralSteps.sequence([
            ...
            Logger.t(
              'Insert content at start of word, collapsed selection',
              GeneralSteps.sequence([
            ...
            Logger.t(
              'Insert content at end of word, collapsed selection',
              GeneralSteps.sequence([
                tinyApis.sSetContent('<p>a</p>'),
                tinyApis.sSetSelection([0, 0], 1, [0, 0], 1),
                sSetContent(editor, 'X', {}),
            ...
            Logger.t(
              'Insert content at end of word with partial text',
              GeneralSteps.sequence([
                tinyApis.sSetContent('<p>a</p>'),
                tinyApis.sSetSelection([0, 0], 1, [0, 0], 1),
