...
UnitTest.asynctest(
  ...
  function (success, failure) {
    ...
    const cHasAllContentsSelected = function (
      startPath,
      startOffset,
      endPath,
      endOffset
      ...
      return Chain.mapper(function (viewBlock: any) {
        ...
        return SelectionUtils.hasAllContentsSelected(
          Element.fromDom(viewBlock.get()),
          rng
        );
      });
    ...
    Pipeline.async(
      ...
      [
        Logger.t(
          'All text is selected in paragraph',
          Chain.asStep(viewBlock, [
            cSetHtml('<p>a</p>'),
            cHasAllContentsSelected([0, 0], 0, [0, 0], 1),
            Assertions.cAssertEq(
              'Should be true since all contents is selected',
              true
            )
          ])
        ),
        ...
        Logger.t(
          'All text is selected in paragraph and sub element',
          Chain.asStep(viewBlock, [
        ...
        Logger.t(
          'All text is selected in paragraph and with traling br',
          Chain.asStep(viewBlock, [
            cSetHtml('<p>a<br></p>'),
            cHasAllContentsSelected([0, 0], 0, [0, 0], 1),
            Assertions.cAssertEq(
        ...
        Logger.t(
          'Collapsed range in paragraph',
          Chain.asStep(viewBlock, [
            cSetHtml('<p>a</p>'),
            cHasAllContentsSelected([0, 0], 0, [0, 0], 0),
            Assertions.cAssertEq(
              'Should be false since only some contents is selected',
              false
            )
          ])
        ),
        Logger.t(
          'Partial text selection in paragraph',
          Chain.asStep(viewBlock, [
            cSetHtml('<p>ab</p>'),
            cHasAllContentsSelected([0, 0], 0, [0, 0], 1),
            Assertions.cAssertEq(
        ...
        Logger.t(
          'Partial mixed selection in paragraph',
          Chain.asStep(viewBlock, [
