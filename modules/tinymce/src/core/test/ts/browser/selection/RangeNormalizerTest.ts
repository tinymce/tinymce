  ...
  function (success, failure) {
    ...
    const mAssertRange = function (startPath, startOffset, endPath, endOffset) {
      return Step.stateful(function (value: any, next, _die) {
        ...
        Assertions.assertDomEq(
          ...
          startContainer,
          Element.fromDom(value.startContainer)
        );
        Assertions.assertEq(
          'Should be expected startOffset',
          startOffset,
          value.startOffset
        );
        Assertions.assertDomEq(
          ...
          endContainer,
          Element.fromDom(value.endContainer)
        );
        Assertions.assertEq(
          'Should be expected endOffset',
          endOffset,
          value.endOffset
        );
    ...
    Pipeline.async(
      ...
      [
        ...
        Logger.t(
          'Normalize webkit triple click selection paragraph',
          GeneralSteps.sequence([
        ...
        Logger.t(
          'Normalize webkit triple click selection heading',
          GeneralSteps.sequence([
        ...
        Logger.t(
          'Normalize webkit triple click selection headings',
          GeneralSteps.sequence([
        ...
        Logger.t(
          'Normalize webkit triple click selection divs',
          GeneralSteps.sequence([
        ...
        Logger.t(
          'Normalize webkit triple click selection between LI:s',
          GeneralSteps.sequence([
        ...
        Logger.t(
          'Normalize from block start to previous block end',
          GeneralSteps.sequence([
        ...
        Logger.t(
          'Do not normalize when end position has a valid previous position in the block',
          GeneralSteps.sequence([
            sSetContent('<p>a</p><p>b<p>'),
        ...
        Logger.t(
          'Do not normalize when selection is on inline elements',
          GeneralSteps.sequence([
