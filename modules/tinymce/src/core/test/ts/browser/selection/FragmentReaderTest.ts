...
UnitTest.asynctest('browser.tinymce.core.selection.FragmentReaderTest', function (success, failure) {
  ...
  Pipeline.async(
    ...
    [
      Logger.t(
        'Fragments on inline elements',
        GeneralSteps.sequence([
          Logger.t(
            'Get fragment from collapsed range',
            Chain.asStep(viewBlock, [cSetHtml('<p><b>abc</b></p>'), cReadFragment([0, 0, 0], 1, [0, 0, 0], 1), cAssertFragmentHtml('')])
          ),
          Logger.t(
            'Get fragment from partially selected text',
          ...
          Logger.t(
            'Get fragment from partially selected inline element',
            Chain.asStep(viewBlock, [
          ...
          Logger.t(
            'Get fragment on text only inside inline element',
            Chain.asStep(viewBlock, [
              cSetHtml('<p><b>a</b></p>'),
          ...
          Logger.t(
            'Get fragment on text only inside inline elements',
            Chain.asStep(viewBlock, [
          ...
          Logger.t(
            'Get fragment indexed element within inline element',
            Chain.asStep(viewBlock, [
      ...
      Logger.t(
        'Fragments on headers',
        GeneralSteps.sequence([
          Logger.t(
            'Get fragment from partially selected text inside h1',
            Chain.asStep(viewBlock, [
          ...
          Logger.t(
            'Get fragment text selection inside h1',
            Chain.asStep(viewBlock, [cSetHtml('<h1>a</h1>'), cReadFragment([0, 0], 0, [0, 0], 1), cAssertFragmentHtml('<h1>a</h1>')])
          ),
          Logger.t(
            'Get fragment text selection inside h2',
            Chain.asStep(viewBlock, [cSetHtml('<h2>a</h2>'), cReadFragment([0, 0], 0, [0, 0], 1), cAssertFragmentHtml('<h2>a</h2>')])
          ),
          Logger.t(
            'Get fragment from text selection inside inline element inside h1',
            Chain.asStep(viewBlock, [
          ...
          Logger.t(
            'Get fragment from text inside a bunch of inline elements inside a h1',
            Chain.asStep(viewBlock, [
      ...
      Logger.t(
        ...
        GeneralSteps.sequence([
          Logger.t(
            'Get fragment from fully selected li contents text in ul',
            Chain.asStep(viewBlock, [
          ...
          Logger.t(
            'Get fragment from fully selected li contents text in ol',
            Chain.asStep(viewBlock, [
          ...
          Logger.t(
            'Get fragment from fully selected li contents text in ul in ol',
            Chain.asStep(viewBlock, [
          ...
          Logger.t(
            'Get fragment from fully selected li mixed contents in ol',
            Chain.asStep(viewBlock, [
          ...
          Logger.t(
            'Get fragment from fully selected li mixed contents in ul',
            Chain.asStep(viewBlock, [
          ...
          Logger.t(
            'Get fragment from fully selected li contents with siblings',
            Chain.asStep(viewBlock, [
          ...
          Logger.t(
            'Get fragment from partially selected li contents (start)',
            Chain.asStep(viewBlock, [
          ...
          Logger.t(
            'Get fragment from partially selected li contents (middle)',
            Chain.asStep(viewBlock, [
              cSetHtml('<ul><li>abc</li></ul>'),
              cReadFragment([0, 0, 0], 1, [0, 0, 0], 2),
          ...
          Logger.t(
            'Get fragment from partially selected li contents (end)',
            Chain.asStep(viewBlock, [
              cSetHtml('<ul><li>abc</li></ul>'),
          ...
          Logger.t(
            'Get fragment from fully selected li contents text in ul with traling br',
            Chain.asStep(viewBlock, [
          ...
          Logger.t(
            'Get fragment from two partially selected li:s',
            Chain.asStep(viewBlock, [
          ...
          Logger.t(
            'Get fragment from two partially selected li:s in nested structure',
            Chain.asStep(viewBlock, [
      ...
      Logger.t(
        ...
        GeneralSteps.sequence([
          Logger.t(
            'Get table fragment from table 2x2 with selection (1,1)-(1,2)',
            Chain.asStep(viewBlock, [
              cSetHtml(
                '<table><tbody><tr><td data-mce-selected="1">A</td><td>B</td></tr><tr><td data-mce-selected="1">C</td><td>D</td></tr></tbody></table>'
              ),
              cReadFragment([0], 0, [0], 1),
              cAssertFragmentHtml(
                '<table><tbody><tr><td data-mce-selected="1">A</td></tr><tr><td data-mce-selected="1">C</td></tr></tbody></table>'
              )
            ])
          ),
          Logger.t(
            'Get table fragment from table 2x2 with selection (1,1)-(2,1)',
            Chain.asStep(viewBlock, [
              cSetHtml(
                '<table><tbody><tr><td data-mce-selected="1">A</td><td data-mce-selected="1">B</td></tr><tr><td>C</td><td>D</td></tr></tbody></table>'
              ),
              cReadFragment([0], 0, [0], 1),
          ...
          Logger.t(
            'Get table fragment from table 2x2 with multi range selection (1,1)-(2,2)',
            Chain.asStep(viewBlock, [
          ...
          Logger.t(
            'Get table fragment from table 2x2 with multi range selection (2,1)-(2,2)',
            Chain.asStep(viewBlock, [
              cSetHtml('<table><tbody><tr><td>A</td><td>B</td></tr><tr><td>C</td><td>D</td></tr></tbody></table>'),
              cReadFragmentCells([
                [0, 0, 0, 1],
