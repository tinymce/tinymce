    ...
    const cAssertFragmentHtml = function (expectedHtml) {
      return Chain.mapper(function (fragment) {
        ...
        Assertions.assertHtml(
          'Should be expected fragment html',
          expectedHtml,
          actualHtml
        );
        return fragment;
          ...
          GeneralSteps.sequence([
            ...
            Logger.t(
              ...
              Chain.asStep(viewBlock, [
                ...
                cReadFragment([0], 0, [0], 1),
                cAssertFragmentHtml(
                  '<table><tbody><tr><td data-mce-selected="1">A</td><td data-mce-selected="1">B</td></tr></tbody></table>'
                )
              ])
            ),
            Logger.t(
            ...
            Logger.t(
              ...
              Chain.asStep(viewBlock, [
                ...
                cAssertFragmentHtml(
                  '<table><tbody><tr><td>B</td></tr><tr><td>D</td></tr></tbody></table>'
                )
              ])
            )
          ])
