...
UnitTest.asynctest('browser.tinymce.core.selection.SelectionBookmarkIframeEditorTest', function (success, failure) {
  Theme();
      ...
      Pipeline.async(
        ...
        browser.isIE()
          ? [
              ...
              Logger.t(
                'assert selection after mouseup, should restore',
                Step.sync(function () {
                  editor.setContent('<p>a</p><p>b</p>');
