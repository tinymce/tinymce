...
UnitTest.asynctest('browser.tinymce.core.FormattingCommandsTest', function (
  ...
  suite.test(
    'Justify - multiple block elements selected - queryCommandState',
    function (editor) {
      editor.setContent(
  ...
  suite.test('Formatting commands (xhtmlTextStyles)', function (editor) {
    ...
    LegacyUnit.equal(
      editor.getContent(),
      '<p><span style="text-decoration: underline;">test 123</span></p>'
    );
    ...
    LegacyUnit.equal(
      editor.getContent(),
      '<p><span style="text-decoration: line-through;">test 123</span></p>'
    );
    ...
    LegacyUnit.equal(
      editor.getContent(),
      '<p><span style="font-family: Arial;">test 123</span></p>'
    );
    ...
    LegacyUnit.equal(
      editor.getContent(),
      `<p><span style="font-family: 'Bauhaus 93';">test 123</span></p>`
    );
    ...
    LegacyUnit.equal(
      editor.getContent(),
      '<p><span style="font-size: xx-large;">test 123</span></p>'
    );
    ...
    LegacyUnit.equal(
      editor.getContent(),
      '<p><span style="font-size: 7pt;">test 123</span></p>'
    );
    ...
    LegacyUnit.equal(
      editor.getContent(),
      '<p><span style="color: #ff0000;">test 123</span></p>'
    );
    ...
    LegacyUnit.equal(
      editor.getContent(),
      '<p><span style="background-color: #ff0000;">test 123</span></p>'
    );
    ...
    LegacyUnit.equal(
      editor.getContent(),
      '<p><span style="font-size: 300%;">test 123</span></p>'
    );

    editor.setContent('<p><font face="Arial" size="7">test 123</font></p>');
    LegacyUnit.equal(
      editor.getContent(),
      '<p><span style="font-size: 300%; font-family: Arial;">test 123</span></p>'
    );

    editor.setContent(
      '<font style="background-color: #ff0000" color="#ff0000">test</font><font face="Arial">test</font>'
    );
    LegacyUnit.equal(
      editor.getContent(),
    ...
    editor.setContent(
      '<p><font face="Arial" style="color: #ff0000">test 123</font></p>'
    );
    LegacyUnit.equal(
      editor.getContent(),
      '<p><span style="color: #ff0000; font-family: Arial;">test 123</span></p>'
    );
  });
  ...
  suite.test('Formatting commands (alignInline)', function (editor) {
    ...
    LegacyUnit.equal(
      editor.getContent(),
      '<p style="text-align: left;">test 123</p>'
    );
    LegacyUnit.equal(
      true,
      editor.queryCommandState('JustifyLeft'),
      'should have JustifyLeft state true'
    );
    ...
    LegacyUnit.equal(
      editor.getContent(),
      '<p style="text-align: center;">test 123</p>'
    );
    LegacyUnit.equal(
      true,
      editor.queryCommandState('JustifyCenter'),
      'should have JustifyCenter state true'
    );
    ...
    LegacyUnit.equal(
      editor.getContent(),
      '<p style="text-align: right;">test 123</p>'
    );
    LegacyUnit.equal(
      true,
      editor.queryCommandState('JustifyRight'),
      'should have JustifyRight state true'
    );
    ...
    LegacyUnit.equal(
      editor.getContent(),
      '<p style="text-align: justify;">test 123</p>'
    );
    LegacyUnit.equal(
      true,
      editor.queryCommandState('JustifyFull'),
      'should have JustifyFull state true'
    );
    ...
    LegacyUnit.equal(
      editor.getContent(),
      '<p><img style="float: left;" src="tinymce/ui/img/raster.gif" /></p>'
    );
    ...
    LegacyUnit.equal(
      editor.getContent(),
      '<p><img style="float: right;" src="tinymce/ui/img/raster.gif" /></p>'
    );
  });
  ...
  suite.test('mceBlockQuote', function (editor) {
    ...
    LegacyUnit.equal(
      editor.getContent().replace(/\s+/g, ''),
      '<blockquote><p>test123</p></blockquote>'
    );
    ...
    LegacyUnit.equal(
      editor.getContent().replace(/\s+/g, ''),
      '<blockquote><p>test123</p><p>test123</p></blockquote>'
    );
  });
  ...
  suite.test('mceInsertLink (link absolute)', function (editor) {
    ...
    LegacyUnit.equal(
      editor.getContent(),
      '<p><a href="http://www.site.com">test 123</a></p>'
    );
  });
  ...
  suite.test('mceInsertLink (link encoded and with class)', function (editor) {
    ...
    LegacyUnit.equal(
      editor.getContent(),
      '<p><a class="test" href="&quot;&amp;&lt;&gt;">test 123</a></p>'
    );
  });
  ...
  suite.test('mceInsertLink (link with space)', function (editor) {
    ...
    LegacyUnit.equal(
      editor.getContent(),
      '<p><a href="foo%20bar">test 123</a></p>'
    );
  });
  ...
  suite.test('mceInsertLink (link floated img)', function (editor) {
    ...
    LegacyUnit.equal(
      editor.getContent(),
      '<p><a href="link"><img style="float: right;" src="about:blank" /></a></p>'
    );
  });
  ...
  suite.test('mceInsertLink (link adjacent text)', function (editor) {
    ...
    LegacyUnit.equal(
      editor.getContent(),
      '<p><a href="#">a</a><a href="link">b</a></p>'
    );
  });
  ...
  suite.test(
    'mceInsertLink (link around existing links with different attrs)',
    function (editor) {
      editor.setContent(
        '<p><a id="a" href="#1">1</a><a id="b" href="#2">2</a></p>'
      );
      editor.execCommand('SelectAll');
  ...
  suite.test(
    'mceInsertLink (link around existing complex contents with links)',
    function (editor) {
      editor.setContent(
  ...
  suite.test('mceInsertLink bug #7331', function (editor) {
    ...
    LegacyUnit.equal(
      editor.getContent(),
      '<table><tbody><tr><td>A</td></tr><tr><td><a href="x">B</a></td></tr></tbody></table>'
    );
  });
  ...
  suite.test('unlink - unselected a[href] with childNodes', function (editor) {
    editor.setContent(
      '<p><a href="test"><strong><em>test</em></strong></a></p>'
    );
  ...
  suite.test('indent/outdent', function (editor) {
    ...
    LegacyUnit.equal(
      editor.getContent(),
      '<p style="padding-left: 40px;">test 123</p>'
    );
    ...
    LegacyUnit.equal(
      editor.getContent(),
      '<p style="padding-left: 80px;">test 123</p>'
    );
  ...
  suite.test('indent/outdent table always uses margin', function (editor) {
    ...
    LegacyUnit.equal(
      editor.getContent(),
      '<table style="margin-left: 40px;"><tbody><tr><td>test</td></tr></tbody></table>'
    );
    ...
    LegacyUnit.equal(
      editor.getContent(),
      '<table style="margin-left: 80px;"><tbody><tr><td>test</td></tr></tbody></table>'
    );
  ...
  suite.test('RemoveFormat', function (editor) {
    editor.setContent(
      '<p><em>test</em> <strong>123</strong> <a href="123">123</a> 123</p>'
    );
    editor.execCommand('SelectAll');
    editor.execCommand('RemoveFormat');
    LegacyUnit.equal(
      editor.getContent(),
      '<p>test 123 <a href="123">123</a> 123</p>'
    );

    editor.setContent(
      '<p><em><em>test</em> <strong>123</strong> <a href="123">123</a> 123</em></p>'
    );
    editor.execCommand('SelectAll');
    editor.execCommand('RemoveFormat');
    LegacyUnit.equal(
    ...
    editor.setContent(
      '<p><em>test<span id="x">test <strong>123</strong></span><a href="123">123</a> 123</em></p>'
    );
    editor.selection.select(editor.dom.get('x'));
    editor.execCommand('RemoveFormat');
    LegacyUnit.equal(
      editor.getContent(),
      '<p><em>test</em><span id="x">test 123</span><em><a href="123">123</a> 123</em></p>'
    );
    ...
    LegacyUnit.equal(
      editor.getContent(),
      '<p>dfn tag code tag samp tag kbd tag var tag cite tag mark tag q tag</p>'
    );
  });
