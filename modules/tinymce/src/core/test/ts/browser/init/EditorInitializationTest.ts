  ...
  Pipeline.async(
    ...
    [
      ...
      Logger.t(
        ...
        GeneralSteps.sequence([mCreateInlineModeMultipleInstances, mAssertEditors, sRemoveAllEditors, mAssertTargets])
      ),
      Logger.t(
        'Initialize on textarea with initial content',
        GeneralSteps.sequence([sInitAndAssertContent('<textarea>Initial Content</textarea>', 'textarea', 'Initial Content')])
      ),
      Logger.t(
        'Initialize on input with initial content',
        GeneralSteps.sequence([sInitAndAssertContent('<input value="Initial Content">', 'input', 'Initial Content')])
      ),
      Logger.t(
        'Initialize on list item with initial content',
        GeneralSteps.sequence([sInitAndAssertContent('<ul><li>Initial Content</li></ul>', 'li', 'Initial Content')])
      )
    ],
    function () {
      viewBlock.detach();
