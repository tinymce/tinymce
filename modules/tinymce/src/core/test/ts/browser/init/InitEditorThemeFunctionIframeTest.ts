...
UnitTest.asynctest('browser.tinymce.core.init.InitEditorThemeFunctionIframeTest', function (success, failure) {
  TinyLoader.setup(
      ...
      Pipeline.async(
        ...
        [
          Logger.t(
            ...
            GeneralSteps.sequence([tinyApis.sSetContent('<p>a</p>'), tinyApis.sAssertContent('<p>a</p>')])
          ),
          Logger.t(
