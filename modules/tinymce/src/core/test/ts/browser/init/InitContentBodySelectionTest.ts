  ...
  Pipeline.async(
    ...
    [
      ...
      Log.stepsAsStep('TINY-4139', 'div and forced_root_block tests', [
        ...
        sInitAndAssertContent('Test p with br with forced_root_block=div', '<p><br /></p>', [0], 0, {
          forced_root_block: false
        }),
        sInitAndAssertContent('Test p with forced_root_block=div', '<p>Initial Content</p>', [0, 0], 0, {
          forced_root_block: false
        }),
        sInitAndAssertContent('Test div with br with forced_root_block=div', '<div><br /></div>', [0], 0, {
          forced_root_block: false
        }),
        sInitAndAssertContent('Test div with forced_root_block=div', '<div>Initial Content</div>', [0, 0], 0, {
          forced_root_block: false
        }),
        sInitAndAssertContent('Test div with br with forced_root_block=div', '<div><br /></div>', [0], 0, {
