    ...
    [
      Logger.t(
        ...
        GeneralSteps.sequence([
          Logger.t(
            'Focus editor initialized on a div with p',
            Chain.asStep({}, [
          ...
          Logger.t(
            'Focus editor initialized on a list',
            Chain.asStep({}, [
          ...
          Logger.t(
            'Selection restored on focus with table cE=true',
            Chain.asStep({}, [
              cCreateEditor(
                '<div class="tinymce-editor"><p>a</p><div>b<table contenteditable="true"><tbody><tr><td>c</td><td></td></tr></tbody></table></div></div>'
              ),
      ...
      Logger.t(
        ...
        GeneralSteps.sequence([
          ...
          Logger.t(
            'Focus on cE=true inside a cE=false',
            Chain.asStep({}, [
              cCreateInlineEditor(
                '<div class="tinymce-editor"><div contenteditable="false">a<div contenteditable="true">b</div></div></div>'
              ),
