...
UnitTest.asynctest('browser.tinymce.core.FormatterApplyTest', function (
  ...
  suite.test('Inline element with attributes merged with child 1', function (
    ...
    LegacyUnit.equal(
      getContent(editor),
      '<p><font face="arial" size="7">1234</font></p>',
  ...
  suite.test('Inline element on selected text with function values', function (
    ...
    LegacyUnit.equal(
      getContent(editor),
      '<p><b style="color: #ff00ff;" title="title2">1234</b></p>',
  ...
  suite.test('Block element on selected elements with attributes', function (
    ...
    LegacyUnit.equal(
      getContent(editor),
      '<div title="test">1234</div><div title="test">5678</div>',
  ...
  suite.test('Underline colors 3', function (editor) {
    ...
    LegacyUnit.equal(
      ...
      `<p><span style="text-decoration: underline;"><span style="font-family: 'arial black';"><em>` +
        ...
        '</em> text</span></span></p>',
      'Underlining colored and underlined text should result in a colored underline'
    );
  });
  ...
  suite.test('Apply ID format to around existing bookmark node', function (
    ...
    LegacyUnit.equal(
      ...
      '<p><span id="id">a<span data-mce-type="bookmark" id="b"></span>b</span></p>'
    );
  });
  ...
  suite.test('TINY-671: Background color on nested font size bug', function (
    ...
    LegacyUnit.equal(
      getContent(editor),
      '<p><span style="background-color: #ff0000;"><strong><span style="font-size: 18px; background-color: #ff0000;">abc</span></strong></span></p>'
    );
  });
