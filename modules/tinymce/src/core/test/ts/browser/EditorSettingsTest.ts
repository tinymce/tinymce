    ...
    function (editor, onSuccess, onFailure) {
      Pipeline.async(
        ...
        [
          Logger.t(
            ...
            Step.sync(() => {
              ...
              Obj.each(expectedPhoneDefaultSettings, (value, key) => {
                Assertions.assertEq(
                  `Should not have default ${key} mobile setting`,
                  true,
                  value !== Obj.get(defaultSettings, key).getOrUndefined()
                );
              });
            })
          ),
          ...
          Logger.t(
            'when unset, toolbar_mode should fall back to the value of toolbar_drawer',
            Step.sync(() => {
          ...
          Logger.t(
            ...
            GeneralSteps.sequence([
              ...
              Logger.t(
                'Override defaults with forced_plugins using arrays',
                Step.sync(function () {
              ...
              Logger.t(
                'Override defaults with forced_plugins using strings',
                Step.sync(function () {
                  const defaultSettings = {
                    forced_plugins: 'a b'
                  };
              ...
              Logger.t(
                'Override defaults with forced_plugins using mixed types and spaces',
                Step.sync(function () {
                  const defaultSettings = {
                    forced_plugins: '  a   b'
                  };
              ...
              Logger.t(
                'Override defaults with just default forced_plugins',
                Step.sync(function () {
                  const defaultSettings = {
                    forced_plugins: ['a', 'b']
                  };
              ...
              Logger.t(
                'Override defaults with just user plugins',
                Step.sync(function () {
                  const defaultSettings = {};
              ...
              Logger.t(
                'Override defaults with forced_plugins should not be possible to override',
                Step.sync(function () {
                  const defaultSettings = {
                    forced_plugins: ['a', 'b']
                  };
              ...
              Logger.t(
                'Getters for various setting types',
                Step.sync(function () {
                  const settings = EditorSettings.getEditorSettings(
                    {} as Editor,
                    'id',
                  ...
                  Assertions.assertEq(
                    ...
                    undefined,
                    EditorSettings.getParam(fakeEditor, 'non_existing')
                  );
                  Assertions.assertEq(
                    'Should be undefined for existing null setting',
                    undefined,
                    EditorSettings.getParam(fakeEditor, 'non_existing')
                  );
                  Assertions.assertEq(
                    'Should be undefined for existing undefined setting',
                    undefined,
              ...
              Logger.t(
                ...
                Step.sync(function () {
                  ...
                  Assertions.assertEq(
                    'Should only have the mobile setting on touch',
                    EditorSettings.getParam(fakeEditor, 'settingA', false),
                    isTouch
                  );
                  Assertions.assertEq(
                    'Should have the expected mobile setting value on touch',
                    EditorSettings.getParam(fakeEditor, 'settingB', false),
                    isTouch
                  );
                  Assertions.assertEq(
                    'Should have the expected desktop setting on desktop',
                    EditorSettings.getParam(fakeEditor, 'settingB', true),
                    isTouch
                  );
                })
              )
          ...
          Logger.t(
            'combineSettings tests',
            GeneralSteps.sequence([
              Logger.t(
                'Merged settings (desktop)',
                Step.sync(function () {
                  Assertions.assertEq(
              ...
              Logger.t(
                'Merged settings forced_plugins in default override settings (desktop)',
                Step.sync(function () {
                  Assertions.assertEq(
              ...
              Logger.t(
                'Merged settings forced_plugins in default override settings (mobile)',
                Step.sync(function () {
                  Assertions.assertEq(
              ...
              Logger.t(
                'Merged settings forced_plugins in default override settings with user mobile settings (desktop)',
                Step.sync(function () {
                  Assertions.assertEq(
              ...
              Logger.t(
                'Merged settings forced_plugins in default override settings with user mobile settings (mobile)',
                Step.sync(function () {
                  Assertions.assertEq(
                ...
                Step.sync(function () {
                  Assertions.assertEq(
                    ...
                    EditorSettings.combineSettings(
                      ...
                      {},
                      { forced_plugins: ['a'] },
                      { plugins: ['b'], mobile: { plugins: ['lists custom'] } }
                    )
                  );
                })
              ),
              ...
              Logger.t(
                'Merged settings forced_plugins in default override forced_plugins in user settings',
                Step.sync(function () {
                  Assertions.assertEq(
              ...
              Logger.t(
                'Merged settings when theme is mobile, on a mobile device',
                Step.sync(function () {
                  Assertions.assertEq(
              ...
              Logger.t(
                'Merged settings when mobile.plugins is undefined, on a mobile device',
                Step.sync(function () {
                  Assertions.assertEq(
              ...
              Logger.t(
                'Merged settings when mobile.plugins is undefined, legacy mobile theme and on a mobile device',
                Step.sync(function () {
                  Assertions.assertEq(
                    'Should fallback to filtered white listed. settings.plugins',
                    {
              ...
              Logger.t(
                'Merged settings with empty mobile.plugins="" on mobile',
                Step.sync(function () {
                  Assertions.assertEq(
              ...
              Logger.t(
                'Merged settings with defined mobile.plugins',
                Step.sync(function () {
                  Assertions.assertEq(
                    'Should allow all plugins',
                    {
                      ...
                      validate: true,
                      external_plugins: {},
                      plugins: 'lists autolink foo bar'
                    },
                    EditorSettings.combineSettings(
                      true,
                      true,
              ...
              Logger.t(
                'Merged settings with defined mobile.plugins and legacy mobile theme',
                Step.sync(function () {
                  Assertions.assertEq(
              ...
              Logger.t(
                'Merged settings with mobile.theme silver and mobile.plugins',
                Step.sync(function () {
                  Assertions.assertEq(
              ...
              Logger.t(
                'Merged settings with mobile.theme silver and mobile.plugins on Desktop',
                Step.sync(function () {
                  Assertions.assertEq(
          ...
          Logger.t(
            ...
            Step.sync(function () {
              ...
              Assertions.assertEq(
                ...
                'function',
                typeof EditorSettings.getParam(editor, 'fun', null, 'function')
              );
              Assertions.assertEq(
              ...
              Assertions.assertEq(
                ...
                ['a', 'b'],
                EditorSettings.getParam(editor, 'strArr', ['x'], 'string[]')
              );
              Assertions.assertEq(
                'Should be expected default array on mixed types',
                ['x'],
                EditorSettings.getParam(editor, 'mixedArr', ['x'], 'string[]')
              );
              Assertions.assertEq(
                'Should be expected default array on boolean',
                ['x'],
                EditorSettings.getParam(editor, 'bool', ['x'], 'string[]')
              );
            })
          )
        ],
