...
UnitTest.asynctest('browser.tinymce.core.html.SaxParserTest', function (
  ...
  suite.test('Parsing cdata', function () {
    ...
    const schemaWithSVGs = Schema({
      valid_children: '+svg[#cdata]',
      custom_elements: 'svg'
    });
  ...
  suite.test('Parse away bogus elements', function () {
    ...
    testBogusSaxParse('a<b data-mce-bogus="all"><!-- x --><?xml?></b>c', 'ac', {
      text: 2
    });
    ...
    testBogusSaxParse('a<b data-mce-bogus="all"></b><b>c</b>', 'a<b>c</b>', {
      start: 1,
      end: 1,
      text: 2
    });
  ...
  suite.test('Retain base64 images', function () {
    ...
    writer.reset();
    parser.parse(
      'a<img src="data:image/gif;base64,R0/yw==" /><img src="data:image/jpeg;base64,R1/yw==" /><!-- <img src="data:image/jpeg;base64,R1/yw==" /> -->b'
    );
    LegacyUnit.equal(
      writer.getContent(),
      'a<img src="data:image/gif;base64,R0/yw==" /><img src="data:image/jpeg;base64,R1/yw==" /><!-- <img src="data:image/jpeg;base64,R1/yw==" /> -->b'
