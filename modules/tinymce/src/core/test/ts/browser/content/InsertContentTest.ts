...
UnitTest.asynctest(
  'browser.tinymce.core.content.InsertContentTest',
  (success, failure) => {
    ...
    suite.test(
      'insertAtCaret - ul with multiple items at beginning of li',
      function (editor) {
        editor.setContent('<ul><li>12</li></ul>');
        editor.focus();
        LegacyUnit.setSelection(editor, 'li', 0);
        ...
        LegacyUnit.equal(
          editor.getContent(),
          '<ul><li>a</li><li>b</li><li>12</li></ul>'
        );
    ...
    suite.test('insertAtCaret - ul with multiple items at end of li', function (
      ...
      LegacyUnit.equal(
        editor.getContent(),
        '<ul><li>12</li><li>a</li><li>b</li><li>c</li></ul>'
      );
      assertSelection(editor, 'li:nth-child(4)', 1);
    });

    suite.test(
      'insertAtCaret - ul with multiple items in middle of li',
      function (editor) {
        editor.setContent('<ul><li>12</li></ul>');
        editor.focus();
        ...
        LegacyUnit.equal(
          editor.getContent(),
          '<ul><li>1</li><li>a</li><li>b</li><li>2</li></ul>'
        );
    ...
    suite.test(
      'insertAtCaret - ul with trailing empty block in middle of li',
      function (editor) {
        editor.setContent('<ul><li>a</li><li>d</li></ul>');
        editor.focus();
        LegacyUnit.setSelection(editor, 'li:nth-child(1)', 1);
        InsertContent.insertAtCaret(editor, {
          content: '<ul><li>b</li><li>c</li></ul><p>\u00a0</p>',
          paste: true
        });
        LegacyUnit.equal(
          editor.getContent(),
    ...
    suite.test(
      'insertAtCaret - ul at beginning of li with empty end li',
      function (editor) {
        editor.setContent('<ul><li>12</li></ul>');
        editor.focus();
        LegacyUnit.setSelection(editor, 'li', 0);
        InsertContent.insertAtCaret(editor, {
          content: '<ul><li>a</li><li></li></ul>',
          paste: true
        });
        LegacyUnit.equal(editor.getContent(), '<ul><li>a</li><li>12</li></ul>');
        assertSelection(editor, 'li:nth-child(2)', 0);
    ...
    suite.test('insertAtCaret - merge inline elements', function (editor) {
      ...
      InsertContent.insertAtCaret(editor, {
        content: '<em><strong>123</strong></em>',
        merge: true
      });
      LegacyUnit.equal(
        editor.getContent(),
        '<p><strong><em>a123bc</em></strong></p>'
      );
    });

    suite.test(
      'insertAtCaret - list into empty table cell with invalid contents #TINY-1231',
      function (editor) {
        editor.getBody().innerHTML =
          '<table class="mce-item-table"><tbody><tr><td><br></td></tr></tbody></table>';
        editor.focus();
        ...
        InsertContent.insertAtCaret(editor, {
          content:
            '<meta http-equiv="content-type" content="text/html; charset=utf-8"><ul><li>a</li></ul>',
          paste: true
        });
        LegacyUnit.equal(
          editor.getBody().innerHTML,
          '<table class="mce-item-table"><tbody><tr><td><ul><li>a</li></ul></td></tr></tbody></table>'
        );
    ...
    suite.test(
      'insertAtCaret - empty paragraph pad the empty element with br on insert and nbsp on save',
      function (editor) {
        ...
        LegacyUnit.equal(
          ...
          '<p>a</p><p><br data-mce-bogus="1"></p><p>b</p>'
        );
        LegacyUnit.equal(editor.getContent(), '<p>a</p><p>\u00a0</p><p>b</p>');
      }
    );

    suite.test('insertAtCaret prevent default of beforeSetContent', function (
      editor
    ) {
      let args;
    ...
    suite.test(
      'insertAtCaret - text content at a text node with a trailing nbsp character',
      function (editor) {
    ...
    suite.test(
      'insertAtCaret - html at a text node with a trailing nbsp character',
      function (editor) {
        editor.setContent('<p>abc&nbsp;</p>');
        editor.focus();
        LegacyUnit.setSelection(editor, 'p', 4);
    ...
    suite.test(
      'insertAtCaret - text in the middle of a text node with nbsp characters',
      function (editor) {
    ...
    suite.test(
      'insertAtCaret - html in the middle of a text node with nbsp characters',
      function (editor) {
        editor.setContent('<p>a&nbsp;c</p>');
        editor.focus();
        LegacyUnit.setSelection(editor, 'p', 2);
