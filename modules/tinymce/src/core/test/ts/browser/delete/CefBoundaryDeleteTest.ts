...
UnitTest.asynctest(
  'browser.tinymce.core.delete.CefBoundaryDeleteTest',
  (success, failure) => {
    Theme();

    const sTestDelete = function (
      _editor: Editor,
      tinyApis: TinyApis,
      ...
      return GeneralSteps.sequence([
        ...
        Logger.t(
          'Should delete single space between cef elements',
        ...
        Logger.t(
          'Should add fake caret if we delete content beside cef elements',
          GeneralSteps.sequence([
            tinyApis.sSetContent(
        ...
        Logger.t(
          'Should add fake caret if we delete range beside cef',
          GeneralSteps.sequence([
            tinyApis.sSetContent(
              '<p><span contenteditable="false">a</span>&nbsp;abc</p>'
            ),
