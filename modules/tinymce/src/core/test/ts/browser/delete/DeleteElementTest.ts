    ...
    function (editor, onSuccess, onFailure) {
      ...
      Pipeline.async(
        ...
        [
          ...
          Logger.t(
            'Delete first image forwards caret before',
            GeneralSteps.sequence([
          ...
          Logger.t(
            'Delete first image forwards caret after',
            GeneralSteps.sequence([
              tinyApis.sSetContent('<p><img src="#1"><img src="#2"></p>'),
              tinyApis.sSetCursor([0], 1),
              sDeleteElementPath(editor, true, [0, 0]),
          ...
          Logger.t(
            'Delete second image forwards caret before',
            GeneralSteps.sequence([
              tinyApis.sSetContent('<p><img src="#1"><img src="#2"></p>'),
              tinyApis.sSetCursor([0], 1),
          ...
          Logger.t(
            'Delete second image forwards caret after',
            GeneralSteps.sequence([
              tinyApis.sSetContent('<p><img src="#1"><img src="#2"></p>'),
              tinyApis.sSetCursor([0], 2),
              sDeleteElementPath(editor, true, [0, 1]),
          ...
          Logger.t(
            'Delete second image backwards caret before',
            GeneralSteps.sequence([
              tinyApis.sSetContent('<p><img src="#1"><img src="#2"></p>'),
              tinyApis.sSetCursor([0], 1),
          ...
          Logger.t(
            'Delete second image backwards caret after',
            GeneralSteps.sequence([
              tinyApis.sSetContent('<p><img src="#1"><img src="#2"></p>'),
              tinyApis.sSetCursor([0], 2),
              sDeleteElementPath(editor, false, [0, 1]),
          ...
          Logger.t(
            'Delete forwards on paragraph to next paragraph with caret position (text)',
            GeneralSteps.sequence([
          ...
          Logger.t(
            'Delete backwards on paragraph to previous paragraph with caret position (text)',
            GeneralSteps.sequence([
              tinyApis.sSetContent('<p>a</p><p>b</p>'),
          ...
          Logger.t(
            'Delete forwards on paragraph to previous paragraph with caret position (text)',
            GeneralSteps.sequence([
              tinyApis.sSetContent('<p>a</p><p>b</p>'),
          ...
          Logger.t(
            'Delete backwards on paragraph to next paragraph with caret position (text)',
            GeneralSteps.sequence([
              tinyApis.sSetContent('<p>a</p><p>b</p>'),
          ...
          Logger.t(
            'Delete element adjacent text nodes forward',
            GeneralSteps.sequence([
          ...
          Logger.t(
            'Delete element adjacent text nodes backwards',
            GeneralSteps.sequence([
              tinyApis.sSetContent('<p>a<br>b</p>'),
          ...
          Logger.t(
            'Delete inline element adjacent text nodes forwards',
            GeneralSteps.sequence([
          ...
          Logger.t(
            'Delete inline element adjacent text nodes backwards',
            GeneralSteps.sequence([
              tinyApis.sSetContent('<p>a&nbsp; <strong>b</strong> &nbsp;c</p>'),
              tinyApis.sSetCursor([0, 2], 0),
              sDeleteElementPath(editor, false, [0, 1]),
          ...
          Logger.t(
            'Delete inline element adjacent text nodes, single space',
            GeneralSteps.sequence([
              tinyApis.sSetContent('<p>a <strong>b</strong>c</p>'),
          ...
          Logger.t(
            'Delete inline element leading only text nodes',
            GeneralSteps.sequence([
          ...
          Logger.t(
            'Delete inline element trailing only text nodes',
            GeneralSteps.sequence([
