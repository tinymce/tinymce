...
UnitTest.asynctest(
  'browser.tinymce.core.delete.CefDeleteNoneditableTest',
  (success, failure) => {
    Theme();
    NoneditablePlugin();
    ...
    TinyLoader.setup(
      (editor: Editor, onSuccess, onFailure) => {
        ...
        const generalTests = [
          Log.stepsAsStep(
            'TINY-3868',
            'Should not backspace cef inside cef with ranged selection',
            [
              tinyApis.sSetContent(
                '<div class="mceNonEditable"><span class="mceNonEditable">a</span> b</div><p>c</p>'
              ),
          ...
          Log.stepsAsStep(
            'TINY-3868',
            'Should not delete cef inside cef with ranged selection',
            [
              tinyApis.sSetContent(
                '<div class="mceNonEditable"><span class="mceNonEditable">a</span> b</div><p>c</p>'
              ),
          ...
          Log.stepsAsStep(
            'TINY-3868',
            'Should backspace cef inside cet with collapsed selection after inner cef',
            [
              tinyApis.sSetContent(
                '<div class="mceNonEditable"><span class="mceEditable"><span class="mceNonEditable">az</span> b</span> c</div><p>d</p>'
              ),
                  ...
                  s.element('body', {
                    children: [
                      s.element('div', {
                        children: [
                          s.element('span', {
                            children: [s.text(str.is(Unicode.nbsp + 'b'))]
                          }),
                          s.text(str.is(' c'))
                        ]
                      }),
                      s.element('p', {
                        children: [s.text(str.is('d'))]
                      })
                    ]
                  })
                )
        ...
        const nonIeTests = [
          Log.stepsAsStep(
            'TINY-3868',
            'Should not backspace cef inside cef with collapsed selection after inner cef',
            [
              tinyApis.sSetContent(
                '<div class="mceNonEditable"><span class="mceNonEditable">a</span> b</div><p>c</p>'
              ),
          ...
          Log.stepsAsStep(
            'TINY-3868',
            'Should not delete cef inside cef with collapsed selection before inner cef',
            [
              tinyApis.sSetContent(
                '<div class="mceNonEditable"><span class="mceNonEditable">a</span> b</div><p>c</p>'
              ),
