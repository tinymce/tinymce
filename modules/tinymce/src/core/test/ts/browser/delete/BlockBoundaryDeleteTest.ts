      ...
      function (editor, onSuccess, onFailure) {
        ...
        Pipeline.async(
          ...
          [
            tinyApis.sFocus(),
            Logger.t(
              'Backspace in same block should remain unchanged',
            ...
            Logger.t(
              'Delete in same block should remain unchanged',
              GeneralSteps.sequence([
                tinyApis.sSetContent('<p>a</p>'),
                tinyApis.sSetCursor([0, 0], 1),
                sDeleteNoop(editor),
            ...
            Logger.t(
              'Backspace between blocks with different parents should not merge',
              GeneralSteps.sequence([
            ...
            Logger.t(
              'Delete between blocks with different parents should not merge',
              GeneralSteps.sequence([
                tinyApis.sSetContent('<p>a</p><div><p>b</p></div>'),
                tinyApis.sSetCursor([0, 0], 1),
                sDeleteNoop(editor),
            ...
            Logger.t(
              'Backspace between textblock and non text block should not merge',
              GeneralSteps.sequence([
            ...
            Logger.t(
              'Delete between textblock and non text block should not merge',
              GeneralSteps.sequence([
                tinyApis.sSetContent('<p>a</p><ul><li>b</li></ul>'),
                tinyApis.sSetCursor([0, 0], 1),
                sDeleteNoop(editor),
            ...
            Logger.t(
              'Backspace on range between blocks should not merge (handled elsewhere)',
              GeneralSteps.sequence([
            ...
            Logger.t(
              'Delete on range between blocks should not merge (handled elsewhere)',
              GeneralSteps.sequence([
                tinyApis.sSetContent('<p>a</p><p>b</p>'),
                tinyApis.sSetSelection([0, 0], 1, [1, 0], 0),
                sDeleteNoop(editor),
            ...
            Logger.t(
              'Backspace between simple blocks should merge',
              GeneralSteps.sequence([
                tinyApis.sSetContent('<p>a</p><p>b</p>'),
            ...
            Logger.t(
              'Delete between simple blocks should merge',
              GeneralSteps.sequence([
                tinyApis.sSetContent('<p>a</p><p>b</p>'),
                tinyApis.sSetCursor([0, 0], 1),
                sDelete(editor),
            ...
            Logger.t(
              'Backspace between complex blocks should merge',
              GeneralSteps.sequence([
            ...
            Logger.t(
              'Delete between complex blocks should merge',
              GeneralSteps.sequence([
            ...
            Logger.t(
              'Backspace from red span to h1 should merge',
              GeneralSteps.sequence([
            ...
            Logger.t(
              'Delete from red span to h1 should merge',
              GeneralSteps.sequence([
                tinyApis.sSetContent(
                  '<p><span style="color: red;">a</span></p><h1>b</h1>'
                ),
                tinyApis.sSetCursor([0, 0, 0], 1),
                sDelete(editor),
                tinyApis.sAssertContent(
                  '<p><span style="color: red;">a</span>b</p>'
                ),
                tinyApis.sAssertSelection([0, 0, 0], 1, [0, 0, 0], 1)
              ])
            ),
            Logger.t(
              'Backspace from block into block with trailing br should merge',
              GeneralSteps.sequence([
                ...
                tinyApis.sAssertContentStructure(
                  ApproxStructure.build(function (s, str, _arr) {
                    return s.element('body', {
                      children: [
                        s.element('p', {
                          children: [s.text(str.is('a')), s.text(str.is('b'))]
                        })
                      ]
                    });
                  })
            ...
            Logger.t(
              'Delete from block into block with trailing br should merge',
              GeneralSteps.sequence([
                tinyApis.sSetRawContent('<p>a<br></p><p>b</p>'),
                tinyApis.sSetCursor([0, 0], 1),
                sDelete(editor),
            ...
            Logger.t(
              'Backspace from empty block into content block should merge',
              GeneralSteps.sequence([
            ...
            Logger.t(
              'Delete from empty block into content block should merge',
              GeneralSteps.sequence([
            ...
            Logger.t(
              'Backspace between empty blocks should merge',
              GeneralSteps.sequence([
            ...
            Logger.t(
              'Delete between empty blocks should merge',
              GeneralSteps.sequence([
                tinyApis.sSetRawContent('<p><br></p><p><br></p>'),
                tinyApis.sSetCursor([0], 0),
                sDelete(editor),
            ...
            Logger.t(
              'Backspace from block into block with trailing noneditable should merge',
              GeneralSteps.sequence([
                tinyApis.sSetRawContent(
                  '<p>a<span contentEditable="false">b</span></p><p>c</p>'
                ),
                tinyApis.sSetCursor([1, 0], 0),
                sBackspace(editor),
                tinyApis.sAssertContentStructure(
            ...
            Logger.t(
              'Delete from block into block with trailing contenteditable should merge',
              GeneralSteps.sequence([
                tinyApis.sSetRawContent(
                  '<p>a<span contentEditable="false">b</span></p><p>c</p>'
                ),
