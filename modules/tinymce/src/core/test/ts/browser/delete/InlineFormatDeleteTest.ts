    ...
    function (editor, onSuccess, onFailure) {
      ...
      Pipeline.async(
        ...
        [
          tinyApis.sFocus(),
          Logger.t(
            'Backspace/delete in unformatted plain text',
            GeneralSteps.sequence([
              Logger.t(
                'Backspace after plain text should do nothing',
                GeneralSteps.sequence([
              ...
              Logger.t(
                'Delete before plain text should do nothing',
                GeneralSteps.sequence([
                  tinyApis.sSetContent('<p>a</p>'),
              ...
              Logger.t(
                'Backspace in middle of plain text should do nothing',
                GeneralSteps.sequence([
              ...
              Logger.t(
                'Delete in middle of plain text should do nothing',
                GeneralSteps.sequence([
                  tinyApis.sSetContent('<p>ab</p>'),
                  tinyApis.sSetCursor([0, 0], 1),
                  sDeleteNoop(editor),
              ...
              Logger.t(
                'Delete in middle of caret format span should do nothing',
                GeneralSteps.sequence([
                  tinyApis.sSetRawContent(
                    '<p>a<span id="_mce_caret" data-mce-bogus="1" data-mce-type="format-caret"><strong>&#65279;</strong></span>b</p>'
                  ),
          ...
          Logger.t(
            'Backspace/delete in at last character',
            GeneralSteps.sequence([
              Logger.t(
                'Backspace after last character in formatted element',
                GeneralSteps.sequence([
              ...
              Logger.t(
                'Delete before last character in formatted element',
                GeneralSteps.sequence([
                  tinyApis.sSetContent('<p><strong><em>a</em></strong></p>'),
              ...
              Logger.t(
                'Backspace before last character in formatted element',
                GeneralSteps.sequence([
              ...
              Logger.t(
                'Delete after last character in formatted element',
                GeneralSteps.sequence([
                  tinyApis.sSetContent('<p><em>a</em><strong>b</strong></p>'),
