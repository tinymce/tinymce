      ...
      function (editor, onSuccess, onFailure) {
        ...
        Pipeline.async(
          ...
          [
            tinyApis.sFocus(),
            Logger.t(
              'Backspace on collapsed range should be a noop',
            ...
            Logger.t(
              'Delete on collapsed range should be a noop',
              GeneralSteps.sequence([
                tinyApis.sSetContent('<p>a</p>'),
                tinyApis.sSetCursor([0, 0], 1),
                sDeleteNoop(editor),
            ...
            Logger.t(
              'Backspace on range between simple blocks should merge',
              GeneralSteps.sequence([
            ...
            Logger.t(
              'Delete on range between simple blocks should merge',
              GeneralSteps.sequence([
                tinyApis.sSetContent('<p>a</p><p>b</p>'),
                tinyApis.sSetSelection([0, 0], 1, [1, 0], 0),
                sDelete(editor),
            ...
            Logger.t(
              ...
              GeneralSteps.sequence([
                tinyApis.sSetContent(
                  '<h1>ab</h1><p><span style="color: red;">cd</span></p>'
                ),
            ...
            Logger.t(
              ...
              GeneralSteps.sequence([
                tinyApis.sSetContent(
                  '<p><span style="color: red;">ab</span></p><h1>cd</h1>'
                ),
                tinyApis.sSetSelection([0, 0, 0], 1, [1, 0], 1),
                sDelete(editor),
                tinyApis.sAssertContent(
                  '<p><span style="color: red;">a</span>d</p>'
                ),
                tinyApis.sAssertSelection([0, 0, 0], 1, [0, 0, 0], 1)
              ])
            ),
            Logger.t(
              'Delete from li to li should merge',
              GeneralSteps.sequence([
            ...
            Logger.t(
              'Delete from nested li to li should merge',
              GeneralSteps.sequence([
                tinyApis.sSetContent(
                  '<ul><li>ab<ul><li>cd</li></ul></li></ul>'
                ),
            ...
            Logger.t(
              'Delete from li to nested li should merge',
              GeneralSteps.sequence([
                tinyApis.sSetContent(
                  '<ul><li>ab<ul><li>cd</li></ul></li><li>ef</li></ul>'
                ),
                tinyApis.sSetSelection([0, 0, 1, 0, 0], 1, [0, 1, 0], 1),
                sDelete(editor),
                tinyApis.sAssertContent(
                  '<ul><li>ab<ul><li>cf</li></ul></li></ul>'
                ),
            ...
            Logger.t(
              'Delete from deep nested li to li should merge',
              GeneralSteps.sequence([
                tinyApis.sSetContent(
                  '<ul><li>ab<ul><li>cd<ul><li>ef</li></li></ul></li></ul>'
                ),
            ...
            Logger.t(
              'Delete on selection of everything should empty editor',
              GeneralSteps.sequence([
                tinyApis.sSetContent('<p>a</p><p>b</p>'),
            ...
            Logger.t(
              'Backspace selected paragraphs in td should produce an padded empty cell and also not delete the whole table',
              GeneralSteps.sequence([
                tinyApis.sSetContent(
            ...
            Logger.t(
              'Delete selected paragraphs in td should produce an padded empty cell and also not delete the whole table',
              GeneralSteps.sequence([
                tinyApis.sSetContent(
                  '<table><tbody><tr><td><p>a</p><p>b</p></td></tr></tbody></table>'
                ),
