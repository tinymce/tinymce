    ...
    [
      Logger.t(
        ...
        GeneralSteps.sequence([
          ...
          Logger.t(
            'Merge two simple blocks with br',
            Chain.asStep(viewBlock, [
          ...
          Logger.t(
            'Merge two headers blocks first one empty',
            Chain.asStep(viewBlock, [
          ...
          Logger.t(
            'Merge two headers blocks second one empty',
            Chain.asStep(viewBlock, [
          ...
          Logger.t(
            'Merge two headers complex blocks',
            Chain.asStep(viewBlock, [
          ...
          Logger.t(
            'Merge two headers blocks first one empty second one complex',
            Chain.asStep(viewBlock, [
          ...
          Logger.t(
            'Merge two headers blocks second one empty first one complex',
            Chain.asStep(viewBlock, [
          ...
          Logger.t(
            'Merge paragraph into list item',
            Chain.asStep(viewBlock, [
          ...
          Logger.t(
            'Merge empty block into empty containing block',
            Chain.asStep(viewBlock, [
          ...
          Logger.t(
            'Merge empty block into containing block',
            Chain.asStep(viewBlock, [
          ...
          Logger.t(
            'Merge first empty item of nested list into containing list item',
            Chain.asStep(viewBlock, [
      ...
      Logger.t(
        ...
        GeneralSteps.sequence([
          ...
          Logger.t(
            'Merge list item into paragraph',
            Chain.asStep(viewBlock, [
          ...
          Logger.t(
            'Merge h1 into parent wrapper div',
            Chain.asStep(viewBlock, [
          ...
          Logger.t(
            'Merge h1 inside a div into parent wrapper div',
            Chain.asStep(viewBlock, [
          ...
          Logger.t(
            'Merge div > div > div > h1 into root div',
            Chain.asStep(viewBlock, [
          ...
          Logger.t(
            'Merge children until we find a block',
            Chain.asStep(viewBlock, [
