...
UnitTest.asynctest('browser.tinymce.core.delete.BlockMergeBoundary', function (
  ...
  const cAssertBlockBoundaryPositions = function (
    fromPath,
    fromOffset,
    toPath,
    toOffset
  ...
  const cAssertBlockBoundaryBlocks = function (
    fromBlockPath: number[],
    toBlockPath: number[]
  ): Chain<Option<BlockBoundary>, Option<BlockBoundary>> {
  ...
  Pipeline.async(
    ...
    [
      ...
      Logger.t(
        'Some block boundaries',
        GeneralSteps.sequence([
          Logger.t(
            'Should some between simple blocks (forwards: true)',
            Chain.asStep(viewBlock, [
          ...
          Logger.t(
            'Should some between simple blocks (forwards: false)',
            Chain.asStep(viewBlock, [
              cSetHtml('<p>a</p><p>b</p>'),
          ...
          Logger.t(
            'Should some between complex blocks (forwards: true)',
            Chain.asStep(viewBlock, [
          ...
          Logger.t(
            'Should some between complex blocks (forwards: false)',
            Chain.asStep(viewBlock, [
              cSetHtml('<p><em>a</em></p><p><em>b</em></p>'),
          ...
          Logger.t(
            'Should some between blocks with br (forwards: true)',
            Chain.asStep(viewBlock, [
