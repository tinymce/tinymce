...
UnitTest.asynctest(
  ...
  function (success, failure) {
    ...
    const sTestDeleteOrBackspaceKey = function (
      editor: Editor,
      tinyApis: TinyApis,
    ...
    TinyLoader.setupLight(
      function (editor, onSuccess, onFailure) {
        ...
        const sTestBackspace = sTestDeleteOrBackspaceKey(
          editor,
          tinyApis,
          tinyActions,
          Keys.backspace()
        );
        const sTestDelete = sTestDeleteOrBackspaceKey(
          editor,
          tinyApis,
          tinyActions,
          46
