...
UnitTest.asynctest('browser.tinymce.core.delete.InlineBoundaryDeleteTest', function (success, failure) {
  ...
  const readLocation = function (editor: Editor) {
    ...
    return BoundaryLocation.readLocation(isInlineTarget, editor.getBody(), CaretPosition.fromRangeStart(editor.selection.getRng()))
      .map(locationName)
      .getOr('none');
  };
    ...
    function (editor, onSuccess, onFailure) {
      ...
      Pipeline.async(
        ...
        [
          ...
          Logger.t(
            'Backspace key on image',
            GeneralSteps.sequence([
              sTestBackspace(
                '<p>a<a href="#"><img src="#" /></a>c</p>',
                [0, 2],
                0,
                '<p>a<a href="#"><img src="#" /></a>c</p>',
                'end',
          ...
          Logger.t(
            ...
            GeneralSteps.sequence([
              ...
              sTestDelete(
                '<p><img src="#1" /><a href="#">b</a><img src="#2" /></p>',
                [0, 1, 0],
                0,
                '<p><img src="#1" /><img src="#2" /></p>',
                'none',
                [0],
                1
              ),
          ...
          Logger.t(
            'Backspace/delete between blocks',
            GeneralSteps.sequence([
              sTestBackspace(
          ...
          Logger.t(
            'Backspace key inline_boundaries: false',
            GeneralSteps.sequence([
