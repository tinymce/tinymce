              ...
              GeneralSteps.sequence([
                ...
                tinyApis.sAssertContentStructure(
                  ApproxStructure.build((s, _str, _arr) =>
                    s.element('body', {
                      children: [ApproxStructure.fromHtml(expectedHTML('<br data-mce-bogus="1">')), s.element(rootBlock, {})]
                    })
                  )
                ),
            ...
            Logger.t(
              ...
              GeneralSteps.sequence([
                ...
                tinyApis.sAssertContentStructure(
                  ApproxStructure.build((s, _str, _arr) =>
                    s.element('body', {
                      children: [s.element(rootBlock, {}), ApproxStructure.fromHtml(expectedHTML('b'))]
                    })
                  )
                ),
                tinyApis.sAssertSelection([1, 0], 0, [1, 0], 0)
            ...
            Logger.t(
              ...
              GeneralSteps.sequence([
                ...
                tinyApis.sAssertContentStructure(
                  ApproxStructure.build((s, _str, _arr) =>
                    s.element('body', {
                      children: [s.element(rootBlock, {}), ApproxStructure.fromHtml(expectedHTML('<br data-mce-bogus="1">'))]
                    })
                  )
                ),
      ...
      Pipeline.async(
        ...
        [
          ...
          sAssertNewLine(
            ...
            (innerHTML: string) =>
              `<p class="${forcedRootBlockAttrs.class}" style="${forcedRootBlockAttrs.style + ' padding-left: 40px;'}">${innerHTML}</p>`
          ),
