  ...
  TinyLoader.setupLight(
    function (editor, onSuccess, onFailure) {
      ...
      Pipeline.async(
        ...
        [
          Logger.t(
            'Enter inside inline boundary link',
            GeneralSteps.sequence([
              Logger.t(
                'Insert br at beginning of inline boundary link',
                GeneralSteps.sequence([
                  tinyApis.sFocus(),
              ...
              Logger.t(
                'Insert br in middle inline boundary link',
                GeneralSteps.sequence([
                  tinyApis.sFocus(),
              ...
              Logger.t(
                'Insert br at end of inline boundary link',
                GeneralSteps.sequence([
                  tinyApis.sFocus(),
                  tinyApis.sSetContent('<p>a<a href="#">b</a>c</p>'),
                  tinyApis.sSetCursor([0, 1, 0], 1),
              ...
              Logger.t(
                'Insert br at end of inline boundary link with trailing br',
                GeneralSteps.sequence([
                  tinyApis.sFocus(),
          ...
          Logger.t(
            'Enter inside inline boundary code',
            GeneralSteps.sequence([
              Logger.t(
                'Insert br at beginning of boundary code',
                GeneralSteps.sequence([
                  tinyApis.sFocus(),
              ...
              Logger.t(
                'Insert br at middle of boundary code',
                GeneralSteps.sequence([
                  tinyApis.sFocus(),
              ...
              Logger.t(
                'Insert br at end of boundary code',
                GeneralSteps.sequence([
                  tinyApis.sFocus(),
                  tinyApis.sSetContent('<p>a<code>b</code>c</p>'),
                  tinyApis.sSetCursor([0, 1, 0], 1),
