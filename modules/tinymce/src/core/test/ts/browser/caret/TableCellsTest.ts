    ...
    [
      Logger.t(
        ...
        GeneralSteps.sequence([
          Logger.t(
            'Should return the top/right cell',
          ...
          Logger.t(
            'Should return the top/left cell',
            Chain.asStep(viewBlock, [
              cSetHtml(
                [
                  '<table style="border-collapse: collapse" border="1">',
      ...
      Logger.t(
        ...
        GeneralSteps.sequence([
          Logger.t(
            'Should return the bottom/right cell',
            Chain.asStep(viewBlock, [
              cSetHtml(
                [
                  '<table style="border-collapse: collapse" border="1">',
          ...
          Logger.t(
            'Should return the bottom/left cell',
            Chain.asStep(viewBlock, [
              cSetHtml(
                [
                  '<table style="border-collapse: collapse" border="1">',
      ...
      Logger.t(
        ...
        GeneralSteps.sequence([
          Logger.t(
            'Should return first positon in the top/right cell',
            Chain.asStep(viewBlock, [
              cSetHtml(
                [
                  '<table style="border-collapse: collapse" border="1">',
          ...
          Logger.t(
            'Should return last positon in the top/right cell',
            Chain.asStep(viewBlock, [
              cSetHtml(
                [
                  '<table style="border-collapse: collapse" border="1">',
          ...
          Logger.t(
            'Should return first positon in the bottom/right cell',
            Chain.asStep(viewBlock, [
              cSetHtml(
                [
                  '<table style="border-collapse: collapse" border="1">',
          ...
          Logger.t(
            'Should return last positon in the bottom/right cell',
            Chain.asStep(viewBlock, [
              cSetHtml(
                [
                  '<table style="border-collapse: collapse" border="1">',
