    ...
    [
      Logger.t(
        ...
        GeneralSteps.sequence([
          ...
          Logger.t(
            'Should walk to from text node offset 0 to 1',
            Chain.asStep(viewBlock, [
              cSetHtml('<p>a</p>'),
          ...
          Logger.t(
            'Should walk to from text node offset 1 to 0',
            Chain.asStep(viewBlock, [
              cSetHtml('<p>a</p>'),
      ...
      Logger.t(
        ...
        GeneralSteps.sequence([
          Logger.t(
            ...
            GeneralSteps.sequence([
              Logger.t(
                'Should walk to second offset in text inside b',
                Chain.asStep(viewBlock, [
              ...
              Logger.t(
                'Should walk from last text position in one b into the second text position in another b',
                Chain.asStep(viewBlock, [
              ...
              Logger.t(
                'Should walk to after input in b',
                Chain.asStep(viewBlock, [
              ...
              Logger.t(
                'Should walk from after input to after input in b',
                Chain.asStep(viewBlock, [
              ...
              Logger.t(
                'Should walk from after input inside b to after input in another b',
                Chain.asStep(viewBlock, [
              ...
              Logger.t(
                'Should walk from after input to second text offset in b',
                Chain.asStep(viewBlock, [
              ...
              Logger.t(
                'Should walk from before first input to after first input',
                Chain.asStep(viewBlock, [
              ...
              Logger.t(
                'Should walk from after first input to after second input',
                Chain.asStep(viewBlock, [
                  cSetHtml('<p><input><input></p>'),
                  cCreateFromPosition([0], 1),
                  cNavigate(true),
              ...
              Logger.t(
                'Should walk from last text node offset over br to first text node offset',
                Chain.asStep(viewBlock, [
                  cSetHtml('<p>a<br>b</p>'),
                  cCreateFromPosition([0, 0], 1),
                  cNavigate(true),
              ...
              Logger.t(
                'Should walk from after input over br to first text node offset',
                Chain.asStep(viewBlock, [
              ...
              Logger.t(
                'Should walk from last text offset in first paragraph to first text offset in second paragraph',
                Chain.asStep(viewBlock, [
          ...
          Logger.t(
            ...
            GeneralSteps.sequence([
              Logger.t(
                'Should walk to first offset in text inside b',
                Chain.asStep(viewBlock, [
              ...
              Logger.t(
                'Should walk to before input in b',
                Chain.asStep(viewBlock, [
              ...
              Logger.t(
                'Should walk from before input to before input in b',
                Chain.asStep(viewBlock, [
              ...
              Logger.t(
                'Should walk from before input inside b to before input in another b',
                Chain.asStep(viewBlock, [
                  cSetHtml('<p><b><input></b><b><input></b></p>'),
                  cCreateFromPosition([0, 1], 0),
                  cNavigate(false),
              ...
              Logger.t(
                'Should walk from before input to first text offset in b',
                Chain.asStep(viewBlock, [
              ...
              Logger.t(
                'Should walk from after last input to after first input',
                Chain.asStep(viewBlock, [
                  cSetHtml('<p><input><input></p>'),
              ...
              Logger.t(
                'Should from after first input to before first input',
                Chain.asStep(viewBlock, [
                  cSetHtml('<p><input><input></p>'),
                  cCreateFromPosition([0], 1),
                  cNavigate(false),
              ...
              Logger.t(
                'Should from before last input to after first input',
                Chain.asStep(viewBlock, [
                  cSetHtml('<p><input><input><input></p>'),
                  cCreateFromPosition([0], 2),
                  cNavigate(false),
              ...
              Logger.t(
                'Should walk from first text node offset over br to last text node offset',
                Chain.asStep(viewBlock, [
                  cSetHtml('<p>a<br>b</p>'),
              ...
              Logger.t(
                'Should walk from before input over br to last text node offset',
                Chain.asStep(viewBlock, [
              ...
              Logger.t(
                'Should walk from first text offset in second paragraph to first text offset in first paragraph',
                Chain.asStep(viewBlock, [
                  cSetHtml('<p>a</p><p>b</p>'),
