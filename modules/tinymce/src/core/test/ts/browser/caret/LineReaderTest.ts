...
UnitTest.asynctest('browser.tinymce.core.caret.LineReader', (success, failure) => {
  ...
  const isSafari13OrLower =
    browser.isSafari() && (browser.version.major < 13 || (browser.version.major === 13 && browser.version.minor < 1));
        ...
        GeneralSteps.sequence([
          ...
          Logger.t(
            ...
            Chain.asStep(
              viewBlock,
              Arr.flatten([
                [cSetHtml('<div style="width: 10px">abc def ghi</div>'), cGetPositionsUntilPreviousLine([0, 0], 6)],
                isSafari13OrLower
                  ? [
                      cAssertLineInfoCaretPositions([
                        { path: [0, 0], offset: 4 },
                  ...
                  : [
                      cAssertLineInfoCaretPositions([{ path: [0, 0], offset: 5 }]),
                      cAssertBreakType(BreakType.Wrap),
          ...
          Logger.t(
            ...
            Chain.asStep(
              viewBlock,
              Arr.flatten([
                [cSetHtml('<div style="width: 10px">abc def ghi</div>'), cGetPositionsUntilPreviousLine([0, 0], 5)],
                isSafari13OrLower
                  ? [
                      cAssertLineInfoCaretPositions([{ path: [0, 0], offset: 4 }]),
                      cAssertBreakType(BreakType.Wrap),
                      cAssertBreakPosition([0, 0], 3)
                    ]
                  : [cAssertLineInfoCaretPositions([]), cAssertBreakType(BreakType.Wrap), cAssertBreakPosition([0, 0], 4)]
              ])
            )
          )
        ])
      ...
      Logger.t(
        ...
        GeneralSteps.sequence([
          Logger.t(
            ...
            Chain.asStep(viewBlock, [cSetHtml('<p>a</p>'), cGetAbovePositions([0, 0], 1), cAssertCaretPositions([])])
          ),
          Logger.t(
      ...
      Logger.t(
        ...
        GeneralSteps.sequence([
          Logger.t(
            ...
            Chain.asStep(viewBlock, [cSetHtml('<p>a</p>'), cGetBelowPositions([0, 0], 0), cAssertCaretPositions([])])
          ),
          Logger.t(
