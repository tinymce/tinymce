...
UnitTest.asynctest(
  'browser.tinymce.core.annotate.AnnotationRemovedTest',
  (success, failure) => {
    Theme();
      ...
      function (editor: Editor, onSuccess, onFailure) {
        ...
        const sSetupData = GeneralSteps.sequence([
          ...
          tinyApis.sSetContent(
            '<p>This was the first paragraph</p><p>This is the second.</p><p>This is the third.</p>'
          ),
        ...
        Pipeline.async(
          {},
          [tinyApis.sFocus(), sSetupData, sTestGetAndRemove],
          onSuccess,
          onFailure
        );
      },
