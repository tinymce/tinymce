...
UnitTest.asynctest(
  'browser.tinymce.core.keyboard.InsertKeysBrModeTest',
  (success, failure) => {
    Theme();
            ...
            Logger.t(
              ...
              GeneralSteps.sequence([
                Logger.t(
                  ...
                  GeneralSteps.sequence([
                    Logger.t(
                      'Insert in text node with nbsp at start of body',
                      GeneralSteps.sequence([
                        tinyApis.sFocus(),
                ...
                Logger.t(
                  ...
                  GeneralSteps.sequence([
                    Logger.t(
                      'Insert in text node with nbsp at end of body',
                      GeneralSteps.sequence([
                        tinyApis.sFocus(),
                        tinyApis.sSetRawContent('a&nbsp;'),
                    ...
                    Logger.t(
                      'Insert in text in node with trailing nbsp before inline',
                      GeneralSteps.sequence([
                        tinyApis.sFocus(),
                        tinyApis.sSetRawContent('a&nbsp;<em>b</em>c'),
                        tinyApis.sSetCursor([0], 0),
