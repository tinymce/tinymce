...
UnitTest.asynctest('browser.tinymce.core.keyboard.EnterKey', function (
  ...
  suite.test('Enter in midde of H1', function (editor) {
    ...
    LegacyUnit.equal(
      editor.selection.getRng().startContainer.parentNode.nodeName,
      'H1'
    );
  });
  ...
  suite.test('Enter before first wrapped IMG in P', function (editor) {
    ...
    LegacyUnit.equal(
      editor.getContent(),
      '<p>\u00a0</p><p><b><img src="about:blank" /></b></p>'
    );
  });
  ...
  suite.test('Enter before last IMG in P with text', function (editor) {
    ...
    LegacyUnit.equal(
      editor.getContent(),
      '<p>abc</p><p><img src="about:blank" /></p>'
    );
    const rng = editor.selection.getRng();
    LegacyUnit.equal(rng.startContainer.nodeName, 'P');
    LegacyUnit.equal(
      rng.startContainer.childNodes[rng.startOffset].nodeName,
      'IMG'
    );
  });
  ...
  suite.test('Enter before last IMG in P with IMG sibling', function (editor) {
    ...
    LegacyUnit.equal(
      editor.getContent(),
      '<p><img src="about:blank" /></p><p><img src="about:blank" /></p>'
    );
    const rng = editor.selection.getRng();
    LegacyUnit.equal(rng.startContainer.nodeName, 'P');
    LegacyUnit.equal(
  ...
  suite.test('Enter after last IMG in P', function (editor) {
    ...
    LegacyUnit.equal(
      editor.getContent(),
      '<p>abc<img src="about:blank" /></p><p>\u00a0</p>'
    );
  });
  ...
  suite.test('Enter before last INPUT in P with IMG sibling', function (
    editor
  ) {
  ...
  suite.test('Enter at end of EM inside P', function (editor) {
    ...
    pressEnter(editor);
    LegacyUnit.equal(
      HtmlUtils.cleanHtml(editor.getBody().innerHTML).replace(
        /<br([^>]+|)>|&nbsp;/g,
        ''
      ),
  ...
  suite.test('Enter at end of STRONG in EM inside P', function (editor) {
    ...
    LegacyUnit.equal(
      editor.selection.getRng().startContainer.nodeName,
      'STRONG'
    );
  });
  ...
  suite.test('Enter at middle of STRONG in EM inside P', function (editor) {
    ...
    LegacyUnit.equal(
      editor.getContent(),
      '<p><em><strong>ab</strong></em></p><p><em><strong>cd</strong></em></p>'
    );
    LegacyUnit.equal(
      editor.selection.getRng().startContainer.parentNode.nodeName,
      'STRONG'
  ...
  suite.test(
    'Enter at middle of P with style, id and class attributes',
    function (editor) {
      ...
      LegacyUnit.equal(
        editor.getContent(),
        '<p id="a" class="b" style="color: #000;">ab</p><p class="b" style="color: #000;">cd</p>'
      );
      LegacyUnit.equal(
        editor.selection.getRng().startContainer.parentNode.nodeName,
        'P'
  ...
  suite.test('Shift+Enter inside STRONG inside TD with BR', function (editor) {
    editor.getBody().innerHTML =
      '<table><tr><td>d <strong>e</strong><br></td></tr></table>';
  ...
  suite.test('Enter inside at beginning of text node in body', function (
    editor
  ) {
    editor.getBody().innerHTML = 'abcd';
  ...
  suite.test(
    'Enter in the middle of text in P with forced_root_block set to false',
    function (editor) {
  ...
  suite.test(
    'Enter at the end of text in P with forced_root_block set to false',
    function (editor) {
      editor.settings.forced_root_block = false;
      editor.getBody().innerHTML = '<p>abc</p>';
      LegacyUnit.setSelection(editor, 'p', 3);
  ...
  suite.test(
    'Enter at the middle of text in BODY with forced_root_block set to false',
    function (editor) {
      editor.settings.forced_root_block = false;
      editor.getBody().innerHTML = 'abcd';
      LegacyUnit.setSelection(editor, 'body', 2);
  ...
  suite.test(
    'Enter at the beginning of text in BODY with forced_root_block set to false',
    function (editor) {
      editor.settings.forced_root_block = false;
      editor.getBody().innerHTML = 'abcd';
      LegacyUnit.setSelection(editor, 'body', 0);
  ...
  suite.test(
    'Enter at the end of text in BODY with forced_root_block set to false',
    function (editor) {
      editor.settings.forced_root_block = false;
      editor.getBody().innerHTML = 'abcd';
      LegacyUnit.setSelection(editor, 'body', 4);
  ...
  suite.test(
    'Enter in empty P at the end of a blockquote and end_container_on_empty_block: true',
    function (editor) {
      editor.settings.end_container_on_empty_block = true;
      editor.getBody().innerHTML =
        '<blockquote><p>abc</p><p><br></p></blockquote>';
      LegacyUnit.setSelection(editor, 'p:last', 0);
      pressEnter(editor);
      LegacyUnit.equal(
        editor.getContent(),
        '<blockquote><p>abc</p></blockquote><p>\u00a0</p>'
      );
      editor.settings.forced_root_block = 'p';
    }
  );
  ...
  suite.test(
    'Enter in empty P at the beginning of a blockquote and end_container_on_empty_block: true',
    function (editor) {
      editor.settings.end_container_on_empty_block = true;
      editor.getBody().innerHTML =
        '<blockquote><p><br></p><p>abc</p></blockquote>';
      LegacyUnit.setSelection(editor, 'p', 0);
      pressEnter(editor);
      LegacyUnit.equal(
        editor.getContent(),
        '<p>\u00a0</p><blockquote><p>abc</p></blockquote>'
      );
      editor.settings.forced_root_block = 'p';
    }
  );
  ...
  suite.test(
    'Enter in empty P at in the middle of a blockquote and end_container_on_empty_block: true',
    function (editor) {
      editor.settings.end_container_on_empty_block = true;
      editor.getBody().innerHTML =
        '<blockquote><p>abc</p><p><br></p><p>123</p></blockquote>';
      LegacyUnit.setSelection(editor, 'p:nth-child(2)', 0);
      pressEnter(editor);
      LegacyUnit.equal(
        editor.getContent(),
        '<blockquote><p>abc</p></blockquote><p>\u00a0</p><blockquote><p>123</p></blockquote>'
      );
      editor.settings.forced_root_block = 'p';
    }
  );
  ...
  suite.test(
    ...
    function (editor) {
      editor.settings.end_container_on_empty_block = true;
      editor.getBody().innerHTML =
        '<blockquote><p>abc</p><p>\u00a0</p><p><br></p><p>123</p></blockquote>';
      LegacyUnit.setSelection(editor, 'p:nth-child(3)', 0);
      pressEnter(editor);
      LegacyUnit.equal(
        editor.getContent(),
        '<blockquote><p>abc</p><p>\u00a0</p></blockquote><p>\u00a0</p><blockquote><p>123</p></blockquote>'
      );
      editor.settings.forced_root_block = 'p';
    }
  );
  ...
  suite.test('Enter at end of H1 with forced_root_block_attrs', function (
    editor
  ) {
  ...
  suite.test('Shift+Enter in the middle of B with a BR after it', function (
    editor
  ) {
  ...
  suite.test('Shift+Enter at the end of B with a BR after it', function (
    editor
  ) {
    editor.getBody().innerHTML = '<p><b>abcd</b><br></p>';
  ...
  suite.test('Enter in beginning of PRE and br_in_pre: false', function (
    editor
  ) {
  ...
  suite.test('Enter in the middle of PRE and br_in_pre: false', function (
    editor
  ) {
    editor.settings.br_in_pre = false;
    editor.getBody().innerHTML = '<pre>abcd</pre>';
  ...
  suite.test(
    'Shift+Enter in beginning of P with forced_root_block set to false',
    function (editor) {
      editor.settings.forced_root_block = false;
      editor.getBody().innerHTML = '<p>abc</p>';
      LegacyUnit.setSelection(editor, 'p', 0);
  ...
  suite.test(
    'Shift+Enter in middle of P with forced_root_block set to false',
    function (editor) {
      editor.settings.forced_root_block = false;
      editor.getBody().innerHTML = '<p>abcd</p>';
      LegacyUnit.setSelection(editor, 'p', 2);
  ...
  suite.test(
    'Shift+Enter at the end of P with forced_root_block set to false',
    function (editor) {
      editor.settings.forced_root_block = false;
      editor.getBody().innerHTML = '<p>abc</p>';
      LegacyUnit.setSelection(editor, 'p', 3);
  ...
  suite.test(
    'Shift+Enter in body with forced_root_block set to false',
    function (editor) {
      editor.settings.forced_root_block = false;
      editor.getBody().innerHTML = 'abcd';
  ...
  suite.test('Enter at the end of DIV layer', function (editor) {
    editor.settings.br_in_pre = false;
    editor.setContent(
      '<div style="position: absolute; top: 1px; left: 2px;">abcd</div>'
    );
    LegacyUnit.setSelection(editor, 'div', 4);
    pressEnter(editor);
    LegacyUnit.equal(
      editor.getContent(),
      '<div style="position: absolute; top: 1px; left: 2px;"><p>abcd</p><p>\u00a0</p></div>'
    );
    delete editor.settings.br_in_pre;
  });

  suite.test(
    'Enter at end of text in a span inside a P and keep_styles: false',
    function (editor) {
      editor.settings.keep_styles = false;
      editor.getBody().innerHTML =
        '<p><em><span style="font-size: 13px;">X</span></em></p>';
      LegacyUnit.setSelection(editor, 'span', 1);
      pressEnter(editor);
      LegacyUnit.equal(
        editor.getContent(),
        '<p><em><span style="font-size: 13px;">X</span></em></p><p>\u00a0</p>'
      );
  ...
  suite.test(
    'keep_styles=false: P should not pass its styles and classes to the new P that is cloned from it when enter is pressed',
    function (editor) {
      editor.settings.keep_styles = false;
      editor.getBody().innerHTML =
        '<p class="red" style="color: #ff0000;"><span style="font-size: 13px;">X</span></p>';
      LegacyUnit.setSelection(editor, 'span', 1);
      pressEnter(editor);
      LegacyUnit.equal(
        editor.getContent(),
        '<p class="red" style="color: #ff0000;"><span style="font-size: 13px;">X</span></p><p>\u00a0</p>'
      );
      delete editor.settings.keep_styles;
    }
  );
  ...
  suite.test(
    'Enter when forced_root_block: false and force_p_newlines: true',
    function (editor) {
      editor.settings.forced_root_block = false;
  ...
  if (!Env.ie || Env.ie > 8) {
    suite.test('Enter before BR between DIVs', function (editor) {
      editor.getBody().innerHTML =
        '<div>a<span>b</span>c</div><br /><div>d</div>';
      const rng = editor.dom.createRng();
      ...
      LegacyUnit.equal(
        editor.getContent(),
        '<div>a<span>b</span>c</div><p>\u00a0</p><p>\u00a0</p><div>d</div>'
      );
    });
  }
  ...
  suite.test('Enter behind table element', function (editor) {
    ...
    LegacyUnit.equal(
      editor.getContent(),
      '<table><tbody><tr><td>x</td></tr></tbody></table><p>\u00a0</p>'
    );
  });
  ...
  suite.test('Enter before table element', function (editor) {
    ...
    LegacyUnit.equal(
      editor.getContent(),
      '<p>\u00a0</p><table><tbody><tr><td>x</td></tr></tbody></table>'
    );
  });
  ...
  suite.test('Enter behind table followed by a p', function (editor) {
    ...
    editor.getBody().innerHTML =
      '<table><tbody><td>x</td></tbody></table><p>x</p>';
    ...
    LegacyUnit.equal(
      editor.getContent(),
      '<table><tbody><tr><td>x</td></tr></tbody></table><p>\u00a0</p><p>x</p>'
    );
  });
  ...
  suite.test('Enter before table element preceded by a p', function (editor) {
    ...
    editor.getBody().innerHTML =
      '<p>x</p><table><tbody><td>x</td></tbody></table>';
    rng.setStartBefore(editor.getBody().lastChild);
    rng.setStartBefore(editor.getBody().lastChild);
    editor.selection.setRng(rng);
    ...
    LegacyUnit.equal(
      editor.getContent(),
      '<p>x</p><p>\u00a0</p><table><tbody><tr><td>x</td></tr></tbody></table>'
    );
  });
  ...
  suite.test('Enter twice before table element', function (editor) {
    ...
    LegacyUnit.equal(
      editor.getContent(),
      '<p>\u00a0</p><p>\u00a0</p><table><tbody><tr><td>x</td></tr></tbody></table>'
    );
  });
  ...
  suite.test('Enter inside first li with block inside', function (editor) {
    editor.getBody().innerHTML =
      '<ul><li><p><br /></p></li><li><p>b</p></li><li>c</li></ul>';
    LegacyUnit.setSelection(editor, 'p', 0);
    pressEnter(editor);
    LegacyUnit.equal(
      editor.getContent(),
      '<p>\u00a0</p><ul><li><p>b</p></li><li>c</li></ul>'
    );
  });

  suite.test('Enter inside middle li with block inside', function (editor) {
    editor.getBody().innerHTML =
      '<ul><li>a</li><li><p><br /></p></li><li>c</li></ul>';
    LegacyUnit.setSelection(editor, 'p', 0);
    pressEnter(editor);
    LegacyUnit.equal(
      editor.getContent(),
      '<ul><li>a</li></ul><p>\u00a0</p><ul><li>c</li></ul>'
    );
  });

  suite.test('Enter inside last li with block inside', function (editor) {
    editor.getBody().innerHTML =
      '<ul><li>a</li><li>b</li><li><p><br /></p></li></ul>';
    LegacyUnit.setSelection(editor, 'p', 0);
    pressEnter(editor);
    LegacyUnit.equal(
      editor.getContent(),
  ...
  suite.test('Enter inside summary element', function (editor) {
    ...
    LegacyUnit.equal(
      editor.getContent(),
      '<details><summary>a<br />b</summary></details>'
    );
  });
