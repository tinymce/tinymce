...
UnitTest.asynctest('browser.tinymce.core.keyboard.EnterKey', (success, failure) => {
  ...
  suite.test('Enter at end of H1', (editor) => {
  ...
  suite.test('Enter in midde of H1', (editor) => {
  ...
  suite.test('Enter before text after EM', (editor) => {
  ...
  suite.test('Enter before first IMG in P', (editor) => {
  ...
  suite.test('Enter before first wrapped IMG in P', (editor) => {
  ...
  suite.test('Enter before last IMG in P with text', (editor) => {
  ...
  suite.test('Enter before last IMG in P with IMG sibling', (editor) => {
  ...
  suite.test('Enter after last IMG in P', (editor) => {
    editor.setContent('<p>abc<img src="about:blank" /></p>');
  ...
  suite.test('Enter before last INPUT in P with text', (editor) => {
  ...
  suite.test('Enter before last INPUT in P with IMG sibling', (editor) => {
  ...
  suite.test('Enter after last INPUT in P', (editor) => {
    editor.setContent('<p>abc<input type="text" /></p>');
    editor.selection.setCursorLocation(editor.getBody().firstChild, 2);
    pressEnter(editor);
  ...
  suite.test('Enter at end of P', (editor) => {
  ...
  suite.test('Enter at end of EM inside P', (editor) => {
  ...
  suite.test('Enter at middle of EM inside P', (editor) => {
  ...
  suite.test('Enter at beginning EM inside P', (editor) => {
    editor.setContent('<p><em>abc</em></p>');
  ...
  suite.test('Enter at end of STRONG in EM inside P', (editor) => {
  ...
  suite.test('Enter at middle of STRONG in EM inside P', (editor) => {
  ...
  suite.test('Enter at beginning STRONG in EM inside P', (editor) => {
    editor.setContent('<p><em><strong>abc</strong></em></p>');
  ...
  suite.test('Enter at beginning of P', (editor) => {
    editor.setContent('<p>abc</p>');
  ...
  suite.test('Enter at middle of P with style, id and class attributes', (editor) => {
  ...
  suite.test('Enter at a range between H1 and P', (editor) => {
  ...
  suite.test('Enter at a range between LI elements', (editor) => {
  ...
  suite.test('Enter at end of H1 in HGROUP', (editor) => {
  ...
  suite.test('Enter inside empty TD', (editor) => {
  ...
  suite.test('Shift+Enter inside STRONG inside TD with BR', (editor) => {
  ...
  suite.test('Enter inside middle of text node in body', (editor) => {
  ...
  suite.test('Enter inside at beginning of text node in body', (editor) => {
    editor.getBody().innerHTML = 'abcd';
  ...
  suite.test('Enter inside at end of text node in body', (editor) => {
    editor.getBody().innerHTML = 'abcd';
  ...
  suite.test('Enter inside empty body', (editor) => {
  ...
  suite.test('Enter in the middle of text in P with forced_root_block set to false', (editor) => {
  ...
  suite.test('Enter at the end of text in P with forced_root_block set to false', (editor) => {
    editor.settings.forced_root_block = false;
    editor.getBody().innerHTML = '<p>abc</p>';
    LegacyUnit.setSelection(editor, 'p', 3);
    pressEnter(editor);
  ...
  suite.test('Enter at the middle of text in BODY with forced_root_block set to false', (editor) => {
    editor.settings.forced_root_block = false;
    editor.getBody().innerHTML = 'abcd';
    LegacyUnit.setSelection(editor, 'body', 2);
    editor.focus();
  ...
  suite.test('Enter at the beginning of text in BODY with forced_root_block set to false', (editor) => {
    editor.settings.forced_root_block = false;
    editor.getBody().innerHTML = 'abcd';
    LegacyUnit.setSelection(editor, 'body', 0);
    editor.focus();
  ...
  suite.test('Enter at the end of text in BODY with forced_root_block set to false', (editor) => {
    editor.settings.forced_root_block = false;
    editor.getBody().innerHTML = 'abcd';
    LegacyUnit.setSelection(editor, 'body', 4);
    editor.focus();
  ...
  suite.test('Enter in empty P at the end of a blockquote and end_container_on_empty_block: true', (editor) => {
  ...
  suite.test('Enter in empty P at the beginning of a blockquote and end_container_on_empty_block: true', (editor) => {
    editor.settings.end_container_on_empty_block = true;
  ...
  suite.test('Enter in empty P at in the middle of a blockquote and end_container_on_empty_block: true', (editor) => {
    editor.settings.end_container_on_empty_block = true;
  ...
  suite.test('Enter inside empty P with empty P siblings', (editor) => {
  ...
  suite.test('Enter at end of H1 with forced_root_block_attrs', (editor) => {
  ...
  suite.test('Shift+Enter at beginning of P', (editor) => {
    editor.getBody().innerHTML = '<p>abc</p>';
    LegacyUnit.setSelection(editor, 'p', 0);
    pressEnter(editor, { shiftKey: true });
  ...
  suite.test('Shift+Enter in the middle of P', (editor) => {
  ...
  suite.test('Shift+Enter at the end of P', (editor) => {
    editor.getBody().innerHTML = '<p>abcd</p>';
  ...
  suite.test('Shift+Enter in the middle of B with a BR after it', (editor) => {
  ...
  suite.test('Shift+Enter at the end of B with a BR after it', (editor) => {
    editor.getBody().innerHTML = '<p><b>abcd</b><br></p>';
  ...
  suite.test('Enter in beginning of PRE', (editor) => {
  ...
  suite.test('Enter in the middle of PRE', (editor) => {
  ...
  suite.test('Enter at the end of PRE', (editor) => {
    editor.getBody().innerHTML = '<pre>abcd</pre>';
  ...
  suite.test('Enter in beginning of PRE and br_in_pre: false', (editor) => {
  ...
  suite.test('Enter in the middle of PRE and br_in_pre: false', (editor) => {
    editor.settings.br_in_pre = false;
    editor.getBody().innerHTML = '<pre>abcd</pre>';
    LegacyUnit.setSelection(editor, 'pre', 2);
    pressEnter(editor);
  ...
  suite.test('Enter at the end of PRE and br_in_pre: false', (editor) => {
    editor.settings.br_in_pre = false;
    editor.getBody().innerHTML = '<pre>abcd</pre>';
    LegacyUnit.setSelection(editor, 'pre', 4);
    pressEnter(editor);
  ...
  suite.test('Shift+Enter in beginning of PRE', (editor) => {
    editor.getBody().innerHTML = '<pre>abc</pre>';
    LegacyUnit.setSelection(editor, 'pre', 0);
    pressEnter(editor, { shiftKey: true });
    LegacyUnit.equal(editor.getContent(), '<pre>\u00a0</pre><pre>abc</pre>');
  ...
  suite.test('Shift+Enter in the middle of PRE', (editor) => {
    editor.getBody().innerHTML = '<pre>abcd</pre>';
    LegacyUnit.setSelection(editor, 'pre', 2);
    pressEnter(editor, { shiftKey: true });
    LegacyUnit.equal(editor.getContent(), '<pre>ab</pre><pre>cd</pre>');
  ...
  suite.test('Shift+Enter at the end of PRE', (editor) => {
    editor.getBody().innerHTML = '<pre>abcd</pre>';
    LegacyUnit.setSelection(editor, 'pre', 4);
    pressEnter(editor, { shiftKey: true });
    LegacyUnit.equal(editor.getContent(), '<pre>abcd</pre><p>\u00a0</p>');
  ...
  suite.test('Shift+Enter in beginning of P with forced_root_block set to false', (editor) => {
    editor.settings.forced_root_block = false;
    editor.getBody().innerHTML = '<p>abc</p>';
    LegacyUnit.setSelection(editor, 'p', 0);
    pressEnter(editor, { shiftKey: true });
  ...
  suite.test('Shift+Enter in middle of P with forced_root_block set to false', (editor) => {
    editor.settings.forced_root_block = false;
    editor.getBody().innerHTML = '<p>abcd</p>';
    LegacyUnit.setSelection(editor, 'p', 2);
    pressEnter(editor, { shiftKey: true });
  ...
  suite.test('Shift+Enter at the end of P with forced_root_block set to false', (editor) => {
    editor.settings.forced_root_block = false;
    editor.getBody().innerHTML = '<p>abc</p>';
    LegacyUnit.setSelection(editor, 'p', 3);
    pressEnter(editor, { shiftKey: true });
  ...
  suite.test('Shift+Enter in body with forced_root_block set to false', (editor) => {
    editor.settings.forced_root_block = false;
    editor.getBody().innerHTML = 'abcd';
  ...
  suite.test('Enter at the end of DIV layer', (editor) => {
    editor.settings.br_in_pre = false;
  ...
  suite.test('Enter at end of text in a span inside a P and keep_styles: false', (editor) => {
  ...
  suite.test(
    'keep_styles=false: P should not pass its styles and classes to the new P that is cloned from it when enter is pressed', (editor) => {
      editor.settings.keep_styles = false;
  ...
  suite.test('Enter when forced_root_block: false and force_p_newlines: true', (editor) => {
    editor.settings.forced_root_block = false;
  ...
  suite.test('Enter at end of br line', (editor) => {
    editor.settings.forced_root_block = false;
    editor.settings.force_p_newlines = true;
  ...
  if (!Env.ie || Env.ie > 8) {
    suite.test('Enter before BR between DIVs', (editor) => {
  ...
  suite.test('Enter behind table element', (editor) => {
    const rng = editor.dom.createRng();
  ...
  suite.test('Enter before table element', (editor) => {
    const rng = editor.dom.createRng();
  ...
  suite.test('Enter behind table followed by a p', (editor) => {
    const rng = editor.dom.createRng();
  ...
  suite.test('Enter before table element preceded by a p', (editor) => {
    const rng = editor.dom.createRng();
  ...
  suite.test('Enter twice before table element', (editor) => {
    const rng = editor.dom.createRng();
  ...
  suite.test('Enter after span with space', (editor) => {
  ...
  suite.test('Enter inside first li with block inside', (editor) => {
  ...
  suite.test('Enter inside middle li with block inside', (editor) => {
  ...
  suite.test('Enter inside last li with block inside', (editor) => {
  ...
  suite.test('Enter inside summary element', (editor) => {
