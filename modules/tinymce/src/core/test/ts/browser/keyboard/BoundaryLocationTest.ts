...
UnitTest.asynctest(
  ...
  function (success, failure) {
    ...
    const createLocation = function (elm, elementPath, offset) {
      ...
      const location = BoundaryLocation.readLocation(
        isInlineTarget,
        elm.dom(),
        pos
      );
    ...
    const locationElement = function (location) {
      return Element.fromDom(
        location.fold(Fun.identity, Fun.identity, Fun.identity, Fun.identity)
      );
    };

    const sTestValidLocation = function (
      html,
      elementPath,
      offset,
      ...
      return Step.sync(function () {
        ...
        Assertions.assertEq(
          'Should be a valid location: ' + html,
          true,
          location.isSome()
        );
        Assertions.assertEq(
          ...
          expectedLocationName,
          locationName(location.getOrDie())
        );
        Assertions.assertDomEq(
          'Should be expected element',
          SelectorFind.descendant(elm, expectedInline).getOrDie(),
          locationElement(location.getOrDie())
        );
      });
    };
    ...
    const sTestInvalidLocation = function (html, elementPath, offset) {
      return Step.sync(function () {
        ...
        const location = createLocation(elm, elementPath, offset);
        Assertions.assertEq(
          'Should not be a valid location: ' + html,
          true,
          location.isNone()
        );
      });
    ...
    const sTestFindLocation = function (
      forward,
      html,
      elementPath,
      offset,
      ...
      return Step.sync(function () {
        ...
        const location = BoundaryLocation.findLocation(
          forward,
          isInlineTarget,
          elm.dom(),
          position
    ...
    const sTestFindLocationInvalid = function (
      forward,
      html,
      elementPath,
      offset
    ...
    const sTestValidLocations = Logger.t(
      'sTestValidLocations',
      GeneralSteps.sequence([
        Logger.t(
          ...
          GeneralSteps.sequence([
            ...
            sTestValidLocation(
              '<p><a href="a">a</a></p><p><a href="b">b</a></p>',
              [0],
              1,
              'after',
              'a'
        ...
        Logger.t(
          'anchor + code locations',
          GeneralSteps.sequence([
            sTestValidLocation(
              '<p><a href="#"><code>a</code></a></p>',
              [0],
              0,
              'before',
              'a'
    ...
    const sTestValidZwspLocations = Logger.t(
      'sTestValidZwspLocations',
      GeneralSteps.sequence([
        sTestValidLocation(
          '<p>' + ZWSP + '<a href="a">a</a></p>',
          [0, 0],
          0,
          'before',
          'a'
    ...
    const sTestInvalidLocations = Logger.t(
      ...
      GeneralSteps.sequence([
        ...
        sTestInvalidLocation(
          '<p><a href="a"><img src="a"><img src="a"></a><img src="a"></p>',
          [0, 0],
          1
        ),
        sTestInvalidLocation(
          '<p dir="rtl"><a href="a">a</a></p>',
          [0, 0, 0],
          0
        ),
        ...
        Logger.t(
          ...
          GeneralSteps.sequence([
            sTestInvalidLocation(
              '<p><span id="_mce_caret">a</span></p>',
              [0, 0, 0],
              0
            ),
            sTestInvalidLocation(
              '<p><span id="_mce_caret"><code>a</code></span></p>',
              [0, 0, 0, 0],
              0
            )
          ])
    ...
    const sTestPrevLocations = Logger.t(
      'sTestPrevLocations',
      GeneralSteps.sequence([
        ...
        sTestPrevLocation(
          '<p><a href="a"><img src="about:blank"></a></p>',
          [0],
          1,
          'end',
          'a'
    ...
    const sTestPrevLocationsBetweenInlines = Logger.t(
    ...
    const sTestPrevLocationsBetweenBlocks = Logger.t(
      ...
      GeneralSteps.sequence([
        ...
        sTestPrevLocation(
          '<p><a href="a">a</a>b</p><p><a href="c">c</a></p>',
          [1, 0, 0],
          0,
          'before',
          'p:nth-child(2) a'
        ...
        sTestPrevLocation(
          '<p><a href="a">a</a><br /></p><p><a href="c">c</a></p>',
          [1],
          0,
          'after',
          'p:nth-child(1) a'
        ),
        sTestPrevLocationInvalid(
          '<p><a href="a">a</a></p><p>b<a href="c">c</a></p>',
          [1, 0],
          1
        ),
        sTestPrevLocationInvalid(
    ...
    const sTestPrevZwspLocations = Logger.t(
      'sTestPrevLocations',
      GeneralSteps.sequence([
        sTestPrevLocation(
          '<p><a href="a">a</a>' + ZWSP + 'b</p>',
          [0, 1],
          2,
          'after',
          'a'
    ...
    const sTestNextLocations = Logger.t(
      'sTestNextLocations',
      GeneralSteps.sequence([
        sTestNextLocation(
          '<p>a<a href="a">b</a></p>',
    ...
    const sTestNextLocationsBetweenInlines = Logger.t(
      'sTestNextLocationsBetweenInlines',
      GeneralSteps.sequence([
        sTestNextLocation(
          '<p><a href="a">a</a><a href="a">b</a></p>',
          [0, 0, 0],
          1,
          'after',
          'a:nth-child(1)'
    ...
    const sTestNextLocationsBetweenBlocks = Logger.t(
    ...
    const sTestNextZwspLocations = Logger.t(
      'sTestNextZwspLocations',
      GeneralSteps.sequence([
        sTestNextLocation(
          '<p>a' + ZWSP + '<a href="a">b</a></p>',
          [0, 0],
          0,
          'before',
          'a'
