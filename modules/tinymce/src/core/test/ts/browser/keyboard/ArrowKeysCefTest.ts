...
describe('browser.tinymce.core.keyboard.ArrowKeysCefTest', () => {
  ...
  context('Cmd+Shif+Up/Down with cef at the start/end of editor content', () => {
    ...
    it('cef block at the start and the end', () => {
      const editor = hook.editor();
  ...
  context('left/right with cef at the start/end of editor content', () => {
    it('TINY-7795: left/right with cef block at the start of selection', () => {
      const editor = hook.editor();
      editor.setContent('<p contenteditable="false">CEF</p><p>abc</p>');
    ...
    it('TINY-7795: left/right with cef block at the end of selection', () => {
      const editor = hook.editor();
      editor.setContent('<p>abc</p><p contenteditable="false">CEF</p>');
    ...
    it('TINY-7795: left/right with cef block at the start and end of selection', () => {
      const editor = hook.editor();
      editor.setContent('<p contenteditable="false">CEF</p><p>abc</p><p contenteditable="false">CEF</p>');
  ...
  context('up/down with cef at the start/end of selection', () => {
    it('TINY-7795: up/down with cef block at the start of selection', () => {
      const editor = hook.editor();
      editor.setContent('<p contenteditable="false">CEF</p><p>abc</p>');
    ...
    it('TINY-7795: up/down with cef block at the end of selection', () => {
      const editor = hook.editor();
      editor.setContent('<p>abc</p><p contenteditable="false">CEF</p>');
    ...
    it('TINY-7795: up/down with cef block at start and end of selection', () => {
      const editor = hook.editor();
      editor.setContent('<p contenteditable="false">CEF</p><p>abc</p><p contenteditable="false">CEF</p>');
