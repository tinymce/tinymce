...
describe('browser.tinymce.core.keyboard.SpaceKeyTest', () => {
  ...
  context('Space key around inline boundary elements', () => {
    ...
    it('TINY-8588: Add one space just after a block', () => {
      const editor = hook.editor();
    ...
    it('TINY-8588: Add two spaces just after a block', () => {
      const editor = hook.editor();
      editor.setContent('<p><span style="display: block;" contenteditable="false">a</span>s</p>');
      TinySelections.setCursor(editor, [ 0, 1 ], 0);
      editor.selection.setContent(' ');
    ...
    it('TINY-8588: Add two spaces after a block while in a span', () => {
      const editor = hook.editor();
    ...
    it('TINY-8588: Add two spaces after a block inside a strong', () => {
      const editor = hook.editor();
