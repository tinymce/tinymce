    ...
    TinyLoader.setupLight(
      function (editor, onSuccess, onFailure) {
        ...
        Pipeline.async(
          ...
          [
            Logger.t(
              'Space key around inline boundary elements',
              GeneralSteps.sequence([
                Logger.t(
                  'Press space at beginning of inline boundary inserting nbsp',
                  GeneralSteps.sequence([
                    tinyApis.sFocus(),
                ...
                Logger.t(
                  'Press space at end of inline boundary inserting nbsp',
                  GeneralSteps.sequence([
                    tinyApis.sFocus(),
                    tinyApis.sSetContent('<p>a <a href="#">b</a> c</p>'),
                ...
                Logger.t(
                  'Press space at beginning of inline boundary inserting space',
                  GeneralSteps.sequence([
                    tinyApis.sFocus(),
                    tinyApis.sSetContent('<p>a<a href="#">b</a>c</p>'),
                    tinyApis.sSetCursor([0, 1, 0], 0),
                ...
                Logger.t(
                  'Press space at end of inline boundary inserting space',
                  GeneralSteps.sequence([
                    tinyApis.sFocus(),
                    tinyApis.sSetContent('<p>a<a href="#">b</a>c</p>'),
                    tinyApis.sSetCursor([0, 1, 0], 1),
                ...
                Logger.t(
                  'Press space at start of inline boundary with leading space inserting nbsp',
                  GeneralSteps.sequence([
                    tinyApis.sFocus(),
                    tinyApis.sSetContent('<p>a<a href="#"> b</a>c</p>'),
                    tinyApis.sSetCursor([0, 1, 0], 0),
                ...
                Logger.t(
                  'Press space at end of inline boundary with trailing space inserting nbsp',
                  GeneralSteps.sequence([
                    tinyApis.sFocus(),
                    tinyApis.sSetContent('<p>a<a href="#">b </a>c</p>'),
