...
UnitTest.asynctest(
  'browser.tinymce.core.keyboard.EnterKeyAnchorTest',
  (success, failure) => {
    Theme();

    const sSetup = function (
      tinyApis: TinyApis,
      html: string,
      elementPath: number[],
      offset: number
    ...
    const sTestEnterAtStartOfAnchorZwsp = function (
      tinyApis: TinyApis,
                  ...
                  s.element('p', {
                    children: addGeckoBr(s, str, [
                      s.element('a', {
                        ...
                        children: [s.text(str.is(Zwsp.ZWSP + 'a'))]
                      })
                    ])
                  })
                ]
    ...
    const sTestEnterAtEndOfAnchorZwsp = function (
      tinyApis: TinyApis,
      tinyActions: TinyActions
    ) {
      return Logger.t(
                  ...
                  s.element('p', {
                    children: addGeckoBr(s, str, [
                      s.element('a', {
                        ...
                        children: [s.text(str.is('a' + Zwsp.ZWSP))]
                      })
                    ])
                  }),
                  s.element('p', {
    ...
    const sTestEnterAtStartOfAnchorZwspWithAdjacentContent = function (
      tinyApis: TinyApis,
      tinyActions: TinyActions
    ) {
      return Logger.t(
                  ...
                  s.element('p', {
                    children: [
                      s.element('a', {
                        ...
                        children: [s.text(str.is(Zwsp.ZWSP + 'b'))]
                      }),
                      s.text(str.is('c'))
                    ]
                  })
    ...
    const sTestEnterAtEndOfAnchorZwspWithAdjacentContent = function (
      tinyApis: TinyApis,
      tinyActions: TinyActions
    ) {
      return Logger.t(
      ...
      function (editor, onSuccess, onFailure) {
        ...
        Pipeline.async(
          ...
          [
            ...
            sTestEnterAtEndOfAnchorZwspWithAdjacentContent(
              tinyApis,
              tinyActions
            )
          ],
