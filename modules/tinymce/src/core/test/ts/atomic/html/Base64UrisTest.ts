...
UnitTest.test('Base64Uris Test', () => {
  ...
  Logger.sync('extractBase64DataUris', () => {
    testExtract('Should not touch images that is not base64 data uris', '<img src="my.gif"><img src="blob:https://localhost">', {
      html: '<img src="my.gif"><img src="blob:https://localhost">',
      uris: {}
    });

    testExtract('Should extract one base64 encoded image from html with just a image', '<img src="data:image/gif;base64,R0/yw==">', {
    ...
    testExtract('Should extract base64 encoded thing with random mime type', '<img src="data:some/thing;base64,R2/yw==">', {
      html: '<img src="$prefix_0">',
      uris: {
