...
const NotificationManager = (editor: Editor): NotificationManager => {
  ...
  return {
     ...
     * <br /><br />
     * For information on the available settings, see: <a href="https://www.tiny.cloud/docs/how-to-guides/creating-custom-ui-components/creating-custom-notifications/">Create custom notifications</a>.
     */
    open,
