...
import { Text, Comment, Document, Element, Node, HTMLElement, DocumentFragment, HTMLTextAreaElement, HTMLInputElement, HTMLBRElement, HTMLImageElement } from '@ephox/dom-globals';
