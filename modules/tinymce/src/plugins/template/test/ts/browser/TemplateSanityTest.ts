          ...
          [
            Log.stepsAsStep('TBA', 'Template: Test basic template insertion', [
              tinyApis.sSetSetting('templates', [
                { title: 'a', description: 'b', content: '<strong>c</strong>' }
              ]),
              Mouse.sClickOn(
            ...
            Log.stepsAsStep('TBA', 'Template: Test basic content replacement', [
              ...
              tinyApis.sSetSetting('template_replace_values', {
                name: 'Tester',
                email: 'test@test.com'
              }),
              Mouse.sClickOn(
            ...
            Log.stepsAsStep(
              'TBA',
              'Template: Test loading in snippet from other file',
              [
                tinyApis.sSetContent(''),
                tinyApis.sSetSetting('templates', [
                  {
                    ...
                    url:
                      '/project/tinymce/src/plugins/template/test/html/test_template.html'
                  }
                ]),
                Mouse.sClickOn(
                  Element.fromDom(editor.getContainer()),
                ...
                Chain.asStep(docBody, [
                  ...
                  UiFinder.cWaitForState(
                    ...
                    (elm) => {
                      const iframeDoc =
                        elm.dom().contentDocument ||
                        elm.dom().contentWindow.document;
                ...
                UiFinder.sExists(
                  docBody,
                  dialogSelector + ' p:contains("<strong>b</strong>")'
                ),
                Mouse.sClickOn(docBody, 'button.tox-button:contains(Save)'),
                Waiter.sTryUntil(
                  'Dialog should close',
