    ...
    TinyLoader.setupLight(
      (editor, onSuccess, onFailure) => {
        ...
        const toolbarButtonSelector =
          '[role="toolbar"] button[aria-label="Insert template"]';
        ...
        Pipeline.async(
          ...
          [
            Log.stepsAsStep(
              'TBA',
              'Template: Test cdate in snippet with default class',
              [
            ...
            Log.stepsAsStep(
              'TBA',
              'Template: Test cdate in snippet with custom class',
              [
            ...
            Log.stepsAsStep(
              'TBA',
              'Template: Test mdate updates with each serialization',
              [
                tinyApis.sSetSetting('templates', [
                  {
                    title: 'a',
                    description: 'b',
                    content:
                      '<div class="mceTmpl"><p class="mdate"></p><p class="cdate"></p></div>'
                  }
                ]),
                tinyApis.sSetSetting(
                ...
                tinyApis.sAssertContent(
                  '<div class="mceTmpl"><p class="mdate">fake modified date</p><p class="cdate">fake created date</p></div>'
                ),
                tinyApis.sSetSetting(
                  'template_mdate_format',
                ...
                tinyApis.sAssertContent(
                  '<div class="mceTmpl"><p class="mdate">changed modified date</p><p class="cdate">fake created date</p></div>'
                ),
                sDeleteSetting('templates'),
            ...
            Log.stepsAsStep(
              'TBA',
              'Template: Test mdate updates with each serialization with custom class',
              [
                ...
                tinyApis.sSetSetting('templates', [
                  {
                    ...
                    description: 'b',
                    content:
                      '<div class="mceTmpl"><p class="modified"></p><p class="cdate"></p></div>'
                  }
                ]),
                tinyApis.sSetSetting(
                  'template_mdate_format',
                ...
                tinyApis.sAssertContent(
                  '<div class="mceTmpl"><p class="modified">fake modified date</p><p class="cdate">fake created date</p></div>'
                ),
                tinyApis.sSetSetting(
                  'template_mdate_format',
                  'changed modified date'
                ...
                tinyApis.sAssertContent(
                  '<div class="mceTmpl"><p class="modified">changed modified date</p><p class="cdate">fake created date</p></div>'
                ),
