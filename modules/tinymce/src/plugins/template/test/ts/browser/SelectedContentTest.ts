      ...
      (editor, onSuccess, onFailure) => {
        ...
        Pipeline.async(
          ...
          [
            Log.stepsAsStep(
              'TBA',
              'Template: Test selectedcontent replacement with default class',
              [
            ...
            Log.stepsAsStep(
              'TBA',
              'Template: Test selectedcontent replacement with custom class',
              [
                tinyApis.sSetContent('Text'),
                tinyApis.sSetSelection([0, 0], 0, [0, 0], 4),
                ...
                tinyApis.sSetSetting('templates', [
                  {
                    ...
                    description: 'b',
                    content:
                      '<h1 class="customSelected">This will be replaced/h1>'
                  }
                ]),
                Mouse.sClickOn(
                  Element.fromDom(editor.getContainer()),
