...
import { getSelectedLink } from 'tinymce/plugins/link/core/SelectedLink';
...
describe('atomic.SelectedLinkTest', () => {
  ...
  describe('returns a link if the end selection is after the link but before a br', () => {
    ...
    it('multiple short ended elements', () => {
  ...
  it('does not return a link since the caret is after the link', () => {
