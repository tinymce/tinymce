...
UnitTest.asynctest(
  'browser.tinymce.plugins.link.RemoveLinkTest',
  (success, failure) => {
    LinkPlugin();
    SilverTheme();
      ...
      function (editor, onSuccess, onFailure) {
        ...
        Pipeline.async(
          ...
          [
            Log.stepsAsStep(
              'TBA',
              'Removing a link with a collapsed selection',
              [
            ...
            Log.stepsAsStep('TBA', 'Removing a link from an image', [
              tinyApis.sSetContent(
                '<p><a href="http://tiny.cloud"><img src="http://moxiecode.cachefly.net/tinymce/v9/images/logo.png" /></a></p>'
              ),
