...
UnitTest.asynctest('browser.tinymce.plugins.link.UseHTTPSTest', (success, failure) => {
  ...
  TinyLoader.setupLight(function (editor, onSuccess, onFailure) {
    ...
    Pipeline.async({}, [
      Log.stepsAsStep('TBA', 'link_use_https: false', [
        tinyApis.sSetSetting('link_use_https', false),
      ...
      Log.stepsAsStep('TBA', 'link_use_https: true', [
        tinyApis.sSetSetting('link_use_https', true),
