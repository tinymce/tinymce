...
UnitTest.asynctest(
  'browser.tinymce.plugins.link.UrlProtocolTest',
  (success, failure) => {
    LinkPlugin();
    SilverTheme();
    ...
    TinyLoader.setupLight(
      (editor, onSuccess, onFailure) => {
        ...
        const testProtocolConfirm = (url, expectedProtocol) => {
          const presence = {};
          presence[
            `a[href="${expectedProtocol}${url}"]:contains("Something")`
          ] = 1;
          ...
          return GeneralSteps.sequence([
            ...
            TestLinkUi.sWaitForUi(
              'Wait for confirm dialog to show',
        ...
        Pipeline.async(
          ...
          [
            ...
            Log.stepsAsStep(
              'TBA',
              'Test new regex for non relative http link',
              [
            ...
            Log.stepsAsStep(
              'TBA',
              'Test regex for non relative link with no protocol',
