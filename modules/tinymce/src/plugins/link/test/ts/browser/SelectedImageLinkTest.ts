...
UnitTest.asynctest(
  'browser.tinymce.plugins.link.SelectedImageTest',
  (success, failure) => {
    LinkPlugin();
    SilverTheme();
      ...
      (editor, onSuccess, onFailure) => {
        ...
        Pipeline.async(
          ...
          [
            ...
            Log.stepsAsStep(
              'TBA',
              'Link: images should be preserved when adding a link',
              [
                ...
                UiFinder.sNotExists(
                  Body.body(),
                  '.tox-label:contains("Text to display")'
                ),
            ...
            Log.stepsAsStep(
              'TBA',
              'Link: images should be preserved when editing a link',
              [
                tinyApis.sSetContent(
                  '<p><a href="http://www.google.com/"><img src="image.png"></a></p>'
                ),
                tinyApis.sSelect('a', []),
                TestLinkUi.sOpenLinkDialog(tinyUi),
                FocusTools.sSetActiveValue(doc, 'http://something'),
