      ...
      function (editor, onSuccess, onFailure) {
        ...
        Pipeline.async(
          ...
          [
            ...
            Log.stepsAsStep(
              'TBA',
              `Link: doesn't add rel noopener stuff with allow_unsafe_link_target: true`,
              [
            ...
            Log.stepsAsStep(
              'TBA',
              'Link: adds if allow_unsafe_link_target: false',
              [
            ...
            Log.stepsAsStep(
              'TBA',
              'Link: allow_unsafe_link_target=false: node filter normalizes and secures rel on SetContent',
              [
                tinyApis.sSetSetting('allow_unsafe_link_target', false),
                tinyApis.sSetContent(
                  '<a href="http://www.google.com" target="_blank" rel="nofollow alternate">Google</a>'
                ),
                tinyApis.sAssertContent(
                  '<p><a href="http://www.google.com" target="_blank" rel="alternate nofollow noopener">Google</a></p>'
                ),
                tinyApis.sSetContent('')
              ]
            ),
            ...
            Log.stepsAsStep(
              'TBA',
              'Link: allow_unsafe_link_target=false: proper option selected for defined rel_list',
              [
                tinyApis.sSetSetting('allow_unsafe_link_target', false),
