...
UnitTest.asynctest(
  'browser.tinymce.plugins.link.ListOptionsTest',
  (success, failure) => {
    LinkPlugin();
    SilverTheme();
    ...
    TinyLoader.setupLight(
      function (editor, onSuccess, onFailure) {
        ...
        const sTestAnchors = Log.stepsAsStep(
          'TBA',
          'Link: Checking anchor generation',
          [
        ...
        const sTestLinkClasses = Log.stepsAsStep(
          'TBA',
          'Link: Checking link class generation',
          [
        ...
        const sTestLinkLists = Log.stepsAsStep(
          'TBA',
          'Link: Checking link list generation',
          [
        ...
        const sTestRels = Log.stepsAsStep(
          'TBA',
          'Link: Checking rel generation',
          [
            ...
            Step.sync(() => {
              const rels = RelOptions.getRels(
                editor,
                Option.some('initial-target')
              );
              Assertions.assertEq(
        ...
        const sTestTargets = Log.stepsAsStep(
          'TBA',
          'Link: Checking targets generation',
          [
