...
UnitTest.asynctest(
  'browser.tinymce.plugins.link.DefaultLinkProtocolTest',
  (success, failure) => {
    LinkPlugin();
    SilverTheme();
        ...
        Pipeline.async(
          ...
          [
            Log.stepsAsStep('TBA', 'link_default_protocol: "http"', [
              ...
              Log.stepsAsStep(
                'TBA',
                'www-urls are prompted to add http:// prefix, accept',
                [
              ...
              Log.stepsAsStep(
                'TBA',
                'www-urls are prompted to add http:// prefix, cancel',
                [
                  TestLinkUi.sInsertLink(tinyUi, 'www.google.com'),
                  TestLinkUi.sWaitForUi(
                    'wait for dialog',
              ...
              Log.stepsAsStep(
                'TBA',
                'other urls are not prompted to add http:// prefix',
                [
            ...
            Log.stepsAsStep('TBA', 'link_default_protocol: "https"', [
              ...
              Log.stepsAsStep(
                'TBA',
                'www-urls are prompted to add https:// prefix, accept',
                [
                  TestLinkUi.sInsertLink(tinyUi, 'www.google.com'),
                  TestLinkUi.sWaitForUi(
                    'wait for dialog',
              ...
              Log.stepsAsStep(
                'TBA',
                'www-urls are prompted to add https:// prefix, cancel',
                [
                  TestLinkUi.sInsertLink(tinyUi, 'www.google.com'),
                  TestLinkUi.sWaitForUi(
                    'wait for dialog',
              ...
              Log.stepsAsStep(
                'TBA',
                'other urls are not prompted to add https:// prefix',
                [
                  TestLinkUi.sInsertLink(tinyUi, 'google.com'),
                  TestLinkUi.sAssertContentPresence(tinyApis, {
                    'a': 1,
