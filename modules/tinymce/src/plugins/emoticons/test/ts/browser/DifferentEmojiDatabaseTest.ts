...
UnitTest.asynctest(
  'browser.tinymce.plugins.emoticons.DifferentEmojiDatabaseTest',
  (success, failure) => {
    EmoticonsPlugin();
    SilverTheme();

    const sTestEditorWithSettings = (categories, databaseUrl) =>
        ...
        TinyLoader.setupLight(
              ...
              [
                ...
                Chain.asStep(Body.body(), [
                  ...
                  Chain.mapper((elements: Element[]) =>
                    Arr.map(elements, (elm: Element) => elm.dom().textContent)
                  ),
          ...
          },
          {
            ...
            emoticons_database_id:
              'tinymce.plugins.emoticons.' + getFilename(databaseUrl)
          },
          onStepSuccess,
          onStepFailure
        );
    ...
    Pipeline.async(
      ...
      Log.steps('TBA', 'Emoticon: Loading databases from different urls', [
        sTestEditorWithSettings(
          ['All', 'People'],
          '/project/tinymce/src/plugins/emoticons/test/js/test-emojis.js'
        ),
        sTestEditorWithSettings(
          ['All', 'Travel and Places'],
          '/project/tinymce/src/plugins/emoticons/test/js/test-emojis-alt.js'
        )
      ]),
      success,
      failure
