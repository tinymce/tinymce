    ...
    function (editor, onSuccess, onFailure) {
      ...
      Pipeline.async(
        ...
        Log.steps('TBA', 'Emoticons: Open dialog, verify custom categories listed and search for custom emoticon', [
          ...
          Chain.asStep({}, [tinyUi.cWaitForPopup('wait for popup', 'div[role="dialog"]')]),
          ...
          Chain.asStep(body, [
            ...
            Assertions.cAssertStructure(
              ...
              ApproxStructure.build((s, str, arr) =>
                s.element('div', {
                  children: [tabElement(s, str, arr)('All'), tabElement(s, str, arr)('People'), tabElement(s, str, arr)('User Defined')]
                })
              )
            )
          ]),
          ...
          Waiter.sTryUntil('Waiting for content update', tinyApis.sAssertContent('<p>⏲</p>'))
        ]),
        onSuccess,
        onFailure
      );
