...
UnitTest.asynctest(
  'browser.tinymce.plugins.emoticons.AppendTest',
  (success, failure) => {
    EmoticonsPlugin();
    SilverTheme();
    ...
    TinyLoader.setupLight(
      function (editor, onSuccess, onFailure) {
        ...
        Pipeline.async(
          ...
          Log.steps(
            'TBA',
            'Emoticons: Open dialog, verify custom categories listed and search for custom emoticon',
            [
              tinyApis.sFocus(),
              ...
              Chain.asStep(body, [
                ...
                Assertions.cAssertStructure(
                  'check custom categories are shown',
              ...
              FocusTools.sTryOnSelector(
                'Focus should have moved to collection',
                doc,
