...
UnitTest.asynctest(
  'browser.tinymce.plugins.emoticons.SearchTest',
  (success, failure) => {
    EmoticonsPlugin();
    SilverTheme();
    ...
    TinyLoader.setupLight(
      function (editor, onSuccess, onFailure) {
        ...
        Pipeline.async(
          ...
          Log.steps(
            'TBA',
            'Emoticons: Open dialog, Search for "rainbow", Rainbow should be first option',
            [
              tinyApis.sFocus(),
      ...
      },
      {
        ...
        emoticons_database_url:
          '/project/tinymce/src/plugins/emoticons/main/js/emojis.js'
      },
      success,
      failure
    );
