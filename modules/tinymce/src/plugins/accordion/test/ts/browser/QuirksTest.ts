...
describe('browser.tinymce.plugins.accordion.QuirksTest', () => {
  ...
  const cases = [
    ...
    { content: '<ul><li>abc<ul><li>def</li></ul></li></ul>', path: [ 0, 0 ], offset: 1 },
    { content: '<ol><li><span style="border: 2px solid red;">abc</span><div>def</div></li></ol>', path: [ 0, 0 ], offset: 1 },
    { content: '<ol><li><span style="border: 2px solid red;">abc</span>\n<div>def</div></li></ol>', path: [ 0, 0 ], offset: 1 },
    { content: '<ul><li><span style="border: 2px solid red;">abc</span><div>def</div></li></ul>', path: [ 0, 0 ], offset: 1 },
    { content: '<ol><li><span style="border: 2px solid red;">abc</span><ul><li>def</li></ul></li></ol>', path: [ 0, 0 ], offset: 1 },
    { content: '<ul><li><span style="border: 2px solid red;">abc</span><ul><li>def</li></ul></li></ul>', path: [ 0, 0 ], offset: 1 },
    { content: '<ol><li>abc<span style="display: block;">def</span></li></ol>', path: [ 0, 0 ], offset: 1 },
    { content: '<ul><li>abc<span style="display: block;">def</span></li></ul>', path: [ 0, 0 ], offset: 1 },
    { content: '<ol><li><span style="border: 2px solid red;">abc</span><span style="display: block;">def</span></li></ol>', path: [ 0, 0 ], offset: 1 },
    { content: '<ul><li><span style="border: 2px solid red;">abc</span><span style="display: block;">def</span></li></ul>', path: [ 0, 0 ], offset: 1 },
    { content: '<ol><li>a<b>b</b>c<div>def</div></li></ol>', path: [ 0, 0 ], offset: 3 },
    { content: '<ol><li><span style="border: 2px solid red;">abc</span>\n<span style="display: block;">def</span></li></ol>', path: [ 0, 0 ], offset: 1 },
    { content: '<ol><li>&nbsp;<span style="display: block;">def</span></li></ol>', path: [ 0, 0 ], offset: 1 },
    { content: '<ol><li>&nbsp;\n<span style="display: block;">def</span></li></ol>', path: [ 0, 0 ], offset: 1 },
