  ...
  TinyLoader.setupLight(
    function (editor, onSuccess, onFailure) {
      ...
      const cClickButton = (name: string) =>
        Chain.fromChains([UiFinder.cFindIn('button[title="' + name + '"]:not([disabled])'), Mouse.cClick]);
          ...
          [
            ...
            Chain.asStep({}, [
              Chain.fromParent(tinyUi.cWaitForPopup('wait for dialog', 'div[role="dialog"]'), [
                Chain.fromChains([UiFinder.cFindIn('input.tox-textfield[placeholder="Find"]'), UiControls.cSetValue('fish')]),
                cClickButton('Find'),
                ...
                Chain.fromChains([UiFinder.cFindIn('input.tox-textfield[placeholder="Replace with"]'), UiControls.cSetValue('squid')]),
