...
UnitTest.asynctest(
  ...
  (success, failure) => {
    ...
    suite.test('TestCase-TBA: SearchReplace: Find single match', function (
      editor
    ) {
      editor.setContent('a');
    ...
    suite.test(
      'TestCase-TBA: SearchReplace: Find single match in multiple elements',
      function (editor) {
    ...
    suite.test(
      'TestCase-TBA: SearchReplace: Find single match, match case: true',
      function (editor) {
    ...
    suite.test(
      'TestCase-TBA: SearchReplace: Find single match, whole words: true',
      function (editor) {
        editor.setContent('a Ax');
        LegacyUnit.equal(
          1,
          editor.plugins.searchreplace.find('a', false, true)
        );
      }
    );

    suite.test(
      'TestCase-TINY-4522: SearchReplace: Find special characters match',
      function (editor) {
        editor.setContent('^^ ^^ ^^^^');
    ...
    suite.test(
      'TestCase-TINY-4522: SearchReplace: Find special characters match, whole words: true',
      function (editor) {
        editor.setContent('^^ ^^ ^^^^');
        LegacyUnit.equal(
          2,
          editor.plugins.searchreplace.find('^^', false, true)
        );
        editor.setContent('50$ 50$50$');
        LegacyUnit.equal(
          1,
          editor.plugins.searchreplace.find('50$', false, true)
        );
      }
    );

    suite.test(
      'TestCase-TINY-4522: SearchReplace: Find word with punctuation, whole words: true',
      function (editor) {
        editor.setContent(
        ...
        LegacyUnit.equal(
          9,
          editor.plugins.searchreplace.find('test', false, true)
        );
        LegacyUnit.equal(
          1,
          editor.plugins.searchreplace.find('test!', false, true)
    ...
    suite.test('TestCase-TBA: SearchReplace: Find multiple matches', function (
      editor
    ) {
    ...
    suite.test(
      'TestCase-TBA: SearchReplace: Find and replace single match',
      function (editor) {
        editor.setContent('a');
    ...
    suite.test(
      'TestCase-TBA: SearchReplace: Find and replace first in multiple matches',
      function (editor) {
        editor.setContent('a b a');
        editor.plugins.searchreplace.find('a');
    ...
    suite.test(
      'TestCase-TBA: SearchReplace: Find and replace two consecutive spaces',
      function (editor) {
    ...
    suite.test(
      'TestCase-TBA: SearchReplace: Find and replace consecutive spaces',
      function (editor) {
        editor.setContent('a&nbsp; &nbsp;b');
        editor.plugins.searchreplace.find('a   ');
        LegacyUnit.equal(editor.plugins.searchreplace.replace('x'), false);
    ...
    suite.test(
      'TestCase-TBA: SearchReplace: Find and replace all in multiple matches',
      function (editor) {
        editor.setContent('a b a');
        editor.plugins.searchreplace.find('a');
        LegacyUnit.equal(
          editor.plugins.searchreplace.replace('x', true, true),
          false
        );
    ...
    suite.test(
      'TestCase-TBA: SearchReplace: Find and replace all spaces with new lines',
      function (editor) {
    ...
    suite.test(
      'TestCase-TBA: SearchReplace: Find multiple matches, move to next and replace',
      function (editor) {
        editor.setContent('a a');
        LegacyUnit.equal(2, editor.plugins.searchreplace.find('a'));
    ...
    suite.test(
      'TestCase-TBA: SearchReplace: Find and replace fragmented match',
      function (editor) {
        ...
        LegacyUnit.equal(
          editor.getContent(),
          '<p><b>abc</b><b>te<i>s</i>t</b></p>'
        );
      }
    );

    suite.test(
      'TestCase-TBA: SearchReplace: Find and replace all fragmented matches',
      function (editor) {
        editor.setContent('<b>te<i>s</i>t</b><b>te<i>s</i>t</b>');
        editor.plugins.searchreplace.find('test');
        LegacyUnit.equal(
          editor.plugins.searchreplace.replace('abc', true, true),
          false
        );
    ...
    suite.test(
      'TestCase-TBA: SearchReplace: Find multiple matches, move to next and replace backwards',
      function (editor) {
        editor.setContent('a a');
        LegacyUnit.equal(2, editor.plugins.searchreplace.find('a'));
        editor.plugins.searchreplace.next();
        LegacyUnit.equal(
          editor.plugins.searchreplace.replace('x', false),
          true
        );
        LegacyUnit.equal(
          editor.plugins.searchreplace.replace('y', false),
          false
        );
    ...
    suite.test(
      'TestCase-TBA: SearchReplace: Find multiple matches and unmark them',
      function (editor) {
        editor.setContent('a b a');
        LegacyUnit.equal(2, editor.plugins.searchreplace.find('a'));
        ...
        LegacyUnit.equal(
          0,
          editor.getBody().getElementsByTagName('span').length
        );
      }
    );

    suite.test(
      'TestCase-TBA: SearchReplace: Find multiple matches with pre blocks',
      function (editor) {
        editor.getBody().innerHTML = 'abc<pre>  abc  </pre>abc';
        LegacyUnit.equal(3, editor.plugins.searchreplace.find('b'));
        LegacyUnit.equal(
          HtmlUtils.normalizeHtml(editor.getBody().innerHTML),
    ...
    TinyLoader.setupLight(
      function (editor, onSuccess, onFailure) {
        Pipeline.async(
          ...
          Log.steps(
            'TBA',
            'SearchReplace: Find and replace matches',
