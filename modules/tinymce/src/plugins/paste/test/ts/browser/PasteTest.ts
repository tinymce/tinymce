...
UnitTest.asynctest(
  'tinymce.plugins.paste.browser.PasteTest',
  (success, failure) => {
    ...
    suite.test('TestCase-TBA: Paste: Plain text toggle event', function (
      editor
    ) {
      const events = [];
      ...
      LegacyUnit.deepEqual(events, [{ state: true }], 'Should be enabled');
    ...
    suite.test('TestCase-TBA: Paste: Paste simple text content', function (
      editor
    ) {
    ...
    suite.test('TestCase-TBA: Paste: Paste text with meta and nbsp', function (
      editor
    ) {
      const rng = editor.dom.createRng();
      ...
      editor.execCommand('mceInsertClipboardContent', false, {
        content: '<meta charset="utf-8">TEST'
      });
      LegacyUnit.equal(editor.getContent(), '<p>1 TEST</p>');
    });

    suite.test('TestCase-TBA: Paste: Paste styled text content', function (
      editor
    ) {
      const rng = editor.dom.createRng();
      ...
      editor.execCommand('mceInsertClipboardContent', false, {
        content:
          '<strong><em><span style="color: red;">TEST</span></em></strong>'
      });
      LegacyUnit.equal(
        editor.getContent(),
        '<p>1<strong><em><span style="color: red;">TEST</span></em></strong>4</p>'
      );
    });

    suite.test('TestCase-TBA: Paste: Paste paragraph in paragraph', function (
      editor
    ) {
      const rng = editor.dom.createRng();
    ...
    suite.test(
      'TestCase-TBA: Paste: Paste paragraphs in complex paragraph',
      function (editor) {
        const rng = editor.dom.createRng();
        ...
        editor.execCommand('mceInsertClipboardContent', false, {
          content: '<p>TEST 1</p><p>TEST 2</p>'
        });
        LegacyUnit.equal(
          editor.getContent(),
          '<p><strong><em>1</em></strong></p><p>TEST 1</p><p>TEST 2</p><p><strong><em>4</em></strong></p>'
        );
      }
    );
    ...
    suite.test('TestCase-TBA: Paste: Paste Word fake list before BR', function (
      editor
    ) {
      let rng = editor.dom.createRng();
      ...
      editor.execCommand('mceInsertClipboardContent', false, {
        content: Strings.wordList1
      });

      LegacyUnit.equal(
        editor.getContent(),
        '<ul><li>Item 1</li><li>Item 2</li><li>Item 3</li><li>Item 4</li><li>Item 5</li><li>Item 6</li></ul><p><br />a</p>'
      );
    });

    suite.test(
      'TestCase-TBA: Paste: Paste Word fake lists interrupted by header',
      function (editor) {
        const rng = editor.dom.createRng();
    ...
    suite.test(
      'TestCase-TBA: Paste: Paste list like paragraph and list',
      function (editor) {
        editor.setContent('');
        ...
        LegacyUnit.equal(
          editor.getContent(),
          '<p>ABC. X</p><ol><li>Y</li></ol>'
        );
      }
    );

    suite.test(
      'TestCase-TBA: Paste: Paste list like paragraph and list (disabled)',
      function (editor) {
        editor.setContent('');
    ...
    suite.test('TestCase-TBA: Paste: Paste Word table', function (editor) {
      ...
      LegacyUnit.equal(
        editor.getContent(),
        '<table><tbody><tr><td width="307"><p>Cell 1</p></td><td width="307"><p>Cell 2</p></td></tr><tr><td width="307"><p>Cell 3</p></td><td width="307"><p>Cell 4</p></td></tr></tbody></table><p>&nbsp;</p>'
      );
    });
    ...
    suite.test('TestCase-TBA: Paste: Paste Office 365', function (editor) {
      ...
      editor.execCommand('mceInsertClipboardContent', false, {
        content: '<div class="OutlineElement Ltr SCX195156559">Test</div>'
      });
    ...
    suite.test('TestCase-TBA: Paste: Paste Google Docs 1', function (editor) {
      ...
      editor.execCommand('mceInsertClipboardContent', false, {
        content:
          '<span id="docs-internal-guid-94e46f1a-1c88-b42b-d502-1d19da30dde7"></span><p dir="ltr>Test</p>'
      });
      LegacyUnit.equal(editor.getContent(), '<p>Test</p>');
    });
    ...
    suite.test(
      'TestCase-TBA: Paste: Paste Word without mso markings',
      function (editor) {
        editor.setContent('');
        editor.execCommand('mceInsertClipboardContent', false, {
          content:
    ...
    suite.test('TestCase-TBA: Paste: Paste Word retain styles', function (
      editor
    ) {
      ...
      editor.execCommand('mceInsertClipboardContent', false, {
        content: '<p class="MsoNormal" style="color: #ff0000">Test</p>'
      });
      LegacyUnit.equal(
        editor.getContent(),
      ...
      LegacyUnit.equal(
        editor.getContent(),
        '<p style="background-color: #ff0000;">Test</p>'
      );
    });

    suite.test(
      'TestCase-TBA: Paste: Paste Word retain bold/italic styles to elements',
      function (editor) {
        ...
        LegacyUnit.equal(
          editor.getContent(),
          '<p><strong>bold</strong><em>italic</em><strong><em>bold + italic</em></strong><strong><span style="color: red;">bold + color</span></strong></p>'
        );
      }
    );

    suite.test('TestCase-TBA: Paste: paste track changes comment', function (
      editor
    ) {
      editor.setContent('');
    ...
    suite.test('TestCase-TBA: Paste: paste nested (UL) word list', function (
      editor
    ) {
      editor.setContent('');
    ...
    suite.test('TestCase-TBA: Paste: paste nested (OL) word list', function (
      editor
    ) {
      editor.setContent('');
    ...
    suite.test('TestCase-TBA: Paste: Paste list start index', function (
      editor
    ) {
    ...
    suite.test(
      'TestCase-TBA: Paste: Paste paste_merge_formats: true',
      function (editor) {
        editor.settings.paste_merge_formats = true;
    ...
    suite.test(
      'TestCase-TBA: Paste: Paste paste_merge_formats: false',
      function (editor) {
        ...
        LegacyUnit.equal(
          editor.getContent(),
          '<p><strong>a<em><strong>b</strong></em></strong></p>'
        );
      }
    );
    ...
    suite.test('TestCase-TBA: Paste: Paste word DIV as P', function (editor) {
      ...
      editor.execCommand('SelectAll');
      editor.execCommand('mceInsertClipboardContent', false, {
        content: '<p class="MsoNormal">1</p><div>2</div>'
      });
      LegacyUnit.equal(editor.getContent(), '<p>1</p><p>2</p>');
    });

    if (Env.ie) {
      suite.test('TestCase-TBA: Paste: Paste part of list from IE', function (
        editor
      ) {
        editor.setContent('');
        editor.execCommand('SelectAll');
        editor.execCommand('mceInsertClipboardContent', false, {
          content: '<li>item2</li><li>item3</li>'
        });
        LegacyUnit.equal(
          trimContent(editor.getContent()),
          '<ul><li>item2</li><li>item3</li></ul>',
          'List tags are inferred when pasting LI'
        );
      });
    }

    suite.test('TestCase-TBA: Paste: Disable default filters', function (
      editor
    ) {
      ...
      LegacyUnit.equal(
        editor.getContent(),
        '<p class="MsoNormal" style="color: #ff0000;">Test</p>'
      );
    });

    suite.test(
      'TestCase-TBA: Paste: paste invalid content with spans on page',
      function (editor) {
        const startingContent =
            '<p>123 testing <span id="x">span later in document</span></p>',
        ...
        LegacyUnit.equal(
          editor.getContent(),
          insertedContent + startingContent
        );
      }
    );

    suite.test('TestCase-TBA: Paste: paste plain text with space', function (
      editor
    ) {
    ...
    suite.test(
      'TestCase-TBA: Paste: paste plain text with linefeeds',
      function (editor) {
        editor.setContent('<p>text</p>');
        const rng = editor.dom.createRng();
        rng.setStart(editor.dom.select('p')[0].firstChild, 1);
    ...
    suite.test(
      'TestCase-TBA: Paste: paste plain text with double linefeeds',
      function (editor) {
        editor.setContent('<p>text</p>');
        const rng = editor.dom.createRng();
        rng.setStart(editor.dom.select('p')[0].firstChild, 1);
        ...
        LegacyUnit.equal(
          editor.getContent(),
          '<p>t</p><p>a</p><p>b</p><p>c</p><p>xt</p>'
        );
      }
    );

    suite.test('TestCase-TBA: Paste: paste plain text with entities', function (
      editor
    ) {
      editor.setContent('<p>text</p>');
      const rng = editor.dom.createRng();
    ...
    suite.test(
      'TestCase-TBA: Paste: paste plain text with paragraphs',
      function (editor) {
        editor.setContent('<p>text</p>');
        const rng = editor.dom.createRng();
        rng.setStart(editor.dom.select('p')[0].firstChild, 1);
        ...
        LegacyUnit.equal(
          editor.getContent(),
          '<p>t</p><p>a<br />&lt;b&gt;b&lt;/b&gt;</p><p>c</p><p>xt</p>'
        );
      }
    );

    suite.test(
      'TestCase-TBA: Paste: paste data image with paste_data_images: false',
      function (editor) {
        editor.setContent('');

        editor.execCommand('mceInsertClipboardContent', false, {
          content:
            '<img src="data:image/gif;base64,R0lGODlhAQABAPAAAP8REf///yH5BAAAAAAALAAAAAABAAEAAAICRAEAOw==">'
        });
        LegacyUnit.equal(editor.getContent(), '');

        editor.execCommand('mceInsertClipboardContent', false, {
          content:
            '<img alt="alt" src="data:image/gif;base64,R0lGODlhAQABAPAAAP8REf///yH5BAAAAAAALAAAAAABAAEAAAICRAEAOw==">'
        });
        LegacyUnit.equal(editor.getContent(), '');
      }
    );
    ...
    suite.test(
      'TestCase-TBA: Paste: paste data image with paste_data_images: true',
      function (editor) {
        ...
        LegacyUnit.equal(
          editor.getContent(),
          '<p><img src="data:image/gif;base64,R0lGODlhAQABAPAAAP8REf///yH5BAAAAAAALAAAAAABAAEAAAICRAEAOw==" /></p>'
        );
      }
    );

    suite.test('TestCase-TBA: Paste: paste data with script', function (
      editor
    ) {
      editor.setContent('');
      editor.execCommand('mceInsertClipboardContent', false, {
        content: `<p><img src="non-existent.png" onerror="alert('!')" /></p>`
      });

      LegacyUnit.equal(
        editor.getContent(),
        '<p><img src="non-existent.png" /></p>'
      );
    });

    suite.test('TestCase-TBA: Paste: paste pre process text (event)', function (
      editor
    ) {
      function callback(e) {
    ...
    suite.test('TestCase-TBA: Paste: paste pre process html (event)', function (
      editor
    ) {
      function callback(e) {
        e.content = 'PRE:' + e.content;
    ...
    suite.test('TestCase-TBA: Paste: paste post process (event)', function (
      editor
    ) {
      function callback(e) {
    ...
    suite.test(
      'TestCase-TBA: Paste: paste innerText of conditional comments',
      function () {
        LegacyUnit.equal(
          Utils.innerText('<![if !supportLists]>X<![endif]>'),
          'X'
        );
      }
    );

    suite.test('TestCase-TBA: Paste: paste innerText of single P', function (
      editor
    ) {
      editor.setContent('<p>a</p>');
    ...
    suite.test(
      'TestCase-TBA: Paste: paste innerText of single P with whitespace wrapped content',
      function (editor) {
        editor.setContent('<p>   a   </p>');
        LegacyUnit.equal(Utils.innerText(editor.getBody().innerHTML), 'a');
      }
    ...
    suite.test('TestCase-TBA: Paste: paste innerText of two P', function (
      editor
    ) {
    ...
    suite.test('TestCase-TBA: Paste: paste innerText of H1 and P', function (
      editor
    ) {
    ...
    suite.test('TestCase-TBA: Paste: paste innerText of P with BR', function (
      editor
    ) {
    ...
    suite.test('TestCase-TBA: Paste: paste innerText of P with WBR', function (
      editor
    ) {
    ...
    suite.test(
      'TestCase-TBA: Paste: paste innerText of P with VIDEO',
      function (editor) {
    ...
    suite.test('TestCase-TBA: Paste: paste innerText of PRE', function (
      editor
    ) {
      editor.getBody().innerHTML = '<pre>a\nb\n</pre>';
      LegacyUnit.equal(
        Utils.innerText(editor.getBody().innerHTML).replace(/\r\n/g, '\n'),
        'a\nb\n'
      );
    });

    suite.test(
      'TestCase-TBA: Paste: paste innerText of textnode with whitespace',
      function (editor) {
        editor.getBody().innerHTML = '<pre> a </pre>';
        LegacyUnit.equal(
          Utils.innerText(
            (editor.getBody().firstChild as HTMLElement).innerHTML
          ),
          ' a '
        );
      }
    ...
    suite.test(
      'TestCase-TBA: Paste: trim html from clipboard fragments',
      function () {
        LegacyUnit.equal(
          Utils.trimHtml('<!--StartFragment-->a<!--EndFragment-->'),
          'a'
        );
        LegacyUnit.equal(
          Utils.trimHtml(
        ...
        LegacyUnit.equal(
          Utils.trimHtml('a<!--StartFragment-->b<!--EndFragment-->c'),
          'abc'
        );
        ...
        LegacyUnit.equal(
          Utils.trimHtml('a<span class="Apple-converted-space">\u00a0</span>b'),
          'a b'
        );
        LegacyUnit.equal(
          Utils.trimHtml('<span class="Apple-converted-space">\u00a0</span>b'),
          ' b'
        );
        LegacyUnit.equal(
          Utils.trimHtml('a<span class="Apple-converted-space">\u00a0</span>'),
          'a '
        );
        LegacyUnit.equal(
          Utils.trimHtml('<span class="Apple-converted-space">\u00a0</span>'),
          ' '
        );
      }
    );
    ...
    if (Env.ie) {
      suite.test('TestCase-TBA: Paste: paste font and u in anchor', function (
        editor
      ) {
        editor.setContent('<p>a</p>');
        LegacyUnit.setSelection(editor, 'p', 1);
    ...
    if (Env.webkit) {
      suite.test(
        'TestCase-TBA: Paste: paste webkit retains text styles runtime styles internal',
        function (editor) {
          ...
          LegacyUnit.equal(
            editor.getContent(),
            '<p>&lt;span style="color:red"&gt;&lt;span data-mce-style="color:red"&gt;</p>'
          );
        }
      );

      suite.test(
        'TestCase-TBA: Paste: paste webkit remove runtime styles internal',
        function (editor) {
          editor.settings.paste_webkit_styles = 'color';
          editor.setContent('');
          editor.execCommand('mceInsertClipboardContent', false, {
            content:
              '<span style="color:red; font-size: 42px" data-mce-style="color: red;">Test</span>'
          });
          LegacyUnit.equal(
            editor.getContent(),
      ...
      suite.test(
        'TestCase-TBA: Paste: paste webkit remove runtime styles (color)',
        function (editor) {
          editor.settings.paste_webkit_styles = 'color';
          editor.setContent('');
          editor.execCommand('mceInsertClipboardContent', false, {
            content: '<span style="color:red; text-indent: 10px">Test</span>'
          });
          LegacyUnit.equal(
            editor.getContent(),
            '<p><span style="color: red;">Test</span></p>'
      ...
      suite.test(
        'TestCase-TBA: Paste: paste webkit remove runtime styles keep before attr',
        function (editor) {
          editor.setContent('');
          editor.execCommand('mceInsertClipboardContent', false, {
            content:
              '<span class="c" style="color:red; text-indent: 10px">Test</span>'
          });
          LegacyUnit.equal(
            editor.getContent(),
            '<p><span class="c">Test</span></p>'
          );
        }
      );

      suite.test(
        'TestCase-TBA: Paste: paste webkit remove runtime styles keep after attr',
        function (editor) {
          editor.setContent('');
          editor.execCommand('mceInsertClipboardContent', false, {
            content:
              '<span style="color:red; text-indent: 10px" title="t">Test</span>'
          });
          LegacyUnit.equal(
            editor.getContent(),
            '<p><span title="t">Test</span></p>'
          );
        }
      );

      suite.test(
        'TestCase-TBA: Paste: paste webkit remove runtime styles keep before/after attr',
        function (editor) {
          editor.setContent('');
          editor.execCommand('mceInsertClipboardContent', false, {
            content:
              '<span class="c" style="color:red; text-indent: 10px" title="t">Test</span>'
          });
          LegacyUnit.equal(
            editor.getContent(),
            '<p><span class="c" title="t">Test</span></p>'
          );
        }
      );

      suite.test(
        'TestCase-TBA: Paste: paste webkit remove runtime styles (background-color)',
        function (editor) {
          editor.settings.paste_webkit_styles = 'background-color';
          editor.setContent('');
          editor.execCommand('mceInsertClipboardContent', false, {
            content:
              '<span style="background-color:red; text-indent: 10px">Test</span>'
          });
          LegacyUnit.equal(
            editor.getContent(),
            '<p><span style="background-color: red;">Test</span></p>'
          );
        }
      );

      suite.test(
        'TestCase-TBA: Paste: paste webkit remove runtime styles (font-size)',
        function (editor) {
          editor.settings.paste_webkit_styles = 'font-size';
          editor.setContent('');
          editor.execCommand('mceInsertClipboardContent', false, {
            content:
              '<span style="font-size:42px; text-indent: 10px">Test</span>'
          });
          LegacyUnit.equal(
            editor.getContent(),
            '<p><span style="font-size: 42px;">Test</span></p>'
          );
        }
      );

      suite.test(
        'TestCase-TBA: Paste: paste webkit remove runtime styles (font-family)',
        function (editor) {
          editor.settings.paste_webkit_styles = 'font-family';
          editor.setContent('');
          editor.execCommand('mceInsertClipboardContent', false, {
            content:
              '<span style="font-family:Arial; text-indent: 10px">Test</span>'
          });
          LegacyUnit.equal(
            editor.getContent(),
      ...
      suite.test(
        'TestCase-TBA: Paste: paste webkit remove runtime styles font-family allowed but not specified',
        function (editor) {
          editor.settings.paste_webkit_styles = 'font-family';
          editor.setContent('');
          editor.execCommand('mceInsertClipboardContent', false, {
            content: '<p title="x" style="text-indent: 10px">Test</p>'
          });
      ...
      suite.test(
        'TestCase-TBA: Paste: paste webkit remove runtime styles (custom styles)',
        function (editor) {
          editor.settings.paste_webkit_styles = 'color font-style';
          editor.setContent('');
          editor.execCommand('mceInsertClipboardContent', false, {
            content:
              '<span style="color: red; font-style: italic; text-indent: 10px">Test</span>'
          });
          LegacyUnit.equal(
            editor.getContent(),
            '<p><span style="color: red; font-style: italic;">Test</span></p>'
          );
        }
      );

      suite.test(
        'TestCase-TBA: Paste: paste webkit remove runtime styles (all)',
        function (editor) {
          ...
          LegacyUnit.equal(
            editor.getContent(),
            '<p><span style="color: red; font-style: italic; text-indent: 10px;">Test</span></p>'
          );
        }
      );

      suite.test(
        'TestCase-TBA: Paste: paste webkit remove runtime styles (none)',
        function (editor) {
      ...
      suite.test(
        'TestCase-TBA: Paste: paste webkit remove runtime styles (color) in the same (color) (named)',
        function (editor) {
          editor.settings.paste_webkit_styles = 'color';
          ...
          LegacyUnit.equal(
            editor.getContent(),
            '<p style="color: red;">ab</p>'
          );
        }
      );

      suite.test(
        'TestCase-TBA: Paste: paste webkit remove runtime styles (color) in the same (color) (hex)',
        function (editor) {
          ...
          LegacyUnit.equal(
            editor.getContent(),
            '<p style="color: #ff0000;">abc</p>'
          );
        }
      );

      suite.test(
        'TestCase-TBA: Paste: paste webkit remove runtime styles (color) in the same (color) (rgb)',
        function (editor) {
    ...
    TinyLoader.setupLight(
      function (editor, onSuccess, onFailure) {
        Pipeline.async(
          ...
          appendTeardown(
            editor,
            Log.steps('TBA', 'Paste: Paste sanity tests', suite.toSteps(editor))
          ),
          onSuccess,
          onFailure
        );
