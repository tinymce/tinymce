...
UnitTest.asynctest('tinymce.plugins.paste.browser.PasteTest', (success, failure) => {
  ...
  suite.test('TestCase-TBA: Paste: Plain text toggle event', function (editor) {
    ...
    editor.execCommand('mceTogglePlainTextPaste');
    LegacyUnit.deepEqual(events, [{ state: true }, { state: false }], 'Should be disabled');

    editor.execCommand('mceTogglePlainTextPaste');
    LegacyUnit.deepEqual(events, [{ state: true }, { state: false }, { state: true }], 'Should be enabled again');
  });
  ...
  suite.test('TestCase-TBA: Paste: Paste styled text content', function (editor) {
    ...
    editor.execCommand('mceInsertClipboardContent', false, {
      content: '<strong><em><span style="color: red;">TEST</span></em></strong>'
    });
  ...
  suite.test('TestCase-TBA: Paste: Paste Google Docs 1', function (editor) {
    ...
    editor.execCommand('mceInsertClipboardContent', false, {
      content: '<span id="docs-internal-guid-94e46f1a-1c88-b42b-d502-1d19da30dde7"></span><p dir="ltr>Test</p>'
    });
    LegacyUnit.equal(editor.getContent(), '<p>Test</p>');
  });
  ...
  suite.test('TestCase-TBA: Paste: Paste Word retain styles', function (editor) {
    ...
    editor.execCommand('SelectAll');
    editor.execCommand('mceInsertClipboardContent', false, {
      content: '<p class="MsoNormal" style="background-color: #ff0000">Test</p>'
    });
  ...
  suite.test('TestCase-TBA: Paste: paste track changes comment', function (editor) {
    ...
    editor.execCommand('mceInsertClipboardContent', false, {
      content:
        '<p class="MsoNormal">1</p>' + '<div style="mso-element: comment;">2</div>' + '<span class="msoDel">3</span>' + '<del>4</del>'
    });
  ...
  suite.test('TestCase-TBA: Paste: paste nested (UL) word list', function (editor) {
    ...
    LegacyUnit.equal(
      editor.getContent(),
      '<ul>' + '<li>a' + '<ul>' + '<li>b' + '<ul>' + '<li>c 1. x</li>' + '</ul>' + '</li>' + '</ul>' + '</li>' + '</ul>'
    );
  });
  ...
  suite.test('TestCase-TBA: Paste: paste data image with paste_data_images: false', function (editor) {
    ...
    editor.execCommand('mceInsertClipboardContent', false, {
      content: '<img src="data:image/gif;base64,R0lGODlhAQABAPAAAP8REf///yH5BAAAAAAALAAAAAABAAEAAAICRAEAOw==">'
    });
    LegacyUnit.equal(editor.getContent(), '');

    editor.execCommand('mceInsertClipboardContent', false, {
      content: '<img alt="alt" src="data:image/gif;base64,R0lGODlhAQABAPAAAP8REf///yH5BAAAAAAALAAAAAABAAEAAAICRAEAOw==">'
    });
    LegacyUnit.equal(editor.getContent(), '');
  });
  ...
  if (Env.webkit) {
    suite.test('TestCase-TBA: Paste: paste webkit retains text styles runtime styles internal', function (editor) {
      ...
      editor.setContent('');
      editor.execCommand('mceInsertClipboardContent', false, {
        content: '&lt;span style="color:red"&gt;&lt;span data-mce-style="color:red"&gt;'
      });
    ...
    suite.test('TestCase-TBA: Paste: paste webkit remove runtime styles internal', function (editor) {
      ...
      editor.setContent('');
      editor.execCommand('mceInsertClipboardContent', false, {
        content: '<span style="color:red; font-size: 42px" data-mce-style="color: red;">Test</span>'
      });
    ...
    suite.test('TestCase-TBA: Paste: paste webkit remove runtime styles keep before attr', function (editor) {
      editor.setContent('');
      editor.execCommand('mceInsertClipboardContent', false, {
        content: '<span class="c" style="color:red; text-indent: 10px">Test</span>'
      });
    ...
    suite.test('TestCase-TBA: Paste: paste webkit remove runtime styles keep after attr', function (editor) {
      editor.setContent('');
      editor.execCommand('mceInsertClipboardContent', false, {
        content: '<span style="color:red; text-indent: 10px" title="t">Test</span>'
      });
    ...
    suite.test('TestCase-TBA: Paste: paste webkit remove runtime styles keep before/after attr', function (editor) {
      editor.setContent('');
      editor.execCommand('mceInsertClipboardContent', false, {
        content: '<span class="c" style="color:red; text-indent: 10px" title="t">Test</span>'
      });
    ...
    suite.test('TestCase-TBA: Paste: paste webkit remove runtime styles (background-color)', function (editor) {
      ...
      editor.setContent('');
      editor.execCommand('mceInsertClipboardContent', false, {
        content: '<span style="background-color:red; text-indent: 10px">Test</span>'
      });
    ...
    suite.test('TestCase-TBA: Paste: paste webkit remove runtime styles (font-size)', function (editor) {
      ...
      editor.setContent('');
      editor.execCommand('mceInsertClipboardContent', false, {
        content: '<span style="font-size:42px; text-indent: 10px">Test</span>'
      });
    ...
    suite.test('TestCase-TBA: Paste: paste webkit remove runtime styles (font-family)', function (editor) {
      ...
      editor.setContent('');
      editor.execCommand('mceInsertClipboardContent', false, {
        content: '<span style="font-family:Arial; text-indent: 10px">Test</span>'
      });
    ...
    suite.test('TestCase-TBA: Paste: paste webkit remove runtime styles (custom styles)', function (editor) {
      ...
      editor.setContent('');
      editor.execCommand('mceInsertClipboardContent', false, {
        content: '<span style="color: red; font-style: italic; text-indent: 10px">Test</span>'
      });
    ...
    suite.test('TestCase-TBA: Paste: paste webkit remove runtime styles (color) in the same (color) (named)', function (editor) {
      ...
      editor.execCommand('mceInsertClipboardContent', false, {
        content:
          '<span style="color:#ff0000; text-indent: 10px">a</span>' + '<span style="color:rgb(255, 0, 0); text-indent: 10px">b</span>'
      });
  ...
  TinyLoader.setupLight(
    function (editor, onSuccess, onFailure) {
      Pipeline.async(
        {},
        appendTeardown(editor, Log.steps('TBA', 'Paste: Paste sanity tests', suite.toSteps(editor))),
        onSuccess,
        onFailure
      );
    },
