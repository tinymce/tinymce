    ...
    function (editor, onSuccess, onFailure) {
      ...
      const steps = Env.webkit
        ? [
            Log.stepsAsStep(
              'TBA',
              'Paste: Paste span with encoded style attribute, paste_webkit_styles: font-family',
              [
                ...
                Paste.sPaste(editor, {
                  'text/html':
                    '<span style="font-family: &quot;a b&quot;;color:green;">b</span>'
                }),
                tinyApis.sAssertContent(
                  `<p><span style="font-family: 'a b';">b</span></p>`
                )
              ]
            ),
            ...
            Log.stepsAsStep(
              'TBA',
              'Paste: Paste span with encoded style attribute, paste_webkit_styles: all',
              [
                ...
                tinyApis.sAssertContent(
                  `<p><span style="font-family: 'a b'; color: green;">b</span></p>`
                )
              ]
            ),
            ...
            Log.stepsAsStep(
              'TBA',
              'Paste: Paste span with encoded style attribute, paste_webkit_styles: none',
              [
                ...
                Paste.sPaste(editor, {
                  'text/html':
                    '<span style="font-family: &quot;a b&quot;;">b</span>'
                }),
            ...
            Log.stepsAsStep(
              'TBA',
              'Paste: Paste span with encoded style attribute, paste_remove_styles_if_webkit: false',
              [
