...
UnitTest.asynctest(
  ...
  (success, failure) => {
    ...
    const cRemoveEditor = function () {
      return Chain.control(McEditor.cRemove, Guard.addLogging('Remove editor'));
    };
    ...
    const cFireFakePasteEvent = function (data) {
      return Chain.control(
        Chain.async(function (editor: any, next, _die) {
          editor.fire('paste', {
            clipboardData: MockDataTransfer.create(data)
          });
          next(editor);
        }),
      ...
      return Chain.control(
        Chain.async(function (editor: any, next, _die) {
          Assertions.assertHtml(
            label || 'Asserting editors content',
            expected,
            editor.getContent()
          );
          next(editor);
    ...
    const pasteData = {
      ...
      Chrome: {
        'text/plain': srcText,
        'text/html':
          '<div>one</div><div>two</div><div><br></div><div>three</div><div><br></div><div><br></div><div>four</div><div><br></div><div><br></div><div><br></div><div>.'
      },
      Edge: {
        'text/plain': srcText,
        'text/html':
          '<div>one<br>two</div><div>three</div><div><br>four</div><div><br></div><div>.</div>'
      },
      IE: {
        'text/plain': srcText,
        'text/html':
          '<p>one<br>two</p><p>three</p><p><br>four</p><p><br></p><p>.</p>'
      }
    };

    const expectedWithRootBlock =
      '<p>one<br />two</p><p>three</p><p><br />four</p><p>&nbsp;</p><p>.</p>';
    const expectedWithRootBlockAndAttrs =
      '<p class="attr">one<br />two</p><p class="attr">three</p><p class="attr"><br />four</p><p class="attr">&nbsp;</p><p class="attr">.</p>';
    const expectedWithoutRootBlock =
      'one<br />two<br /><br />three<br /><br /><br />four<br /><br /><br /><br />.';
    ...
    Pipeline.async(
      ...
      [
        Chain.asStep(
          ...
          Log.chains(
            'TBA',
            'Paste: Assert forced_root_block <p></p> is added to the pasted data',
            [
        ...
        Chain.asStep(
          ...
          Log.chains(
            'TBA',
            'Paste: Assert forced_root_block <p class="attr"></p> is added to the pasted data',
            [
              cCreateEditorFromSettings({
                plugins: 'paste',
                forced_root_block: 'p',
        ...
        Chain.asStep(
          ...
          Log.chains(
            'TBA',
            'Paste: Assert forced_root_block is not added to the pasted data',
            [
              cCreateEditorFromSettings({
                plugins: 'paste',
