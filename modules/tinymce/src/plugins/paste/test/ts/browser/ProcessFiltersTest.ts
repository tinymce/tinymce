    ...
    function (editor, onSuccess, onFailure) {
      Pipeline.async(
        ...
        [
          ...
          Chain.asStep(
            editor,
            Log.chains('TBA', 'Paste: Paste pre/post process passthough as is', [
          ...
          Chain.asStep(
            editor,
            Log.chains('TBA', 'Paste: Paste pre/post process passthough unsafe content', [
              cProcessPrePost(`<img src="non-existent.png" onerror="alert('!')">`, true, Fun.noop, Fun.noop),
              Assertions.cAssertEq('Should be changed if dangerous content', {
          ...
          Chain.asStep(
            editor,
            Log.chains('TBA', 'Paste: Paste pre/post process assert internal false', [
          ...
          Chain.asStep(
            editor,
            Log.chains('TBA', 'Paste: Paste pre/post process assert internal true', [
          ...
          Chain.asStep(
            editor,
            Log.chains('TBA', 'Paste: Paste pre/post process alter on preprocess', [
          ...
          Chain.asStep(
            editor,
            Log.chains('TBA', 'Paste: Paste pre/post process alter on postprocess', [
          ...
          Chain.asStep(
            editor,
            Log.chains('TBA', 'Paste: Paste pre/post process alter on preprocess/postprocess', [
          ...
          Chain.asStep(
            editor,
            Log.chains('TBA', 'Paste: Paste pre/post process prevent default on preProcess', [
          ...
          Chain.asStep(
            editor,
            Log.chains('TBA', 'Paste: Paste pre/post process prevent default on postProcess', [
