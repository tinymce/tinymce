...
UnitTest.asynctest(
  ...
  (success, failure) => {
    ...
    const assertInternal = function (expectedFlag) {
      return function (e) {
        Assertions.assertEq(
          'Should be expected internal flag',
          expectedFlag,
          e.internal
        );
      };
      ...
      function (editor, onSuccess, onFailure) {
        Pipeline.async(
          ...
          [
            Chain.asStep(
              editor,
              Log.chains('TBA', 'Paste: Paste pre process only', [
                cProcessPre('a', true, preProcessHandler),
                Assertions.cAssertEq('Should be preprocessed by adding a X', {
                  content: 'aX',
                  cancelled: false
                })
              ])
            ...
            Chain.asStep(
              ...
              Log.chains(
                'TBA',
                'Paste: Paste pre/post process passthough as is',
                [
                  cProcessPrePost('a', true, Fun.noop, Fun.noop),
                  Assertions.cAssertEq(
                    'Should be unchanged with safe content',
                    { content: 'a', cancelled: false }
                  )
                ]
              )
            ),
            ...
            Chain.asStep(
              ...
              Log.chains(
                'TBA',
                'Paste: Paste pre/post process passthough unsafe content',
                [
                  cProcessPrePost(
                    `<img src="non-existent.png" onerror="alert('!')">`,
                    true,
                    Fun.noop,
                    Fun.noop
                  ),
                  Assertions.cAssertEq(
                    'Should be changed if dangerous content',
                    {
                      content: '<img src="non-existent.png">',
                      cancelled: false
                    }
                  )
                ]
            ...
            Chain.asStep(
              ...
              Log.chains(
                'TBA',
                'Paste: Paste pre/post process assert internal false',
                [
                  cProcessPrePost(
                    'a',
                    false,
                  ...
                  Assertions.cAssertEq('Should be unchanged', {
                    content: 'a',
                    cancelled: false
                  })
                ]
            ...
            Chain.asStep(
              ...
              Log.chains(
                'TBA',
                'Paste: Paste pre/post process assert internal true',
                [
                  cProcessPrePost(
                    'a',
                    true,
            ...
            Chain.asStep(
              ...
              Log.chains(
                'TBA',
                'Paste: Paste pre/post process alter on preprocess',
                [
            ...
            Chain.asStep(
              ...
              Log.chains(
                'TBA',
                'Paste: Paste pre/post process alter on postprocess',
                [
                  cProcessPrePost(
                    'a<b>b</b>c',
                    true,
                    Fun.noop,
                    postProcessHandler(editor)
                  ),
                  Assertions.cAssertEq('Should have all b elements removed', {
                    content: 'abc',
                    cancelled: false
                  })
                ]
            ...
            Chain.asStep(
              ...
              Log.chains(
                'TBA',
                'Paste: Paste pre/post process alter on preprocess/postprocess',
                [
                  cProcessPrePost(
                    'a<b>b</b>c',
                    true,
                  ...
                  Assertions.cAssertEq(
                    'Should have all b elements removed and have a X added',
                    {
                      content: 'abcX',
                      cancelled: false
                    }
            ...
            Chain.asStep(
              ...
              Log.chains(
                'TBA',
                'Paste: Paste pre/post process prevent default on preProcess',
                [
                  cProcessPrePost(
                    'a<b>b</b>c',
                    true,
                  ...
                  Assertions.cAssertEq(
                    'Should have all b elements removed and be cancelled',
                    {
                      content: 'a<b>b</b>c',
                      cancelled: true
                    }
            ...
            Chain.asStep(
              ...
              Log.chains(
                'TBA',
                'Paste: Paste pre/post process prevent default on postProcess',
                [
                  cProcessPrePost(
                    'a<b>b</b>c',
                    true,
                  ...
                  Assertions.cAssertEq(
                    'Should have a X added and be cancelled',
                    {
                      content: 'a<b>b</b>cX',
                      cancelled: true
                    }
