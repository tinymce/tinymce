...
</p><h1>Navigate within UI sections</h1>
...
</p><p>If the current focus is at the ‘top’ of a particular UI section, pressing the <strong>Esc</strong> key also exits
...
</p><h1>Navigate non-tabbed dialogs</h1>
