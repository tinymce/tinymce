...
const tab = (): Dialog.TabSpec => {
  ...
  const changeLogLink = '<a href="https://www.tiny.cloud/docs/tinymce/6/changelog/?utm_campaign=editor_referral&utm_medium=help_dialog&utm_source=tinymce" rel="noreferrer noopener" target="_blank">TinyMCE ' + version + '</a>';
