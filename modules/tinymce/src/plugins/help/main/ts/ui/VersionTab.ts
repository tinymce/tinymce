...
const tab = (): Dialog.TabSpec => {
  ...
  const changeLogLink = '<a href="https://www.tiny.cloud/docs/release-information/changelog/?utm_campaign=editor_referral&utm_medium=help_dialog&utm_source=tinymce" target="_blank">TinyMCE ' + version + '</a>';
