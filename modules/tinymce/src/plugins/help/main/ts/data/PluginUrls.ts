...
const urls = Arr.map<PartialPluginUrl, PluginUrl>([
  ...
  { key: 'exportpdf', name: 'Export PDF', type: PluginType.Premium },
  { key: 'exportword', name: 'Export Word', type: PluginType.Premium },
  ...
  { key: 'importword', name: 'Import Word', type: PluginType.Premium },
