...
UnitTest.asynctest(
  'browser.tinymce.plugins.fullpage.FullPageDialogPluginTest',
  function (success, failure) {
    ...
    const selectors = {
      ...
      descriptionInput:
        'label.tox-label:contains(Description) + input.tox-textfield',
    ...
    TinyLoader.setupLight(
      function (editor, onSuccess, onFailure) {
        ...
        Pipeline.async(
          ...
          Log.steps(
            'TBA',
            'FullPage: Test initial data, set new input values, open dialog, verify that the dialog data matches the input values',
            [
              sInitialState(editor),
              sCheckInputValue(
                'Title',
                selectors.titleInput,
                'Fullpage Dialog Test Title'
              ),
              ...
              Keyboard.sKeydown(doc, Keys.tab(), {}),
              FocusTools.sIsOnSelector(
                'The save button should be focused',
                doc,
              ...
              sCheckInputValue(
                'Robots',
                selectors.robotsInput,
                'the nu robots'
              ),
              sCheckInputValue(
                'Author',
                selectors.authorInput,
                'the nu author'
              ),
              sCheckInputValue(
                'Encoding',
