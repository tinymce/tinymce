...
UnitTest.asynctest('browser.tinymce.plugins.importcss.ImportCssGroupsTest', (success, failure) => {
  ...
  const sTestEditorWithSettings = (assertions, pluginSettings) =>
    Step.async((onStepSuccess, onStepFailure) => {
      TinyLoader.setupLight(
        (editor, onSuccess, onFailure) => {
          ...
          const sOpenStyleMenu = GeneralSteps.sequence([tinyUi.sClickOnToolbar('Clicking on the styleselect dropdown', 'button')]);
        ...
        sTestEditorWithSettings(
          {
            navigation: [
              {
                item: 'Other',
                subitems: ['h1.red.DDD', 'p.other.DDD', 'span.inline.DDD']
              },
              {
                item: 'Advanced',
                subitems: ['h2.advanced.CCC', 'h3.advanced.CCC', 'h4.advanced.CCC']
              }
            ],
            choice: {
        ...
        sTestEditorWithSettings(
          {
            navigation: [
              {
                item: 'Other',
                subitems: ['h1.red.OtherGroup', 'p.other.OtherGroup', 'span.inline.OtherGroup']
              },
              {
                item: 'Advanced',
                subitems: ['h2.advanced.AdvGroup', 'h3.advanced.AdvGroup', 'h4.advanced.AdvGroup']
              }
            ],
            choice: {
        ...
        sTestEditorWithSettings(
          {
            navigation: [
              {
                item: 'Other',
                subitems: ['h1.red', 'p.other', 'span.inline', 'h2.advanced', 'h3.advanced', 'h4.advanced']
              },
              {
                item: 'Advanced',
                subitems: ['h2.advanced', 'h3.advanced', 'h4.advanced']
              }
            ],
            choice: {
              keysBeforeExecute: [Keys.right()],
        ...
        sTestEditorWithSettings(
          {
            navigation: [
              {
                item: 'Other',
                subitems: ['h1.red', 'p.other', 'span.inline']
              },
              {
                item: 'Advanced',
                subitems: ['h2.advanced', 'h3.advanced', 'h4.advanced']
