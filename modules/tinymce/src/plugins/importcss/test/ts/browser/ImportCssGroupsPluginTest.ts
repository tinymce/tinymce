...
UnitTest.asynctest(
  'browser.tinymce.plugins.importcss.ImportCssGroupsTest',
  (success, failure) => {
    Plugin();
    Theme();
        ...
        TinyLoader.setupLight(
          (editor, onSuccess, onFailure) => {
            ...
            const sOpenStyleMenu = GeneralSteps.sequence([
              tinyUi.sClickOnToolbar(
                'Clicking on the styleselect dropdown',
                'button'
              )
            ]);

            const navigationSteps = MenuNavigationTestUtils.generateNavigation(
              doc,
            ...
            Pipeline.async(
              ...
              Arr.flatten([
                ...
                [sOpenStyleMenu],
                navigationSteps,
                Arr.map(assertions.choice.keysBeforeExecute, (k) =>
                  Keyboard.sKeydown(doc, k, {})
                ),
          ...
          },
          {
            ...
            importcss_selector_converter:
              pluginSettings.importcss_selector_converter,
              ...
              navigation: [
                {
                  ...
                  subitems: [
                    'h1.red.OtherGroup',
                    'p.other.OtherGroup',
                    'span.inline.OtherGroup'
                  ]
                },
                {
                  item: 'Advanced',
                  subitems: [
                    'h2.advanced.AdvGroup',
                    'h3.advanced.AdvGroup',
                    'h4.advanced.AdvGroup'
                  ]
                }
              ],
              choice: {
