          ...
          Step.label(
            ...
            GeneralSteps.sequence([
              ...
              Step.label(
                ...
                tinyApis.sAssertContentStructure(Utils.forcedRootBlockInlineStructHelper('strong', 'a'))
              )
            ])
          ),
          Step.label(
            ...
            GeneralSteps.sequence([
              ...
              Step.label(
                ...
                tinyApis.sAssertContentStructure(Utils.forcedRootBlockStructHelper('h1', ' heading 1'))
              )
            ])
          )
        ],
