...
UnitTest.asynctest(
  'browser.tinymce.plugins.imagetools.ContextToolbarTest',
  (success, failure) => {
    Theme();
    ImagePlugin();
    ImageToolsPlugin();
    ...
    TinyLoader.setupLight(
      function (editor, onSuccess, onFailure) {
        ...
        const srcUrl =
          '/project/tinymce/src/plugins/imagetools/demo/img/dogleft.gif';
        ...
        const sOpenContextToolbar = (source) =>
          GeneralSteps.sequence([
            ...
            tinyUi.sWaitForUi(
              ...
              '.tox-toolbar button[aria-label="Rotate counterclockwise"]'
            )
          ]);
        ...
        const sWaitForDialogOpenThenCloseDialog = (childSelector: string) => {
          ...
          return GeneralSteps.sequence([
            ...
            Waiter.sTryUntil(
              ...
              UiFinder.sNotExists(TinyDom.fromDom(document.body), selector),
              50,
              5000
            )
          ]);
          ...
          Chain.asStep({ editor }, [
            Chain.label(
              ...
              NamedChain.asChain([
                ...
                Chain.label(
                  'Store img src before flip',
                  NamedChain.write('srcBeforeFlip', cGetImageSrc)
                ),
                Chain.label(
                  'Flip image',
                  NamedChain.read('editor', cClickContextToolbarButton(label))
                ),
                Waiter.cTryUntilPredicate(
        ...
        Pipeline.async(
          ...
          [
            ...
            Log.stepsAsStep(
              'TBA',
              'ImageTools: context toolbar keyboard navigation test',
              [
                sOpenContextToolbar(srcUrl),
                sPressKeyboardShortcutKey,
                sAssertFocusOnItem(
                  'Rotate counterclockwise button',
                  'button[aria-label="Rotate counterclockwise"]'
                ),
                sPressRightArrowKey,
                sAssertFocusOnItem(
                ...
                sAssertFocusOnItem(
                  ...
                  'button[aria-label="Flip vertically"]'
                ),
                sPressRightArrowKey,
                sAssertFocusOnItem(
                  'Flip horizontally button',
                  'button[aria-label="Flip horizontally"]'
                ),
                sPressRightArrowKey,
                sAssertFocusOnItem(
                  'Edit image button',
                ...
                sAssertFocusOnItem(
                  ...
                  'button[aria-label="Image options"]'
                ),
                sPressRightArrowKey,
                sAssertFocusOnItem(
                  'Rotate counterclockwise button',
            ...
            Log.stepsAsStep(
              'TBA',
              'ImageTools: context toolbar functionality test',
              [
                sOpenContextToolbar(srcUrl),
        ...
        */
                sWaitForDialogOpenThenCloseDialog(
                  'div.tox-image-tools__image>img'
                ),
