...
UnitTest.asynctest('browser.tinymce.plugins.image.core.ImageDataTest', (success, failure) => {
  ...
  const cCreate = (data: ImageData) =>
    Chain.control(Chain.inject(Element.fromDom(create(normalizeCss, data))), Guard.addLogging(`Create ${data}`));
  ...
  Pipeline.async(
    ...
    [
      ...
      Chain.asStep(
        Element.fromTag('div'),
        Log.chains('TBA', 'Image: Read/write model to simple image without change', [
      ...
      Chain.asStep(
        Element.fromTag('div'),
        Log.chains('TBA', 'Image: Read/write model to complex image without change', [
          cSetHtml(
      ...
      Chain.asStep(
        Element.fromTag('div'),
        Log.chains('TBA', 'Image: Read/write model to simple image with changes', [
          cSetHtml('<img src="some.gif">'),
          cReadFromImage,
          cUpdateModel({
            src: 'some2.gif',
      ...
      Chain.asStep(
        Element.fromTag('div'),
        Log.chains('TBA', 'Image: Read/write model to complex image with changes', [
          cSetHtml(
            '<img src="some.gif" class="class" width="100" height="200" style="margin: 1px 2px; border: 1px solid red" alt="alt" title="title">'
          ),
          cReadFromImage,
      ...
      Chain.asStep(
        Element.fromTag('div'),
        Log.chains('TBA', 'Image: write null as alt will remove the attribute', [
      ...
      Chain.asStep(
        Element.fromTag('div'),
        Log.chains('TBA', 'Image: Read/write model to image with style size without change', [
      ...
      Chain.asStep(
        Element.fromTag('div'),
        Log.chains('TBA', 'Image: Read/write model to image with style size with size change', [
          cSetHtml('<img src="some.gif" style="width: 100px; height: 200px">'),
          cReadFromImage,
          cAssertModel({
            src: 'some.gif',
