...
UnitTest.asynctest(
  'browser.tinymce.plugins.image.DialogTest',
  (success, failure) => {
    SilverTheme();
    Plugin();
      ...
      function (editor, onSuccess, onFailure) {
        ...
        Pipeline.async(
          ...
          [
            ...
            Log.stepsAsStep(
              'TBA',
              'Insert Image Dialog with filepicker cycle',
              [
            ...
            Log.stepsAsStep('TBA', 'Insert Image Dialog with all options', [
              ...
              api.sSetSetting('image_class_list', [
                { title: 'sample', value: 'sample' }
              ]),
              api.sSetSetting('image_list', [
                { title: 'sample', value: 'sample' }
              ]),
            ...
            Log.stepsAsStep('TBA', 'Insert Image Dialog with upload tab', [
              ...
              sAssertFocused(
                'Upload tab',
                '.tox-dialog__body-nav-item:contains("Upload")'
              ),
              sPressTab,
              sAssertFocused(
                'Browse for an image',
                '.tox-dropzone button.tox-button'
              ),
              sPressTab,
              sAssertFocused('Cancel', 'button.tox-button:contains("Cancel")'),
              sPressTab,
