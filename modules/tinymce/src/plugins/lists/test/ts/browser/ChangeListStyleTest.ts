      ...
      function (editor, onSuccess, onFailure) {
        ...
        Pipeline.async(
          ...
          [
            ...
            Log.stepsAsStep(
              'TBA',
              'Lists: ul to ol, selection from parent to sublist',
              [
            ...
            Log.stepsAsStep(
              'TBA',
              'Lists: ol to ul, selection from parent to sublist',
              [
            ...
            Log.stepsAsStep(
              'TBA',
              'Lists: alpha to ol, cursor only in parent',
              [
                tinyApis.sSetContent(
                  '<ul style="list-style-type: lower-alpha;"><li>a</li><ol style="list-style-type: lower-alpha;"><li>b</li></ol></ul>'
                ),
                tinyApis.sSetCursor([0, 0, 0], 0),
                tinyUi.sClickOnToolbar(
                  'click bullist button',
            ...
            Log.stepsAsStep(
              'TBA',
              'Lists: alpha to ol, selection from parent to sublist',
              [
                tinyApis.sSetContent(
                  '<ul style="list-style-type: lower-alpha;"><li>a</li><ol style="list-style-type: lower-alpha;"><li>b</li></ol></ul>'
                ),
            ...
            Log.stepsAsStep(
              'TBA',
              'Lists: alpha to ul, cursor only in parent',
              [
                tinyApis.sSetContent(
            ...
            Log.stepsAsStep(
              'TBA',
              'Lists: alpha to ul, selection from parent to sublist',
              [
                tinyApis.sSetContent(
                  '<ol style="list-style-type: lower-alpha;"><li>a</li><ol style="list-style-type: lower-alpha;"><li>b</li></ol></ol>'
                ),
