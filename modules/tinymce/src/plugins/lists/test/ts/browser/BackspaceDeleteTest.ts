...
UnitTest.asynctest(
  ...
  (success, failure) => {
    ...
    suite.test(
      'TestCase-TBA: Lists: Backspace at beginning of single LI in UL',
      function (editor) {
    ...
    suite.test(
      'TestCase-TBA: Lists: Backspace at end of single LI in UL',
      function (editor) {
    ...
    suite.test(
      'TestCase-TBA: Lists: Backspace at beginning of first LI in UL',
      function (editor) {
        editor.getBody().innerHTML = LegacyUnit.trimBrs(
    ...
    suite.test(
      'TestCase-TBA: Lists: Backspace at beginning of middle LI in UL',
      function (editor) {
        editor.getBody().innerHTML = LegacyUnit.trimBrs(
    ...
    suite.test(
      'TestCase-TBA: Lists: Backspace at beginning of start LI in UL inside UL',
      function (editor) {
        editor.getBody().innerHTML = LegacyUnit.trimBrs(
          '<ul>' +
            '<li>a' +
    ...
    suite.test(
      'TestCase-TBA: Lists: Backspace at beginning of middle LI in UL inside UL',
      function (editor) {
        editor.getBody().innerHTML = LegacyUnit.trimBrs(
          '<ul>' +
            '<li>a' +
    ...
    suite.test(
      'TestCase-TBA: Lists: Backspace at beginning of LI with empty LI above in UL',
      function (editor) {
        editor.getBody().innerHTML = LegacyUnit.trimBrs(
    ...
    suite.test(
      'TestCase-TBA: Lists: Backspace at beginning of LI with BR padded empty LI above in UL',
      function (editor) {
    ...
    suite.test('TestCase-TBA: Lists: Backspace at empty LI (IE)', function (
      editor
    ) {
      editor.getBody().innerHTML =
        '<ul>' + '<li>a</li>' + '<li></li>' + '<li>b</li>' + '</ul>';
    ...
    suite.test(
      'TestCase-TBA: Lists: Backspace at beginning of LI with empty LI with STRING and BR above in UL',
      function (editor) {
        editor.getBody().innerHTML =
          '<ul>' +
          '<li>a</li>' +
    ...
    suite.test(
      'TestCase-TBA: Lists: Backspace at nested LI with adjacent BR',
      function (editor) {
        editor.getBody().innerHTML =
          '<ul>' +
          '<li>1' +
        ...
        LegacyUnit.equal(
          editor.getContent(),
          '<ul><li>1<ul><li></li><li>2</li></ul></li><li>3</li></ul>'
        );
        LegacyUnit.equal(editor.selection.getNode().nodeName, 'LI');
      }
    );
    ...
    suite.test(
      'TestCase-TBA: Lists: Backspace at LI selected with triple-click in UL',
      function (editor) {
        editor.getBody().innerHTML = LegacyUnit.trimBrs(
          '<ul>' +
            '<li>a</li>' +
        ...
        LegacyUnit.equal(
          LegacyUnit.trimBrs(editor.getContent()),
          '<ul>' +
            '<li>b' +
            '<ul>' +
            '<li>c</li>' +
    ...
    suite.test(
      'TestCase-TBA: Lists: Backspace at partially selected list',
      function (editor) {
        editor.getBody().innerHTML = LegacyUnit.trimBrs(
          '<p>abc</p>' +
            '<ul>' +
    ...
    suite.test(
      'TestCase-TBA: Lists: Delete at end of single LI in UL',
      function (editor) {
        editor.getBody().innerHTML = LegacyUnit.trimBrs(
          '<ul>' + '<li>a</li>' + '</ul>'
        );
    ...
    suite.test(
      'TestCase-TBA: Lists: Delete at end of first LI in UL',
      function (editor) {
        editor.getBody().innerHTML = LegacyUnit.trimBrs(
          '<ul>' + '<li>a</li>' + '<li>b</li>' + '</ul>'
        );
        ...
        LegacyUnit.equal(editor.getContent(), '<ul>' + '<li>ab</li>' + '</ul>');
    ...
    suite.test(
      'TestCase-TBA: Lists: Delete at end of middle LI in UL',
      function (editor) {
        editor.getBody().innerHTML = LegacyUnit.trimBrs(
          '<ul>' + '<li>a</li>' + '<li>b</li>' + '<li>c</li>' + '</ul>'
        );
    ...
    suite.test(
      'TestCase-TBA: Lists: Delete at end of start LI in UL inside UL',
      function (editor) {
        editor.getBody().innerHTML = LegacyUnit.trimBrs(
          '<ul>' +
            '<li>a' +
    ...
    suite.test(
      'TestCase-TBA: Lists: Delete at end of middle LI in UL inside UL',
      function (editor) {
        editor.getBody().innerHTML = LegacyUnit.trimBrs(
          '<ul>' +
            '<li>a' +
    ...
    suite.test(
      'TestCase-TBA: Lists: Delete at end of LI before empty LI',
      function (editor) {
        editor.getBody().innerHTML =
          '<ul>' + '<li>a</li>' + '<li></li>' + '<li>b</li>' + '</ul>';
    ...
    suite.test(
      'TestCase-TBA: Lists: Delete at end of LI before BR padded empty LI',
      function (editor) {
        editor.getBody().innerHTML =
          '<ul>' + '<li>a</li>' + '<li><br></li>' + '<li>b</li>' + '</ul>';
    ...
    suite.test(
      'TestCase-TBA: Lists: Delete at end of LI before empty LI with STRONG',
      function (editor) {
        editor.getBody().innerHTML =
          '<ul>' +
          '<li>a</li>' +
    ...
    suite.test(
      'TestCase-TBA: Lists: Delete at nested LI with adjacent BR',
      function (editor) {
        editor.getBody().innerHTML =
          '<ul>' +
          '<li>1' +
    ...
    suite.test('TestCase-TBA: Lists: Delete at BR before text in LI', function (
      editor
    ) {
      editor.getBody().innerHTML =
        '<ul>' + '<li>1</li>' + '<li>2<br></li>' + '<li>3</li>' + '</ul>';
    ...
    suite.test('TestCase-TBA: Lists: Backspace merge li elements', function (
      editor
    ) {
      ...
      LegacyUnit.equal(editor.selection.getNode().nodeName, 'LI');
      LegacyUnit.equal(
        editor.selection.getRng().startContainer.nodeType,
        3,
    ...
    suite.test(
      'TestCase-TBA: Lists: Backspace at block inside li element into li without block element',
      function (editor) {
        editor.getBody().innerHTML =
          '<ul>' + '<li>1</li>' + '<li><p>2</p></li>' + '<li>3</li>' + '</ul>';
    ...
    suite.test(
      'TestCase-TBA: Lists: Backspace at block inside li element into li with block element',
      function (editor) {
        editor.getBody().innerHTML =
          '<ul>' +
          '<li><p>1</p></li>' +
    ...
    suite.test(
      'TestCase-TBA: Lists: Backspace at block inside li element into li with multiple block elements',
      function (editor) {
        editor.getBody().innerHTML =
          '<ul>' +
          '<li><p>1</p><p>2</p></li>' +
        ...
        LegacyUnit.equal(
          editor.getContent(),
          '<ul>' + '<li><p>1</p><p>2</p>3</li>' + '<li>4</li>' + '</ul>'
        );
        LegacyUnit.equal(editor.selection.getNode().nodeName, 'LI');
      }
    );
    ...
    suite.test(
      'TestCase-TBA: Lists: Delete at block inside li element into li without block element',
      function (editor) {
        editor.getBody().innerHTML =
          '<ul>' + '<li><p>1</p></li>' + '<li>2</li>' + '<li>3</li>' + '</ul>';
    ...
    suite.test(
      'TestCase-TBA: Lists: Delete at block inside li element into li with block element',
      function (editor) {
        editor.getBody().innerHTML =
          '<ul>' +
          '<li><p>1</p></li>' +
    ...
    suite.test(
      'TestCase-TBA: Lists: Delete at block inside li element into li with multiple block elements',
      function (editor) {
        editor.getBody().innerHTML =
          '<ul>' +
          '<li>1</li>' +
        ...
        LegacyUnit.equal(
          editor.getContent(),
          '<ul>' + '<li>1<p>2</p><p>3</p></li>' + '<li>4</li>' + '</ul>'
        );
        LegacyUnit.equal(editor.selection.getNode().nodeName, 'LI');
      }
    );
    ...
    suite.test('Delete into indented list', function (editor) {
      ...
      LegacyUnit.equal(editor.getContent(), '<ol>' + '<li>ab</li>' + '</ol>');
      LegacyUnit.equal(editor.selection.getNode().nodeName, 'LI');
    });

    suite.test(
      'TestCase-TBA: Lists: Backspace at beginning of LI in UL inside UL and then undo',
      function (editor) {
        editor.resetContent(
          '<ul>' +
            '<li>item 1</li>' +
