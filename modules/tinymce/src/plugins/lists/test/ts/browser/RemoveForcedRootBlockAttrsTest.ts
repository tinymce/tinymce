...
UnitTest.asynctest(
  'tinymce.lists.browser.RemoveForcedRootBlockAttrsTest',
  (success, failure) => {
    ...
    suite.test(
      'TestCase-TBA: Lists: Remove UL with forced_root_block_attrs',
      (editor) => {
        ...
        LegacyUnit.equal(editor.getContent(), '<p data-editor="1">a</p>');
