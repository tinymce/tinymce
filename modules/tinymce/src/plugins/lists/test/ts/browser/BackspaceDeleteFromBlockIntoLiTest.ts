      ...
      function (editor, onSuccess, onFailure) {
        ...
        Pipeline.async(
          ...
          [
            Log.stepsAsStep(
              'TBA',
              'Lists: backspace from p inside div into li',
              [
                tinyApis.sFocus(),
                tinyApis.sSetContent(
                  '<ul><li>a</li></ul><div><p><br /></p></div>'
                ),
            ...
            Log.stepsAsStep(
              'TBA',
              'Lists: backspace from p inside blockquote into li',
              [
                tinyApis.sFocus(),
                tinyApis.sSetContent(
                  '<ul><li>a</li></ul><blockquote><p><br /></p></blockquote>'
                ),
                tinyApis.sSetCursor([1, 0, 0], 0),
                tinyActions.sContentKeystroke(Keys.backspace(), {}),
                tinyApis.sAssertContent('<ul><li>a</li></ul>')
            ...
            Log.stepsAsStep(
              'TBA',
              'Lists: backspace from b inside p inside blockquote into li',
              [
                tinyApis.sFocus(),
                tinyApis.sSetContent(
                  '<ul><li>a</li></ul><blockquote><p><b><br /></b></p></blockquote>'
                ),
            ...
            Log.stepsAsStep(
              'TBA',
              'Lists: backspace from span inside p inside blockquote into li',
              [
                tinyApis.sFocus(),
                tinyApis.sSetContent(
                  '<ul><li>a</li></ul><blockquote><p><span class="x"><br /></span></p></blockquote>'
                ),
                tinyApis.sSetCursor([1, 0, 0, 0], 0),
                tinyActions.sContentKeystroke(Keys.backspace(), {}),
                tinyApis.sAssertContent('<ul><li>a</li></ul>')
