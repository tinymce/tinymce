...
UnitTest.asynctest(
  ...
  (success, failure) => {
    ...
    suite.test(
      'TestCase-TBA: Lists: Backspace at beginning of LI on body UL',
      function (editor) {
        editor.focus();
    ...
    suite.test('TestCase-TBA: Lists: Delete at end of LI on body UL', function (
      editor
    ) {
      editor.focus();
      editor.selection.setCursorLocation(
      ...
      EditorManager.init({
        ...
        init_instance_callback(editor) {
          Pipeline.async(
            ...
            Log.steps(
              'TBA',
              'Lists: Backspace delete inline tests',
