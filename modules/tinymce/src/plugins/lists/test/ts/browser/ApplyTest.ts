...
UnitTest.asynctest('tinymce.lists.browser.ApplyTest', (success, failure) => {
  ...
  suite.test('TestCase-TBA: Lists: Apply UL list to single P', function (
    editor
  ) {
  ...
  suite.test('TestCase-TBA: Lists: Apply UL list to single empty P', function (
    editor
  ) {
    editor.getBody().innerHTML = LegacyUnit.trimBrs('<p><br></p>');
    ...
    LegacyUnit.equal(
      LegacyUnit.trimBrs(editor.getContent({ format: 'raw' })),
      '<ul><li></li></ul>'
    );
    LegacyUnit.equal(editor.selection.getNode().nodeName, 'LI');
  });

  suite.test('TestCase-TBA: Lists: Apply UL list to multiple Ps', function (
    editor
  ) {
  ...
  suite.test('TestCase-TBA: Lists: Apply OL list to single P', function (
    editor
  ) {
    editor.getBody().innerHTML = LegacyUnit.trimBrs('<p>a</p>');
  ...
  suite.test('TestCase-TBA: Lists: Apply OL list to single empty P', function (
    editor
  ) {
    editor.getBody().innerHTML = LegacyUnit.trimBrs('<p><br></p>');
  ...
  suite.test('TestCase-TBA: Lists: Apply OL list to multiple Ps', function (
    editor
  ) {
    editor.getBody().innerHTML = LegacyUnit.trimBrs(
      '<p>a</p>' + '<p>b</p>' + '<p>c</p>'
  ...
  suite.test('Apply OL to UL list with collapsed selection', function (editor) {
    editor.getBody().innerHTML = LegacyUnit.trimBrs(
      '<ul>' + '<li>a</li>' + '<li>b</li>' + '<li>c</li>' + '</ul>'
    );
  ...
  suite.test(
    'TestCase-TBA: Lists: Apply UL to OL list collapsed selection',
    function (editor) {
      editor.getBody().innerHTML = LegacyUnit.trimBrs(
        '<ol>' + '<li>a</li>' + '<li>b</li>' + '<li>c</li>' + '</ol>'
      );
  ...
  suite.test(
    'TestCase-TBA: Lists: Apply UL to P and merge with adjacent lists',
    function (editor) {
      editor.getBody().innerHTML = LegacyUnit.trimBrs(
        '<ul>' +
          '<li>a</li>' +
  ...
  suite.test(
    'TestCase-TBA: Lists: Apply UL to OL and merge with adjacent lists',
    function (editor) {
      editor.getBody().innerHTML = LegacyUnit.trimBrs(
        '<ul>' +
          '<li>a</li>' +
  ...
  suite.test(
    'TestCase-TBA: Lists: Apply OL to P and merge with adjacent lists',
    function (editor) {
      editor.getBody().innerHTML = LegacyUnit.trimBrs(
        '<ol>' +
          '<li>a</li>' +
  ...
  suite.test(
    'TestCase-TBA: Lists: Apply OL to UL and merge with adjacent lists',
    function (editor) {
      editor.getBody().innerHTML = LegacyUnit.trimBrs(
        '<ol>' +
          '<li>1a</li>' +
  ...
  suite.test(
    ...
    function (editor) {
      ...
      editor.focus();
      LegacyUnit.setSelection(editor, 'ul li', 1);
      LegacyUnit.execCommand(editor, 'InsertOrderedList', null, {
  ...
  suite.test(
    ...
    function (editor) {
      ...
      editor.focus();
      LegacyUnit.setSelection(editor, 'ul li', 1);
      LegacyUnit.execCommand(editor, 'InsertOrderedList', false, {
  ...
  suite.test(
    'TestCase-TBA: Lists: Apply UL list to single text line',
    function (editor) {
  ...
  suite.test(
    'TestCase-TBA: Lists: Apply UL list to single text line with BR',
    function (editor) {
      editor.settings.forced_root_block = false;

      editor.getBody().innerHTML = 'a<br>';
  ...
  suite.test(
    'TestCase-TBA: Lists: Apply UL list to multiple lines separated by BR',
    function (editor) {
      editor.settings.forced_root_block = false;

      editor.getBody().innerHTML = 'a<br>' + 'b<br>' + 'c';
  ...
  suite.test(
    ...
    function (editor) {
      ...
      editor.getBody().innerHTML = 'a<br>' + 'b<br>' + 'c<br>';
  ...
  suite.test(
    'TestCase-TBA: Lists: Apply UL list to multiple formatted lines separated by BR',
    function (editor) {
      editor.settings.forced_root_block = false;

      editor.getBody().innerHTML =
        '<strong>a</strong><br>' + '<span>b</span><br>' + '<em>c</em>';
      ...
      LegacyUnit.equal(
        ...
        Env.ie && Env.ie < 9 ? 'LI' : 'EM'
      );
    }
  );

  suite.test(
    'TestCase-TBA: Lists: Apply UL list to br line and text block line',
    function (editor) {
      editor.settings.forced_root_block = false;

      editor.setContent('a' + '<p>b</p>');
  ...
  suite.test(
    'TestCase-TBA: Lists: Apply UL list to text block line and br line',
    function (editor) {
      editor.settings.forced_root_block = false;

      editor.getBody().innerHTML = '<p>a</p>' + 'b';
  ...
  suite.test(
    'TestCase-TBA: Lists: Apply UL list to all BR lines (SelectAll)',
    function (editor) {
      editor.settings.forced_root_block = false;
  ...
  suite.test(
    'TestCase-TBA: Lists: Apply UL list to all P lines (SelectAll)',
    function (editor) {
      editor.getBody().innerHTML = '<p>a</p>' + '<p>b</p>' + '<p>c</p>';
  ...
  suite.test(
    'TestCase-TBA: Lists: Apply UL list to more than two paragraphs',
    function (editor) {
      editor.getBody().innerHTML = LegacyUnit.trimBrs(
        '<p>a</p>' + '<p>b</p>' + '<p>c</p>'
      );
  ...
  suite.test('TestCase-TBA: Lists: Apply UL with custom attributes', function (
    editor
  ) {
    editor.getBody().innerHTML = LegacyUnit.trimBrs('<p>a</p>');
    ...
    LegacyUnit.equal(
      editor.getContent(),
      '<ul class="a" data-custom="c1"><li>a</li></ul>'
    );
  });

  suite.test(
    'TestCase-TBA: Lists: Apply UL and LI with custom attributes',
    function (editor) {
      editor.getBody().innerHTML = LegacyUnit.trimBrs('<p>a</p>');
  ...
  suite.test(
    'TestCase-TBA: Lists: Handle one empty unordered list items without error',
    function (editor) {
      editor.getBody().innerHTML =
      ...
      LegacyUnit.equal(
        editor.getBody().innerHTML,
        '<p>a</p>' + '<p>b</p>' + '<p><br data-mce-bogus="1"></p>'
      );
    }
  );

  suite.test(
    'TestCase-TBA: Lists: Handle several empty unordered list items without error',
    function (editor) {
      editor.getBody().innerHTML =
        '<ul>' +
        '<li>a</li>' +
  ...
  suite.test(
    'TestCase-TBA: Lists: Handle one empty ordered list items without error',
    function (editor) {
      editor.getBody().innerHTML =
  ...
  suite.test(
    'TestCase-TBA: Lists: Handle several empty ordered list items without error',
    function (editor) {
      editor.getBody().innerHTML =
        '<ol>' +
        '<li>a</li>' +
  ...
  suite.test(
    'TestCase-TBA: Lists: Apply list on paragraphs with list between',
    function (editor) {
      editor.getBody().innerHTML =
  ...
  suite.test(
    'TestCase-TBA: Lists: Apply unordered list on children on a fully selected ordered list',
    function (editor) {
      editor.getBody().innerHTML =
        '<ol>' +
        '<li>a' +
  ...
  suite.test(
    'TestCase-TBA: Lists: Apply unordered list on empty table cell',
    function (editor) {
      editor.getBody().innerHTML =
        '<table>' +
        '<tbody>' +
      ...
      LegacyUnit.equal(
        editor.getBody().innerHTML,
        '<table><tbody><tr><td><ul><li><br></li></ul></td></tr></tbody></table>'
      );
    }
  );

  suite.test(
    'TestCase-TBA: Lists: Apply unordered list on table cell with two lines br',
    function (editor) {
      editor.getBody().innerHTML =
        '<table>' +
        '<tbody>' +
      ...
      LegacyUnit.equal(
        editor.getBody().innerHTML,
        '<table><tbody><tr><td><ul><li>a</li></ul>b</td></tr></tbody></table>'
      );
    }
  );

  suite.test(
    'TestCase-TBA: Lists: Apply UL list to single P with forced_root_block_attrs',
    function (editor) {
      editor.settings.forced_root_block = 'p';
  ...
  TinyLoader.setupLight(
    function (editor, onSuccess, onFailure) {
      Pipeline.async(
        {},
        Log.steps('TBA', 'Lists: Apply list tests', suite.toSteps(editor)),
        onSuccess,
        onFailure
      );
    },
