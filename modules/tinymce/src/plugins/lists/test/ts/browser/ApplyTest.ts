...
UnitTest.asynctest('tinymce.lists.browser.ApplyTest', (success, failure) => {
  ...
  suite.test('TestCase-TBA: Lists: Apply UL list to multiple Ps', function (editor) {
    editor.getBody().innerHTML = LegacyUnit.trimBrs('<p>a</p>' + '<p>b</p>' + '<p>c</p>');
  ...
  suite.test('TestCase-TBA: Lists: Apply OL list to multiple Ps', function (editor) {
    ...
    LegacyUnit.equal(editor.getContent(), '<ol>' + '<li>a</li>' + '<li>b</li>' + '<li>c</li>' + '</ol>');
    LegacyUnit.equal(editor.selection.getStart().nodeName, 'LI');
  });

  suite.test('TestCase-TBA: Lists: Apply OL to UL list', function (editor) {
    editor.getBody().innerHTML = LegacyUnit.trimBrs('<ul>' + '<li>a</li>' + '<li>b</li>' + '<li>c</li>' + '</ul>');
  ...
  suite.test('TestCase-TBA: Lists: Apply UL to OL list', function (editor) {
    editor.getBody().innerHTML = LegacyUnit.trimBrs('<ol>' + '<li>a</li>' + '<li>b</li>' + '<li>c</li>' + '</ol>');
  ...
  suite.test('TestCase-TBA: Lists: Apply UL to P and merge with adjacent lists', function (editor) {
    editor.getBody().innerHTML = LegacyUnit.trimBrs('<ul>' + '<li>a</li>' + '</ul>' + '<p>b</p>' + '<ul>' + '<li>c</li>' + '</ul>');
  ...
  suite.test('TestCase-TBA: Lists: Apply OL to P and merge with adjacent lists', function (editor) {
    editor.getBody().innerHTML = LegacyUnit.trimBrs('<ol>' + '<li>a</li>' + '</ol>' + '<p>b</p>' + '<ol>' + '<li>c</li>' + '</ol>');
  ...
  suite.test('TestCase-TBA: Lists: Apply OL to UL and merge with adjacent lists', function (editor) {
    ...
    LegacyUnit.equal(
      editor.getContent(),
      '<ol>' + '<li>1a</li>' + '<li>1b</li>' + '<li>2a</li>' + '<li>2b</li>' + '<li>3a</li>' + '<li>3b</li>' + '</ol>'
    );
    LegacyUnit.equal(editor.selection.getStart().nodeName, 'LI');
  });

  suite.test('Apply OL to UL and DO not merge with adjacent lists because styles are different (exec has style)', function (editor) {
    editor.getBody().innerHTML = LegacyUnit.trimBrs(
    ...
    LegacyUnit.equal(
      editor.getContent(),
      '<ol>' + '<li>a</li>' + '</ol>' + '<ol style="list-style-type: lower-alpha;"><li>b</li></ol>' + '<ol>' + '<li>c</li>' + '</ol>'
    );
    LegacyUnit.equal(editor.selection.getStart().nodeName, 'LI');
  });

  suite.test('Apply OL to P and DO not merge with adjacent lists because styles are different (exec has style)', function (editor) {
    editor.getBody().innerHTML = LegacyUnit.trimBrs('<ol>' + '<li>a</li>' + '</ol>' + '<p>b</p>' + '<ol>' + '<li>c</li>' + '</ol>');
  ...
  suite.test('Apply OL to UL and DO not merge with adjacent lists because styles are different (original has style)', function (editor) {
    editor.getBody().innerHTML = LegacyUnit.trimBrs(
  ...
  suite.test('Apply OL to UL should merge with adjacent lists because styles are the same (both have roman)', function (editor) {
    editor.getBody().innerHTML = LegacyUnit.trimBrs(
      '<ol style="list-style-type: upper-roman;">' +
        '<li>a</li>' +
        '</ol>' +
    ...
    LegacyUnit.equal(
      editor.getContent(),
      '<ol style="list-style-type: upper-roman;">' + '<li>a</li>' + '<li>b</li>' + '<li>c</li>' + '</ol>'
    );
    LegacyUnit.equal(editor.selection.getStart().nodeName, 'LI');
  });
  ...
  suite.test('Apply OL to UL should merge with below lists because styles are the same (both have roman), but not above list', function (
    editor
  ) {
    editor.getBody().innerHTML = LegacyUnit.trimBrs(
      '<ol style="list-style-type: upper-roman;">' +
  ...
  suite.test('Apply OL to UL and DO not merge with adjacent lists because classes are different', function (editor) {
    editor.getBody().innerHTML = LegacyUnit.trimBrs(
      '<ol class="a">' + '<li>a</li>' + '</ol>' + '<ul><li>b</li></ul>' + '<ol class="b">' + '<li>c</li>' + '</ol>'
    );
    ...
    LegacyUnit.equal(
      editor.getContent(),
      '<ol class="a">' + '<li>a</li>' + '</ol>' + '<ol><li>b</li></ol>' + '<ol class="b">' + '<li>c</li>' + '</ol>'
    );
    LegacyUnit.equal(editor.selection.getStart().nodeName, 'LI');
  });
  ...
  suite.test('Apply UL list to multiple lines separated by BR and with trailing BR', function (editor) {
    editor.settings.forced_root_block = false;
  ...
  suite.test('TestCase-TBA: Lists: Apply UL list to multiple formatted lines separated by BR', function (editor) {
    ...
    editor.getBody().innerHTML = '<strong>a</strong><br>' + '<span>b</span><br>' + '<em>c</em>';
    ...
    LegacyUnit.equal(
      editor.getContent(),
      '<ul>' + '<li><strong>a</strong></li>' + '<li><span>b</span></li>' + '<li><em>c</em></li>' + '</ul>'
    );
  ...
  suite.test('TestCase-TBA: Lists: Apply UL list to br line and text block line', function (editor) {
    ...
    LegacyUnit.equal(editor.getContent(), '<ul>' + '<li>a</li>' + '<li>b</li>' + '</ul>');
  ...
  suite.test('TestCase-TBA: Lists: Handle one empty unordered list items without error', function (editor) {
    editor.getBody().innerHTML = '<ul>' + '<li>a</li>' + '<li>b</li>' + '<li></li>' + '</ul>';

    editor.execCommand('SelectAll');
    LegacyUnit.setSelection(editor, 'li:first', 0, 'li:last', 0);
    LegacyUnit.execCommand(editor, 'InsertUnorderedList');

    LegacyUnit.equal(editor.getBody().innerHTML, '<p>a</p>' + '<p>b</p>' + '<p><br data-mce-bogus="1"></p>');
  });

  suite.test('TestCase-TBA: Lists: Handle several empty unordered list items without error', function (editor) {
    editor.getBody().innerHTML =
      '<ul>' + '<li>a</li>' + '<li>b</li>' + '<li></li>' + '<li>c</li>' + '<li></li>' + '<li>d</li>' + '<li></li>' + '<li>e</li>' + '</ul>';
  ...
  suite.test('TestCase-TBA: Lists: Handle one empty ordered list items without error', function (editor) {
    editor.getBody().innerHTML = '<ol>' + '<li>a</li>' + '<li>b</li>' + '<li></li>' + '</ol>';
  ...
  suite.test('TestCase-TBA: Lists: Handle several empty ordered list items without error', function (editor) {
    editor.getBody().innerHTML =
      '<ol>' + '<li>a</li>' + '<li>b</li>' + '<li></li>' + '<li>c</li>' + '<li></li>' + '<li>d</li>' + '<li></li>' + '<li>e</li>' + '</ol>';
  ...
  suite.test('TestCase-TBA: Lists: Apply list on paragraphs with list between', function (editor) {
    editor.getBody().innerHTML = '<p>a</p>' + '<ol>' + '<li>b</li>' + '</ol>' + '<p>c</p>';
  ...
  suite.test('TestCase-TBA: Lists: Apply unordered list on children on a fully selected ordered list', function (editor) {
    editor.getBody().innerHTML = '<ol>' + '<li>a' + '<ol>' + '<li>b</li>' + '</ol>' + '</li>' + '<li>c</li>' + '</ol>';
  ...
  suite.test('TestCase-TBA: Lists: Apply unordered list on empty table cell', function (editor) {
    editor.getBody().innerHTML = '<table>' + '<tbody>' + '<tr>' + '<td>' + '<br />' + '</td>' + '</tr>' + '</tbody>' + '</table>';
  ...
  suite.test('TestCase-TBA: Lists: Apply unordered list on table cell with two lines br', function (editor) {
    editor.getBody().innerHTML = '<table>' + '<tbody>' + '<tr>' + '<td>' + 'a<br>b' + '</td>' + '</tr>' + '</tbody>' + '</table>';
  ...
  suite.test('TestCase-TBA: Lists: Apply UL list to single P with forced_root_block_attrs', function (editor) {
    ...
    editor.getBody().innerHTML = LegacyUnit.trimBrs('<p data-editor="1">a</p>');
