...
UnitTest.asynctest('tinymce.lists.browser.OutdentTest', (success, failure) => {
  ...
  suite.test(
    'TestCase-TBA: Lists: Outdent inside LI in beginning of OL in LI',
    function (editor) {
  ...
  suite.test(
    'TestCase-TBA: Lists: Outdent inside LI in middle of OL in LI',
    function (editor) {
      editor.getBody().innerHTML = LegacyUnit.trimBrs(
        '<ol>' +
          '<li>a' +
  ...
  suite.test(
    'TestCase-TBA: Lists: Outdent inside LI in end of OL in LI',
    function (editor) {
      editor.getBody().innerHTML = LegacyUnit.trimBrs(
        '<ol>' +
          '<li>a' +
  ...
  suite.test(
    'TestCase-TBA: Lists: Outdent inside LI in beginning of OL in OL',
    function (editor) {
      editor.getBody().innerHTML = LegacyUnit.trimBrs(
        '<ol>' +
          '<li>a</li>' +
  ...
  suite.test(
    'TestCase-TBA: Lists: Outdent inside LI in middle of OL in OL',
    function (editor) {
      editor.getBody().innerHTML = LegacyUnit.trimBrs(
        '<ol>' +
          '<li>a</li>' +
  ...
  suite.test(
    'TestCase-TBA: Lists: Outdent inside first/last LI in inner OL',
    function (editor) {
      editor.getBody().innerHTML = LegacyUnit.trimBrs(
        '<ol>' +
          '<li>1' +
      ...
      LegacyUnit.setSelection(
        editor,
        'ol ol li:nth-child(1)',
        0,
        'ol ol li:nth-child(2)',
        1
      );
      LegacyUnit.execCommand(editor, 'Outdent');
  ...
  suite.test(
    'TestCase-TBA: Lists: Outdent inside first LI in inner OL where OL is single child of parent LI',
    function (editor) {
      editor.getBody().innerHTML = LegacyUnit.trimBrs(
        '<ol>' +
          '<li>a</li>' +
  ...
  suite.test(
    'TestCase-TBA: Lists: Outdent inside LI in end of OL in OL',
    function (editor) {
      editor.getBody().innerHTML = LegacyUnit.trimBrs(
        '<ol>' +
          '<li>a</li>' +
  ...
  suite.test(
    'TestCase-TBA: Lists: Outdent inside only child LI in OL in OL',
    function (editor) {
      editor.getBody().innerHTML = LegacyUnit.trimBrs(
  ...
  suite.test(
    'TestCase-TBA: Lists: Outdent multiple LI in OL and nested OL',
    function (editor) {
      editor.getBody().innerHTML = LegacyUnit.trimBrs(
        '<ol>' + '<li>a' + '<ol>' + '<li>b</li>' + '</ol>' + '</li>' + '</ol>'
      );
  ...
  suite.test(
    'TestCase-TBA: Lists: Outdent on li with inner block element',
    function (editor) {
      editor.getBody().innerHTML = LegacyUnit.trimBrs(
        '<ul>' +
          '<li><p>a</p></li>' +
  ...
  suite.test(
    'TestCase-TBA: Lists: Outdent on nested li with inner block element',
    function (editor) {
      editor.getBody().innerHTML = LegacyUnit.trimBrs(
        '<ul>' +
          '<li>' +
  ...
  suite.test('Outdenting an item should not affect its attributes', function (
    editor
  ) {
    editor.getBody().innerHTML = LegacyUnit.trimBrs(
      '<ul>' +
  ...
  TinyLoader.setupLight(
    function (editor, onSuccess, onFailure) {
      Pipeline.async(
        {},
        Log.steps('TBA', 'Lists: Outdent tests', suite.toSteps(editor)),
        onSuccess,
        onFailure
      );
    },
