...
UnitTest.asynctest('tinymce.lists.browser.OutdentTest', (success, failure) => {
  ...
  suite.test('TestCase-TBA: Lists: Outdent inside LI in beginning of OL in LI', function (editor) {
    editor.getBody().innerHTML = LegacyUnit.trimBrs('<ol>' + '<li>a' + '<ol>' + '<li>b</li>' + '<li>c</li>' + '</ol>' + '</li>' + '</ol>');

    editor.focus();
    LegacyUnit.setSelection(editor, 'li li', 1);
    LegacyUnit.execCommand(editor, 'Outdent');

    LegacyUnit.equal(editor.getContent(), '<ol>' + '<li>a</li>' + '<li>b' + '<ol>' + '<li>c</li>' + '</ol>' + '</li>' + '</ol>');
  ...
  suite.test('TestCase-TBA: Lists: Outdent inside LI in middle of OL in LI', function (editor) {
    editor.getBody().innerHTML = LegacyUnit.trimBrs(
      '<ol>' + '<li>a' + '<ol>' + '<li>b</li>' + '<li>c</li>' + '<li>d</li>' + '</ol>' + '</li>' + '</ol>'
    );
    ...
    LegacyUnit.equal(
      editor.getContent(),
      '<ol>' + '<li>a' + '<ol>' + '<li>b</li>' + '</ol>' + '</li>' + '<li>c' + '<ol>' + '<li>d</li>' + '</ol>' + '</li>' + '</ol>'
    );
  ...
  suite.test('TestCase-TBA: Lists: Outdent inside LI in beginning of OL in OL', function (editor) {
    editor.getBody().innerHTML = LegacyUnit.trimBrs('<ol>' + '<li>a</li>' + '<ol>' + '<li>b</li>' + '<li>c</li>' + '</ol>' + '</ol>');
  ...
  suite.test('TestCase-TBA: Lists: Outdent inside LI in middle of OL in OL', function (editor) {
    editor.getBody().innerHTML = LegacyUnit.trimBrs(
      '<ol>' + '<li>a</li>' + '<ol>' + '<li>b</li>' + '<li>c</li>' + '<li>d</li>' + '</ol>' + '</ol>'
    );
  ...
  suite.test('TestCase-TBA: Lists: Outdent inside first/last LI in inner OL', function (editor) {
    editor.getBody().innerHTML = LegacyUnit.trimBrs(
      '<ol>' + '<li>1' + '<ol>' + '<li>2</li>' + '<li>3</li>' + '</ol>' + '</li>' + '<li>4</li>' + '</ol>'
    );
    ...
    LegacyUnit.equal(editor.getContent(), '<ol>' + '<li>1</li>' + '<li>2</li>' + '<li>3</li>' + '<li>4</li>' + '</ol>');
  ...
  suite.test('TestCase-TBA: Lists: Outdent inside first LI in inner OL where OL is single child of parent LI', function (editor) {
    editor.getBody().innerHTML = LegacyUnit.trimBrs(
      '<ol>' + '<li>a</li>' + '<li>' + '<ol>' + '<li>b</li>' + '<li>c</li>' + '</ol>' + '</li>' + '</ol>'
    );
  ...
  suite.test('TestCase-TBA: Lists: Outdent inside only child LI in OL in OL', function (editor) {
    ...
    LegacyUnit.equal(editor.getContent(), '<ol>' + '<li>a</li>' + '<li>b</li>' + '</ol>');
  ...
  suite.test('TestCase-TBA: Lists: Outdent multiple LI in OL and nested OL', function (editor) {
    ...
    LegacyUnit.equal(editor.getContent(), '<p>a</p>' + '<ol>' + '<li>b</li>' + '</ol>');
  });
  ...
  suite.test('TestCase-TBA: Lists: Outdent on li with inner block element', function (editor) {
    ...
    LegacyUnit.equal(editor.getContent(), '<ul>' + '<li><p>a</p></li>' + '</ul>' + '<p>b</p>' + '<ul>' + '<li><p>c</p></li>' + '</ul>');
  });
  ...
  suite.test('TestCase-TBA: Lists: Outdent on nested li with inner block element', function (editor) {
    ...
    LegacyUnit.equal(editor.getContent(), '<ul>' + '<li><p>a</p></li>' + '<li><p>b</p></li>' + '<li><p>c</p></li>' + '</ul>');
  });

  suite.test('Outdent nested ul in ol', function (editor) {
    editor.getBody().innerHTML = LegacyUnit.trimBrs(
      '<ol>' + '<li style="list-style-type: none;">' + '<ul>' + '<li>a</li>' + '</ul>' + '</li>' + '</ol>'
    );
  ...
  suite.test('Outdenting an item should not affect its attributes', function (editor) {
    editor.getBody().innerHTML = LegacyUnit.trimBrs(
      '<ul>' + '<li style="color: red;" class="xyz">a' + '<ul>' + '<li style="color: blue;">b</li>' + '</ul>' + '</li>' + '</ul>'
    );
    ...
    LegacyUnit.equal(
      editor.getContent(),
      '<ul>' + '<li style="color: red;" class="xyz">a</li>' + '<li style="color: blue;">b</li>' + '</ul>'
    );
  });
