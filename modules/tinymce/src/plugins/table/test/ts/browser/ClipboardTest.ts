...
UnitTest.asynctest(
  ...
  (success, failure) => {
    ...
    suite.test(
      'TestCase-TBA: Table: mceTablePasteRowBefore command',
      (editor) => {
        editor.focus();
        editor.setContent(
          '<table>' +
    ...
    suite.test(
      'TestCase-TBA: Table: mceTablePasteRowAfter command',
      (editor) => {
        editor.setContent(
          '<table>' +
            '<tr><td>1</td><td>2</td></tr>' +
    ...
    suite.test(
      'TestCase-TBA: Table: mceTablePasteRowAfter command with thead and tfoot',
      (editor) => {
        editor.setContent(
          '<table>' +
            '<thead>' +
    ...
    suite.test(
      'TestCase-TBA: Table: mceTablePasteRowAfter from merged row source',
      (editor) => {
        editor.setContent(
          '<table>' +
            '<tbody>' +
    ...
    suite.test(
      'TestCase-TBA: Table: mceTablePasteRowAfter from merged row source to merged row target',
      (editor) => {
        editor.setContent(
          '<table>' +
            '<tbody>' +
    ...
    suite.test(
      'TestCase-TBA: Table: mceTablePasteRowAfter to wider table',
      (editor) => {
        editor.setContent(
          '<table>' +
            '<tbody>' +
    ...
    suite.test(
      'TestCase-TBA: Table: mceTablePasteRowAfter to narrower table',
      (editor) => {
        editor.setContent(
          '<table>' +
            '<tbody>' +
        ...
        selectRangeXY(
          ...
          'table:nth-child(1) tr:nth-child(2) td:nth-child(3)'
        );
        editor.execCommand('mceTableCopyRow');
    ...
    suite.test(
      'TestCase-TBA: Table: Copy/paste several rows with multiple rowspans',
      (editor) => {
        editor.setContent(
          '<table>' +
            '<tbody>' +
    ...
    suite.test('TestCase-TBA: Table: row clipboard api', (editor) => {
      ...
      editor.plugins.table.setClipboardRows(
        clipboardRows.concat([createRow(['a', 'b']), createRow(['c', 'd'])])
      );
    ...
    TinyLoader.setupLight(
      (editor, onSuccess, onFailure) => {
        Pipeline.async(
          {},
          Log.steps('TBA', 'Table: Test Clipboard', suite.toSteps(editor)),
          onSuccess,
          onFailure
        );
      },
