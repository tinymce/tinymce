...
UnitTest.asynctest(
  ...
  (success, failure) => {
    ...
    suite.test('TestCase-TBA: Table: mceTableInsertColAfter command', function (
      editor
    ) {
      editor.focus();
      editor.setContent(
    ...
    suite.test(
      'TestCase-TBA: Table: mceTableInsertColAfter command with two selected columns',
      function (editor) {
    ...
    suite.test(
      'TestCase-TBA: Table: mceTableInsertColBefore command',
      function (editor) {
        editor.setContent(
          '<table><tr><td>1</td></tr><tr><td>2</td></tr></table>'
        );
    ...
    suite.test(
      'TestCase-TBA: Table: mceTableInsertColBefore command with two selected columns',
      function (editor) {
        editor.getBody().innerHTML =
    ...
    suite.test('TestCase-TBA: Table: mceTableInsertRowAfter command', function (
      editor
    ) {
    ...
    suite.test(
      'TestCase-TBA: Table: mceTableInsertRowAfter command with two selected rows',
      function (editor) {
        editor.getBody().innerHTML =
    ...
    suite.test(
      'TestCase-TBA: Table: mceTableInsertRowAfter command on merged cells',
      function (editor) {
        editor.setContent(
          '<table>' +
    ...
    suite.test(
      'TestCase-TBA: Table: mceTableInsertRowBefore command',
      function (editor) {
        editor.setContent('<table><tr><td>1</td><td>2</td></tr></table>');
        LegacyUnit.setSelection(editor, 'td', 0);
    ...
    suite.test(
      'TestCase-TBA: Table: mceTableInsertRowBefore command with two selected rows',
      function (editor) {
        editor.getBody().innerHTML =
          '<table><tr><td data-mce-selected="1">1</td><td>2</td></tr><tr><td data-mce-selected="1">3</td><td>4</td></tr></table>';
        LegacyUnit.setSelection(editor, 'tr', 0);
