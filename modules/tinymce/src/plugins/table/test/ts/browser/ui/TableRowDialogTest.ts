  ...
  (success, failure) => {
    ...
    TinyLoader.setupLight(
      (editor, onSuccess, onFailure) => {
        ...
        const baseHtml =
          '<table style="border: 1px solid black; border-collapse: collapse;" border="1"><tr><td>X</td></tr></table>';
        ...
        const advHtml =
          '<table style="border: 1px solid black; border-collapse: collapse;" border="1"><thead>' +
        ...
        const baseGetTest = () =>
          Log.stepsAsStep(
            'TBA',
            'Table: Table row properties dialog (get data from plain cell)',
            [
              tinyApis.sSetSetting('table_row_advtab', false),
              UiFinder.sWaitForVisible(
                'waiting for editor',
                Element.fromDom(document.body),
                'div.tox-tinymce'
              ),
        ...
        const baseGetSetTest = () =>
          Log.stepsAsStep(
            'TBA',
            'Table: Table row properties dialog (update all)',
            [
              UiFinder.sWaitForVisible(
                'waiting for editor',
                Element.fromDom(document.body),
              ...
              tinyApis.sAssertContent(
                '<table style="border: 1px solid black; border-collapse: collapse;" border="1"><thead><tr style="height: 10px; text-align: right;"><td>X</td></tr></thead></table>'
              )
            ]
          );
        ...
        const captionTest = () =>
          Log.stepsAsStep(
            'TBA',
            'Table: Caption should always stay the firstChild of the table (see TINY-1167)',
            [
              tinyApis.sSetContent(
                '<table><caption>CAPTION</caption><tbody><tr><td>X</td></tr><tr><td>Y</td></tr></tbody></table>'
              ),
              tinyApis.sSelect('td', [0]),
              TableTestUtils.sOpenTableDialog(tinyUi),
        ...
        const advGetTest = () =>
          Log.stepsAsStep(
            'TBA',
            'Table: Table row properties dialog (get data from complex row)',
            [
        ...
        const advGetSetTest = () =>
          Log.stepsAsStep(
            'TBA',
            'Table: Update advanced styles from row properties dialog',
            [
              UiFinder.sWaitForVisible(
                'waiting for editor',
                Element.fromDom(document.body),
        ...
        const advRemoveTest = () =>
          Log.stepsAsStep(
            'TBA',
            'Table: Remove all advanced styles through the style field',
            [
              tinyApis.sSetContent(advHtml),
        ...
        const multiUpdateTest = () => {
          ...
          return Log.stepsAsStep(
            'TBA',
            'Table: Table row properties dialog update multiple rows',
            [
        ...
        const changeHeaderToBodyTest = () => {
          const initialHtml =
            '<table style="border: 1px solid black; border-collapse: collapse;" border="1"><thead><tr><td>X</td></tr></thead><tbody><tr><td>Y</td></tr></tbody></table>';
          const expectedHtml =
            '<table style="border: 1px solid black; border-collapse: collapse;" border="1"><tbody><tr><td>X</td></tr><tr><td>Y</td></tr></tbody></table>';
          ...
          return Log.stepsAsStep(
            'TBA',
            'Table: Change table row type from header to body',
            [
              tinyApis.sSetContent(initialHtml),
