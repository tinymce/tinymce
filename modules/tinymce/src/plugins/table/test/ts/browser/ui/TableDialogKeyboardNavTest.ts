...
UnitTest.asynctest(
  'browser.tinymce.plugins.table.TableDialogKeyboardNavTest',
  (success, failure) => {
    Plugin();
    SilverTheme();
    ...
    TinyLoader.setupLight(
      (editor, onSuccess, onFailure) => {
        ...
        Pipeline.async(
          ...
          Log.steps(
            'TBA',
            'Table: Open dialog, test the tab key navigation cycles through all focusable fields in General and Advanced tabs',
            [
              ...
              sAssertFocusOnItem(
                'General Tab',
                '.tox-dialog__body-nav-item:contains("General")'
              ),
              sPressTabKey,
              ...
              sAssertFocusOnItem(
                'Cell spacing',
                'label:contains("Cell spacing") + input'
              ),
              sPressTabKey,
              sAssertFocusOnItem(
                'Cell padding',
                'label:contains("Cell padding") + input'
              ),
              sPressTabKey,
              sAssertFocusOnItem(
                'Border width',
                'label:contains("Border width") + input'
              ),
              sPressTabKey,
              ...
              sAssertFocusOnItem(
                'Alignment',
                'label:contains("Alignment") + .tox-selectfield select'
              ),
              sPressTabKey,
              ...
              sAssertFocusOnItem(
                'Advanced Tab',
                '.tox-dialog__body-nav-item:contains("Advanced")'
              ),
              sPressTabKey,
              sAssertFocusOnItem(
                'Border style',
                'label:contains("Border style") + .tox-selectfield select'
              ),
              sPressTabKey,
              sAssertFocusOnItem(
                'Border color',
                '.tox-form div:nth-child(2) input'
              ),
              sPressTabKey,
              sAssertFocusOnItem(
                'Border colorpicker',
                '.tox-form div:nth-child(2) span'
              ),
              sPressTabKey,
              sAssertFocusOnItem(
                'Background color',
                '.tox-form div:nth-child(3) input'
              ),
              sPressTabKey,
              sAssertFocusOnItem(
                'Background colorpicker',
                '.tox-form div:nth-child(3) span'
              ),
              sPressTabKey,
              sAssertFocusOnItem('Cancel', '.tox-button:contains("Cancel")'),
              sPressTabKey,
