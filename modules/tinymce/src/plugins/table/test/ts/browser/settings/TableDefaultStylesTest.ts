        ...
        [
          Logger.t(
            ...
            GeneralSteps.sequence([
              ...
              Waiter.sTryUntil(
                'click table grid',
                tinyUi.sClickOnUi('click table grid', 'div.tox-insert-table-picker div[role="button"]:nth(0)')
              ), // button for 1x1 table
          ...
          Logger.t(
            'test default style border attribute',
            GeneralSteps.sequence([
              tinyApis.sFocus(),
              tinyApis.sSetSetting('table_default_styles', {
