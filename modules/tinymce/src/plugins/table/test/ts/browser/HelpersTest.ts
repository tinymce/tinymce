...
UnitTest.asynctest(
  'browser.tinymce.plugins.table.HelpersTest',
  (success, failure) => {
    Plugin();
    SilverTheme();
          ...
          [
            Log.stepsAsStep('TBA', 'Table: extractDataFromCellElement 1', [
              ...
              Chain.asStep(Element.fromDom(editor.getBody()), [
                ...
                Chain.op((td) => {
                  const cellData = Helpers.extractDataFromCellElement(
                    editor,
                    td.dom(),
                    true
                  );
                  ...
                  Assertions.assertEq(
                    'Extracts border-color',
                    '#d91111',
                    cellData.bordercolor
                  );
                  Assertions.assertEq(
                    'Extracts border-style',
                    'dashed',
                    cellData.borderstyle
                  );
                })
              ])
            ]),
            Log.stepsAsStep('TBA', 'Table: extractDataFromCellElement 2', [
              ...
              Chain.asStep(Element.fromDom(editor.getBody()), [
                ...
                Chain.op((td) => {
                  ...
                  Assertions.assertEq(
                    'Extracts width from style',
                    '20px',
                    cellData.width
                  );
                  Assertions.assertEq(
                    'Extracts height from style',
                    '30px',
                    cellData.height
                  );
                  Assertions.assertEq(
                    'Extracts background-color from rgb',
                    '#333333',
                    cellData.backgroundcolor
                  );
                  Assertions.assertEq(
                    'Extracts border-color from rgb',
                    '#d91111',
                    cellData.bordercolor
                  );
                })
            ...
            Log.stepsAsStep('TBA', 'Table: extractDataFromCellElement 2', [
              ...
              Chain.asStep(Element.fromDom(editor.getBody()), [
                ...
                Chain.op((td) => {
                  ...
                  Assertions.assertEq(
                    'Extracts border-color from shorthand',
                    '#008000',
                    cellData.bordercolor
                  );
                  Assertions.assertEq(
                    'Extracts border-style from shorthand',
                    'dashed',
                    cellData.borderstyle
                  );
                })
            ...
            Log.stepsAsStep('TBA', 'Table: extractDataFromRowElement', [
              ...
              Chain.asStep(Element.fromDom(editor.getBody()), [
                ...
                Chain.op((tr) => {
                  const rowData = Helpers.extractDataFromRowElement(
                    editor,
                    tr.dom(),
                    true
                  );
            ...
            Log.stepsAsStep('TBA', 'Table: extractDataFromTableElement 1', [
              ...
              Chain.asStep(Element.fromDom(editor.getBody()), [
                ...
                Chain.op((table) => {
                  const tableData = Helpers.extractDataFromTableElement(
                    editor,
                    table.dom(),
                    true
                  );
                  ...
                  Assertions.assertEq(
                    'Extracts cellspacing',
                    '1',
                    tableData.cellspacing
                  );
                  Assertions.assertEq(
                    'Extracts cellpadding',
                    '2',
                    tableData.cellpadding
                  );
                  Assertions.assertEq(
                    'Extracts caption',
                    true,
            ...
            Log.stepsAsStep(
              'TBA',
              'Table: extractDataFromTableElement 2 - right alignment',
              [
                tinyApis.sSetContent(
            ...
            Log.stepsAsStep(
              'TBA',
              'Table: extractDataFromTableElement 2 - left alignment',
              [
                tinyApis.sSetContent(
            ...
            Log.stepsAsStep(
              'TBA',
              'Table: extractDataFromTableElement 3 - border width from border-width style',
              [
            ...
            Log.stepsAsStep(
              'TBA',
              'Table: extractDataFromTableElement 4 - border width from border style',
              [
                tinyApis.sSetSetting('table_style_by_css', true),
                tinyApis.sSetContent(
            ...
            Log.stepsAsStep(
              'TBA',
              'Table: extractDataFromTableElement 5 - border width from border attr',
              [
            ...
            Log.stepsAsStep(
              'TBA',
              'Table: extractDataFromTableElement 6 - border width from children',
              [
                tinyApis.sSetSetting('table_style_by_css', false),
                tinyApis.sSetContent(
            ...
            Log.stepsAsStep(
              'TBA',
              'Table: extractDataFromTableElement 7 - border width, style and color from collapsed style',
              [
                tinyApis.sSetSetting('table_style_by_css', true),
                tinyApis.sSetContent(
                ...
                Chain.asStep(Element.fromDom(editor.getBody()), [
                  ...
                  Chain.op((table) => {
                    ...
                    Assertions.assertEq(
                      'Extracts border-style',
                      'double',
                      tableData.borderstyle
                    );
                    Assertions.assertEq(
                      'Extracts border-color',
                      'red',
                      tableData.bordercolor
                    );
                  })
                ])
              ]
