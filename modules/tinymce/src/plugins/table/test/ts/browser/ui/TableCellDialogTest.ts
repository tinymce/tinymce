...
UnitTest.asynctest(
  ...
  (success, failure) => {
    ...
    const generalSelectors = {
      ...
      celltype:
        'label.tox-label:contains(Cell type) + div.tox-selectfield>select',
    ...
    TinyLoader.setupLight(
      (editor, onSuccess, onFailure) => {
        ...
        const baseGetTest = () =>
          Log.stepsAsStep(
            'TBA',
            'Table: Table cell properties dialog (get data from basic cell)',
            [
        ...
        const baseGetSetTest = () =>
          Log.stepsAsStep(
            'TBA',
            'Table: Table cell properties dialog (get/set data from/to basic cell)',
            [
              tinyApis.sSetSetting('table_cell_advtab', false),
              tinyApis.sSetContent(baseHtml),
              tinyApis.sSelect('td', [0]),
              ...
              tinyApis.sAssertContent(
                '<table><tbody><tr><td style="width: 100px; height: 101px;">a</td><td>b</td></tr></tbody></table>'
              )
            ]
          );
        ...
        const advGetTest = () => {
          ...
          return Log.stepsAsStep(
            'TBA',
            'Table: Table cell properties dialog (get data from advanced cell)',
            [
        ...
        const advGetSetTest = () => {
          ...
          const advHtml =
            '<table><tbody><tr><th style="width: 10px; height: 11px; vertical-align: top; text-align: right; ' +
            'border-color: red; border-style: dashed; background-color: blue;" scope="row">X</th></tr></tbody></table>';

          return Log.stepsAsStep(
            'TBA',
            'Table: Table cell properties dialog (update all, including advanced)',
            [
              tinyApis.sSetSetting('table_cell_advtab', true),
        ...
        const multiUpdate = () => {
          ...
          return Log.stepsAsStep(
            'TBA',
            'Table: Table cell properties dialog update multiple cells',
            [
