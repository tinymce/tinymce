    ...
    testCommand(editor, 'mceTableMergeCells', [
      {
        ...
        after: '<table>' + '<tbody>' + '<tr><td>a1b1a2b2</td></tr>' + '</tbody>' + '</table>'
      },

      {
        ...
        after:
          '<table>' + '<tbody>' + '<tr><td colspan="2">a1b1a2b2</td></tr>' + '<tr><td>a3</td><td>b3</td></tr>' + '</tbody>' + '</table>'
      },

      {
        ...
        before:
          ...
          '</tbody>' +
          '</table>',
        after: '<table>' + '<tbody>' + '<tr><td>a1</td><td>b1b2</td></tr>' + '</tbody>' + '</table>'
      },

      {
        ...
        before:
          ...
          '</tbody>' +
          '</table>',
        after: '<table>' + '<tbody>' + '<tr><td>a1</td></tr>' + '<tr><td>a2b2</td></tr>' + '</tbody>' + '</table>'
      },

      {
        ...
        before:
          ...
          '</tbody>' +
          '</table>',
        after: '<table>' + '<tbody>' + '<tr><td>a1</td><td>b1</td><td>c1c2c3</td></tr>' + '</tbody>' + '</table>'
      },

      {
        ...
        before:
          ...
          '</table>',
        after:
          '<table>' + '<tbody>' + '<tr><td>a1b1c1</td></tr>' + '<tr><td>a2</td></tr>' + '<tr><td>a3</td></tr>' + '</tbody>' + '</table>'
      },
