...
UnitTest.asynctest(
  'browser.tinymce.plugins.anchor.AnchorContentEditableTest',
  (success, failure) => {
    AnchorPlugin();
    SilverTheme();
      ...
      (editor: Editor, onSuccess, onFailure) => {
        ...
        Pipeline.async(
          ...
          [
            Log.stepsAsStep(
              'TINY-2788',
              'Anchor: Add anchor without inner html, check contenteditable is false',
              [
            ...
            Log.stepsAsStep(
              'TINY-2788',
              'Anchor: Add anchor with inner html, check contenteditable is not present and inner html is present',
              [
