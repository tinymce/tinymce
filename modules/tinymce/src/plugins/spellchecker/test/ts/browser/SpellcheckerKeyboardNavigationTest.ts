    ...
    TinyLoader.setup(
      function (editor, onSuccess, onFailure) {
        ...
        Pipeline.async(
          ...
          Log.steps(
            'TBA',
            'Spellchecker: Reaching the spellchecker via the keyboard',
            [
              ...
              sPressDown,
              sAssertFocused(
                'Spellcheck tool menu item',
                '.tox-collection__item:contains("Spellcheck")'
              ...
              sAssertFocused(
                'First language',
                '.tox-collection__item:contains("English")'
              ) // Languages can be reached by keyboard
            ]
          ),
          onSuccess,
          onFailure
