...
UnitTest.test('atomic.core.UrlPatternsTest', function () {
  ...
  check('https://www.youtube.com/watch?v=b3XFjWInBog', 'https://www.youtube.com/embed/b3XFjWInBog');

  check('https://vimeo.com/12345', 'https://player.vimeo.com/video/12345?title=0&byline=0&portrait=0&color=8dc7dc');

  check('https://vimeo.com/channels/staffpicks/12345', 'https://player.vimeo.com/video/12345?title=0&amp;byline=0');

  check('http://www.dailymotion.com/video/x5iscr6', 'http://www.dailymotion.com/embed/video/x5iscr6');

  check('http://www.dai.ly/x5iscr6', 'http://www.dailymotion.com/embed/video/x5iscr6');
});
