...
describe('browser.tinymce.plugins.media.core.PlaceholderTest', () => {
  ...
  context('media_live_embeds=false', () => {
    ...
    it('TBA: Set and assert iframe placeholder structure', async () => pTestPlaceholder(hook.editor(),
    ...
    it('TBA: Set and assert video placeholder structure', async () => pTestPlaceholder(hook.editor(),
    ...
    it('TBA: Set and assert audio placeholder structure', async () => pTestPlaceholder(hook.editor(),
  ...
  context('media_live_embeds=true', () => {
    ...
    it('TBA: Set and assert live iframe embed structure', async () => pTestPlaceholder(hook.editor(),
      'https://www.youtube.com/watch?v=P_205ZY52pY',
      '<p><iframe src="https://www.youtube.com/embed/P_205ZY52pY" width="560" ' +
      'height="314" sandbox="" allowfullscreen="allowfullscreen"></iframe></p>',
