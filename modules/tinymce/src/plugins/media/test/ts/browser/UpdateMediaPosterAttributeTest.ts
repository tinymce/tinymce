...
UnitTest.asynctest(
  'browser.plugins.media.UpdateMediaPosterAttributeTest',
  (success, failure) => {
    Plugin();
    Theme();
    ...
    TinyLoader.setupLight(
      (editor, onSuccess, onFailure) => {
        ...
        const sOpenAdvTab = () =>
          GeneralSteps.sequence([
            ...
            ui.sClickOnUi(
              ...
              'div.tox-tab:contains(Advanced)'
            )
          ]);

        const sCloseDialog = ui.sClickOnUi(
          'Click Save',
        ...
        Pipeline.async(
          ...
          Log.steps(
            'TBA',
            'Media: Assert embed data of the video after updating dimensions and media poster value',
            [
