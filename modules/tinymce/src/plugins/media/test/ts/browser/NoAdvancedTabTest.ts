...
UnitTest.asynctest(
  'browser.tinymce.plugins.media.NoAdvancedTabTest',
  (success, failure) => {
    Plugin();
    Theme();
    ...
    Pipeline.async(
      ...
      [
        Log.chainsAsStep(
          'TBA',
          'Media: if alt source and poster set to false, do not show advance tab',
          [
            Chain.fromParent(
        ...
        Log.chainsAsStep(
          'TBA',
          'Media: if alt source and poster not set to false, show advance tab',
          [
            Chain.fromParent(
              Editor.cFromSettings({
                plugins: ['media'],
