        ...
        Pipeline.async(
          ...
          [
            ...
            Log.stepsAsStep('TBA', 'Media: test cached response', [
                ...
                Chain.fromParent(
                  ...
                  [
                    ...
                    Chain.runStepsOnValue(() => [
                      Utils.sAssertEmbedData(tinyUi, '<div>x</div>')
                    ]),
                    Chain.fromChains([Utils.cSetSourceInput(tinyUi, 'XXX')]),
                    Chain.fromChains([
              ...
              sWaitForAndAssertNotification(
                '<p>Media embed handler threw unknown error.</p>'
              ),
