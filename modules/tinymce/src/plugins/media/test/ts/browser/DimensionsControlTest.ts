  ...
  TinyLoader.setupLight(
    function (editor, onSuccess, onFailure) {
      ...
      Pipeline.async(
        ...
        Log.steps(
          'TBA',
          'Media: Open dialog, assert dimensions fields are not present while media_dimensions is false. Close dialog and assert dialog is not present',
          [
            Utils.sOpenDialog(ui),
            Chain.asStep({}, [
              Chain.fromParent(ui.cWaitForPopup('wait for popup', 'div.tox-dialog'), [
