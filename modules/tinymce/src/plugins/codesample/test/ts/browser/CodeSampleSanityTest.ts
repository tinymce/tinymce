      ...
      (editor, onSuccess, onFailure) => {
        ...
        Pipeline.async(
          ...
          [
            Log.stepsAsStep(
              'TBA',
              'CodeSample: Open the dialog and check it has the right initial values',
              [
                TestUtils.sOpenDialogAndAssertInitial(
                  editor,
                  docBody,
                  'markup',
                  ''
            ...
            Log.stepsAsStep(
              'TBA',
              'CodeSample: Set the codesample content, submit and check the editor content changes correctly',
              [
                TestUtils.sSetTextareaContent(markupContent),
                TestUtils.sSubmitDialog(docBody),
                TestUtils.sAssertEditorContents(
                  editorBody,
                  'markup',
                  markupContent,
                  'pre.language-markup'
            ...
            Log.stepsAsStep(
              'TBA',
              'CodeSample: Re-open the dialog and check the dialog language and content is correct - focus problems and make this fail',
              [
                TestUtils.sOpenDialogAndAssertInitial(
                  editor,
                  docBody,
            ...
            Log.stepsAsStep(
              'TBA',
              'CodeSample: Set the codesample content but CANCEL and check the editor content did not change',
              [
