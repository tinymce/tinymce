      ...
      function (editor, onSuccess, onFailure) {
        ...
        const steps = Env.browser.isIE()
          ...
          : [
              ...
              Log.stepsAsStep(
                'TBA',
                'AutoLink: Chrome adds a nbsp between link and text',
                [
                  tinyApis.sSetContent(
                    '<p><a href="http://www.domain.com">www.domain.com</a>&nbsp;www.domain.com</p>'
                  ),
                  ...
                  tinyApis.sAssertContent(
                    '<p><a href="http://www.domain.com">www.domain.com</a>&nbsp;<a href="http://www.domain.com">www.domain.com</a>&nbsp;</p>'
                  )
                ]
              ),
              Log.stepsAsStep(
                'TBA',
                'AutoLink: FireFox does not seem to add a nbsp between link and text',
                [
                  tinyApis.sSetContent(
                    '<p><a href="http://www.domain.com">www.domain.com</a> www.domain.com</p>'
                  ),
