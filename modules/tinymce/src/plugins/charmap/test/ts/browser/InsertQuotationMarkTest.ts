    ...
    TinyLoader.setupLight(
      function (editor, onSuccess, onFailure) {
        ...
        Pipeline.async(
          ...
          Log.steps(
            'TBA',
            'Charmap: Open dialog, click on the All tab and click on Quotation Mark and then assert Quotation Mark is inserted',
            [
              tinyApis.sFocus(),
              ...
              Chain.asStep({}, [
                Chain.fromParent(
                  ...
                  [
                    ...
                    Mouse.cClickOn(
                      '.tox-collection .tox-collection__item-icon:contains(")'
                    ) // Could not get span[data-glyph="\"""] or similar to work...
                  ]
                )
              ]),
