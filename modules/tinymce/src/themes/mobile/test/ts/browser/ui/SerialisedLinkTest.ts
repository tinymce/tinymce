...
UnitTest.asynctest('Browser Test: ui.SerialisedLinkTest', (success, failure) => {
          ...
          Assertions.assertStructure(
            ...
            ApproxStructure.build(function (s, str, arr) {
              return s.element('span', {
                ...
                classes: [(expected ? arr.not : arr.has)('tinymce-mobile-toolbar-navigation-disabled')]
              });
            }),
            button
          );
  ...
  const sClickNavigation = function (selector) {
    return Chain.asStep({}, [TestUi.cGetFocused, TestUi.cGetParent, TestUi.cGetParent, UiFinder.cFindIn(selector), Mouse.cClick]);
  };
