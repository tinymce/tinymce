...
UnitTest.asynctest('Editor resizing tests', function (success, failure) {
  ...
  const getDimensionsTests = Log.stepsAsStep('TBA', 'Check the correct dimensions are returned', [
    ...
    makeDimensionsTest('Height less than minimum, only vertical resize', -500, 0, ResizeTypes.Vertical, 500, {
      height: 400
    }),
    makeDimensionsTest('Height greater than maximum, only vertical resize', 500, 0, ResizeTypes.Vertical, 500, {
      height: 600
    }),
