          ...
          Pipeline.async(
            ...
            [
              ...
              Step.label(
                ...
                StickyUtils.sScrollAndAssertStructure(isToolbarTop, 1, StickyUtils.expectedScrollEventBound)
              ),
              Step.label(
              ...
              Step.label(
                ...
                StickyUtils.sScrollAndAssertStructure(isToolbarTop, 500, StickyUtils.expectedEditorHidden)
              ),
              StickyUtils.sAssertHeaderDocked(isToolbarTop),
              ...(toolbarMode === ToolbarMode.default
                ...
                : [
                    Step.label(
                      ...
                      GeneralSteps.sequence([MenuUtils.sOpenMore(toolbarMode), MenuUtils.sAssertMoreDrawerInViewport(toolbarMode)])
                    )
                  ]),
              ...
              Step.label(
                ...
                StickyUtils.sOpenMenuAndTestScrolling(MenuUtils.sOpenAlignMenu('open align'), 1, isToolbarTop)
              ),
              Step.label(
