...
const cOpen = <T>(editor: Editor, spec: Types.Dialog.DialogApi<T>, params: Record<string, any>) =>
...
const cClose = Chain.fromChainsWith(Body.body(), [Mouse.cClickOn('[aria-label="Close"]'), UiFinder.cNotExists('[role="dialog"]')]);
...
export { sOpen, sClose, cOpen, cOpenWithStore, cClose, sWaitForOpen };
