...
UnitTest.asynctest(
  'Silver fixed_toolbar_container test',
  (success, failure) => {
    SilverTheme();

    const toolbarContainer = Element.fromHtml(
      '<div id="toolbar" style="margin: 50px 0;"></div>'
    );
          ...
          s.element('div', {
            ...
            children: [
                            ...
                            children: [
                              s.element('button', {
                                ...
                                children: [
                                  s.element('span', {
                                    classes: [
                                      arr.has('tox-mbtn__select-label')
                                    ],
                                    html: str.is('File')
                                  }),
                                  s.element('div', {
                                    classes: [
                                      arr.has('tox-mbtn__select-chevron')
                                    ],
              ...
              s.element('div', {
                classes: [
                  arr.has('tox'),
                  arr.has('tox-silver-sink'),
                  arr.has('tox-tinymce-aux')
                ]
              })
            ]
          })
