      ...
      const cAssertEditorSize = (
        ...
        Chain.control(
          Chain.op((container: Element) => {
            Assertions.assertEq(
              `Editor should be ${expectedHeight}px high`,
              expectedHeight,
              container.dom().offsetHeight
            );
            Assertions.assertEq(
              `Editor should be ${expectedWidth}px wide`,
              expectedWidth,
      ...
      Pipeline.async(
        ...
        [
          Chain.asStep(Body.body(), [
            ...
            Chain.label(
              'Test resize with max/min sizing',
              NamedChain.asChain([
                NamedChain.direct(
                ...
                NamedChain.direct(
                  'body',
                  cResizeToPos(400, 400, 300, 300),
                  '_'
                ),
                NamedChain.direct(
                  'container',
                  cAssertEditorSize(300, 300),
                  '_'
                ),
                ...
                NamedChain.direct(
                  'body',
                  cResizeToPos(300, 300, 450, 450),
                  '_'
                ),
                NamedChain.direct(
                  'container',
                  cAssertEditorSize(450, 450),
                  '_'
                ),
                ...
                NamedChain.direct(
                  'body',
                  cResizeToPos(450, 450, 450, 250),
                  '_'
                ),
                NamedChain.direct(
                  'container',
                  cAssertEditorSize(450, 300),
                  '_'
                ),
                ...
                NamedChain.direct(
                  'body',
                  cResizeToPos(450, 300, 450, 550),
                  '_'
                ),
                NamedChain.direct(
                  'container',
                  cAssertEditorSize(450, 500),
                  '_'
                ),
                ...
                NamedChain.direct(
                  'body',
                  cResizeToPos(450, 500, 250, 500),
                  '_'
                ),
                NamedChain.direct(
                  'container',
                  cAssertEditorSize(300, 500),
                  '_'
                ),
