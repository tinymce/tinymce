...
UnitTest.asynctest('NotificationManagerImpl test', (success, failure) => {
  ...
  const cSetText = (text: string) =>
    Chain.op((notification: NotificationApi) => {
      notification.text(text);
    });

  const cSetProgress = (progress: number) =>
    Chain.op((notification: NotificationApi) => {
      notification.progressBar.value(progress);
    });

  const cAssertPosition = (
    prefix: string,
    x: number,
    y: number,
    diff: number = 5
    ...
    Chain.op((notification: NotificationApi) => {
      ...
      Assertions.assertEq(
        `${prefix} top position should be ${y}px~=${top}px`,
        true,
        Math.abs(y - top) < diff
      );
      Assertions.assertEq(
        `${prefix} left position should be ${x}px~=${left}px`,
        true,
        Math.abs(x - left) < diff
      );
    });
                ...
                children: [
                  ...
                  ...(progress !== undefined
                    ? [
                        s.element('div', {
                          classes: [
                            arr.has('tox-progress-bar'),
                            arr.has('tox-progress-indicator')
                          ],
                          children: [
                            s.element('div', {
        ...
        [
          Chain.control(
            NamedChain.asChain([
              NamedChain.write(
                'nError',
                cOpenNotification(editor, 'error', 'Message 1')
              ),
              NamedChain.write(
                'nWarn',
                cOpenNotification(editor, 'warning', 'Message 2')
              ),
              NamedChain.write(
                'nInfo',
                cOpenNotification(editor, 'info', 'Message 3')
              ),
              NamedChain.write(
                'nSuccess',
                cOpenNotification(editor, 'success', 'Message 4')
              ),
              ...
              NamedChain.direct(
                'nError',
                cAssertStructure(
                  'Check error notification structure',
                  'error',
                  'Message 1'
                ),
                '_'
              ...
              NamedChain.direct(
                'nWarn',
                cAssertStructure(
                  'Check warning notification structure',
                  'warning',
                  'Message 2'
                ),
                '_'
              ...
              NamedChain.direct(
                'nInfo',
                cAssertStructure(
                  'Check info notification structure',
                  'info',
                  'Message 3'
                ),
                '_'
              ...
              NamedChain.direct(
                'nSuccess',
                cAssertStructure(
                  'Check success notification structure',
                  'success',
                  'Message 4'
                ),
                '_'
              ...
              NamedChain.direct(
                'nError',
                cAssertPosition('Error notification', 220, -200),
                '_'
              ),
              NamedChain.direct(
                'nWarn',
                cAssertPosition('Warning notification', 220, -152),
                '_'
              ),
              NamedChain.direct(
                'nInfo',
                cAssertPosition('Info notification', 220, -104),
                '_'
              ),
              NamedChain.direct(
                'nSuccess',
                cAssertPosition('Success notification', 220, -56),
                '_'
              ),
              ...
              NamedChain.direct(
                'nWarn',
                cAssertPosition('Warning notification', 220, -200),
                '_'
              ),
              NamedChain.direct(
                'nInfo',
                cAssertPosition('Info notification', 220, -150),
                '_'
              ),
              NamedChain.direct(
                'nSuccess',
                cAssertPosition('Success notification', 220, -100),
                '_'
              ),
              ...
              NamedChain.direct(
                'nSuccess',
                cAssertPosition('Success notification', 220, -150),
                '_'
              ),
          ...
          Chain.control(
            Chain.fromChains([
              ...
              cAssertStructure(
                'Check initial notification structure',
                'success',
                'Message'
              ),
          ...
          Chain.control(
            Chain.fromChains([
              ...
              cSetProgress(50),
              cAssertStructure(
                'Check notification structure with 50% progress',
                'success',
                'Message',
                50
              ),
              cSetProgress(100),
              cAssertStructure(
                'Check notification structure with 100% progress',
                'success',
                'Message',
                100
              ),
        ...
        [
          Chain.control(
            NamedChain.asChain([
              ...
              NamedChain.direct(
                'nError',
                cAssertPosition('Error notification', 220, -399),
                '_'
              ),
              NamedChain.direct(
                'nWarn',
                cAssertPosition('Warning notification', 220, -351),
                '_'
              ),
              ...
              NamedChain.direct(
                'nError',
                cAssertPosition('Error notification', 220, -299),
                '_'
              ),
              NamedChain.direct(
                'nWarn',
                cAssertPosition('Warning notification', 220, -251),
                '_'
              ),
  ...
  Pipeline.async(
    {},
    [sNotificationTopStep, sNotificationBottomStep],
    success,
    failure
  );
});
