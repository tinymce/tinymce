...
UnitTest.asynctest('Statusbar Structure Test', (success, failure) => {
  ...
  Pipeline.async(
    ...
    [
      ...
      Log.step(
        'TBA',
        'Full statusbar - check element path on content change',
        Chain.asStep({}, [
                            ...
                            s.element('div', {
                              ...
                              children: [
                                s.element('div', {
                                  ...
                                  children: [
                                    s.element('div', {
                                      children: [s.text(str.is('p'))]
                                    }),
                                    s.element('div', {
                                      children: [s.text(str.is(' » '))]
                                    }),
                                    s.element('div', {
                                      children: [s.text(str.is('strong'))]
                                    })
                                  ]
                                })
                              ]
