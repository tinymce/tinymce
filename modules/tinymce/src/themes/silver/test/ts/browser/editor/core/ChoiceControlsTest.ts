...
describe('browser.tinymce.themes.silver.editor.core.ChoiceControlsTest', () => {
  ...
  const defaultLanguages = [
    'English (US)', 'English (UK)', 'Spanish', 'Finnish', 'French', 'Danish', 'German',
    'Dutch', 'Italian', 'Norwegian', 'Portuguese (Brazil)', 'Swedish', 'Chinese'
  ];
  ...
  context('Line height: Default settings', () => {
  ...
  context('Content language: Default settings', () => {
    const hook = TinyHooks.bddSetup<Editor>(contentLanguageSettings, [ Theme ]);
  ...
  context('Content language: Advanced settings', () => {
    const hook = TinyHooks.bddSetup<Editor>(contentLanguageSettings, [ Theme ]);
