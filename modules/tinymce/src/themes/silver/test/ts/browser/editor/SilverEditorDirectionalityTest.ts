...
UnitTest.asynctest(
  'Editor (Silver) directionality test',
  (success, failure) => {
    Theme();
    ...
    const cGetEditorContainer = Chain.mapper((editor: Editor) =>
    ...
    const makeStep = (config, label, editorStructure) =>
      Chain.asStep({}, [
        ...
        NamedChain.asChain([
          ...
          NamedChain.direct(
            'editorContainer',
            Assertions.cAssertStructure(label, editorStructure),
            'assertion'
          ),
    ...
    Pipeline.async(
      ...
      [
        Log.step(
          'TBA',
          'Test directionality of the editor UI when set to use a rtl language',
          makeStep(
            {
              theme: 'silver',
              language: 'ar',
        ...
        Log.step(
          'TBA',
          'Test directionality of the editor UI when set to use a language without directionality',
          makeStep(
            {
              theme: 'silver',
              language: 'en',
