      ...
      Pipeline.async(
        ...
        browser.isIE()
          ...
          : [
              Log.stepsAsStep(
                'TBA',
                'TextColor: apply and remove forecolor and make sure of the right command has been executed',
                [
                  tinyApis.sFocus(),
                  ...
                  tinyUi.sClickOnToolbar(
                    'click forecolor',
                    '[aria-label="Text color"] > .tox-tbtn + .tox-split-button__chevron'
                  ),
                  tinyUi.sWaitForUi(
                    'wait for color swatch to open',
                    '.tox-swatches'
                  ),
                  tinyUi.sClickOnUi(
                    'click color',
                    'div[data-mce-color="#169179"]'
                  ),
              ...
              Log.stepsAsStep(
                'TBA',
                'TextColor: apply and remove backcolor and make sure of the right command has been executed',
                [
                  tinyApis.sFocus(),
                  tinyApis.sSetContent('hello test'),
                  tinyApis.sSetSelection([0, 0], 0, [0, 0], 5),
                  tinyUi.sClickOnToolbar(
                    'click backcolor',
                    '[aria-label="Background color"] > .tox-tbtn + .tox-split-button__chevron'
                  ),
                  tinyUi.sWaitForUi(
                    'wait for color swatch to open',
                    '.tox-swatches'
