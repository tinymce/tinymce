...
UnitTest.asynctest('Editor (Silver) test', (success, failure) => {
  ...
  const cCreateEditorWithMenubar = (menubar) =>
  ...
  Pipeline.async(
    ...
    [
      Log.chainsAsStep(
        'TBA',
        'Testing menubar: false should not create menubar at all',
        [
          NamedChain.asChain([
            ...
            NamedChain.direct(
              'body',
              UiFinder.cWaitForVisible('Waiting for container', '.tox-tinymce'),
              '_tiny'
            ),
            NamedChain.direct(
              'body',
              cCountNumber('.tox-menubar'),
              'numMenubars'
            ),
            NamedChain.direct(
              'numMenubars',
              Assertions.cAssertEq('Should be no menubars', 0),
              Id.generate('')
            ),
      ...
      Log.chainsAsStep(
        'TBA',
        'Testing menubar: true should create default menubar',
        [
          NamedChain.asChain([
            NamedChain.writeValue('body', Body.body()),
            ...
            NamedChain.direct(
              'body',
              cExtractOnlyOne('.tox-menubar'),
              'menubar'
            ),
            NamedChain.direct(
              'menubar',
              cAssertIsDefaultMenubar,
              Id.generate('')
            ),
            NamedChain.direct('editor', McagarEditor.cRemove, Id.generate('')),
            NamedChain.bundle(Result.value)
      ...
      Log.chainsAsStep(
        'TBA',
        'Testing menubar: undefined should create default menubar',
        [
          NamedChain.asChain([
            NamedChain.writeValue('body', Body.body()),
      ...
      Log.chainsAsStep(
        'TBA',
        'Testing menubar: "file edit" should create "file edit" menubar',
        [
          NamedChain.asChain([
            NamedChain.writeValue('body', Body.body()),
