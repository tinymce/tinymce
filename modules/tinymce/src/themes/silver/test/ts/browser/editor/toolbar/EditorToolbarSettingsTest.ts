...
UnitTest.asynctest('Editor (Silver) test', (success, failure) => {
  ...
  const cAssertIsDefaultToolbar = Assertions.cAssertStructure(
    ...
    ApproxStructure.build((s, str, arr) =>
      s.element('div', {
        ...
        children: Arr.map([1, 2, 3, 4, 5], (
          _ // Technically meant to be 6 groups by default but the link and image plugins aren't loaded here so whatever
  ...
  Pipeline.async(
    ...
    [
      ...
      Log.chainsAsStep(
        'TBA',
        'Testing toolbar: "bold italic | stufffffed | strikethrough underline" should create "bold italic | strikethrough underline" toolbar',
        [
          NamedChain.asChain([
            NamedChain.writeValue('body', Body.body()),
      ...
      Log.chainsAsStep(
        'TBA',
        'Testing toolbar: ["bold italic", "underline | strikethrough"] should create "bold italic" and "underline | strikethrough" toolbars',
        [
          NamedChain.asChain([
            NamedChain.writeValue('body', Body.body()),
      ...
      Log.chainsAsStep(
        'TBA',
        'Testing multiple toolbars: toolbar: "link", toolbar1: "bold italic underline" and toolbar2: "strikethrough" should create a "bold italic underline" toolbar and a "strikethrough" toolbar',
        [
          NamedChain.asChain([
            NamedChain.writeValue('body', Body.body()),
      ...
      Log.chainsAsStep(
        'TBA',
        'Testing multiple toolbars: toolbar1: "bold italic underline" and toolbar2: ["strikethrough"] should create "bold italic underline" toolbar and ignore toolbar2',
        [
          NamedChain.asChain([
            NamedChain.writeValue('body', Body.body()),
      ...
      Log.chainsAsStep(
        'TBA',
        'Testing multiple toolbars: toolbar: false and toolbar2: "bold italic" should create "bold italic" toolbar and ignore toolbar',
        [
          NamedChain.asChain([
            NamedChain.writeValue('body', Body.body()),
      ...
      Log.chainsAsStep(
        'TBA',
        'Testing multiple toolbars: toolbar: empty array and toolbar1: "bold italic" and toolbar2: "strikethrough" should create a "bold italic" toolbar and a "strikethrough" toolbar and ignore toolbar',
        [
          NamedChain.asChain([
            NamedChain.writeValue('body', Body.body()),
      ...
      Log.chainsAsStep(
        'TBA',
        'Testing multiple toolbars: toolbar1: false and toolbar2: "bold italic underline" should create "bold italic underline toolbar and ignore toolbar1',
        [
          NamedChain.asChain([
            NamedChain.writeValue('body', Body.body()),
      ...
      Log.chainsAsStep(
        'TBA',
        'Testing multiple toolbars: toolbar1: "bold italic | underline" and toolbar9: "strikethrough" should create a "bold italic | underline" toolbar and a "strikethrough" toolbar',
        [
          NamedChain.asChain([
            NamedChain.writeValue('body', Body.body()),
      ...
      Log.chainsAsStep(
        'TBA',
        'Testing toolbar with toolbar group names: toolbar: [ { name: "history", items: [ "undo", "redo" ] }, { name: "formatting", items: [ "bold", "italic" ] } ] should create a "undo redo | bold italic" toolbar',
        [
          NamedChain.asChain([
            NamedChain.writeValue('body', Body.body()),
            NamedChain.write(
