...
UnitTest.asynctest('Editor (Silver) test', (success, failure) => {
  ...
  TinyLoader.setup(
    (editor, onSuccess, onFailure) => {
      ...
      const sCheckItemsAtLocation = sCheckItemsAtLocationPlus(
        Step.pass,
        Step.pass,
        (text) => MenuUtils.sOpenMenu('', text)
      );
      const sCheckAlignItemsAtLocation = sCheckItemsAtLocationPlus(
        Step.pass,
        Step.pass,
        () => MenuUtils.sOpenAlignMenu('')
      );
      ...
      const sTestAlignment = Log.stepsAsStep(
        'TBA',
        'Checking alignment ticks and updating',
        [
      ...
      const sTestFontSelect = Log.stepsAsStep(
        'TBA',
        'Checking fontselect ticks and updating',
        [
          tinyApis.sSetContent('<p>First paragraph</p><p>Second paragraph</p>'),
          tinyApis.sSetCursor([0, 0], 'Fi'.length),
      ...
      const sTestFontSizeSelect = Log.stepsAsStep(
        'TBA',
        'Checking fontsize ticks and updating',
        [
          tinyApis.sSetContent('<p>First paragraph</p><p>Second paragraph</p>'),
          tinyApis.sSetCursor([0, 0], 'Fi'.length),
      ...
      const sTestFormatSelect = Log.stepsAsStep(
        'TBA',
        'Checking format ticks and updating',
        [
          tinyApis.sSetContent('<p>First paragraph</p><p>Second paragraph</p>'),
          tinyApis.sSetCursor([0, 0], 'Fi'.length),
          ...
          Mouse.sClickOn(
            Body.body(),
            '[role="menubar"] [role="menuitem"]:contains("Format")'
          ),
      ...
      const sTestStyleSelect = Log.stepsAsStep(
        'TBA',
        'Checking style ticks and updating',
        [
          tinyApis.sSetContent('<p>First paragraph</p><p>Second paragraph</p>'),
          tinyApis.sSetCursor([0, 0], 'Fi'.length),
      ...
      const sTestToolbarKeyboardNav = Log.stepsAsStep(
        'TBA',
        'Checking toolbar keyboard navigation',
        [
          tinyApis.sSetContent('<p>First paragraph</p><p>Second paragraph</p>'),
          tinyApis.sSetCursor([0, 0], 'Fi'.length),
          MenuUtils.sOpenAlignMenu('Align'),
