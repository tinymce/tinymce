...
UnitTest.asynctest('SilverContextMenuTest', (success, failure) => {
  ...
  TinyLoader.setup(
    (editor, onSuccess, onFailure) => {
      ...
      const sOpenContextMenu = (target) =>
        Chain.asStep(editor, [
          tinyUi.cTriggerContextMenu(
            ...
            target,
            '.tox-silver-sink .tox-collection [role="menuitem"]'
          ),
          Chain.wait(0)
        ]);
      ...
      const sAssertRemoveLinkHtmlStructure = Assertions.sAssertStructure(
        'Assert remove link',
      ...
      Pipeline.async(
        ...
        [
          ...
          Log.stepsAsStep('TBA', 'Test context menus on empty editor', [
            ...
            sAssertFocusOnItem(
              'Link',
              '.tox-collection__item:contains("Link...")'
            ),
            sPressEnterKey,
          ...
          Log.stepsAsStep('TBA', 'Test context menus on a link', [
            tinyApis.sSetContent(
              '<p><a href="http://tiny.cloud/">Tiny</a></p>'
            ),
            ...
            sAssertFocusOnItem(
              'Remove Link',
              '.tox-collection__item:contains("Remove link")'
            ),
            sPressDownArrowKey,
            sAssertFocusOnItem(
              'Open Link',
              '.tox-collection__item:contains("Open link")'
            ),
            sPressDownArrowKey,
            sAssertFocusOnItem(
              'Link',
          ...
          Log.stepsAsStep('TBA', 'Test context menus on image inside a table', [
            ...
            sAssertFocusOnItem(
              'Image',
              '.tox-collection__item:contains("Image")'
            ),
            sPressDownArrowKey,
            sAssertFocusOnItem(
              'Edit Image',
              '.tox-collection__item:contains("Edit image")'
            ),
            sPressDownArrowKey,
            sAssertFocusOnItem(
              'Cell',
