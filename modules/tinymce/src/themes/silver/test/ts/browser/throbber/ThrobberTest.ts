...
UnitTest.asynctest(
  'tinymce.themes.silver.test.browser.throbber.ThrobberTest',
  (success, failure) => {
    Theme();
    ...
    TinyLoader.setupLight(
      (editor, onSuccess, onFailure) => {
        const sSetProgressState = (state: boolean, time?: number) =>
          Step.sync(() => {
            if (state) {
