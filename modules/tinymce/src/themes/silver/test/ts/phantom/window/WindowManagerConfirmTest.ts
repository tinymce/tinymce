...
UnitTest.asynctest('WindowManager:confirm Test', (success, failure) => {
    ...
    GeneralSteps.sequence([
      ...
      Step.sync(() => {
        Assertions.assertStructure(
          'A basic confirm dialog should have these components',
  ...
  const sShouldFocusOnYesButton = GeneralSteps.sequence([
    ...
    FocusTools.sTryOnSelector(
      'When the confirm dialog loads, focus should be on the yes button',
  ...
  const sClickShouldFocusOnFirstButton = GeneralSteps.sequence([
    ...
    FocusTools.sTryOnSelector(
      'When the alert dialog loads, focus should be on the yes button',
      Element.fromDom(document),
      'button:contains(Yes)'
    ),
