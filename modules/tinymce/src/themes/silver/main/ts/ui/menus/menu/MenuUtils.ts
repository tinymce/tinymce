...
export const createHorizontalPartialMenuWithAlloyItems = (
  value: string,
  _hasIcons: boolean,
  items,
  _columns: Types.ColumnTypes,
  _presets: Types.PresetTypes
): PartialMenuSpec => {
...
export const createPartialMenuWithAlloyItems = (
  value: string,
  hasIcons: boolean,
  items,
