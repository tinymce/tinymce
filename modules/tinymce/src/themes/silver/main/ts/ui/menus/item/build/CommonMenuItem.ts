...
const renderCommonItem = <T>(
  spec: CommonMenuItemSpec<T>,
...
const renderCommonChoice = <T>(
  spec: CommonCollectionItemSpec,
  structure: ItemStructure,
  itemResponse: ItemResponse,
  providersbackstage: UiFactoryBackstageProviders
): AlloySpec =>
...
export { buildData, renderCommonItem, renderCommonChoice };
