...
const findStart = (dom: DOMUtils, initRange: Range, ch: string, minChars = 0): Option<AutocompleteContext> => {
...
const getContext = (dom: DOMUtils, initRange: Range, ch: string, minChars = 0): Option<AutocompleteContext> => AutocompleteTag.detect(Element.fromDom(initRange.startContainer)).fold(
