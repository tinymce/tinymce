...
- `mceLink` command can now take `true` value to always open link dialog #TINY-8057
- `Link` menu and toolbar buttons now always execute `mceLink` command #TINY-8057
