...
- Added a new `tablecellbordercolor` toolbar button and menu item to select table cell border colors with accompanying setting `table_cell_border_color_map` to customize available values #TINY-7480
- Added a new `tablecellbackgroundcolor` toolbar button and menu item to select table cell background colors with accompanying setting `table_cell_background_color_map` to customize available values #TINY-7480
- Added a new `initData` property to `fancymenuitem` to allow custom initialization data to be provided #TINY-7480
