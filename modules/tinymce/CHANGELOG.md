...
### Added
- New `expand` function added to `tinymce.selection` which expands the selection around a word. #TINY-9001
- New `expand` function added to `tinymce.dom.RangeUtils` to return an expanded range around a word. #TINY-9001
