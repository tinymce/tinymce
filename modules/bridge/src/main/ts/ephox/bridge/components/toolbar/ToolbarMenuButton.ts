...
export interface ToolbarMenuButtonInstanceApi
  extends BaseMenuButtonInstanceApi {}
...
export const isMenuButtonButton = (spec: any): spec is ToolbarMenuButton =>
  spec.type === 'menubutton';

export const createMenuButton = (
  spec: any
): Result<ToolbarMenuButton, ValueSchema.SchemaError<any>> =>
