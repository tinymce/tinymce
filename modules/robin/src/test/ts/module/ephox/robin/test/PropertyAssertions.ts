...
// DUPE with agar.
const getTrace = function (err: any): string { // TODO narrow type
...
const formatErr = function (label: string, err: any): string { // TODO narrow type
...
const check = function <T extends any[]> (label: string, arbitraries: T, f: Function): void { // TODO narrow types
