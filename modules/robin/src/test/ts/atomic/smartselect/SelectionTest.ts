  ...
  const doc1 = TestUniverse(
    Gene('root', 'root', [
      Gene('p1', 'p', [
        ...
        Gene('s1', 'span', [TextGene('h', 'sane')]),
        Gene('image', 'img', []),
        TextGene('i', 'again.')
      ]),
      Gene('p2', 'p', [TextGene('j', 'What now?')])
    ])
  );

  const doc2 = TestUniverse(
    Gene('root', 'root', [
      TextGene('a', 'This is '),
      Gene('b', 'span', [TextGene('c', 'som')]),
      TextGene('d', 'eth'),
      Gene('e', 'b', [TextGene('f', 'ing that you should')]),
      TextGene('g', ' see.'),
