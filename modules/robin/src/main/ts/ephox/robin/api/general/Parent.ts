...
import {
  breakPath as xBreakPath,
  breakToLeft as xBreakToLeft,
  breakToRight as xBreakToRight,
  BrokenPath,
  LeftRight
} from '../../parent/Breaker';
...
type AncestorsFn = <E, D>(
  universe: Universe<E, D>,
  start: E,
  finish: E,
  isRoot?: ((x: E) => boolean) | undefined
) => AncestorsFnResult<E>;
const ancestors: AncestorsFn = SubsetFn.ancestors;

type BreakToLeftFn = <E, D>(
  universe: Universe<E, D>,
  parent: E,
  child: E
) => Option<LeftRight<E>>;
