...
// with that language.
const filterZone = function <E> (zone: Zone<E>, onlyLang: string): Optional<Zone<E>> {
  return zone.lang === onlyLang ? Optional.some(zone) : Optional.none<Zone<E>>();
};

const fromBoundedWith = function <E, D> (universe: Universe<E, D>, left: E, right: E, envLang: string, onlyLang: string, transform: (universe: Universe<E, D>, item: E) => WordDecisionItem<E>): Optional<Zone<E>> {
...
const fromBounded = function <E, D> (universe: Universe<E, D>, left: E, right: E, envLang: string, onlyLang: string): Optional<Zone<E>> {
  return fromBoundedWith(universe, left, right, envLang, onlyLang, WordDecision.detail);
};

const fromRange = function <E, D> (universe: Universe<E, D>, start: E, finish: E, envLang: string, onlyLang: string): Optional<Zone<E>> {
...
const fromInline = function <E, D> (universe: Universe<E, D>, element: E, envLang: string, onlyLang: string): Optional<Zone<E>> {
  const isLanguageBoundary = LanguageZones.strictBounder(envLang, onlyLang);
...
const scour = function <E, D> (universe: Universe<E, D>, element: E, envLang: string, onlyLang: string): Optional<Zone<E>> {
...
const empty = function <E> (): Optional<Zone<E>> {
