...
const findIn = (
  ...
  selector: string
): Result<Element<any>, TestLabel> => UiSearcher.findIn(container, selector);
...
const cHasState = <T>(
  predicate: (element: Element<T>) => boolean
