      ...
      StepSequence.sequenceSame([
        Logger.t(
          ...
          StepSequence.sequenceSame([
            ...
            Step.sync(() => {
              const dataTransfer = pasteState
                .get()
                .getOrDie('Could not get dataTransfer from state');

              Assert.eq(
                'Should be expected plain text',
                'Hello world!',
          ...
          StepSequence.sequenceSame([
            ...
            Step.sync(() => {
              ...
              Assert.eq(
                'Should be expected mime type',
                'text/html',
                dataTransfer.items[1].type
              );
              Assert.eq(
                'Should be expected mime type',
                'text/html',
                dataTransfer.files[1].type
              );
            })
          ])
        ),
        ...
        Logger.t(
          'Paste using dataTransfer mutator',
          StepSequence.sequenceSame([
