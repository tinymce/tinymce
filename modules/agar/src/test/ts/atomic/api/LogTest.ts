...
UnitTest.asynctest('LogTest', (success, failure) => {
  ...
  const logStepsAsStepInArrayTest = StepAssertions.testStepsFail('TestCase-06: Step failure', [
    Log.stepsAsStep('06', 'Step failure', [Assertions.sAssertEq('Assert failure', true, false)])
  ]);
  ...
  const logChainsAsChainTest = StepAssertions.testChainFail(
    ...
    true,
    Log.chainsAsChain('11', 'Chain failure', [Assertions.cAssertEq('Assert failure', true), Assertions.cAssertEq('Assert failure', false)])
  );

  const logChainsAsChainInArrayTest = StepAssertions.testChainsFail('TestCase-12: Chain failure (1)', true, [
    Log.chainsAsChain('12', 'Chain failure', [Assertions.cAssertEq('Assert failure', true), Assertions.cAssertEq('Assert failure', false)])
  ]);
