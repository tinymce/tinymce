	...
	return function(editor) {
		...
		function registerEventHandlers() {
			...
			function insertClipboardContent(clipboardContent, isKeyBoardPaste, plainTextMode) {
				...
				if (hasContentType(clipboardContent, 'public.html')) {
					content = clipboardContent['public.html'];
				} else if (hasContentType(clipboardContent, 'text/html')) {
...
define("tinymce/pasteplugin/Plugin", [
	...
	PluginManager.add('mobile_paste', function(editor) {
