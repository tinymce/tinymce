...
(function(tinymce) {
	...
	tinymce.create('tinymce.ui.Button:tinymce.ui.Control', {
		...
		renderHTML : function() {
			...
			h = '<a role="button" tabindex="-1" id="' + this.id + '" href="javascript:;" class="' + cp + ' ' + cp + 'Enabled ' + s['class'] + (l ? ' ' + cp + 'Labeled' : '') +'" onmousedown="return false;" onclick="return false;" aria-label="' + DOM.encode(s.title) + '" title="' + DOM.encode(s.title) + '">';
