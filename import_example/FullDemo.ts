...
import * as InlineCssApiRunner from './InlineCssApiRunner';
...
export default (): void => {
  ...
  const settings: RawEditorOptions = {
    ...
    plugins: [
      ...
      'save', 'table', 'directionality', 'emoticons', 'template', 'importcss', 'codesample', 'help', 'inlinecss'
    ],
    // rtl_ui: true,
    ...
    content_style: `
      ...
      @import url("custom_1.css") all and (max-width: 900px);
    `,
